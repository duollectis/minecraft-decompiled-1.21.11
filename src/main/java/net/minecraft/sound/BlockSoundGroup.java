...
/**
 * Группа звуков блока, объединяющая все пять типов звуковых событий
 * (разрушение, шаг, установка, удар, падение) вместе с громкостью и высотой тона.
 *
 * <p>Экземпляры этого класса являются иммутабельными и создаются один раз
 * как статические константы. Каждый тип блока в игре ссылается на одну
 * из предопределённых групп.
 */
public class BlockSoundGroup {
	...
	public static final BlockSoundGroup COPPER_GOLEM_STATUE = new BlockSoundGroup(
		1.0F, 1.0F,
		SoundEvents.BLOCK_COPPER_GOLEM_STATUE_BREAK,
		SoundEvents.BLOCK_COPPER_GOLEM_STATUE_STEP,
		SoundEvents.BLOCK_COPPER_GOLEM_STATUE_PLACE,
		SoundEvents.BLOCK_COPPER_GOLEM_STATUE_HIT,
		SoundEvents.BLOCK_COPPER_GOLEM_STATUE_FALL
	);
	...
	public static final BlockSoundGroup SHELF = new BlockSoundGroup(
		1.0F, 1.0F,
		SoundEvents.BLOCK_SHELF_BREAK,
		SoundEvents.BLOCK_SHELF_STEP,
		SoundEvents.BLOCK_SHELF_PLACE,
		SoundEvents.BLOCK_SHELF_HIT,
		SoundEvents.BLOCK_SHELF_FALL
	);
	...
	public static final BlockSoundGroup IRON = new BlockSoundGroup(
		1.0F, 1.0F,
		SoundEvents.BLOCK_IRON_BREAK,
		SoundEvents.BLOCK_IRON_STEP,
		SoundEvents.BLOCK_IRON_PLACE,
		SoundEvents.BLOCK_IRON_HIT,
		SoundEvents.BLOCK_IRON_FALL
	);
	public static final BlockSoundGroup DRIED_GHAST = new BlockSoundGroup(
		1.0F, 1.0F,
		SoundEvents.BLOCK_DRIED_GHAST_BREAK,
		SoundEvents.BLOCK_DRIED_GHAST_STEP,
		SoundEvents.INTENTIONALLY_EMPTY,
		SoundEvents.INTENTIONALLY_EMPTY,
		SoundEvents.BLOCK_DRIED_GHAST_FALL
	);
