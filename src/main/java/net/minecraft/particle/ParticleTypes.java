...
public class ParticleTypes {
	...
	public static final ParticleType<DragonBreathParticleEffect> DRAGON_BREATH = register(
			"dragon_breath",
			false,
			DragonBreathParticleEffect::createCodec,
			DragonBreathParticleEffect::createPacketCodec
	);
	...
	public static final ParticleType<EffectParticleEffect> EFFECT = register(
			"effect", false, EffectParticleEffect::createCodec, EffectParticleEffect::createPacketCodec
	);
	...
	public static final ParticleType<TintedParticleEffect> ENTITY_EFFECT = register(
			"entity_effect", false, TintedParticleEffect::createCodec, TintedParticleEffect::createPacketCodec
	);
	...
	public static final ParticleType<TintedParticleEffect> TINTED_LEAVES = register(
			"tinted_leaves", false, TintedParticleEffect::createCodec, TintedParticleEffect::createPacketCodec
	);
	...
	public static final ParticleType<SculkChargeParticleEffect> SCULK_CHARGE = register(
			"sculk_charge",
			true,
			type -> SculkChargeParticleEffect.CODEC,
			type -> SculkChargeParticleEffect.PACKET_CODEC
	);
	...
	public static final ParticleType<TintedParticleEffect> FLASH = register(
			"flash", false, TintedParticleEffect::createCodec, TintedParticleEffect::createPacketCodec
	);
	...
	public static final ParticleType<EffectParticleEffect> INSTANT_EFFECT = register(
			"instant_effect", false, EffectParticleEffect::createCodec, EffectParticleEffect::createPacketCodec
	);
	...
	private static <T extends ParticleEffect> ParticleType<T> register(
		...
		return Registry.register(
				Registries.PARTICLE_TYPE, name, new ParticleType<T>(alwaysShow) {
					@Override
