...
/**
 * {@code DustColorTransitionParticleEffect}.
 */
public class DustColorTransitionParticleEffect extends AbstractDustParticleEffect {
	...
	public static final DustColorTransitionParticleEffect
			DEFAULT =
			new DustColorTransitionParticleEffect(3790560, 16711680, 1.0F);
	...
	public static final PacketCodec<RegistryByteBuf, DustColorTransitionParticleEffect>
			PACKET_CODEC =
			PacketCodec.tuple(
