...
public interface StructurePieceType {
   ...
   StructurePieceType NETHER_FORTRESS_BRIDGE_CROSSING = register((Simple) NetherFortressGenerator.BridgeCrossing::new, "NeBCr");
   ...
   StructurePieceType NETHER_FORTRESS_CORRIDOR_STAIRS = register((Simple) NetherFortressGenerator.CorridorStairs::new, "NeCCS");
   StructurePieceType NETHER_FORTRESS_CORRIDOR_BALCONY = register((Simple) NetherFortressGenerator.CorridorBalcony::new, "NeCTB");
   StructurePieceType NETHER_FORTRESS_CORRIDOR_EXIT = register((Simple) NetherFortressGenerator.CorridorExit::new, "NeCE");
   StructurePieceType NETHER_FORTRESS_CORRIDOR_CROSSING = register((Simple) NetherFortressGenerator.CorridorCrossing::new, "NeSCSC");
   StructurePieceType NETHER_FORTRESS_CORRIDOR_LEFT_TURN = register((Simple) NetherFortressGenerator.CorridorLeftTurn::new, "NeSCLT");
   StructurePieceType NETHER_FORTRESS_SMALL_CORRIDOR = register((Simple) NetherFortressGenerator.SmallCorridor::new, "NeSC");
   StructurePieceType NETHER_FORTRESS_CORRIDOR_RIGHT_TURN = register((Simple) NetherFortressGenerator.CorridorRightTurn::new, "NeSCRT");
   StructurePieceType NETHER_FORTRESS_CORRIDOR_NETHER_WARTS_ROOM = register((Simple) NetherFortressGenerator.CorridorNetherWartsRoom::new, "NeCSR");
   StructurePieceType NETHER_FORTRESS_BRIDGE_PLATFORM = register((Simple) NetherFortressGenerator.BridgePlatform::new, "NeMT");
   StructurePieceType NETHER_FORTRESS_BRIDGE_SMALL_CROSSING = register((Simple) NetherFortressGenerator.BridgeSmallCrossing::new, "NeRC");
   StructurePieceType NETHER_FORTRESS_BRIDGE_STAIRS = register((Simple) NetherFortressGenerator.BridgeStairs::new, "NeSR");
   ...
   StructurePieceType STRONGHOLD_FIVE_WAY_CROSSING = register((Simple) StrongholdGenerator.FiveWayCrossing::new, "SH5C");
   ...
   StructurePieceType STRONGHOLD_SPIRAL_STAIRCASE = register((Simple) StrongholdGenerator.SpiralStaircase::new, "SHSD");
   ...
   StructurePieceType OCEAN_MONUMENT_DOUBLE_X_ROOM = register((Simple) OceanMonumentGenerator.DoubleXRoom::new, "OMDXR");
   StructurePieceType OCEAN_MONUMENT_DOUBLE_X_Y_ROOM = register((Simple) OceanMonumentGenerator.DoubleXYRoom::new, "OMDXYR");
   StructurePieceType OCEAN_MONUMENT_DOUBLE_Y_ROOM = register((Simple) OceanMonumentGenerator.DoubleYRoom::new, "OMDYR");
   StructurePieceType OCEAN_MONUMENT_DOUBLE_Y_Z_ROOM = register((Simple) OceanMonumentGenerator.DoubleYZRoom::new, "OMDYZR");
   StructurePieceType OCEAN_MONUMENT_DOUBLE_Z_ROOM = register((Simple) OceanMonumentGenerator.DoubleZRoom::new, "OMDZR");
   StructurePieceType OCEAN_MONUMENT_ENTRY_ROOM = register((Simple) OceanMonumentGenerator.Entry::new, "OMEntry");
   StructurePieceType OCEAN_MONUMENT_PENTHOUSE = register((Simple) OceanMonumentGenerator.Penthouse::new, "OMPenthouse");
   StructurePieceType OCEAN_MONUMENT_SIMPLE_ROOM = register((Simple) OceanMonumentGenerator.SimpleRoom::new, "OMSimple");
   StructurePieceType OCEAN_MONUMENT_SIMPLE_TOP_ROOM = register((Simple) OceanMonumentGenerator.SimpleRoomTop::new, "OMSimpleT");
