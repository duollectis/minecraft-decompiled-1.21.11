...
public abstract class StructurePiece {
	...
	protected boolean isUnderSeaLevel(WorldView world, int x, int z, int y, BlockBox box) {
		...
		return !box.contains(blockPos) ? false : blockPos.getY() < world.getTopY(
	...
	protected boolean canReplace(BlockState state) {
		return state.isAir() || state.isLiquid() || state.isOf(Blocks.GLOW_LICHEN) || state.isOf(Blocks.SEAGRASS)
