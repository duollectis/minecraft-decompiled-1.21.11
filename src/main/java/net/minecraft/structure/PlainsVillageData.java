...
/**
 * {@code PlainsVillageData}.
 */
public class PlainsVillageData {

	public static final RegistryKey<StructurePool>
			TOWN_CENTERS_KEY =
			StructurePools.ofVanilla("village/plains/town_centers");
	private static final RegistryKey<StructurePool>
			TERMINATORS_KEY =
			StructurePools.ofVanilla("village/plains/terminators");
	...
	public static void bootstrap(Registerable<StructurePool> poolRegisterable) {
		...
		RegistryEntry<PlacedFeature>
				registryEntry2 =
				registryEntryLookup.getOrThrow(VillagePlacedFeatures.FLOWER_PLAIN);
		...
		RegistryEntry<StructureProcessorList>
				registryEntry4 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.MOSSIFY_10_PERCENT);
		RegistryEntry<StructureProcessorList>
				registryEntry5 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.MOSSIFY_20_PERCENT);
		RegistryEntry<StructureProcessorList>
				registryEntry6 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.MOSSIFY_70_PERCENT);
		RegistryEntry<StructureProcessorList>
				registryEntry7 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.ZOMBIE_PLAINS);
		RegistryEntry<StructureProcessorList>
				registryEntry8 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.STREET_PLAINS);
		RegistryEntry<StructureProcessorList>
				registryEntry9 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.FARM_PLAINS);
						...
						ImmutableList.of(
								...
								Pair.of(
										StructurePoolElement.ofLegacySingle(
												"village/plains/town_centers/plains_meeting_point_2"), 50
								),
								Pair.of(
										StructurePoolElement.ofProcessedLegacySingle(
				...
				new StructurePool(
						...
						ImmutableList.of(
								...
								new Pair[]{
										...
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/plains/houses/plains_shepherds_house_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofProcessedLegacySingle(
										...
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/plains/houses/plains_stable_2"), 2
										),
										Pair.of(
												StructurePoolElement.ofProcessedLegacySingle(
										...
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/plains/houses/plains_animal_pen_1"), 1
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/plains/houses/plains_animal_pen_2"), 1
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/plains/houses/plains_animal_pen_3"), 5
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/plains/houses/plains_accessory_1"), 1
										),
										Pair.of(
												StructurePoolElement.ofProcessedLegacySingle(
										...
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/plains/houses/plains_meeting_point_5"), 1
										),
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						ImmutableList.of(
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/plains/zombie/villagers/nitwit"),
										1
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/plains/zombie/villagers/unemployed"),
										10
								)
						),
						StructurePool.Projection.RIGID
