...
/**
 * {@code PillagerOutpostGenerator}.
 */
public class PillagerOutpostGenerator {

	public static final RegistryKey<StructurePool>
			STRUCTURE_POOLS =
			StructurePools.ofVanilla("pillager_outpost/base_plates");
	...
	public static void bootstrap(Registerable<StructurePool> poolRegisterable) {
		...
		RegistryEntry<StructureProcessorList>
				registryEntry =
				registryEntryLookup.getOrThrow(StructureProcessorLists.OUTPOST_ROT);
		...
		poolRegisterable.register(
				...
				new StructurePool(
						...
						ImmutableList.of(Pair.of(
								StructurePoolElement.ofLegacySingle("pillager_outpost/base_plate"),
								1
						)),
		...
		StructurePools.register(
				...
				new StructurePool(
						registryEntry2,
						ImmutableList.of(Pair.of(
								StructurePoolElement.ofLegacySingle("pillager_outpost/feature_plate"),
								1
						)),
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						ImmutableList.of(
								...
								Pair.of(
										StructurePoolElement.ofLegacySingle("pillager_outpost/feature_cage_with_allays"),
										1
								),
