...
public class StrongholdGenerator {
   ...
   abstract static class Piece extends StructurePiece {
      ...
      public Piece(StructurePieceType structurePieceType, NbtCompound nbtCompound) {
         ...
         this.entryDoor = nbtCompound.<StrongholdGenerator.Piece.EntranceType>get("EntryDoor", StrongholdGenerator.Piece.EntranceType.CODEC).orElseThrow();
      }
   ...
   public static class PortalRoom extends StrongholdGenerator.Piece {
      ...
      public static StrongholdGenerator.@Nullable PortalRoom create(StructurePiecesHolder holder, int x, int y, int z, Direction orientation, int chainLength) {
