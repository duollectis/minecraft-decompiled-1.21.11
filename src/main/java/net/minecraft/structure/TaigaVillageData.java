...
/**
 * {@code TaigaVillageData}.
 */
public class TaigaVillageData {

	public static final RegistryKey<StructurePool>
			TOWN_CENTERS_KEY =
			StructurePools.ofVanilla("village/taiga/town_centers");
	private static final RegistryKey<StructurePool>
			TERMINATORS_KEY =
			StructurePools.ofVanilla("village/taiga/terminators");
	...
	public static void bootstrap(Registerable<StructurePool> poolRegisterable) {
		...
		RegistryEntry<PlacedFeature>
				registryEntry3 =
				registryEntryLookup.getOrThrow(VillagePlacedFeatures.PILE_PUMPKIN);
		RegistryEntry<PlacedFeature>
				registryEntry4 =
				registryEntryLookup.getOrThrow(VillagePlacedFeatures.PATCH_TAIGA_GRASS);
		RegistryEntry<PlacedFeature>
				registryEntry5 =
				registryEntryLookup.getOrThrow(VillagePlacedFeatures.PATCH_BERRY_BUSH);
		...
		RegistryEntry<StructureProcessorList>
				registryEntry7 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.ZOMBIE_TAIGA);
		RegistryEntry<StructureProcessorList>
				registryEntry8 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.STREET_SNOWY_OR_TAIGA);
		RegistryEntry<StructureProcessorList>
				registryEntry9 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.FARM_TAIGA);
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						ImmutableList.of(
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/taiga/zombie/villagers/nitwit"),
										1
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/taiga/zombie/villagers/unemployed"),
										10
								)
						),
						StructurePool.Projection.RIGID
