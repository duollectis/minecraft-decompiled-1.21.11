...
/**
 * {@code DesertVillageData}.
 */
public class DesertVillageData {

	public static final RegistryKey<StructurePool>
			TOWN_CENTERS_KEY =
			StructurePools.ofVanilla("village/desert/town_centers");
	private static final RegistryKey<StructurePool>
			TERMINATORS_KEY =
			StructurePools.ofVanilla("village/desert/terminators");
	private static final RegistryKey<StructurePool>
			ZOMBIE_TERMINATORS_KEY =
			StructurePools.ofVanilla("village/desert/zombie/terminators");

	public static void bootstrap(Registerable<StructurePool> poolRegisterable) {
		RegistryEntryLookup<PlacedFeature>
				registryEntryLookup =
				poolRegisterable.getRegistryLookup(RegistryKeys.PLACED_FEATURE);
		...
		RegistryEntry<StructureProcessorList>
				registryEntry3 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.ZOMBIE_DESERT);
		RegistryEntry<StructureProcessorList>
				registryEntry4 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.FARM_DESERT);
		...
		poolRegisterable.register(
				...
				new StructurePool(
						...
						ImmutableList.of(
								Pair.of(
										StructurePoolElement.ofLegacySingle(
												"village/desert/town_centers/desert_meeting_point_1"), 98
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle(
												"village/desert/town_centers/desert_meeting_point_2"), 98
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle(
												"village/desert/town_centers/desert_meeting_point_3"), 49
								),
								Pair.of(
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						ImmutableList.of(
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/zombie/streets/corner_01"),
										3
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/zombie/streets/corner_02"),
										3
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/zombie/streets/straight_01"),
										4
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/zombie/streets/straight_02"),
										4
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/zombie/streets/straight_03"),
										3
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/zombie/streets/crossroad_01"),
										3
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/zombie/streets/crossroad_02"),
										3
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/zombie/streets/crossroad_03"),
										3
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/zombie/streets/square_01"),
										3
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/zombie/streets/square_02"),
										3
								),
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						ImmutableList.of(
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/houses/desert_small_house_1"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/houses/desert_small_house_2"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/houses/desert_small_house_3"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/houses/desert_small_house_4"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/houses/desert_small_house_5"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/houses/desert_small_house_6"),
										1
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/houses/desert_small_house_7"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/houses/desert_small_house_8"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle(
												"village/desert/houses/desert_medium_house_1"), 2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle(
												"village/desert/houses/desert_medium_house_2"), 2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle(
												"village/desert/houses/desert_butcher_shop_1"), 2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/houses/desert_tool_smith_1"),
										2
								),
								new Pair[]{
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/desert/houses/desert_fletcher_house_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/desert/houses/desert_shepherd_house_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/desert/houses/desert_armorer_1"), 1
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/desert/houses/desert_fisher_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/desert/houses/desert_tannery_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/desert/houses/desert_cartographer_house_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/desert/houses/desert_library_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/desert/houses/desert_mason_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/desert/houses/desert_weaponsmith_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/desert/houses/desert_temple_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/desert/houses/desert_temple_2"), 2
										),
										Pair.of(
												StructurePoolElement.ofProcessedLegacySingle(
										...
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/desert/houses/desert_animal_pen_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/desert/houses/desert_animal_pen_2"), 2
										),
		...
		poolRegisterable.register(
				...
				new StructurePool(
						...
						ImmutableList.of(
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/terminators/terminator_01"),
										1
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/terminators/terminator_02"),
										1
								)
						),
						StructurePool.Projection.TERRAIN_MATCHING
		...
		poolRegisterable.register(
				...
				new StructurePool(
						...
						ImmutableList.of(
								...
								Pair.of(
										StructurePoolElement.ofLegacySingle(
												"village/desert/zombie/terminators/terminator_02"), 1
								)
						),
						StructurePool.Projection.TERRAIN_MATCHING
				)
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						ImmutableList.of(
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/zombie/villagers/nitwit"),
										1
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/desert/zombie/villagers/unemployed"),
										10
								)
						),
						StructurePool.Projection.RIGID
