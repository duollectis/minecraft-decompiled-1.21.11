...
/**
 * {@code SnowyVillageData}.
 */
public class SnowyVillageData {

	public static final RegistryKey<StructurePool>
			TOWN_CENTERS_KEY =
			StructurePools.ofVanilla("village/snowy/town_centers");
	private static final RegistryKey<StructurePool>
			TERMINATORS_KEY =
			StructurePools.ofVanilla("village/snowy/terminators");
	...
	public static void bootstrap(Registerable<StructurePool> poolRegisterable) {
		...
		RegistryEntry<StructureProcessorList>
				registryEntry4 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.STREET_SNOWY_OR_TAIGA);
		RegistryEntry<StructureProcessorList>
				registryEntry5 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.FARM_SNOWY);
		RegistryEntry<StructureProcessorList>
				registryEntry6 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.ZOMBIE_SNOWY);
						...
						ImmutableList.of(
								Pair.of(
										StructurePoolElement.ofLegacySingle(
												"village/snowy/town_centers/snowy_meeting_point_1"), 100
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle(
												"village/snowy/town_centers/snowy_meeting_point_2"), 50
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle(
												"village/snowy/town_centers/snowy_meeting_point_3"), 150
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle(
												"village/snowy/zombie/town_centers/snowy_meeting_point_1"), 2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle(
												"village/snowy/zombie/town_centers/snowy_meeting_point_2"), 1
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle(
												"village/snowy/zombie/town_centers/snowy_meeting_point_3"), 3
								)
						),
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						ImmutableList.of(
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/snowy/houses/snowy_small_house_1"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/snowy/houses/snowy_small_house_2"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/snowy/houses/snowy_small_house_3"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/snowy/houses/snowy_small_house_4"),
										3
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/snowy/houses/snowy_small_house_5"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/snowy/houses/snowy_small_house_6"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/snowy/houses/snowy_small_house_7"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/snowy/houses/snowy_small_house_8"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/snowy/houses/snowy_medium_house_1"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/snowy/houses/snowy_medium_house_2"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/snowy/houses/snowy_medium_house_3"),
										2
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/snowy/houses/snowy_butchers_shop_1"),
										2
								),
								new Pair[]{
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_butchers_shop_2"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_tool_smith_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_fletcher_house_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_shepherds_house_1"), 3
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_armorer_house_1"), 1
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_armorer_house_2"), 1
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_fisher_cottage"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_tannery_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_cartographer_house_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_library_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_masons_house_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_masons_house_2"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_weapon_smith_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_temple_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofProcessedLegacySingle(
										...
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_animal_pen_1"), 2
										),
										Pair.of(
												StructurePoolElement.ofLegacySingle(
														"village/snowy/houses/snowy_animal_pen_2"), 2
										),
		...
		StructurePools.register(
				...
				new StructurePool(
						registryEntry7,
						ImmutableList.of(Pair.of(StructurePoolElement.ofFeature(registryEntry), 1)),
						StructurePool.Projection.RIGID
				)
		);
		StructurePools.register(
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						ImmutableList.of(
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/snowy/zombie/villagers/nitwit"),
										1
								),
								Pair.of(
										StructurePoolElement.ofLegacySingle("village/snowy/zombie/villagers/unemployed"),
										10
								)
						),
						StructurePool.Projection.RIGID
