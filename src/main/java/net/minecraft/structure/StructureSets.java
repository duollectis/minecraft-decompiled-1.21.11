...
public interface StructureSets {
	...
	static void bootstrap(Registerable<StructureSet> structureSetRegisterable) {
		RegistryEntryLookup<Structure>
				registryEntryLookup =
				structureSetRegisterable.getRegistryLookup(RegistryKeys.STRUCTURE);
		RegistryEntryLookup<Biome>
				registryEntryLookup2 =
				structureSetRegisterable.getRegistryLookup(RegistryKeys.BIOME);
		...
		structureSetRegisterable.register(
				...
				new StructureSet(
						registryEntryLookup.getOrThrow(StructureKeys.DESERT_PYRAMID),
						new RandomSpreadStructurePlacement(32, 8, SpreadType.LINEAR, 14357617)
				)
		);
		structureSetRegisterable.register(
				StructureSetKeys.IGLOOS,
				new StructureSet(
						registryEntryLookup.getOrThrow(StructureKeys.IGLOO),
						new RandomSpreadStructurePlacement(32, 8, SpreadType.LINEAR, 14357618)
				)
		);
		structureSetRegisterable.register(
				StructureSetKeys.JUNGLE_TEMPLES,
				new StructureSet(
						registryEntryLookup.getOrThrow(StructureKeys.JUNGLE_PYRAMID),
						new RandomSpreadStructurePlacement(32, 8, SpreadType.LINEAR, 14357619)
				)
		);
		structureSetRegisterable.register(
				StructureSetKeys.SWAMP_HUTS,
				new StructureSet(
						registryEntryLookup.getOrThrow(StructureKeys.SWAMP_HUT),
		...
		structureSetRegisterable.register(
				...
				new StructureSet(
						registryEntryLookup.getOrThrow(StructureKeys.ANCIENT_CITY),
		...
		structureSetRegisterable.register(
				...
				new StructureSet(
						registryEntryLookup.getOrThrow(StructureKeys.MONUMENT),
						new RandomSpreadStructurePlacement(32, 5, SpreadType.TRIANGULAR, 10387313)
				)
		);
		structureSetRegisterable.register(
				StructureSetKeys.WOODLAND_MANSIONS,
				new StructureSet(
						registryEntryLookup.getOrThrow(StructureKeys.MANSION),
		...
		structureSetRegisterable.register(
				...
				new StructureSet(
						...
						new RandomSpreadStructurePlacement(
								new Vec3i(9, 0, 9),
								StructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_2,
								0.01F,
								0,
								Optional.empty(),
								1,
				...
				new StructureSet(
						List.of(
								...
								StructureSet.createEntry(
										registryEntryLookup.getOrThrow(StructureKeys.BASTION_REMNANT),
										3
								)
						),
		...
		structureSetRegisterable.register(
				...
				new StructureSet(
						registryEntryLookup.getOrThrow(StructureKeys.NETHER_FOSSIL),
						new RandomSpreadStructurePlacement(2, 1, SpreadType.LINEAR, 14357921)
				)
		);
		structureSetRegisterable.register(
				StructureSetKeys.END_CITIES,
				new StructureSet(
						registryEntryLookup.getOrThrow(StructureKeys.END_CITY),
		...
		structureSetRegisterable.register(
				...
				new StructureSet(
						...
						new ConcentricRingsStructurePlacement(
								...
								3,
								128,
								registryEntryLookup2.getOrThrow(BiomeTags.STRONGHOLD_BIASED_TO)
						)
				)
		);
		structureSetRegisterable.register(
				...
				new StructureSet(
						registryEntryLookup.getOrThrow(StructureKeys.TRAIL_RUINS),
						new RandomSpreadStructurePlacement(34, 8, SpreadType.LINEAR, 83469867)
				)
		);
		structureSetRegisterable.register(
				StructureSetKeys.TRIAL_CHAMBERS,
				new StructureSet(
						registryEntryLookup.getOrThrow(StructureKeys.TRIAL_CHAMBERS),
						new RandomSpreadStructurePlacement(34, 12, SpreadType.LINEAR, 94251327)
				)
		);
	}
}
