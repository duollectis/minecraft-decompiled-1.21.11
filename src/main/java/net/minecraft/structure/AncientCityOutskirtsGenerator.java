...
/**
 * {@code AncientCityOutskirtsGenerator}.
 */
public class AncientCityOutskirtsGenerator {
	...
	public static void bootstrap(Registerable<StructurePool> poolRegisterable) {
		...
		RegistryEntry<PlacedFeature>
				registryEntry =
				registryEntryLookup.getOrThrow(UndergroundPlacedFeatures.SCULK_PATCH_ANCIENT_CITY);
		...
		RegistryEntry<StructureProcessorList>
				registryEntry2 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.ANCIENT_CITY_GENERIC_DEGRADATION);
		RegistryEntry<StructureProcessorList>
				registryEntry3 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.ANCIENT_CITY_WALLS_DEGRADATION);
				...
				new StructurePool(
						...
						ImmutableList.of(
								...
								new Pair[]{
										...
										Pair.of(
												StructurePoolElement.ofList(ImmutableList.of(StructurePoolElement.ofSingle(
		...
		StructurePools.register(
				...
				new StructurePool(
						registryEntry4,
						ImmutableList.of(
								Pair.of(StructurePoolElement.ofFeature(registryEntry), 6),
