...
/**
 * {@code JungleTempleGenerator}.
 */
public class JungleTempleGenerator extends ShiftableStructurePiece {

	public static final int TEMPLE_SIZE = 12;
	public static final int DEPTH = 15;
	private boolean placedMainChest;
	private boolean placedHiddenChest;
	private boolean placedTrap1;
	private boolean placedTrap2;
	private static final JungleTempleGenerator.CobblestoneRandomizer
	...
	public void generate(
		...
		if (this.adjustToAverageHeight(world, chunkBox, 0)) {
			...
			BlockState
					blockState =
					Blocks.COBBLESTONE_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.EAST);
			BlockState
					blockState2 =
					Blocks.COBBLESTONE_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.WEST);
			BlockState
					blockState3 =
					Blocks.COBBLESTONE_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.SOUTH);
			BlockState
					blockState4 =
					Blocks.COBBLESTONE_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.NORTH);
			...
			this.addBlock(
					...
					Blocks.TRIPWIRE_HOOK
							.getDefaultState()
							.with(TripwireHookBlock.FACING, Direction.EAST)
							.with(TripwireHookBlock.ATTACHED, true),
					1,
					-3,
					8,
					chunkBox
			...
			this.addBlock(
					...
					Blocks.TRIPWIRE_HOOK
							.getDefaultState()
							.with(TripwireHookBlock.FACING, Direction.WEST)
							.with(TripwireHookBlock.ATTACHED, true),
					4,
					-3,
					8,
			...
			this.addBlock(
					...
					Blocks.TRIPWIRE
							.getDefaultState()
							.with(TripwireBlock.EAST, true)
							.with(TripwireBlock.WEST, true)
							.with(TripwireBlock.ATTACHED, true),
					2,
					-3,
					8,
					chunkBox
			...
			this.addBlock(
					...
					Blocks.TRIPWIRE_HOOK
							.getDefaultState()
							.with(TripwireHookBlock.FACING, Direction.NORTH)
							.with(TripwireHookBlock.ATTACHED, true),
					7,
					-3,
					1,
			...
			this.addBlock(
					...
					Blocks.TRIPWIRE_HOOK
							.getDefaultState()
							.with(TripwireHookBlock.FACING, Direction.SOUTH)
							.with(TripwireHookBlock.ATTACHED, true),
					7,
					-3,
					5,
			...
			this.addBlock(
					...
					Blocks.TRIPWIRE
							.getDefaultState()
							.with(TripwireBlock.NORTH, true)
							.with(TripwireBlock.SOUTH, true)
							.with(TripwireBlock.ATTACHED, true),
					7,
					-3,
					2,
			...
			this.addBlock(
					world,
					Blocks.STICKY_PISTON.getDefaultState().with(PistonBlock.FACING, Direction.UP),
					9,
					-2,
					8,
					chunkBox
			...
			this.addBlock(
					world,
					Blocks.STICKY_PISTON.getDefaultState().with(PistonBlock.FACING, Direction.WEST),
					10,
					-2,
					8,
					chunkBox
			...
			if (!this.placedHiddenChest) {
				this.placedHiddenChest =
						this.addChest(world, chunkBox, random, 9, -3, 10, LootTables.JUNGLE_TEMPLE_CHEST);
			}
		}
	}

	/**
	 * {@code CobblestoneRandomizer}.
	 */
