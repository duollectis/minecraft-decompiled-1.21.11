...
public class MineshaftGenerator {
   ...
   private static MineshaftGenerator.@Nullable MineshaftPart pickPiece(
      StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength, MineshaftStructure.Type type
   ) {
         ...
         if (i < 8) {
            if (direction != Direction.NORTH && direction != Direction.SOUTH) {
               ...
               for (int kx = this.boundingBox.getMinZ() + 3; kx + 3 <= this.boundingBox.getMaxZ(); kx += 5) {
                  ...
                  if (l == 0) {
                     MineshaftGenerator.pieceGenerator(
                        start, holder, random, this.boundingBox.getMinX() - 1, this.boundingBox.getMinY(), kx, Direction.WEST, i + 1
                     );
                  } else if (l == 1) {
                     MineshaftGenerator.pieceGenerator(
                        start, holder, random, this.boundingBox.getMaxX() + 1, this.boundingBox.getMinY(), kx, Direction.EAST, i + 1
                     );
                  }
               }
            }
