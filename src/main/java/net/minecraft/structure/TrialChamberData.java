...
/**
 * {@code TrialChamberData}.
 */
public class TrialChamberData {

	public static final RegistryKey<StructurePool>
			CHAMBER_END_POOL_KEY =
			StructurePools.ofVanilla("trial_chambers/chamber/end");
	public static final RegistryKey<StructurePool>
			HALLWAY_FALLBACK_POOL_KEY =
			StructurePools.ofVanilla("trial_chambers/hallway/fallback");
	public static final List<StructurePoolAliasBinding>
			ALIAS_BINDINGS =
			ImmutableList.<StructurePoolAliasBinding>builder()
			             .add(
					             StructurePoolAliasBinding.randomGroup(
							             Pool.<List<StructurePoolAliasBinding>>builder()
							                 .add(
									                 List.of(
											                 StructurePoolAliasBinding.direct(
													                 spawner("contents/ranged"),
													                 spawner("ranged/skeleton")
											                 ),
											                 StructurePoolAliasBinding.direct(
													                 spawner("contents/slow_ranged"),
	...
	public static void bootstrap(Registerable<StructurePool> poolRegisterable) {
		RegistryEntryLookup<StructurePool>
				registryEntryLookup =
				poolRegisterable.getRegistryLookup(RegistryKeys.TEMPLATE_POOL);
		...
		RegistryEntryLookup<StructureProcessorList>
				registryEntryLookup2 =
				poolRegisterable.getRegistryLookup(RegistryKeys.PROCESSOR_LIST);
		RegistryEntry<StructureProcessorList>
				registryEntry3 =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.TRIAL_CHAMBERS_COPPER_BULB_DEGRADATION);
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						List.of(
								Pair.of(
										StructurePoolElement.ofSingle(
												"trial_chambers/chamber/addon/full_stacked_walkway"), 1
								),
								Pair.of(
										StructurePoolElement.ofSingle(
												"trial_chambers/chamber/addon/full_stacked_walkway_2"), 1
								),
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/chamber/addon/full_corner_column"),
										1
								),
								Pair.of(StructurePoolElement.ofSingle("trial_chambers/chamber/addon/grate_bridge"), 1),
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/chamber/addon/hanging_platform"),
										1
								),
								Pair.of(
										StructurePoolElement.ofSingle(
												"trial_chambers/chamber/addon/short_grate_platform"), 1
								),
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/chamber/addon/short_platform"),
										1
								),
								Pair.of(
										StructurePoolElement.ofSingle(
												"trial_chambers/chamber/addon/lower_staircase_down"), 1
								),
								Pair.of(
										StructurePoolElement.ofSingle(
												"trial_chambers/chamber/addon/walkway_with_bridge_1"), 1
								),
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						List.of(
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/chamber/assembly/full_column"),
										2
								),
								...
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/chamber/assembly/left_staircase_1"),
										1
								),
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/chamber/assembly/left_staircase_2"),
										1
								),
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/chamber/assembly/left_staircase_3"),
										1
								),
								Pair.of(
										StructurePoolElement.ofSingle(
												"trial_chambers/chamber/assembly/right_staircase_1"), 1
								),
								Pair.of(
										StructurePoolElement.ofSingle(
												"trial_chambers/chamber/assembly/right_staircase_2"), 1
								),
								Pair.of(
										StructurePoolElement.ofSingle(
												"trial_chambers/chamber/assembly/right_staircase_3"), 1
								)
						),
						StructurePool.Projection.RIGID
				)
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						List.of(
								...
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/chamber/eruption/breeze_slice_1"),
										1
								),
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						List.of(
								...
								Pair.of(
										StructurePoolElement.ofSingle(
												"trial_chambers/chamber/slanted/ominous_upper_arm_1"), 1
								)
						),
						StructurePool.Projection.RIGID
				)
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						List.of(
								...
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/chamber/pedestal/ominous_slice_1"),
										1
								),
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						List.of(
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/hallway/corridor_connector_1"),
										1
								),
								Pair.of(
										StructurePoolElement.ofProcessedSingle(
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						List.of(
								...
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/corridor/addon/ladder_to_middle"),
										1
								),
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/corridor/addon/arrow_dispenser"),
										1
								),
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						List.of(
								...
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/corridor/addon/walled_walkway"),
										1
								)
						),
						StructurePool.Projection.RIGID
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						List.of(
								...
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/corridor/addon/open_walkway_upper"),
										2
								),
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/corridor/addon/chandelier_upper"),
										1
								),
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/corridor/addon/decoration_upper"),
										1
								),
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						List.of(
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/corridor/atrium/bogged_relief"),
										1
								),
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/corridor/atrium/breeze_relief"),
										1
								),
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/corridor/atrium/spiral_relief"),
										1
								),
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/corridor/atrium/spider_relief"),
										1
								),
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/corridor/atrium/grand_staircase_1"),
										1
								),
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/corridor/atrium/grand_staircase_2"),
										1
								),
								Pair.of(
										StructurePoolElement.ofSingle("trial_chambers/corridor/atrium/grand_staircase_3"),
										1
								)
						),
						StructurePool.Projection.RIGID
		...
		StructurePools.register(
				...
				new StructurePool(
						registryEntry,
						List.of(Pair.of(StructurePoolElement.ofSingle("trial_chambers/decor/disposal"), 1)),
						StructurePool.Projection.RIGID
				)
		);
		StructurePools.register(
		...
		StructurePools.register(
				...
				new StructurePool(
						...
						List.of(
								...
								Pair.of(StructurePoolElement.ofSingle("trial_chambers/decor/undecorated_pot"), 1)
						),
						StructurePool.Projection.RIGID
				)
		);
		StructurePools.register(
				...
				new StructurePool(
						registryEntry,
						List.of(Pair.of(StructurePoolElement.ofSingle("trial_chambers/reward/vault"), 1)),
						StructurePool.Projection.RIGID
				)
		);
		StructurePools.register(
				...
				new StructurePool(
						registryEntry,
						List.of(Pair.of(StructurePoolElement.ofSingle("trial_chambers/reward/ominous_vault"), 1)),
						StructurePool.Projection.RIGID
				)
		);
		StructurePools.register(
		...
		StructurePools.register(
				...
				new StructurePool(
						registryEntry,
						List.of(Pair.of(StructurePoolElement.ofSingle("trial_chambers/chests/connectors/supply"), 1)),
						StructurePool.Projection.RIGID
				)
		);
		StructurePools.register(
				...
				new StructurePool(
						registryEntry,
						List.of(Pair.of(StructurePoolElement.ofSingle("trial_chambers/chests/supply"), 1)),
						StructurePool.Projection.RIGID
				)
		);
		StructurePools.register(
				...
				new StructurePool(
						registryEntry,
						List.of(Pair.of(StructurePoolElement.ofSingle("trial_chambers/spawner/connectors/ranged"), 1)),
						StructurePool.Projection.RIGID
				)
		);
		StructurePools.register(
				...
				new StructurePool(
						registryEntry,
						List.of(Pair.of(
								StructurePoolElement.ofSingle("trial_chambers/spawner/connectors/slow_ranged"),
								1
						)),
						StructurePool.Projection.RIGID
				)
		...
		StructurePools.register(
				...
				new StructurePool(
						registryEntry,
						List.of(Pair.of(StructurePoolElement.ofSingle("trial_chambers/spawner/connectors/melee"), 1)),
						StructurePool.Projection.RIGID
				)
		);
		StructurePools.register(
				...
				new StructurePool(
						registryEntry,
						List.of(Pair.of(
								StructurePoolElement.ofSingle("trial_chambers/spawner/connectors/small_melee"),
								1
						)),
						StructurePool.Projection.RIGID
				)
		...
		StructurePools.register(
				...
				new StructurePool(
						registryEntry,
						List.of(Pair.of(StructurePoolElement.ofSingle("trial_chambers/spawner/connectors/breeze"), 1)),
						StructurePool.Projection.RIGID
				)
		);
		StructurePools.register(
		...
		StructurePools.register(
				...
				new StructurePool(
						registryEntry,
						List.of(Pair.of(StructurePoolElement.ofSingle("trial_chambers/spawner/breeze/breeze"), 1)),
						StructurePool.Projection.RIGID
				)
		);
		StructurePools.register(
