   ...
   public static class CorridorStairs extends NetherFortressGenerator.Piece {
      ...
      public void generate(
         ...
         for (int i = 0; i <= 9; i++) {
            ...
            this.fillWithOutline(
               world, chunkBox, 0, j + 1, i, 0, k - 1, i, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false
            );
            this.fillWithOutline(
               world, chunkBox, 4, j + 1, i, 4, k - 1, i, Blocks.NETHER_BRICKS.getDefaultState(), Blocks.NETHER_BRICKS.getDefaultState(), false
            );
            if ((i & 1) == 0) {
