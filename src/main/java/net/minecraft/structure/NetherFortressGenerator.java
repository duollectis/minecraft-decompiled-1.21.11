...
public class NetherFortressGenerator {
	...
	private static final int MAX_BRIDGE_CHAIN_LENGTH = 30;
	...
	static NetherFortressGenerator.@Nullable Piece createPiece(
	...
	public static class BridgeEnd extends NetherFortressGenerator.Piece {
		...
		public static NetherFortressGenerator.@Nullable BridgeEnd create(
				StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength
		) {
	...
	public static class BridgePlatform extends NetherFortressGenerator.Piece {
		...
		public static NetherFortressGenerator.@Nullable BridgePlatform create(
		...
		public void generate(
			...
			BlockState
					blockState =
					Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.WEST, true).with(FenceBlock.EAST, true);
			BlockState
					blockState2 =
					Blocks.NETHER_BRICK_FENCE
							.getDefaultState()
			...
			this.addBlock(
					world,
					Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.WEST, true),
					1,
					6,
					3,
					chunkBox
			...
			this.addBlock(
					world,
					Blocks.NETHER_BRICK_FENCE.getDefaultState().with(FenceBlock.EAST, true),
					5,
					6,
					3,
					chunkBox
	...
	public static class BridgeSmallCrossing extends NetherFortressGenerator.Piece {
		...
		public static NetherFortressGenerator.@Nullable BridgeSmallCrossing create(
				StructurePiecesHolder holder, int x, int y, int z, Direction orientation, int chainLength
		) {
	...
	public static class CorridorBalcony extends NetherFortressGenerator.Piece {
		...
		public static NetherFortressGenerator.@Nullable CorridorBalcony create(
				StructurePiecesHolder holder, int x, int y, int z, Direction orientation, int chainLength
		) {
	...
	public static class CorridorCrossing extends NetherFortressGenerator.Piece {
		...
		public static NetherFortressGenerator.@Nullable CorridorCrossing create(
				StructurePiecesHolder holder, int x, int y, int z, Direction orientation, int chainLength
		) {
		...
		public void generate(
			...
			for (int ix = 3; ix <= 9; ix += 2) {
				this.fillWithOutline(
						...
						8,
						ix,
						blockState2.with(FenceBlock.WEST, true),
						blockState2.with(FenceBlock.WEST, true),
						false
				);
				this.fillWithOutline(
	...
	public static class CorridorLeftTurn extends NetherFortressGenerator.Piece {
		...
		public static NetherFortressGenerator.@Nullable CorridorLeftTurn create(
				StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength
		) {
			BlockBox blockBox = BlockBox.rotated(x, y, z, -1, 0, 0, 5, 7, 5, orientation);
			return isInBounds(blockBox) && holder.getIntersecting(blockBox) == null
	...
	public static class CorridorNetherWartsRoom extends NetherFortressGenerator.Piece {
		...
		public void generate(
			...
			BlockState
					blockState5 =
					Blocks.NETHER_BRICK_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.NORTH);
	...
	public static class CorridorRightTurn extends NetherFortressGenerator.Piece {
		...
		public static NetherFortressGenerator.@Nullable CorridorRightTurn create(
				StructurePiecesHolder holder, Random random, int x, int y, int z, Direction orientation, int chainLength
		) {
			BlockBox blockBox = BlockBox.rotated(x, y, z, -1, 0, 0, 5, 7, 5, orientation);
			return isInBounds(blockBox) && holder.getIntersecting(blockBox) == null
	...
	public static class CorridorStairs extends NetherFortressGenerator.Piece {
		...
		public void generate(
			...
			BlockState
					blockState =
					Blocks.NETHER_BRICK_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.SOUTH);
			BlockState
					blockState2 =
					Blocks.NETHER_BRICK_FENCE
							.getDefaultState()
	...
	abstract static class Piece extends StructurePiece {
		...
		private NetherFortressGenerator.@Nullable Piece pickPiece(
			...
			while (j < 5 && bl) {
				...
				for (NetherFortressGenerator.PieceData pieceData : possiblePieces) {
					k -= pieceData.weight;
					if (k < 0) {
						if (!pieceData.canGenerate(chainLength)
								|| pieceData == start.lastPiece && !pieceData.repeatable) {
							break;
						}
		...
		private @Nullable StructurePiece pieceGenerator(
				NetherFortressGenerator.Start start,
				StructurePiecesHolder holder,
				Random random,
				int x,
			...
			if (Math.abs(x - start.getBoundingBox().getMinX()) <= 112
				...
				StructurePiece
						structurePiece =
						this.pickPiece(start, list, holder, random, x, y, z, orientation, chainLength + 1);
	...
	static class PieceData {
		...
		public PieceData(
				Class<? extends NetherFortressGenerator.Piece> pieceType,
				int weight,
				int limit,
				boolean repeatable
		) {
	...
	public static class SmallCorridor extends NetherFortressGenerator.Piece {
		...
		public static NetherFortressGenerator.@Nullable SmallCorridor create(
				StructurePiecesHolder holder, int x, int y, int z, Direction orientation, int chainLength
		) {
			BlockBox blockBox = BlockBox.rotated(x, y, z, -1, 0, 0, 5, 7, 5, orientation);
			return isInBounds(blockBox) && holder.getIntersecting(blockBox) == null
	...
	public static class Start extends NetherFortressGenerator.BridgeCrossing {
		...
		final List<NetherFortressGenerator.PieceData> bridgePieces = new ArrayList<>();
		final List<NetherFortressGenerator.PieceData> corridorPieces = new ArrayList<>();
