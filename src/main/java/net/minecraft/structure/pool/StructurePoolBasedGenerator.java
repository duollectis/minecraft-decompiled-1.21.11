                  ...
                  (Consumer<StructurePiecesCollector>)(collector -> {
                     ...
                     if (size > 0) {
                        Box box = new Box(
                           ...
                           Math.max(m - maxDistanceFromCenter.vertical(), heightLimitView.getBottomY() + dimensionPadding.bottom()),
                           j - maxDistanceFromCenter.horizontal(),
                           i + maxDistanceFromCenter.horizontal() + 1,
                           Math.min(m + maxDistanceFromCenter.vertical() + 1, heightLimitView.getTopYInclusive() + 1 - dimensionPadding.top()),
                           ...
                           for (StructureTemplate.JigsawBlockInfo jigsawBlockInfo2 : list2) {
                              if (JigsawBlock.attachmentMatches(jigsawBlockInfo, jigsawBlockInfo2)) {
                                 ...
                                 if (!VoxelShapes.matchesAnywhere(
                                    (VoxelShape)mutableObject2.get(), VoxelShapes.cuboid(Box.from(blockBox4).contract(0.25)), BooleanBiFunction.ONLY_SECOND
                                 )) {
                                    mutableObject2.setValue(
                                       VoxelShapes.combine(
                                          (VoxelShape)mutableObject2.get(), VoxelShapes.cuboid(Box.from(blockBox4)), BooleanBiFunction.ONLY_FIRST
                                       )
                                    );
