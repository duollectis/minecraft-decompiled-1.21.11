...
public class BastionBridgeData {
	...
	public static void bootstrap(Registerable<StructurePool> poolRegisterable) {
		...
		RegistryEntry<StructureProcessorList>
				registryEntry =
				registryEntryLookup.getOrThrow(StructureProcessorLists.ENTRANCE_REPLACEMENT);
		RegistryEntry<StructureProcessorList>
				registryEntry2 =
				registryEntryLookup.getOrThrow(StructureProcessorLists.BASTION_GENERIC_DEGRADATION);
		RegistryEntry<StructureProcessorList>
				registryEntry3 =
				registryEntryLookup.getOrThrow(StructureProcessorLists.BRIDGE);
		RegistryEntry<StructureProcessorList>
				registryEntry4 =
				registryEntryLookup.getOrThrow(StructureProcessorLists.RAMPART_DEGRADATION);
