...
public class TradeOffers {
         ...
         map.put(
            ...
            copyToFastUtilMap(
               ImmutableMap.of(
                  1,
                  new TradeOffers.Factory[]{
                     new TradeOffers.BuyItemFactory(Items.PAPER, 24, 12, 2), new TradeOffers.SellItemFactory(Items.MAP, 7, 1, 12, 1, 0.05F)
                  },
                  2,
                  new TradeOffers.Factory[]{
                  ...
                  new TradeOffers.Factory[]{
                     ...
                     TradeOffers.TypedWrapperFactory.of(
                        new TradeOffers.SellItemFactory(Items.BLUE_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.SNOW, VillagerType.TAIGA
                     ),
                     TradeOffers.TypedWrapperFactory.of(
                        new TradeOffers.SellItemFactory(Items.WHITE_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.SNOW, VillagerType.PLAINS
                     ),
                     TradeOffers.TypedWrapperFactory.of(
                        new TradeOffers.SellItemFactory(Items.RED_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.SNOW, VillagerType.SAVANNA
                     ),
                     TradeOffers.TypedWrapperFactory.of(
                        new TradeOffers.SellItemFactory(Items.GREEN_BANNER, 2, 1, 12, 15, 0.05F),
                        VillagerType.DESERT,
                        VillagerType.SAVANNA,
                        VillagerType.JUNGLE
                     ),
                     TradeOffers.TypedWrapperFactory.of(
                        new TradeOffers.SellItemFactory(Items.LIME_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.DESERT, VillagerType.TAIGA
                     ),
                     TradeOffers.TypedWrapperFactory.of(
                        new TradeOffers.SellItemFactory(Items.PURPLE_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.TAIGA, VillagerType.SWAMP
                     ),
                     TradeOffers.TypedWrapperFactory.of(
                        new TradeOffers.SellItemFactory(Items.CYAN_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.DESERT, VillagerType.SNOW
                     ),
                     TradeOffers.TypedWrapperFactory.of(
                        new TradeOffers.SellItemFactory(Items.YELLOW_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.PLAINS, VillagerType.JUNGLE
                     ),
                     TradeOffers.TypedWrapperFactory.of(
                        new TradeOffers.SellItemFactory(Items.ORANGE_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.SAVANNA, VillagerType.DESERT
                     ),
                     TradeOffers.TypedWrapperFactory.of(
                        new TradeOffers.SellItemFactory(Items.BROWN_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.PLAINS, VillagerType.JUNGLE
                     ),
                     ...
                     TradeOffers.TypedWrapperFactory.of(
                        new TradeOffers.SellItemFactory(Items.LIGHT_BLUE_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.SNOW, VillagerType.SWAMP
                     ),
                     TradeOffers.TypedWrapperFactory.of(
                        new TradeOffers.SellItemFactory(Items.PINK_BANNER, 2, 1, 12, 15, 0.05F), VillagerType.TAIGA, VillagerType.PLAINS
                     ),
   ...
   public static class SellPotionHoldingItemFactory implements TradeOffers.Factory {
      ...
      public TradeOffer create(ServerWorld world, Entity entity, Random random) {
         ...
         List<RegistryEntry<Potion>> list = Registries.POTION
            .streamEntries()
            .filter(entry -> !entry.value().getEffects().isEmpty() && world.getBrewingRecipeRegistry().isBrewable(entry))
   ...
   public record TypedWrapperFactory(Map<RegistryKey<VillagerType>, TradeOffers.Factory> typeToFactory) implements TradeOffers.Factory {
      ...
      public static TradeOffers.TypedWrapperFactory of(TradeOffers.Factory factory, RegistryKey<VillagerType>... types) {
         return new TradeOffers.TypedWrapperFactory(Arrays.stream(types).collect(Collectors.toMap(registryKey -> registryKey, registryKey -> factory)));
      }
