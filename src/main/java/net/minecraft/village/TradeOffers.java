...
public class TradeOffers {
	...
	public static final Map<RegistryKey<VillagerProfession>, Int2ObjectMap<TradeOffers.Factory[]>>
								...
								copyToFastUtilMap(
										ImmutableMap.of(
												...
												new TradeOffers.Factory[]{
														...
														new TradeOffers.SellSuspiciousStewFactory(
						...
						map.put(
								...
								copyToFastUtilMap(
										ImmutableMap.of(
												...
												3,
												new TradeOffers.Factory[]{
														new TradeOffers.BuyItemFactory(Items.SALMON, 13, 16, 20),
								...
								copyToFastUtilMap(
										ImmutableMap.of(
												...
												new TradeOffers.Factory[]{
														...
														new TradeOffers.SellPotionHoldingItemFactory(
																Items.ARROW,
																5,
																Items.TIPPED_ARROW,
																5,
						...
						map.put(
								...
								copyToFastUtilMap(
										ImmutableMap.of(
												1,
												new TradeOffers.Factory[]{
														new TradeOffers.BuyItemFactory(Items.PAPER, 24, 12, 2),
														new TradeOffers.SellItemFactory(Items.MAP, 7, 1, 12, 1, 0.05F)
												},
												2,
												new TradeOffers.Factory[]{
												...
												new TradeOffers.Factory[]{
														...
														TradeOffers.TypedWrapperFactory.of(
																new TradeOffers.SellItemFactory(
																		...
																		15,
																		0.05F
																), VillagerType.SNOW, VillagerType.TAIGA
														),
														TradeOffers.TypedWrapperFactory.of(
																new TradeOffers.SellItemFactory(
																		Items.WHITE_BANNER,
																		...
																		15,
																		0.05F
																), VillagerType.SNOW, VillagerType.PLAINS
														),
														TradeOffers.TypedWrapperFactory.of(
																new TradeOffers.SellItemFactory(
																		Items.RED_BANNER,
																		...
																		15,
																		0.05F
																), VillagerType.SNOW, VillagerType.SAVANNA
														),
														TradeOffers.TypedWrapperFactory.of(
																new TradeOffers.SellItemFactory(
																		Items.GREEN_BANNER,
														...
														TradeOffers.TypedWrapperFactory.of(
																new TradeOffers.SellItemFactory(
																		...
																		15,
																		0.05F
																), VillagerType.DESERT, VillagerType.TAIGA
														),
														TradeOffers.TypedWrapperFactory.of(
																new TradeOffers.SellItemFactory(
																		Items.PURPLE_BANNER,
														...
														TradeOffers.TypedWrapperFactory.of(
																new TradeOffers.SellItemFactory(
																		...
																		15,
																		0.05F
																), VillagerType.DESERT, VillagerType.SNOW
														),
														TradeOffers.TypedWrapperFactory.of(
																new TradeOffers.SellItemFactory(
																		Items.YELLOW_BANNER,
														...
														TradeOffers.TypedWrapperFactory.of(
																new TradeOffers.SellItemFactory(
																		...
																		15,
																		0.05F
																), VillagerType.SNOW, VillagerType.SWAMP
														),
														TradeOffers.TypedWrapperFactory.of(
																new TradeOffers.SellItemFactory(
																		Items.PINK_BANNER,
																		...
																		15,
																		0.05F
																), VillagerType.TAIGA, VillagerType.PLAINS
														),
														TradeOffers.TypedWrapperFactory.of(
																new TradeOffers.SellItemFactory(
																		Items.GRAY_BANNER,
						...
						map.put(
								...
								copyToFastUtilMap(
										ImmutableMap.of(
												1,
												new TradeOffers.Factory[]{
														new TradeOffers.BuyItemFactory(Items.ROTTEN_FLESH, 32, 16, 2),
														new TradeOffers.SellItemFactory(Items.REDSTONE, 1, 2, 1)
												},
												2,
												new TradeOffers.Factory[]{
														new TradeOffers.BuyItemFactory(Items.GOLD_INGOT, 3, 12, 10),
														new TradeOffers.SellItemFactory(Items.LAPIS_LAZULI, 1, 1, 5)
												},
												3,
												new TradeOffers.Factory[]{
														new TradeOffers.BuyItemFactory(Items.RABBIT_FOOT, 2, 12, 20),
												...
												5,
												new TradeOffers.Factory[]{
														new TradeOffers.BuyItemFactory(Items.NETHER_WART, 22, 12, 30),
														new TradeOffers.SellItemFactory(
						...
						map.put(
								...
								copyToFastUtilMap(
										ImmutableMap.of(
												...
												3,
												new TradeOffers.Factory[]{
														new TradeOffers.BuyItemFactory(Items.RABBIT_HIDE, 9, 12, 20),
														new TradeOffers.SellDyedArmorFactory(
																Items.LEATHER_CHESTPLATE,
																7
														)
						...
						map.put(
								...
								copyToFastUtilMap(
										ImmutableMap.of(
												1,
												new TradeOffers.Factory[]{
														new TradeOffers.BuyItemFactory(Items.CLAY_BALL, 10, 16, 2),
														new TradeOffers.SellItemFactory(Items.BRICK, 1, 10, 16, 1)
												},
												2,
												new TradeOffers.Factory[]{
														new TradeOffers.BuyItemFactory(Blocks.STONE, 20, 16, 10),
														new TradeOffers.SellItemFactory(
	...
	public static final List<Pair<TradeOffers.Factory[], Integer>>
			WANDERING_TRADER_TRADES =
			ImmutableList.<Pair<TradeOffers.Factory[], Integer>>builder()
			             .add(
					             Pair.of(
							             new TradeOffers.Factory[]{
			             ...
			             .add(
					             Pair.of(
							             new TradeOffers.Factory[]{
									             ...
									             new TradeOffers.SellItemFactory(
											             createPotionStack(Potions.LONG_INVISIBILITY),
											             5,
											             1,
											             1,
											             1
							            ...
							            .put(
									            ...
									            new TradeOffers.Factory[]{
											            new TradeOffers.BuyItemFactory(
													            ...
													            12,
													            2
											            ), new TradeOffers.BuyItemFactory(Items.IRON_INGOT, 5, 12, 2)
									            }
							            )
							            .put(
									            2,
									            ...
									            new TradeOffers.Factory[]{
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.DESERT_ARMORER_BOOTS_4
													            ),
													            VillagerType.DESERT
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.DESERT_ARMORER_HELMET_4
													            ),
													            VillagerType.DESERT
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.DESERT_ARMORER_LEGGINGS_4
													            ),
													            VillagerType.DESERT
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.DESERT_ARMORER_CHESTPLATE_4
													            ),
													            VillagerType.DESERT
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.PLAINS_ARMORER_BOOTS_4
													            ),
													            VillagerType.PLAINS
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.PLAINS_ARMORER_HELMET_4
													            ),
													            VillagerType.PLAINS
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.PLAINS_ARMORER_LEGGINGS_4
													            ),
													            VillagerType.PLAINS
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.PLAINS_ARMORER_CHESTPLATE_4
													            ),
													            VillagerType.PLAINS
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SAVANNA_ARMORER_BOOTS_4
													            ),
													            VillagerType.SAVANNA
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SAVANNA_ARMORER_HELMET_4
													            ),
													            VillagerType.SAVANNA
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SAVANNA_ARMORER_LEGGINGS_4
													            ),
													            VillagerType.SAVANNA
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SAVANNA_ARMORER_CHESTPLATE_4
													            ),
													            VillagerType.SAVANNA
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SNOW_ARMORER_BOOTS_4
													            ),
													            VillagerType.SNOW
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SNOW_ARMORER_HELMET_4
													            ),
													            VillagerType.SNOW
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.JUNGLE_ARMORER_BOOTS_4
													            ),
													            VillagerType.JUNGLE
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.JUNGLE_ARMORER_HELMET_4
													            ),
													            VillagerType.JUNGLE
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.JUNGLE_ARMORER_LEGGINGS_4
													            ),
													            VillagerType.JUNGLE
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.JUNGLE_ARMORER_CHESTPLATE_4
													            ),
													            VillagerType.JUNGLE
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SWAMP_ARMORER_BOOTS_4
													            ),
													            VillagerType.SWAMP
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SWAMP_ARMORER_HELMET_4
													            ),
													            VillagerType.SWAMP
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SWAMP_ARMORER_LEGGINGS_4
													            ),
													            VillagerType.SWAMP
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            15,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SWAMP_ARMORER_CHESTPLATE_4
													            ),
													            VillagerType.SWAMP
											            ),
											            TradeOffers.TypedWrapperFactory.of(
									            ...
									            new TradeOffers.Factory[]{
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.ProcessItemFactory(
															            ...
															            30,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.DESERT_ARMORER_CHESTPLATE_5
													            ),
													            VillagerType.DESERT
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.ProcessItemFactory(
															            ...
															            30,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.DESERT_ARMORER_LEGGINGS_5
													            ),
													            VillagerType.DESERT
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.ProcessItemFactory(
															            ...
															            30,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.PLAINS_ARMORER_LEGGINGS_5
													            ),
													            VillagerType.PLAINS
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.ProcessItemFactory(
															            ...
															            30,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.PLAINS_ARMORER_BOOTS_5
													            ),
													            VillagerType.PLAINS
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.ProcessItemFactory(
															            ...
															            30,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SAVANNA_ARMORER_HELMET_5
													            ),
													            VillagerType.SAVANNA
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.ProcessItemFactory(
															            ...
															            30,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SAVANNA_ARMORER_CHESTPLATE_5
													            ),
													            VillagerType.SAVANNA
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.ProcessItemFactory(
															            ...
															            30,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SNOW_ARMORER_BOOTS_5
													            ),
													            VillagerType.SNOW
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.ProcessItemFactory(
															            ...
															            30,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SNOW_ARMORER_HELMET_5
													            ),
													            VillagerType.SNOW
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            30,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.JUNGLE_ARMORER_HELMET_5
													            ),
													            VillagerType.JUNGLE
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            30,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.JUNGLE_ARMORER_BOOTS_5
													            ),
													            VillagerType.JUNGLE
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            30,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SWAMP_ARMORER_HELMET_5
													            ),
													            VillagerType.SWAMP
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.SellItemFactory(
															            ...
															            30,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.SWAMP_ARMORER_BOOTS_5
													            ),
													            VillagerType.SWAMP
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.ProcessItemFactory(
															            ...
															            30,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.TAIGA_ARMORER_CHESTPLATE_5
													            ),
													            VillagerType.TAIGA
											            ),
											            TradeOffers.TypedWrapperFactory.of(
													            new TradeOffers.ProcessItemFactory(
															            ...
															            30,
															            0.05F,
															            TradeRebalanceEnchantmentProviders.TAIGA_ARMORER_LEGGINGS_5
													            ),
													            VillagerType.TAIGA
											            ),
											            TradeOffers.TypedWrapperFactory.of(
	...
	private static TradeOffers.Factory createLibrarianTradeFactory(int experience) {
		return new TradeOffers.TypedWrapperFactory(
				ImmutableMap.<RegistryKey<VillagerType>, TradeOffers.Factory>builder()
				            .put(
						            VillagerType.DESERT,
						            new TradeOffers.EnchantBookFactory(experience, EnchantmentTags.DESERT_COMMON_TRADE)
				            )
				            .put(
						            VillagerType.JUNGLE,
						            new TradeOffers.EnchantBookFactory(experience, EnchantmentTags.JUNGLE_COMMON_TRADE)
				            )
				            .put(
						            VillagerType.PLAINS,
						            new TradeOffers.EnchantBookFactory(experience, EnchantmentTags.PLAINS_COMMON_TRADE)
				            )
				            .put(
						            VillagerType.SAVANNA,
						            new TradeOffers.EnchantBookFactory(experience, EnchantmentTags.SAVANNA_COMMON_TRADE)
				            )
				            .put(
						            VillagerType.SNOW,
						            new TradeOffers.EnchantBookFactory(experience, EnchantmentTags.SNOW_COMMON_TRADE)
				            )
				            .put(
						            VillagerType.SWAMP,
						            new TradeOffers.EnchantBookFactory(experience, EnchantmentTags.SWAMP_COMMON_TRADE)
				            )
				            .put(
						            VillagerType.TAIGA,
						            new TradeOffers.EnchantBookFactory(experience, EnchantmentTags.TAIGA_COMMON_TRADE)
				            )
				            .build()
		);
	}
	...
	private static TradeOffers.Factory createMasterLibrarianTradeFactory() {
		return new TradeOffers.TypedWrapperFactory(
				ImmutableMap.<RegistryKey<VillagerType>, TradeOffers.Factory>builder()
				            .put(
						            VillagerType.DESERT,
						            new TradeOffers.EnchantBookFactory(30, 3, 3, EnchantmentTags.DESERT_SPECIAL_TRADE)
				            )
				            .put(
						            VillagerType.JUNGLE,
						            new TradeOffers.EnchantBookFactory(30, 2, 2, EnchantmentTags.JUNGLE_SPECIAL_TRADE)
				            )
				            .put(
						            VillagerType.PLAINS,
						            new TradeOffers.EnchantBookFactory(30, 3, 3, EnchantmentTags.PLAINS_SPECIAL_TRADE)
				            )
				            .put(
						            VillagerType.SAVANNA,
						            new TradeOffers.EnchantBookFactory(30, 3, 3, EnchantmentTags.SAVANNA_SPECIAL_TRADE)
				            )
				            .put(
						            VillagerType.SNOW,
						            new TradeOffers.EnchantBookFactory(30, EnchantmentTags.SNOW_SPECIAL_TRADE)
				            )
				            .put(
						            VillagerType.SWAMP,
						            new TradeOffers.EnchantBookFactory(30, EnchantmentTags.SWAMP_SPECIAL_TRADE)
				            )
				            .put(
						            VillagerType.TAIGA,
						            new TradeOffers.EnchantBookFactory(30, 2, 2, EnchantmentTags.TAIGA_SPECIAL_TRADE)
				            )
				            .build()
		);
	}
	...
	private static TradedItem createPotion(RegistryEntry<Potion> potion) {
		return new TradedItem(Items.POTION).withComponents(builder -> builder.add(
	...
	public static class BuyItemFactory implements TradeOffers.Factory {
		...
		public BuyItemFactory(ItemConvertible item, int maxUses, int experience, int price) {
			this(item, maxUses, experience, price, 1);
		}
		...
		public BuyItemFactory(TradedItem stack, int count, int maxUses, int experience) {
			this.stack = stack;
			this.maxUses = count;
	...
	public static class EnchantBookFactory implements TradeOffers.Factory {
		...
		public EnchantBookFactory(
				int experience,
				int minLevel,
				int maxLevel,
				TagKey<Enchantment> possibleEnchantments
		) {
	...
	public static class ProcessItemFactory implements TradeOffers.Factory {
		...
		private ProcessItemFactory(
			...
			this(
					...
					price,
					processed.copyWithCount(processedCount),
					maxUses,
					experience,
					multiplier,
					Optional.empty()
	...
	public static class SellMapFactory implements TradeOffers.Factory {
		...
		public SellMapFactory(
				int price,
				TagKey<Structure> structure,
				String nameKey,
	...
	public static class SellPotionHoldingItemFactory implements TradeOffers.Factory {
		...
		public SellPotionHoldingItemFactory(
				Item arrow,
				int secondCount,
				Item tippedArrow,
				int sellCount,
	...
	public static class TypeAwareBuyForOneEmeraldFactory implements TradeOffers.Factory {
		...
		public TypeAwareBuyForOneEmeraldFactory(
				int count,
				int maxUses,
				int experience,
				Map<RegistryKey<VillagerType>, Item> map
		) {
			Registries.VILLAGER_TYPE
					.getKeys()
					.stream()
					.filter(typeKey -> !map.containsKey(typeKey))
					.findAny()
					.ifPresent(typeKey -> {
