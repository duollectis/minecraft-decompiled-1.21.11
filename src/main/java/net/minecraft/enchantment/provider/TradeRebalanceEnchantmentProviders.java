...
public interface TradeRebalanceEnchantmentProviders {
   ...
   static void bootstrap(Registerable<EnchantmentProvider> registry) {
      ...
      registry.register(
         DESERT_ARMORER_BOOTS_4, new SingleEnchantmentProvider(registryEntryLookup.getOrThrow(Enchantments.THORNS), ConstantIntProvider.create(1))
      );
      registry.register(
      ...
      registry.register(
         DESERT_ARMORER_HELMET_4, new SingleEnchantmentProvider(registryEntryLookup.getOrThrow(Enchantments.THORNS), ConstantIntProvider.create(1))
      );
      registry.register(
      ...
      registry.register(
         ...
         new SingleEnchantmentProvider(registryEntryLookup.getOrThrow(Enchantments.PROJECTILE_PROTECTION), ConstantIntProvider.create(1))
      );
      registry.register(
         SWAMP_ARMORER_BOOTS_4, new SingleEnchantmentProvider(registryEntryLookup.getOrThrow(Enchantments.MENDING), ConstantIntProvider.create(1))
      );
      registry.register(
      ...
      registry.register(
         SWAMP_ARMORER_HELMET_4, new SingleEnchantmentProvider(registryEntryLookup.getOrThrow(Enchantments.MENDING), ConstantIntProvider.create(1))
      );
      registry.register(
      ...
      registry.register(
         ...
         new SingleEnchantmentProvider(registryEntryLookup.getOrThrow(Enchantments.BLAST_PROTECTION), ConstantIntProvider.create(1))
      );
   }
}
