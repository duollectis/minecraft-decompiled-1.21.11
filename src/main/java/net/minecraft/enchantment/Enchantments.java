...
public class Enchantments {
   ...
   public static final RegistryKey<Enchantment> LUNGE = of("lunge");
   ...
   public static void bootstrap(Registerable<Enchantment> registry) {
            ...
            .addEffect(
               ...
               AllOfLootCondition.builder(
                  EntityPropertiesLootCondition.builder(
                     LootContext.EntityReference.THIS, EntityPredicate.Builder.create().flags(EntityFlagsPredicate.Builder.create().onGround(true))
                  ),
                  InvertedLootCondition.builder(
                     EntityPropertiesLootCondition.builder(
                        LootContext.EntityReference.THIS, EntityPredicate.Builder.create().vehicle(EntityPredicate.Builder.create())
                     )
                  )
               )
            )
      ...
      AllOfLootCondition.Builder builder2 = AllOfLootCondition.builder(
         InvertedLootCondition.builder(
            EntityPropertiesLootCondition.builder(LootContext.EntityReference.THIS, EntityPredicate.Builder.create().vehicle(EntityPredicate.Builder.create()))
         ),
         AnyOfLootCondition.builder(
            AllOfLootCondition.builder(
               EnchantmentActiveCheckLootCondition.requireActive(),
               EntityPropertiesLootCondition.builder(
                  LootContext.EntityReference.THIS, EntityPredicate.Builder.create().flags(EntityFlagsPredicate.Builder.create().flying(false))
               ),
               AnyOfLootCondition.builder(
                  EntityPropertiesLootCondition.builder(
                  ...
                  EntityPropertiesLootCondition.builder(
                     LootContext.EntityReference.THIS, EntityPredicate.Builder.create().flags(EntityFlagsPredicate.Builder.create().onGround(false)).build()
                  )
               )
            ),
            AllOfLootCondition.builder(
      ...
      register(
         ...
         Enchantment.builder(
            ...
            .addEffect(
               ...
               EntityPropertiesLootCondition.builder(LootContext.EntityReference.THIS, builder)
            )
            .addEffect(
               EnchantmentEffectComponentTypes.TICK,
               new PlaySoundEnchantmentEffect(
                  List.of(SoundEvents.PARTICLE_SOUL_ESCAPE), ConstantFloatProvider.create(0.6F), UniformFloatProvider.create(0.6F, 1.0F)
               ),
               AllOfLootCondition.builder(
                  RandomChanceLootCondition.builder(0.35F), EntityPropertiesLootCondition.builder(LootContext.EntityReference.THIS, builder)
               )
            )
      );
      register(
         ...
         Enchantment.builder(
            ...
            .addEffect(
               ...
               EntityPropertiesLootCondition.builder(
                  ...
                  EntityPredicate.Builder.create().type(EntityTypePredicate.create(registryEntryLookup5, EntityType.PLAYER))
               )
            )
      );
      register(
      ...
      register(
         ...
         Enchantment.builder(
            ...
            .addEffect(
               ...
               EntityPropertiesLootCondition.builder(
                  LootContext.EntityReference.DIRECT_ATTACKER, EntityPredicate.Builder.create().type(registryEntryLookup5, EntityTypeTags.ARROWS).build()
               )
            )
      );
      register(
      ...
      register(
         ...
         Enchantment.builder(
            ...
            .addEffect(
               ...
               AllOfEnchantmentEffects.allOf(
                  new ChangeItemDamageEnchantmentEffect(new EnchantmentLevelBasedValue.Constant(1.0F)),
                  new ApplyExhaustionEnchantmentEffect(EnchantmentLevelBasedValue.linear(4.0F)),
                  new ApplyImpulseEnchantmentEffect(new Vec3d(0.0, 0.0, 1.0), new Vec3d(1.0, 0.0, 1.0), EnchantmentLevelBasedValue.linear(0.458F)),
                  new PlaySoundEnchantmentEffect(
                     List.of(SoundEvents.ITEM_SPEAR_LUNGE_1, SoundEvents.ITEM_SPEAR_LUNGE_2, SoundEvents.ITEM_SPEAR_LUNGE_3),
                     ConstantFloatProvider.create(1.0F),
                     ConstantFloatProvider.create(1.0F)
                  )
               ),
               AllOfLootCondition.builder(
                  ...
                  EntityPropertiesLootCondition.builder(
                     LootContext.EntityReference.THIS, EntityPredicate.Builder.create().flags(EntityFlagsPredicate.Builder.create().isFallFlying(false))
                  ),
                  EntityPropertiesLootCondition.builder(
                     LootContext.EntityReference.THIS, EntityPredicate.Builder.create().flags(EntityFlagsPredicate.Builder.create().isInWater(false))
                  )
               )
            )
      );
         ...
         Enchantment.builder(
            ...
            .addEffect(
               ...
               AllOfEnchantmentEffects.allOf(
                  ...
                  new PlaySoundEnchantmentEffect(
                     List.of(SoundEvents.ITEM_TRIDENT_THUNDER), ConstantFloatProvider.create(5.0F), ConstantFloatProvider.create(1.0F)
                  )
               ),
               AllOfLootCondition.builder(
                  WeatherCheckLootCondition.create().thundering(true),
                  EntityPropertiesLootCondition.builder(
                     LootContext.EntityReference.THIS, EntityPredicate.Builder.create().location(LocationPredicate.Builder.create().canSeeSky(true))
                  ),
                  EntityPropertiesLootCondition.builder(
                     LootContext.EntityReference.DIRECT_ATTACKER, EntityPredicate.Builder.create().type(registryEntryLookup5, EntityType.TRIDENT)
                  )
               )
            )
            .addEffect(
               ...
               AllOfLootCondition.builder(
                  WeatherCheckLootCondition.create().thundering(true),
                  EntityPropertiesLootCondition.builder(
                     LootContext.EntityReference.THIS, EntityPredicate.Builder.create().type(registryEntryLookup5, EntityType.TRIDENT)
                  ),
                  LocationCheckLootCondition.builder(
                     LocationPredicate.Builder.create()
                        .canSeeSky(true)
                        .block(net.minecraft.predicate.BlockPredicate.Builder.create().tag(registryEntryLookup4, BlockTags.LIGHTNING_RODS))
                  )
               )
            )
      );
