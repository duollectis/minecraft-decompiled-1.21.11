	...
	public static void bootstrap(Registerable<Enchantment> registry) {
		...
		EntityPredicate.Builder builder = EntityPredicate.Builder.create()
		                                                         ...
		                                                         .flags(EntityFlagsPredicate.Builder
				                                                         ...
				                                                         .flying(false)
				                                                         .onGround(true))
		                                                         .movement(MovementPredicate.horizontalSpeed(NumberRange.DoubleRange.atLeast(
				                                                         1.0E-5F)))
		                                                         .movementAffectedBy(
		...
		AllOfLootCondition.Builder builder2 = AllOfLootCondition.builder(
				InvertedLootCondition.builder(
						EntityPropertiesLootCondition.builder(
								LootContext.EntityReference.THIS,
								EntityPredicate.Builder.create().vehicle(EntityPredicate.Builder.create())
						)
				),
						...
						AllOfLootCondition.builder(
								...
								AnyOfLootCondition.builder(
										...
										EntityPropertiesLootCondition.builder(
												...
												EntityPredicate.Builder
														.create()
														.flags(EntityFlagsPredicate.Builder.create().onGround(false))
														.build()
										)
								)
						),
		...
		register(
				...
				Enchantment.builder(
				           ...
				           .addEffect(
						           ...
						           AllOfLootCondition.builder(
								           RandomChanceLootCondition.builder(EnchantmentLevelLootNumberProvider.create(
										           EnchantmentLevelBasedValue.constant(0.04F))),
								           EntityPropertiesLootCondition.builder(
										           LootContext.EntityReference.THIS,
										           EntityPredicate.Builder.create()
										                                  .flags(EntityFlagsPredicate.Builder
				           ...
				           .addEffect(
						           ...
						           new SpawnParticlesEnchantmentEffect(
								           ...
								           SpawnParticlesEnchantmentEffect.fixedVelocity(ConstantFloatProvider.create(
										           0.1F)),
				           ...
				           .addEffect(
						           ...
						           new PlaySoundEnchantmentEffect(
								           List.of(SoundEvents.PARTICLE_SOUL_ESCAPE),
								           ConstantFloatProvider.create(0.6F),
								           UniformFloatProvider.create(0.6F, 1.0F)
						           ),
						           AllOfLootCondition.builder(
								           RandomChanceLootCondition.builder(0.35F),
								           EntityPropertiesLootCondition.builder(
										           LootContext.EntityReference.THIS,
										           builder
								           )
				...
				Enchantment.builder(
				           ...
				           .addEffect(
						           ...
						           EntityPropertiesLootCondition.builder(
						                                        ...
						                                        .and(DamageSourcePropertiesLootCondition.builder(
								                                        DamageSourcePredicate.Builder
										                                        .create()
										                                        .isDirect(true)))
				           )
				...
				Enchantment.builder(
				           ...
				           .addEffect(
						           ...
						           new AttributeEnchantmentEffect(
								           ...
								           new EnchantmentLevelBasedValue.Fraction(
										           EnchantmentLevelBasedValue.linear(1.0F),
		...
		register(
				...
				Enchantment.builder(
				           ...
				           .addEffect(
						           ...
						           new AddEnchantmentEffect(EnchantmentLevelBasedValue.linear(5.0F))
				           )
		);
		register(
				registry,
		...
		register(
				...
				Enchantment.builder(
				           ...
				           .addEffect(
						           ...
						           AllOfEnchantmentEffects.allOf(
								           new ChangeItemDamageEnchantmentEffect(new EnchantmentLevelBasedValue.Constant(
										           1.0F)),
		...
		register(
				...
				Enchantment.builder(
				           ...
				           .addEffect(
						           ...
						           EnchantmentEffectTarget.VICTIM,
						           AllOfEnchantmentEffects.allOf(
								           new SummonEntityEnchantmentEffect(
										           RegistryEntryList.of(EntityType.LIGHTNING_BOLT.getRegistryEntry()),
										           false
								           ),
								           new PlaySoundEnchantmentEffect(
										           List.of(SoundEvents.ITEM_TRIDENT_THUNDER),
		...
		register(
				...
				Enchantment.builder(
				           ...
				           .addEffect(
						           ...
						           new AddEnchantmentEffect(EnchantmentLevelBasedValue.linear(10.0F))
				           )
		);
		register(
				registry,
				...
				Enchantment.builder(
				           ...
				           .addNonListEffect(
						           EnchantmentEffectComponentTypes.CROSSBOW_CHARGE_TIME,
				           ...
				           .addNonListEffect(
						           ...
						           List.of(
								           new CrossbowItem.LoadingSounds(
										           Optional.of(SoundEvents.ITEM_CROSSBOW_QUICK_CHARGE_1),
										           Optional.empty(),
										           Optional.of(SoundEvents.ITEM_CROSSBOW_LOADING_END)
								           ),
								           new CrossbowItem.LoadingSounds(
										           Optional.of(SoundEvents.ITEM_CROSSBOW_QUICK_CHARGE_2),
										           Optional.empty(),
										           Optional.of(SoundEvents.ITEM_CROSSBOW_LOADING_END)
								           ),
								           new CrossbowItem.LoadingSounds(
										           Optional.of(SoundEvents.ITEM_CROSSBOW_QUICK_CHARGE_3),
										           Optional.empty(),
										           Optional.of(SoundEvents.ITEM_CROSSBOW_LOADING_END)
								           )
						           )
				...
				Enchantment.builder(
				           ...
				           .addEffect(
						           ...
						           new ExplodeEnchantmentEffect(
								           false,
								           Optional.empty(),
								           Optional.of(EnchantmentLevelBasedValue.lookup(
						           ...
						           EntityPropertiesLootCondition.builder(
								           ...
								           EntityPredicate.Builder.create()
								                                  .flags(EntityFlagsPredicate.Builder
										                                  .create()
										                                  .flying(false))
								                                  .movement(MovementPredicate.fallDistance(NumberRange.DoubleRange.atLeast(
										                                  1.5)))
						           )
				           )
		);
