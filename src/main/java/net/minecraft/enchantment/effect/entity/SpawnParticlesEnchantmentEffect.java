...
public record SpawnParticlesEnchantmentEffect(
   ...
   public record PositionSource(SpawnParticlesEnchantmentEffect.PositionSourceType type, float offset, float scale) {
      ...
      public static final MapCodec<SpawnParticlesEnchantmentEffect.PositionSource> CODEC = (MapCodec<SpawnParticlesEnchantmentEffect.PositionSource>) RecordCodecBuilder.<SpawnParticlesEnchantmentEffect.PositionSource>mapCodec(
            instance -> instance.group(
