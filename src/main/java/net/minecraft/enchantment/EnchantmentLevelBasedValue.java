...
public interface EnchantmentLevelBasedValue {
   ...
   public record Exponent(EnchantmentLevelBasedValue base, EnchantmentLevelBasedValue power) implements EnchantmentLevelBasedValue {
      public static final MapCodec<EnchantmentLevelBasedValue.Exponent> CODEC = RecordCodecBuilder.mapCodec(
         instance -> instance.group(
               EnchantmentLevelBasedValue.CODEC.fieldOf("base").forGetter(EnchantmentLevelBasedValue.Exponent::base),
               EnchantmentLevelBasedValue.CODEC.fieldOf("power").forGetter(EnchantmentLevelBasedValue.Exponent::power)
            )
