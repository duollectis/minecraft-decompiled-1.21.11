...
public class EnchantmentHelper {
   ...
   public static void forEachEnchantment(ItemStack stack, EquipmentSlot slot, LivingEntity entity, EnchantmentHelper.ContextAwareConsumer contextAwareConsumer) {
      if (!stack.isEmpty()) {
   ...
   public static void onAttack(ServerWorld world, Entity attacker) {
      if (attacker instanceof LivingEntity livingEntity) {
         forEachEnchantment(
            ...
            livingEntity,
            (enchantment, level, context) -> enchantment.value().onPiercingAttack(world, level, context, attacker)
         );
      }
   }
   ...
   public static void onTargetDamaged(
      ServerWorld world, Entity target, DamageSource damageSource, @Nullable ItemStack weapon, java.util.function.@Nullable Consumer<Item> breakCallback
   ) {
