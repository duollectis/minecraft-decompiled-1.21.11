...
public class BeehiveBlock extends BlockWithEntity {
   ...
   public static void dropHoneycomb(
      ServerWorld world, ItemStack tool, BlockState state, @Nullable BlockEntity blockEntity, @Nullable Entity interactingEntity, BlockPos pos
   ) {
      generateBlockInteractLoot(
         world, LootTables.BEEHIVE_HARVEST, state, blockEntity, tool, interactingEntity, (worldx, stack) -> dropStack(worldx, pos, stack)
      );
   }
