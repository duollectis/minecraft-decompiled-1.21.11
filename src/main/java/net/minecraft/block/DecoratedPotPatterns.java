...
/**
 * Реестр всех паттернов декорированного горшка. Содержит маппинг черепков на паттерны
 * и регистрирует их в игровом реестре.
 */
public class DecoratedPotPatterns {
	...
	private static DecoratedPotPattern register(
			Registry<DecoratedPotPattern> registry,
			RegistryKey<DecoratedPotPattern> key,
			String id
	) {
