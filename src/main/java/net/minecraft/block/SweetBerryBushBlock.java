...
public class SweetBerryBushBlock extends PlantBlock implements Fertilizable {
	...
	protected void onEntityCollision(
		...
		if (entity instanceof LivingEntity && entity.getType() != EntityType.FOX
			...
			if (world instanceof ServerWorld serverWorld && state.get(AGE) != 0) {
				Vec3d
						vec3d =
						entity.isControlledByPlayer() ? entity.getMovement()
	...
	protected ActionResult onUseWithItem(
		...
		int i = state.get(AGE);
		boolean bl = i == 3;
		return (ActionResult) (!bl && stack.isOf(Items.BONE_MEAL) ? ActionResult.PASS : super.onUseWithItem(
				stack,
				state,
				world,
				pos,
