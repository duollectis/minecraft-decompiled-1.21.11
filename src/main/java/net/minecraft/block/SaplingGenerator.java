...
public final class SaplingGenerator {
	...
	public static final Codec<SaplingGenerator>
			CODEC =
	...
	public static final SaplingGenerator BIRCH = new SaplingGenerator(
			"birch",
			Optional.empty(),
			Optional.of(TreeConfiguredFeatures.BIRCH),
			Optional.of(TreeConfiguredFeatures.BIRCH_BEES_005)
	);
	public static final SaplingGenerator JUNGLE = new SaplingGenerator(
			"jungle",
			Optional.of(TreeConfiguredFeatures.MEGA_JUNGLE_TREE),
			Optional.of(TreeConfiguredFeatures.JUNGLE_TREE_NO_VINE),
			Optional.empty()
	);
	public static final SaplingGenerator
			...
			new SaplingGenerator(
					"acacia",
					Optional.empty(),
					Optional.of(TreeConfiguredFeatures.ACACIA),
					Optional.empty()
			);
	public static final SaplingGenerator CHERRY = new SaplingGenerator(
			"cherry",
			Optional.empty(),
			Optional.of(TreeConfiguredFeatures.CHERRY),
			Optional.of(TreeConfiguredFeatures.CHERRY_BEES_005)
	);
	...
	private @Nullable RegistryKey<ConfiguredFeature<?, ?>> getSmallTreeFeature(Random random, boolean flowersNearby) {
		...
		return flowersNearby && this.beesVariant.isPresent() ? this.beesVariant.get()
		                                                     : this.regularVariant.orElse(null);
	}

	private @Nullable RegistryKey<ConfiguredFeature<?, ?>> getMegaTreeFeature(Random random) {
		return this.rareMegaVariant.isPresent() && random.nextFloat() < this.rareChance ? this.rareMegaVariant.get()
