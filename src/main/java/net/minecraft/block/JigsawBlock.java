...
public class JigsawBlock extends Block implements BlockEntityProvider, OperatorBlock {
	...
	public static boolean attachmentMatches(
			StructureTemplate.JigsawBlockInfo info1,
			StructureTemplate.JigsawBlockInfo info2
	) {
		...
		return direction == direction2.getOpposite() && (bl || direction3 == direction4) && info1
				.target()
				.equals(info2.name());
	}
