...
public class Blocks {
	...
	private static final AbstractBlock.ContextPredicate
			SHULKER_BOX_SUFFOCATES_PREDICATE =
	...
	public static final Block
			...
			register(
					"air",
					AirBlock::new,
					AbstractBlock.Settings.create().replaceable().noCollision().dropsNothing().air()
			);
	...
	public static final Block DIRT = register(
			"dirt",
			AbstractBlock.Settings.create().mapColor(MapColor.DIRT_BROWN).strength(0.5F).sounds(BlockSoundGroup.GRAVEL)
	);
	...
	public static final Block SPRUCE_LOG = register(
			"spruce_log",
			PillarBlock::new,
			createLogSettings(MapColor.SPRUCE_BROWN, MapColor.BROWN, BlockSoundGroup.WOOD)
	);
	public static final Block BIRCH_LOG = register(
			"birch_log",
			PillarBlock::new,
			createLogSettings(MapColor.PALE_YELLOW, MapColor.OFF_WHITE, BlockSoundGroup.WOOD)
	);
	public static final Block JUNGLE_LOG = register(
			"jungle_log",
			PillarBlock::new,
			createLogSettings(MapColor.DIRT_BROWN, MapColor.SPRUCE_BROWN, BlockSoundGroup.WOOD)
	);
	public static final Block ACACIA_LOG = register(
			"acacia_log",
			PillarBlock::new,
			createLogSettings(MapColor.ORANGE, MapColor.STONE_GRAY, BlockSoundGroup.WOOD)
	);
	public static final Block CHERRY_LOG = register(
			"cherry_log",
			PillarBlock::new,
			createLogSettings(MapColor.TERRACOTTA_WHITE, MapColor.TERRACOTTA_GRAY, BlockSoundGroup.CHERRY_WOOD)
	);
	public static final Block
			DARK_OAK_LOG =
			register(
					"dark_oak_log",
					PillarBlock::new,
					createLogSettings(MapColor.BROWN, MapColor.BROWN, BlockSoundGroup.WOOD)
			);
	public static final Block PALE_OAK_LOG = register(
			"pale_oak_log",
			PillarBlock::new,
			createLogSettings(
					PALE_OAK_PLANKS.getDefaultMapColor(),
					PALE_OAK_WOOD.getDefaultMapColor(),
	...
	public static final Block MANGROVE_LOG = register(
			"mangrove_log",
			PillarBlock::new,
			createLogSettings(MapColor.RED, MapColor.SPRUCE_BROWN, BlockSoundGroup.WOOD)
	);
	...
	public static final Block BAMBOO_BLOCK = register(
			"bamboo_block",
			PillarBlock::new,
			createLogSettings(MapColor.YELLOW, MapColor.DARK_GREEN, BlockSoundGroup.BAMBOO_WOOD)
	);
	public static final Block STRIPPED_SPRUCE_LOG = register(
			"stripped_spruce_log",
			PillarBlock::new,
			createLogSettings(MapColor.SPRUCE_BROWN, MapColor.SPRUCE_BROWN, BlockSoundGroup.WOOD)
	);
	public static final Block STRIPPED_BIRCH_LOG = register(
			"stripped_birch_log",
			PillarBlock::new,
			createLogSettings(MapColor.PALE_YELLOW, MapColor.PALE_YELLOW, BlockSoundGroup.WOOD)
	);
	public static final Block STRIPPED_JUNGLE_LOG = register(
			"stripped_jungle_log",
			PillarBlock::new,
			createLogSettings(MapColor.DIRT_BROWN, MapColor.DIRT_BROWN, BlockSoundGroup.WOOD)
	);
	public static final Block STRIPPED_ACACIA_LOG = register(
			"stripped_acacia_log",
			PillarBlock::new,
			createLogSettings(MapColor.ORANGE, MapColor.ORANGE, BlockSoundGroup.WOOD)
	);
	public static final Block STRIPPED_CHERRY_LOG = register(
			"stripped_cherry_log",
			PillarBlock::new,
			createLogSettings(MapColor.TERRACOTTA_WHITE, MapColor.TERRACOTTA_PINK, BlockSoundGroup.CHERRY_WOOD)
	);
	...
	public static final Block STRIPPED_MANGROVE_LOG = register(
			...
			PillarBlock::new,
			createLogSettings(MapColor.RED, MapColor.RED, BlockSoundGroup.WOOD)
	);
	public static final Block STRIPPED_BAMBOO_BLOCK = register(
			"stripped_bamboo_block",
			PillarBlock::new,
			createLogSettings(MapColor.YELLOW, MapColor.YELLOW, BlockSoundGroup.BAMBOO_WOOD)
	);
	...
	public static final Block MANGROVE_LEAVES = register(
			"mangrove_leaves",
			settings -> new MangroveLeavesBlock(0.01F, settings),
			createLeavesSettings(BlockSoundGroup.GRASS)
	);
	public static final Block AZALEA_LEAVES = register(
			...
			settings -> new UntintedParticleLeavesBlock(
					0.01F,
					TintedParticleEffect.create(ParticleTypes.TINTED_LEAVES, -9399763),
					settings
			),
	...
	public static final Block SPONGE = register(
			"sponge",
			SpongeBlock::new,
			AbstractBlock.Settings.create().mapColor(MapColor.YELLOW).strength(0.6F).sounds(BlockSoundGroup.SPONGE)
	);
	public static final Block WET_SPONGE = register(
			"wet_sponge",
			WetSpongeBlock::new,
			AbstractBlock.Settings.create().mapColor(MapColor.YELLOW).strength(0.6F).sounds(BlockSoundGroup.WET_SPONGE)
	);
	...
	public static final Block LAPIS_BLOCK = register(
			"lapis_block",
			AbstractBlock.Settings.create().mapColor(MapColor.LAPIS_BLUE).requiresTool().strength(3.0F, 3.0F)
	);
	...
	public static final Block
			STICKY_PISTON =
			register("sticky_piston", settings -> new PistonBlock(true, settings), createPistonSettings());
	...
	public static final Block
			PISTON =
			register("piston", settings -> new PistonBlock(false, settings), createPistonSettings());
	...
	public static final Block WHEAT = register(
			...
			CropBlock::new,
			AbstractBlock.Settings.create()
			                      .mapColor(state -> state.get(CropBlock.AGE) >= 6 ? MapColor.YELLOW
			                                                                       : MapColor.DARK_GREEN)
			                      .noCollision()
			                      .ticksRandomly()
			                      .breakInstantly()
	...
	public static final Block ACACIA_WALL_SIGN = register(
			...
			copyLootTable(ACACIA_SIGN, true)
					.mapColor(MapColor.ORANGE)
					.solid()
					.instrument(NoteBlockInstrument.BASS)
					.noCollision()
	...
	public static final Block SPRUCE_WALL_HANGING_SIGN = register(
			...
			copyLootTable(SPRUCE_HANGING_SIGN, true)
					.mapColor(MapColor.OAK_TAN)
					.solid()
					.instrument(NoteBlockInstrument.BASS)
					.noCollision()
	...
	public static final Block ACACIA_WALL_HANGING_SIGN = register(
			...
			copyLootTable(ACACIA_HANGING_SIGN, true)
					.mapColor(MapColor.ORANGE)
					.solid()
					.instrument(NoteBlockInstrument.BASS)
					.noCollision()
	...
	public static final Block CRIMSON_WALL_HANGING_SIGN = register(
			...
			copyLootTable(CRIMSON_HANGING_SIGN, true)
					.mapColor(MapColor.DULL_PINK)
					.solid()
					.instrument(NoteBlockInstrument.BASS)
					.noCollision()
	...
	public static final Block WARPED_WALL_HANGING_SIGN = register(
			...
			copyLootTable(WARPED_HANGING_SIGN, true)
					.mapColor(MapColor.DARK_AQUA)
					.solid()
					.instrument(NoteBlockInstrument.BASS)
					.noCollision()
	...
	public static final Block BAMBOO_WALL_HANGING_SIGN = register(
			...
			copyLootTable(BAMBOO_HANGING_SIGN, true)
					.mapColor(MapColor.YELLOW)
					.solid()
					.instrument(NoteBlockInstrument.BASS)
					.noCollision()
	...
	public static final Block SOUL_SOIL = register(
			"soul_soil",
			AbstractBlock.Settings.create().mapColor(MapColor.BROWN).strength(0.5F).sounds(BlockSoundGroup.SOUL_SOIL)
	);
	...
	public static final Block COPPER_TORCH = register(
			"copper_torch",
			settings -> new TorchBlock(ParticleTypes.COPPER_FIRE_FLAME, settings),
			AbstractBlock.Settings
					.create()
					.noCollision()
					.breakInstantly()
	...
	public static final Block COPPER_WALL_TORCH = register(
			"copper_wall_torch",
			settings -> new WallTorchBlock(ParticleTypes.COPPER_FIRE_FLAME, settings),
			copyLootTable(COPPER_TORCH, true)
					.noCollision()
					.breakInstantly()
					.luminance(state -> 14)
					.sounds(BlockSoundGroup.WOOD)
	...
	public static final Block
			...
			registerStainedGlassBlock("magenta_stained_glass", DyeColor.MAGENTA);
	public static final Block
			LIGHT_BLUE_STAINED_GLASS =
			registerStainedGlassBlock("light_blue_stained_glass", DyeColor.LIGHT_BLUE);
	...
	public static final Block
			...
			registerStainedGlassBlock("light_gray_stained_glass", DyeColor.LIGHT_GRAY);
	...
	public static final Block PACKED_MUD = register(
			"packed_mud",
			AbstractBlock.Settings.copyShallow(DIRT).strength(1.0F, 3.0F).sounds(BlockSoundGroup.PACKED_MUD)
	);
	...
	public static final Block INFESTED_STONE = register(
			"infested_stone",
			settings -> new InfestedBlock(STONE, settings),
	...
	public static final Block INFESTED_COBBLESTONE = register(
			...
			settings -> new InfestedBlock(COBBLESTONE, settings),
			AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_BLUE_GRAY)
	);
	public static final Block INFESTED_STONE_BRICKS = register(
			"infested_stone_bricks",
			settings -> new InfestedBlock(STONE_BRICKS, settings),
			AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_BLUE_GRAY)
	);
	...
	public static final Block IRON_BARS = register(
			"iron_bars",
			PaneBlock::new,
			AbstractBlock.Settings.create().requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.IRON).nonOpaque()
	);
	public static final CopperBlockSet COPPER_BARS = CopperBlockSet.create(
			"copper_bars",
			Blocks::register,
			PaneBlock::new,
			OxidizablePaneBlock::new,
			oxidationLevel -> AbstractBlock.Settings
					.create()
					.requiresTool()
					.strength(5.0F, 6.0F)
	...
	public static final CopperBlockSet COPPER_CHAINS = CopperBlockSet.create(
			"copper_chain",
			Blocks::register,
			ChainBlock::new,
			OxidizableChainBlock::new,
			oxidationLevel -> AbstractBlock.Settings
					.create()
					.solid()
					.requiresTool()
	...
	public static final Block CAULDRON = register(
			"cauldron",
			CauldronBlock::new,
			AbstractBlock.Settings.create().mapColor(MapColor.STONE_GRAY).requiresTool().strength(2.0F).nonOpaque()
	);
	public static final Block WATER_CAULDRON = register(
			"water_cauldron",
			settings -> new LeveledCauldronBlock(
	...
	public static final Block TRIPWIRE = register(
			"tripwire",
			settings -> new TripwireBlock(TRIPWIRE_HOOK, settings),
	...
	public static final Block
			COBBLESTONE_WALL =
			register("cobblestone_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(COBBLESTONE).solid());
	...
	public static final Block
			FLOWER_POT =
			register("flower_pot", settings -> new FlowerPotBlock(AIR, settings), createFlowerPotSettings());
	...
	public static final Block POTTED_DARK_OAK_SAPLING = register(
			...
			settings -> new FlowerPotBlock(DARK_OAK_SAPLING, settings),
			createFlowerPotSettings()
	);
	public static final Block POTTED_PALE_OAK_SAPLING = register(
			"potted_pale_oak_sapling",
			settings -> new FlowerPotBlock(PALE_OAK_SAPLING, settings),
			createFlowerPotSettings()
	);
	public static final Block POTTED_MANGROVE_PROPAGULE = register(
			"potted_mangrove_propagule",
			settings -> new FlowerPotBlock(MANGROVE_PROPAGULE, settings),
			createFlowerPotSettings()
	);
	public static final Block
			POTTED_FERN =
			register("potted_fern", settings -> new FlowerPotBlock(FERN, settings), createFlowerPotSettings());
	public static final Block
			POTTED_DANDELION =
			register(
					"potted_dandelion",
					settings -> new FlowerPotBlock(DANDELION, settings),
					createFlowerPotSettings()
			);
	public static final Block
			POTTED_POPPY =
			register("potted_poppy", settings -> new FlowerPotBlock(POPPY, settings), createFlowerPotSettings());
	...
	public static final Block
			POTTED_ALLIUM =
			register("potted_allium", settings -> new FlowerPotBlock(ALLIUM, settings), createFlowerPotSettings());
	...
	public static final Block
			...
			register(
					"potted_red_tulip",
					settings -> new FlowerPotBlock(RED_TULIP, settings),
					createFlowerPotSettings()
			);
	...
	public static final Block
			...
			register(
					"potted_pink_tulip",
					settings -> new FlowerPotBlock(PINK_TULIP, settings),
					createFlowerPotSettings()
			);
	...
	public static final Block
			...
			register(
					"potted_cornflower",
					settings -> new FlowerPotBlock(CORNFLOWER, settings),
					createFlowerPotSettings()
			);
	public static final Block POTTED_LILY_OF_THE_VALLEY = register(
			"potted_lily_of_the_valley",
			settings -> new FlowerPotBlock(LILY_OF_THE_VALLEY, settings),
			createFlowerPotSettings()
	);
	...
	public static final Block
			...
			register(
					"potted_dead_bush",
					settings -> new FlowerPotBlock(DEAD_BUSH, settings),
					createFlowerPotSettings()
			);
	public static final Block
			POTTED_CACTUS =
			register("potted_cactus", settings -> new FlowerPotBlock(CACTUS, settings), createFlowerPotSettings());
	...
	public static final Block
			OAK_BUTTON =
			register("oak_button", settings -> new ButtonBlock(BlockSetType.OAK, 30, settings), createButtonSettings());
	public static final Block
			SPRUCE_BUTTON =
			register(
					"spruce_button",
					settings -> new ButtonBlock(BlockSetType.SPRUCE, 30, settings),
					createButtonSettings()
			);
	public static final Block
			BIRCH_BUTTON =
			register(
					"birch_button",
					settings -> new ButtonBlock(BlockSetType.BIRCH, 30, settings),
					createButtonSettings()
			);
	public static final Block
			JUNGLE_BUTTON =
			register(
					"jungle_button",
					settings -> new ButtonBlock(BlockSetType.JUNGLE, 30, settings),
					createButtonSettings()
			);
	public static final Block
			ACACIA_BUTTON =
			register(
					"acacia_button",
					settings -> new ButtonBlock(BlockSetType.ACACIA, 30, settings),
					createButtonSettings()
			);
	public static final Block
			CHERRY_BUTTON =
	...
	public static final Block WITHER_SKELETON_WALL_SKULL = register(
			...
			copyLootTable(WITHER_SKELETON_SKULL, true).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY)
	);
	...
	public static final Block PLAYER_WALL_HEAD = register(
			...
			copyLootTable(PLAYER_HEAD, true).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY)
	);
	...
	public static final Block PIGLIN_WALL_HEAD = register(
			...
			copyLootTable(PIGLIN_HEAD, true).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY)
	);
	...
	public static final Block
			...
			registerOldStairsBlock("prismarine_brick_stairs", PRISMARINE_BRICKS);
	public static final Block
			DARK_PRISMARINE_STAIRS =
			registerOldStairsBlock("dark_prismarine_stairs", DARK_PRISMARINE);
	...
	public static final Block NETHER_WART_BLOCK = register(
			"nether_wart_block",
			AbstractBlock.Settings.create().mapColor(MapColor.RED).strength(1.0F).sounds(BlockSoundGroup.WART_BLOCK)
	);
	...
	public static final Block DRIED_KELP_BLOCK = register(
			"dried_kelp_block",
			AbstractBlock.Settings.create().mapColor(MapColor.GREEN).strength(0.5F, 2.5F).sounds(BlockSoundGroup.GRASS)
	);
	...
	public static final Block SEA_PICKLE = register(
			...
			AbstractBlock.Settings.create()
			                      .mapColor(MapColor.GREEN)
			                      .luminance(state -> SeaPickleBlock.isDry(state) ? 0 : 3 + 3
			                                                                                * state.get(SeaPickleBlock.PICKLES))
			                      .sounds(BlockSoundGroup.SLIME)
			                      .nonOpaque()
			                      .pistonBehavior(PistonBehavior.DESTROY)
	);
	...
	public static final Block
			POTTED_BAMBOO =
			register("potted_bamboo", settings -> new FlowerPotBlock(BAMBOO, settings), createFlowerPotSettings());
	public static final Block
			VOID_AIR =
			register(
					"void_air",
	...
	public static final Block
			...
			registerOldStairsBlock("polished_granite_stairs", POLISHED_GRANITE);
	public static final Block
			SMOOTH_RED_SANDSTONE_STAIRS =
			registerOldStairsBlock("smooth_red_sandstone_stairs", SMOOTH_RED_SANDSTONE);
	public static final Block
			MOSSY_STONE_BRICK_STAIRS =
			registerOldStairsBlock("mossy_stone_brick_stairs", MOSSY_STONE_BRICKS);
	public static final Block
			POLISHED_DIORITE_STAIRS =
			registerOldStairsBlock("polished_diorite_stairs", POLISHED_DIORITE);
	public static final Block
			MOSSY_COBBLESTONE_STAIRS =
			registerOldStairsBlock("mossy_cobblestone_stairs", MOSSY_COBBLESTONE);
	public static final Block
			END_STONE_BRICK_STAIRS =
			registerOldStairsBlock("end_stone_brick_stairs", END_STONE_BRICKS);
	public static final Block STONE_STAIRS = registerOldStairsBlock("stone_stairs", STONE);
	public static final Block
			SMOOTH_SANDSTONE_STAIRS =
			registerOldStairsBlock("smooth_sandstone_stairs", SMOOTH_SANDSTONE);
	...
	public static final Block
			...
			registerOldStairsBlock("red_nether_brick_stairs", RED_NETHER_BRICKS);
	public static final Block
			POLISHED_ANDESITE_STAIRS =
			registerOldStairsBlock("polished_andesite_stairs", POLISHED_ANDESITE);
	public static final Block DIORITE_STAIRS = registerOldStairsBlock("diorite_stairs", DIORITE);
	public static final Block
			POLISHED_GRANITE_SLAB =
			register("polished_granite_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(POLISHED_GRANITE));
	...
	public static final Block
			...
			register("mossy_stone_brick_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(MOSSY_STONE_BRICKS));
	public static final Block
			POLISHED_DIORITE_SLAB =
			register("polished_diorite_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(POLISHED_DIORITE));
	public static final Block
			MOSSY_COBBLESTONE_SLAB =
			register("mossy_cobblestone_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(MOSSY_COBBLESTONE));
	public static final Block
			END_STONE_BRICK_SLAB =
			register("end_stone_brick_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(END_STONE_BRICKS));
	public static final Block
			SMOOTH_SANDSTONE_SLAB =
			register("smooth_sandstone_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(SMOOTH_SANDSTONE));
	public static final Block
			SMOOTH_QUARTZ_SLAB =
			register("smooth_quartz_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(SMOOTH_QUARTZ));
	public static final Block
			GRANITE_SLAB =
			register("granite_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(GRANITE));
	public static final Block
			ANDESITE_SLAB =
			register("andesite_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(ANDESITE));
	public static final Block
			RED_NETHER_BRICK_SLAB =
			register("red_nether_brick_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(RED_NETHER_BRICKS));
	public static final Block
			POLISHED_ANDESITE_SLAB =
			register("polished_andesite_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(POLISHED_ANDESITE));
	public static final Block
			DIORITE_SLAB =
			register("diorite_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(DIORITE));
	public static final Block
			BRICK_WALL =
			register("brick_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(BRICKS).solid());
	public static final Block
			PRISMARINE_WALL =
			register("prismarine_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(PRISMARINE).solid());
	public static final Block
			RED_SANDSTONE_WALL =
			register("red_sandstone_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(RED_SANDSTONE).solid());
	...
	public static final Block
			GRANITE_WALL =
			register("granite_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(GRANITE).solid());
	public static final Block
			STONE_BRICK_WALL =
			register("stone_brick_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(STONE_BRICKS).solid());
	public static final Block
			MUD_BRICK_WALL =
			register("mud_brick_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(MUD_BRICKS).solid());
	public static final Block
			NETHER_BRICK_WALL =
			register("nether_brick_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(NETHER_BRICKS).solid());
	public static final Block
			ANDESITE_WALL =
			register("andesite_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(ANDESITE).solid());
	...
	public static final Block
			SANDSTONE_WALL =
			register("sandstone_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(SANDSTONE).solid());
	...
	public static final Block
			DIORITE_WALL =
			register("diorite_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(DIORITE).solid());
	...
	public static final CopperBlockSet COPPER_LANTERNS = CopperBlockSet.create(
			"copper_lantern",
			Blocks::register,
			LanternBlock::new,
	...
	public static final Block
			WARPED_STEM =
			register("warped_stem", PillarBlock::new, createNetherStemSettings(MapColor.DARK_AQUA));
	public static final Block
			STRIPPED_WARPED_STEM =
			register("stripped_warped_stem", PillarBlock::new, createNetherStemSettings(MapColor.DARK_AQUA));
	...
	public static final Block
			CRIMSON_STEM =
			register("crimson_stem", PillarBlock::new, createNetherStemSettings(MapColor.DULL_PINK));
	public static final Block
			STRIPPED_CRIMSON_STEM =
			register("stripped_crimson_stem", PillarBlock::new, createNetherStemSettings(MapColor.DULL_PINK));
	...
	public static final Block CRIMSON_WALL_SIGN = register(
			...
			copyLootTable(CRIMSON_SIGN, true)
					.mapColor(CRIMSON_PLANKS.getDefaultMapColor())
					.instrument(NoteBlockInstrument.BASS)
					.solid()
					.noCollision()
	...
	public static final Block WARPED_WALL_SIGN = register(
			...
			copyLootTable(WARPED_SIGN, true)
					.mapColor(WARPED_PLANKS.getDefaultMapColor())
					.instrument(NoteBlockInstrument.BASS)
					.solid()
					.noCollision()
	...
	public static final Block TEST_BLOCK = register(
			"test_block",
			TestBlock::new,
			AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_GRAY).strength(-1.0F, 3600000.0F).dropsNothing()
	);
	...
	public static final Block TARGET = register(
			"target",
			TargetBlock::new,
			AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).strength(0.5F).sounds(BlockSoundGroup.GRASS)
	);
	...
	public static final Block
			BLACKSTONE_WALL =
			register("blackstone_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(BLACKSTONE).solid());
	public static final Block
			BLACKSTONE_SLAB =
			register(
					"blackstone_slab",
					SlabBlock::new,
					AbstractBlock.Settings.copyShallow(BLACKSTONE).strength(2.0F, 6.0F)
			);
	public static final Block
			POLISHED_BLACKSTONE =
			register("polished_blackstone", AbstractBlock.Settings.copyShallow(BLACKSTONE).strength(2.0F, 6.0F));
	...
	public static final Block POLISHED_BLACKSTONE_BRICK_SLAB = register(
			...
			SlabBlock::new,
			AbstractBlock.Settings.copyShallow(POLISHED_BLACKSTONE_BRICKS).strength(2.0F, 6.0F)
	);
	public static final Block
			POLISHED_BLACKSTONE_BRICK_STAIRS =
			registerOldStairsBlock("polished_blackstone_brick_stairs", POLISHED_BLACKSTONE_BRICKS);
	public static final Block POLISHED_BLACKSTONE_BRICK_WALL = register(
			"polished_blackstone_brick_wall",
			WallBlock::new,
			AbstractBlock.Settings.copyShallow(POLISHED_BLACKSTONE_BRICKS).solid()
	);
	public static final Block GILDED_BLACKSTONE = register(
			"gilded_blackstone",
			AbstractBlock.Settings.copyShallow(BLACKSTONE).sounds(BlockSoundGroup.GILDED_BLACKSTONE)
	);
	public static final Block
			POLISHED_BLACKSTONE_STAIRS =
			registerOldStairsBlock("polished_blackstone_stairs", POLISHED_BLACKSTONE);
	...
	public static final Block
			QUARTZ_BRICKS =
			register("quartz_bricks", AbstractBlock.Settings.copyShallow(QUARTZ_BLOCK));
	public static final Block CANDLE = register("candle", CandleBlock::new, createCandleSettings(MapColor.PALE_YELLOW));
	public static final Block
			WHITE_CANDLE =
			register("white_candle", CandleBlock::new, createCandleSettings(MapColor.WHITE_GRAY));
	public static final Block
			ORANGE_CANDLE =
			register("orange_candle", CandleBlock::new, createCandleSettings(MapColor.ORANGE));
	public static final Block
			MAGENTA_CANDLE =
			register("magenta_candle", CandleBlock::new, createCandleSettings(MapColor.MAGENTA));
	public static final Block
			LIGHT_BLUE_CANDLE =
			register("light_blue_candle", CandleBlock::new, createCandleSettings(MapColor.LIGHT_BLUE));
	public static final Block
			YELLOW_CANDLE =
			register("yellow_candle", CandleBlock::new, createCandleSettings(MapColor.YELLOW));
	public static final Block
			LIME_CANDLE =
			register("lime_candle", CandleBlock::new, createCandleSettings(MapColor.LIME));
	public static final Block
			PINK_CANDLE =
			register("pink_candle", CandleBlock::new, createCandleSettings(MapColor.PINK));
	public static final Block
			GRAY_CANDLE =
			register("gray_candle", CandleBlock::new, createCandleSettings(MapColor.GRAY));
	public static final Block
			LIGHT_GRAY_CANDLE =
			register("light_gray_candle", CandleBlock::new, createCandleSettings(MapColor.LIGHT_GRAY));
	public static final Block
			CYAN_CANDLE =
			register("cyan_candle", CandleBlock::new, createCandleSettings(MapColor.CYAN));
	public static final Block
			PURPLE_CANDLE =
			register("purple_candle", CandleBlock::new, createCandleSettings(MapColor.PURPLE));
	public static final Block
			BLUE_CANDLE =
			register("blue_candle", CandleBlock::new, createCandleSettings(MapColor.BLUE));
	public static final Block
			BROWN_CANDLE =
			register("brown_candle", CandleBlock::new, createCandleSettings(MapColor.BROWN));
	public static final Block
			GREEN_CANDLE =
			register("green_candle", CandleBlock::new, createCandleSettings(MapColor.GREEN));
	public static final Block RED_CANDLE = register("red_candle", CandleBlock::new, createCandleSettings(MapColor.RED));
	public static final Block
			BLACK_CANDLE =
			register("black_candle", CandleBlock::new, createCandleSettings(MapColor.BLACK));
	...
	public static final Block
			TUFF_SLAB =
			register("tuff_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(TUFF));
	public static final Block TUFF_STAIRS = register(
			"tuff_stairs",
			settings -> new StairsBlock(TUFF.getDefaultState(), settings),
			AbstractBlock.Settings.copyShallow(TUFF)
	);
	public static final Block
			TUFF_WALL =
			register("tuff_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(TUFF).solid());
	public static final Block
			POLISHED_TUFF =
			register("polished_tuff", AbstractBlock.Settings.copyShallow(TUFF).sounds(BlockSoundGroup.POLISHED_TUFF));
	public static final Block
			POLISHED_TUFF_SLAB =
			register("polished_tuff_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(POLISHED_TUFF));
	public static final Block POLISHED_TUFF_STAIRS = register(
			"polished_tuff_stairs",
			settings -> new StairsBlock(POLISHED_TUFF.getDefaultState(), settings),
			AbstractBlock.Settings.copyShallow(POLISHED_TUFF)
	);
	public static final Block
			POLISHED_TUFF_WALL =
			register("polished_tuff_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(POLISHED_TUFF).solid());
	public static final Block CHISELED_TUFF = register("chiseled_tuff", AbstractBlock.Settings.copyShallow(TUFF));
	public static final Block
			TUFF_BRICKS =
			register("tuff_bricks", AbstractBlock.Settings.copyShallow(TUFF).sounds(BlockSoundGroup.TUFF_BRICKS));
	public static final Block
			TUFF_BRICK_SLAB =
			register("tuff_brick_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(TUFF_BRICKS));
	public static final Block TUFF_BRICK_STAIRS = register(
			"tuff_brick_stairs",
			settings -> new StairsBlock(TUFF_BRICKS.getDefaultState(), settings),
			AbstractBlock.Settings.copyShallow(TUFF_BRICKS)
	);
	public static final Block
			TUFF_BRICK_WALL =
			register("tuff_brick_wall", WallBlock::new, AbstractBlock.Settings.copyShallow(TUFF_BRICKS).solid());
	public static final Block
			CHISELED_TUFF_BRICKS =
			register("chiseled_tuff_bricks", AbstractBlock.Settings.copyShallow(TUFF_BRICKS));
	...
	public static final Block SCULK_SENSOR = register(
			...
			AbstractBlock.Settings.create()
			                      ...
			                      .luminance(state -> 1)
			                      .emissiveLighting((state, world, pos) -> SculkSensorBlock.getPhase(state)
	...
	public static final Block SCULK = register(
			"sculk",
			SculkBlock::new,
			AbstractBlock.Settings.create().mapColor(MapColor.BLACK).strength(0.2F).sounds(BlockSoundGroup.SCULK)
	);
	...
	public static final Block
			...
			register("waxed_oxidized_chiseled_copper", AbstractBlock.Settings.copy(OXIDIZED_CHISELED_COPPER));
	...
	public static final Block
			...
			register("waxed_exposed_chiseled_copper", AbstractBlock.Settings.copy(EXPOSED_CHISELED_COPPER));
	public static final Block
			WAXED_CHISELED_COPPER =
			register("waxed_chiseled_copper", AbstractBlock.Settings.copy(CHISELED_COPPER));
	public static final Block OXIDIZED_CUT_COPPER_STAIRS = register(
			"oxidized_cut_copper_stairs",
			settings -> new OxidizableStairsBlock(
					Oxidizable.OxidationLevel.OXIDIZED,
					OXIDIZED_CUT_COPPER.getDefaultState(),
					settings
			),
	...
	public static final Block WEATHERED_CUT_COPPER_STAIRS = register(
			...
			settings -> new OxidizableStairsBlock(
					...
					WEATHERED_CUT_COPPER.getDefaultState(),
					settings
			),
			AbstractBlock.Settings.copy(WEATHERED_COPPER)
	);
	public static final Block EXPOSED_CUT_COPPER_STAIRS = register(
			...
			settings -> new OxidizableStairsBlock(
					...
					EXPOSED_CUT_COPPER.getDefaultState(),
					settings
			),
			AbstractBlock.Settings.copy(EXPOSED_COPPER)
	);
	...
	public static final Block CUT_COPPER_SLAB = register(
			"cut_copper_slab",
			settings -> new OxidizableSlabBlock(Oxidizable.OxidationLevel.UNAFFECTED, settings),
			AbstractBlock.Settings.copy(CUT_COPPER)
	);
	public static final Block
			WAXED_COPPER_BLOCK =
			register("waxed_copper_block", AbstractBlock.Settings.copy(COPPER_BLOCK));
	public static final Block
			WAXED_WEATHERED_COPPER =
			register("waxed_weathered_copper", AbstractBlock.Settings.copy(WEATHERED_COPPER));
	public static final Block
			WAXED_EXPOSED_COPPER =
			register("waxed_exposed_copper", AbstractBlock.Settings.copy(EXPOSED_COPPER));
	public static final Block
			WAXED_OXIDIZED_COPPER =
			register("waxed_oxidized_copper", AbstractBlock.Settings.copy(OXIDIZED_COPPER));
	public static final Block
			WAXED_OXIDIZED_CUT_COPPER =
			register("waxed_oxidized_cut_copper", AbstractBlock.Settings.copy(OXIDIZED_COPPER));
	public static final Block
			WAXED_WEATHERED_CUT_COPPER =
			register("waxed_weathered_cut_copper", AbstractBlock.Settings.copy(WEATHERED_COPPER));
	public static final Block
			WAXED_EXPOSED_CUT_COPPER =
			register("waxed_exposed_cut_copper", AbstractBlock.Settings.copy(EXPOSED_COPPER));
	public static final Block
			WAXED_CUT_COPPER =
			register("waxed_cut_copper", AbstractBlock.Settings.copy(COPPER_BLOCK));
	public static final Block
			WAXED_OXIDIZED_CUT_COPPER_STAIRS =
			registerStairsBlock("waxed_oxidized_cut_copper_stairs", WAXED_OXIDIZED_CUT_COPPER);
	public static final Block
			WAXED_WEATHERED_CUT_COPPER_STAIRS =
			registerStairsBlock("waxed_weathered_cut_copper_stairs", WAXED_WEATHERED_CUT_COPPER);
	public static final Block
			WAXED_EXPOSED_CUT_COPPER_STAIRS =
			registerStairsBlock("waxed_exposed_cut_copper_stairs", WAXED_EXPOSED_CUT_COPPER);
	public static final Block
			WAXED_CUT_COPPER_STAIRS =
			registerStairsBlock("waxed_cut_copper_stairs", WAXED_CUT_COPPER);
	...
	public static final Block COPPER_TRAPDOOR = register(
			"copper_trapdoor",
			settings -> new OxidizableTrapdoorBlock(
					BlockSetType.COPPER,
					Oxidizable.OxidationLevel.UNAFFECTED,
					settings
			),
	...
	public static final Block
			WAXED_COPPER_GRATE =
			register("waxed_copper_grate", GrateBlock::new, AbstractBlock.Settings.copy(COPPER_GRATE));
	...
	public static final Block
			WAXED_COPPER_BULB =
			register("waxed_copper_bulb", BulbBlock::new, AbstractBlock.Settings.copy(COPPER_BULB));
	public static final Block
			WAXED_EXPOSED_COPPER_BULB =
			register("waxed_exposed_copper_bulb", BulbBlock::new, AbstractBlock.Settings.copy(EXPOSED_COPPER_BULB));
	...
	public static final Block COPPER_CHEST = register(
			"copper_chest",
			settings -> new OxidizableCopperChestBlock(
					Oxidizable.OxidationLevel.UNAFFECTED,
	...
	public static final Block COPPER_GOLEM_STATUE = register(
			"copper_golem_statue",
			settings -> new OxidizableCopperGolemStatueBlock(Oxidizable.OxidationLevel.UNAFFECTED, settings),
			AbstractBlock.Settings.create()
			                      .mapColor(COPPER_BLOCK.getDefaultMapColor())
			                      .strength(3.0F, 6.0F)
	...
	public static final Block EXPOSED_COPPER_GOLEM_STATUE = register(
			...
			settings -> new OxidizableCopperGolemStatueBlock(Oxidizable.OxidationLevel.EXPOSED, settings),
	...
	public static final Block WEATHERED_COPPER_GOLEM_STATUE = register(
			...
			settings -> new OxidizableCopperGolemStatueBlock(Oxidizable.OxidationLevel.WEATHERED, settings),
	...
	public static final Block OXIDIZED_COPPER_GOLEM_STATUE = register(
			...
			settings -> new OxidizableCopperGolemStatueBlock(Oxidizable.OxidationLevel.OXIDIZED, settings),
	...
	public static final Block WAXED_COPPER_GOLEM_STATUE = register(
			...
			settings -> new CopperGolemStatueBlock(Oxidizable.OxidationLevel.UNAFFECTED, settings),
	...
	public static final Block WAXED_EXPOSED_COPPER_GOLEM_STATUE = register(
			...
			settings -> new CopperGolemStatueBlock(Oxidizable.OxidationLevel.EXPOSED, settings),
	...
	public static final Block WAXED_WEATHERED_COPPER_GOLEM_STATUE = register(
			...
			settings -> new CopperGolemStatueBlock(Oxidizable.OxidationLevel.WEATHERED, settings),
	...
	public static final Block WAXED_OXIDIZED_COPPER_GOLEM_STATUE = register(
			...
			settings -> new CopperGolemStatueBlock(Oxidizable.OxidationLevel.OXIDIZED, settings),
			AbstractBlock.Settings.copy(OXIDIZED_COPPER_GOLEM_STATUE)
	);
	public static final Block LIGHTNING_ROD = register(
			"lightning_rod",
			settings -> new OxidizableLightningRodBlock(Oxidizable.OxidationLevel.UNAFFECTED, settings),
			AbstractBlock.Settings
					.create()
					.mapColor(MapColor.ORANGE)
					.solid()
	...
	public static final Block EXPOSED_LIGHTNING_ROD = register(
			...
			settings -> new OxidizableLightningRodBlock(Oxidizable.OxidationLevel.EXPOSED, settings),
	...
	public static final Block WEATHERED_LIGHTNING_ROD = register(
			...
			settings -> new OxidizableLightningRodBlock(Oxidizable.OxidationLevel.WEATHERED, settings),
	...
	public static final Block OXIDIZED_LIGHTNING_ROD = register(
			...
			settings -> new OxidizableLightningRodBlock(Oxidizable.OxidationLevel.OXIDIZED, settings),
			AbstractBlock.Settings.copy(LIGHTNING_ROD).mapColor(MapColor.TEAL)
	);
	public static final Block
			WAXED_LIGHTNING_ROD =
			register("waxed_lightning_rod", LightningRodBlock::new, AbstractBlock.Settings.copy(LIGHTNING_ROD));
	public static final Block WAXED_EXPOSED_LIGHTNING_ROD = register(
			"waxed_exposed_lightning_rod", LightningRodBlock::new, AbstractBlock.Settings.copy(EXPOSED_LIGHTNING_ROD)
	);
	...
	public static final Block WAXED_OXIDIZED_LIGHTNING_ROD = register(
			"waxed_oxidized_lightning_rod", LightningRodBlock::new, AbstractBlock.Settings.copy(OXIDIZED_LIGHTNING_ROD)
	);
	...
	public static final Block
			COBBLED_DEEPSLATE =
			register("cobbled_deepslate", AbstractBlock.Settings.copyShallow(DEEPSLATE).strength(3.5F, 6.0F));
	public static final Block
			COBBLED_DEEPSLATE_STAIRS =
			registerOldStairsBlock("cobbled_deepslate_stairs", COBBLED_DEEPSLATE);
	public static final Block
			COBBLED_DEEPSLATE_SLAB =
			register("cobbled_deepslate_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(COBBLED_DEEPSLATE));
	...
	public static final Block POLISHED_DEEPSLATE = register(
			"polished_deepslate",
			AbstractBlock.Settings.copyShallow(COBBLED_DEEPSLATE).sounds(BlockSoundGroup.POLISHED_DEEPSLATE)
	);
	public static final Block
			POLISHED_DEEPSLATE_STAIRS =
			registerOldStairsBlock("polished_deepslate_stairs", POLISHED_DEEPSLATE);
	...
	public static final Block DEEPSLATE_TILES = register(
			"deepslate_tiles",
			AbstractBlock.Settings.copyShallow(COBBLED_DEEPSLATE).sounds(BlockSoundGroup.DEEPSLATE_TILES)
	);
	public static final Block DEEPSLATE_TILE_STAIRS = registerOldStairsBlock("deepslate_tile_stairs", DEEPSLATE_TILES);
	public static final Block
			DEEPSLATE_TILE_SLAB =
			register("deepslate_tile_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(DEEPSLATE_TILES));
	public static final Block
			DEEPSLATE_TILE_WALL =
			register(
					"deepslate_tile_wall",
					WallBlock::new,
					AbstractBlock.Settings.copyShallow(DEEPSLATE_TILES).solid()
			);
	public static final Block DEEPSLATE_BRICKS = register(
			"deepslate_bricks",
			AbstractBlock.Settings.copyShallow(COBBLED_DEEPSLATE).sounds(BlockSoundGroup.DEEPSLATE_BRICKS)
	);
	public static final Block
			DEEPSLATE_BRICK_STAIRS =
			registerOldStairsBlock("deepslate_brick_stairs", DEEPSLATE_BRICKS);
	public static final Block
			DEEPSLATE_BRICK_SLAB =
			register("deepslate_brick_slab", SlabBlock::new, AbstractBlock.Settings.copyShallow(DEEPSLATE_BRICKS));
	...
	public static final Block
			...
			register("cracked_deepslate_bricks", AbstractBlock.Settings.copyShallow(DEEPSLATE_BRICKS));
	public static final Block
			CRACKED_DEEPSLATE_TILES =
			register("cracked_deepslate_tiles", AbstractBlock.Settings.copyShallow(DEEPSLATE_TILES));
	...
	public static final Block
			POTTED_AZALEA_BUSH =
			register("potted_azalea_bush", settings -> new FlowerPotBlock(AZALEA, settings), createFlowerPotSettings());
	public static final Block POTTED_FLOWERING_AZALEA_BUSH = register(
			"potted_flowering_azalea_bush",
			settings -> new FlowerPotBlock(FLOWERING_AZALEA, settings),
			createFlowerPotSettings()
	);
	...
	public static final Block CRAFTER = register(
			"crafter",
			CrafterBlock::new,
			AbstractBlock.Settings.create().mapColor(MapColor.STONE_GRAY).strength(1.5F, 3.5F)
	);
	...
	private static Block registerBedBlock(String id, DyeColor color) {
		return register(
				...
				AbstractBlock.Settings.create()
				                      .mapColor(state -> state.get(BedBlock.PART) == BedPart.FOOT ? color.getMapColor()
				                                                                                  : MapColor.WHITE_GRAY)
				                      .sounds(BlockSoundGroup.WOOD)
				                      .strength(0.2F)
				                      .nonOpaque()
	...
	public static AbstractBlock.Settings createLogSettings(
		...
		return AbstractBlock.Settings.create()
		                             .mapColor(state -> state.get(PillarBlock.AXIS) == Direction.Axis.Y ? topMapColor
		                                                                                                : sideMapColor)
		                             .instrument(NoteBlockInstrument.BASS)
		                             .strength(2.0F)
		                             .sounds(sounds)
	...
	private static Block registerOldStairsBlock(String id, Block base) {
		return register(
				id,
				settings -> new StairsBlock(base.getDefaultState(), settings),
