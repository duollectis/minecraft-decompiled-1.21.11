...
public class Blocks {
   ...
   public static final Block AZALEA_LEAVES = register(
      "azalea_leaves",
      settings -> new UntintedParticleLeavesBlock(0.01F, TintedParticleEffect.create(ParticleTypes.TINTED_LEAVES, -9399763), settings),
   ...
   public static final Block CHEST = register(
      "chest",
      settings -> new ChestBlock(() -> BlockEntityType.CHEST, SoundEvents.BLOCK_CHEST_OPEN, SoundEvents.BLOCK_CHEST_CLOSE, settings),
   ...
   public static final CopperBlockSet COPPER_BARS = CopperBlockSet.create(
      ...
      oxidationLevel -> AbstractBlock.Settings.create().requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.COPPER).nonOpaque()
   );
   public static final Block IRON_CHAIN = register(
      "iron_chain", ChainBlock::new, AbstractBlock.Settings.create().solid().requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.CHAIN).nonOpaque()
   );
   public static final CopperBlockSet COPPER_CHAINS = CopperBlockSet.create(
      ...
      oxidationLevel -> AbstractBlock.Settings.create().solid().requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.CHAIN).nonOpaque()
   );
   ...
   public static final Block SKELETON_SKULL = register(
      ...
      AbstractBlock.Settings.create().instrument(NoteBlockInstrument.SKELETON).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY).nonOpaque()
   );
   ...
   public static final Block WITHER_SKELETON_SKULL = register(
      ...
      AbstractBlock.Settings.create().instrument(NoteBlockInstrument.WITHER_SKELETON).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY).nonOpaque()
   );
   ...
   public static final Block ZOMBIE_HEAD = register(
      ...
      AbstractBlock.Settings.create().instrument(NoteBlockInstrument.ZOMBIE).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY).nonOpaque()
   );
   ...
   public static final Block PLAYER_HEAD = register(
      ...
      AbstractBlock.Settings.create().instrument(NoteBlockInstrument.CUSTOM_HEAD).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY).nonOpaque()
   );
   ...
   public static final Block CREEPER_HEAD = register(
      ...
      AbstractBlock.Settings.create().instrument(NoteBlockInstrument.CREEPER).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY).nonOpaque()
   );
   ...
   public static final Block DRAGON_HEAD = register(
      ...
      AbstractBlock.Settings.create().instrument(NoteBlockInstrument.DRAGON).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY).nonOpaque()
   );
   ...
   public static final Block PIGLIN_HEAD = register(
      ...
      AbstractBlock.Settings.create().instrument(NoteBlockInstrument.PIGLIN).strength(1.0F).pistonBehavior(PistonBehavior.DESTROY).nonOpaque()
   );
   ...
   public static final Block COPPER_CHEST = register(
      ...
      settings -> new OxidizableCopperChestBlock(
         Oxidizable.OxidationLevel.UNAFFECTED, SoundEvents.BLOCK_COPPER_CHEST_OPEN, SoundEvents.BLOCK_COPPER_CHEST_CLOSE, settings
      ),
      AbstractBlock.Settings.create().mapColor(COPPER_BLOCK.getDefaultMapColor()).strength(3.0F, 6.0F).sounds(BlockSoundGroup.COPPER).requiresTool()
   );
   public static final Block EXPOSED_COPPER_CHEST = register(
      "exposed_copper_chest",
      settings -> new OxidizableCopperChestBlock(
         Oxidizable.OxidationLevel.EXPOSED, SoundEvents.BLOCK_COPPER_CHEST_OPEN, SoundEvents.BLOCK_COPPER_CHEST_CLOSE, settings
      ),
   ...
   public static final Block WEATHERED_COPPER_CHEST = register(
      ...
      settings -> new OxidizableCopperChestBlock(
         Oxidizable.OxidationLevel.WEATHERED, SoundEvents.BLOCK_COPPER_CHEST_WEATHERED_OPEN, SoundEvents.BLOCK_COPPER_CHEST_WEATHERED_CLOSE, settings
      ),
   ...
   public static final Block OXIDIZED_COPPER_CHEST = register(
      ...
      settings -> new OxidizableCopperChestBlock(
         Oxidizable.OxidationLevel.OXIDIZED, SoundEvents.BLOCK_COPPER_CHEST_OXIDIZED_OPEN, SoundEvents.BLOCK_COPPER_CHEST_OXIDIZED_CLOSE, settings
      ),
   ...
   public static final Block WAXED_EXPOSED_COPPER_CHEST = register(
      ...
      settings -> new CopperChestBlock(Oxidizable.OxidationLevel.EXPOSED, SoundEvents.BLOCK_COPPER_CHEST_OPEN, SoundEvents.BLOCK_COPPER_CHEST_CLOSE, settings),
   ...
   public static final Block WAXED_LIGHTNING_ROD = register("waxed_lightning_rod", LightningRodBlock::new, AbstractBlock.Settings.copy(LIGHTNING_ROD));
   ...
   public static final Block WAXED_WEATHERED_LIGHTNING_ROD = register(
      "waxed_weathered_lightning_rod", LightningRodBlock::new, AbstractBlock.Settings.copy(WEATHERED_LIGHTNING_ROD)
   );
