...
public record TrialSpawnerConfig(
	...
	public static final Codec<TrialSpawnerConfig> CODEC = RecordCodecBuilder.create(
			instance -> instance.group(
					                    ...
					                    MobSpawnerEntry.DATA_POOL_CODEC
							                    .optionalFieldOf("spawn_potentials", Pool.empty())
							                    .forGetter(TrialSpawnerConfig::spawnPotentials),
					                    Pool.createCodec(LootTable.TABLE_KEY)
	...
	public static final Codec<RegistryEntry<TrialSpawnerConfig>>
			ENTRY_CODEC =
			RegistryElementCodec.of(RegistryKeys.TRIAL_SPAWNER, CODEC);
