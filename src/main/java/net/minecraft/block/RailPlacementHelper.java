...
public class RailPlacementHelper {
	...
	private boolean isVerticallyNearRail(BlockPos pos) {
		return AbstractRailBlock.isRail(this.world, pos) || AbstractRailBlock.isRail(this.world, pos.up())
	...
	private @Nullable RailPlacementHelper getNeighboringRail(BlockPos pos) {
		...
		if (AbstractRailBlock.isRail(blockState)) {
			...
			if (AbstractRailBlock.isRail(blockState)) {
				...
				blockPos = pos.down();
				blockState = this.world.getBlockState(blockPos);
				return AbstractRailBlock.isRail(blockState) ? new RailPlacementHelper(this.world, blockPos, blockState)
				                                            : null;
			}
		}
	}
