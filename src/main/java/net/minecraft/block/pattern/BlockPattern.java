...
public class BlockPattern {
   ...
   @VisibleForTesting
   public BlockPattern.@Nullable Result testTransform(WorldView world, BlockPos frontTopLeft, Direction forwards, Direction up) {
   ...
   private BlockPattern.@Nullable Result testTransform(
      BlockPos frontTopLeft, Direction forwards, Direction up, LoadingCache<BlockPos, CachedBlockPosition> cache
   ) {
