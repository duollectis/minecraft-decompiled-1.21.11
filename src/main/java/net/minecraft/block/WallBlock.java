...
public class WallBlock extends Block implements Waterloggable {
   ...
   private BlockState getStateWith(BlockState state, boolean north, boolean east, boolean south, boolean west, VoxelShape aboveShape) {
      return state.with(NORTH_WALL_SHAPE, this.getWallShape(north, aboveShape, WALL_SHAPES_FOR_TALL_TEST_BY_DIRECTION.get(Direction.NORTH)))
         .with(EAST_WALL_SHAPE, this.getWallShape(east, aboveShape, WALL_SHAPES_FOR_TALL_TEST_BY_DIRECTION.get(Direction.EAST)))
         .with(SOUTH_WALL_SHAPE, this.getWallShape(south, aboveShape, WALL_SHAPES_FOR_TALL_TEST_BY_DIRECTION.get(Direction.SOUTH)))
         .with(WEST_WALL_SHAPE, this.getWallShape(west, aboveShape, WALL_SHAPES_FOR_TALL_TEST_BY_DIRECTION.get(Direction.WEST)));
   }
