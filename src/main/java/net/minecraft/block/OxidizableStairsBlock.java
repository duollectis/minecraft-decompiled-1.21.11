	...
	public static final MapCodec<OxidizableStairsBlock> CODEC = RecordCodecBuilder.mapCodec(
			instance -> instance.group(
					                    Oxidizable.OxidationLevel.CODEC
							                    ...
							                    .forGetter(Degradable::getDegradationLevel),
					                    BlockState.CODEC
							                    .fieldOf("base_state")
							                    .forGetter(oxidizableStairsBlock -> oxidizableStairsBlock.baseBlockState),
					                    createSettingsCodec()
			                    )
