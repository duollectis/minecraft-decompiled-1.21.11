...
/**
 * Константы ключей реестра для блоков, используемых в логике стеблей и плодов
 * (тыква, дыня и их стебли). Применяются в {@link AttachedStemBlock} для поиска
 * связанного плода по направлению.
 */
