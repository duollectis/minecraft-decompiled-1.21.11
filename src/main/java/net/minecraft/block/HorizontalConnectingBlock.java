...
/**
 * {@code HorizontalConnectingBlock}.
 */
public abstract class HorizontalConnectingBlock extends Block implements Waterloggable {
	...
	protected HorizontalConnectingBlock(
		...
		super(settings);
		this.collisionShapeFunction =
				this.createShapeFunction(radius1, collisionHeight, boundingHeight1, 0.0F, collisionHeight);
	...
	protected Function<BlockState, VoxelShape> createShapeFunction(
		...
		Map<Direction, VoxelShape>
				map =
				VoxelShapes.createHorizontalFacingShapeMap(Block.createCuboidZShape(
						height1,
						offset2,
						height2,
						0.0,
