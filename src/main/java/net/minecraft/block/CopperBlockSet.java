   ...
   public static <WaxedBlock extends Block, WeatheringBlock extends Block & Oxidizable> CopperBlockSet create(
      ...
      return new CopperBlockSet(
         (Block)registerFunction.apply(
            baseId,
            (Function<AbstractBlock.Settings, Block>)settings -> unwaxedBlockFactory.apply(Oxidizable.OxidationLevel.UNAFFECTED, settings),
            settingsFromOxidationLevel.apply(Oxidizable.OxidationLevel.UNAFFECTED)
         ),
         (Block)registerFunction.apply(
            "exposed_" + baseId,
            (Function<AbstractBlock.Settings, Block>)settings -> unwaxedBlockFactory.apply(Oxidizable.OxidationLevel.EXPOSED, settings),
            settingsFromOxidationLevel.apply(Oxidizable.OxidationLevel.EXPOSED)
         ),
         (Block)registerFunction.apply(
            "weathered_" + baseId,
            (Function<AbstractBlock.Settings, Block>)settings -> unwaxedBlockFactory.apply(Oxidizable.OxidationLevel.WEATHERED, settings),
            settingsFromOxidationLevel.apply(Oxidizable.OxidationLevel.WEATHERED)
         ),
         (Block)registerFunction.apply(
            "oxidized_" + baseId,
            (Function<AbstractBlock.Settings, Block>)settings -> unwaxedBlockFactory.apply(Oxidizable.OxidationLevel.OXIDIZED, settings),
            settingsFromOxidationLevel.apply(Oxidizable.OxidationLevel.OXIDIZED)
         ),
         (Block)registerFunction.apply("waxed_" + baseId, waxedBlockFactory::apply, settingsFromOxidationLevel.apply(Oxidizable.OxidationLevel.UNAFFECTED)),
         (Block)registerFunction.apply("waxed_exposed_" + baseId, waxedBlockFactory::apply, settingsFromOxidationLevel.apply(Oxidizable.OxidationLevel.EXPOSED)),
         (Block)registerFunction.apply(
            "waxed_weathered_" + baseId, waxedBlockFactory::apply, settingsFromOxidationLevel.apply(Oxidizable.OxidationLevel.WEATHERED)
         ),
         (Block)registerFunction.apply(
            "waxed_oxidized_" + baseId, waxedBlockFactory::apply, settingsFromOxidationLevel.apply(Oxidizable.OxidationLevel.OXIDIZED)
         )
      );
   }
