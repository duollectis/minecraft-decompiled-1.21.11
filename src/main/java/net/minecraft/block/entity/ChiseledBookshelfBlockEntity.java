...
/**
 * {@code ChiseledBookshelfBlockEntity}.
 */
	...
	public boolean canTransferTo(Inventory hopperInventory, int slot, ItemStack stack) {
		return hopperInventory.containsAny(
				itemStack2 -> itemStack2.isEmpty()
				              ? true
				              : ItemStack.areItemsAndComponentsEqual(stack, itemStack2)
				                && itemStack2.getCount() + stack.getCount() <= hopperInventory.getMaxCount(itemStack2)
		);
	}
