...
public class BlockEntityType<T extends BlockEntity> implements FabricBlockEntityType {
	...
	public static final BlockEntityType<FurnaceBlockEntity>
			FURNACE =
			create("furnace", FurnaceBlockEntity::new, Blocks.FURNACE);
	public static final BlockEntityType<ChestBlockEntity> CHEST = create(
			"chest",
	...
	public static final BlockEntityType<TrappedChestBlockEntity>
			TRAPPED_CHEST =
			create("trapped_chest", TrappedChestBlockEntity::new, Blocks.TRAPPED_CHEST);
	public static final BlockEntityType<EnderChestBlockEntity>
			ENDER_CHEST =
			create("ender_chest", EnderChestBlockEntity::new, Blocks.ENDER_CHEST);
	public static final BlockEntityType<JukeboxBlockEntity>
			JUKEBOX =
			create("jukebox", JukeboxBlockEntity::new, Blocks.JUKEBOX);
	public static final BlockEntityType<DispenserBlockEntity>
			DISPENSER =
			create("dispenser", DispenserBlockEntity::new, Blocks.DISPENSER);
	public static final BlockEntityType<DropperBlockEntity>
			DROPPER =
			create("dropper", DropperBlockEntity::new, Blocks.DROPPER);
	...
	public static final BlockEntityType<MobSpawnerBlockEntity>
			MOB_SPAWNER =
			create("mob_spawner", MobSpawnerBlockEntity::new, Blocks.SPAWNER);
	public static final BlockEntityType<CreakingHeartBlockEntity>
			CREAKING_HEART =
			create("creaking_heart", CreakingHeartBlockEntity::new, Blocks.CREAKING_HEART);
	public static final BlockEntityType<PistonBlockEntity>
			PISTON =
			create("piston", PistonBlockEntity::new, Blocks.MOVING_PISTON);
	public static final BlockEntityType<BrewingStandBlockEntity>
			BREWING_STAND =
			create("brewing_stand", BrewingStandBlockEntity::new, Blocks.BREWING_STAND);
	...
	public static final BlockEntityType<EndPortalBlockEntity>
			END_PORTAL =
			create("end_portal", EndPortalBlockEntity::new, Blocks.END_PORTAL);
	public static final BlockEntityType<BeaconBlockEntity>
			BEACON =
			create("beacon", BeaconBlockEntity::new, Blocks.BEACON);
	...
	public static final BlockEntityType<HopperBlockEntity>
			HOPPER =
			create("hopper", HopperBlockEntity::new, Blocks.HOPPER);
	public static final BlockEntityType<ComparatorBlockEntity>
			COMPARATOR =
			create("comparator", ComparatorBlockEntity::new, Blocks.COMPARATOR);
	...
	public static final BlockEntityType<EndGatewayBlockEntity>
			END_GATEWAY =
			create("end_gateway", EndGatewayBlockEntity::new, Blocks.END_GATEWAY);
	...
	public static final BlockEntityType<ConduitBlockEntity>
			CONDUIT =
			create("conduit", ConduitBlockEntity::new, Blocks.CONDUIT);
	public static final BlockEntityType<BarrelBlockEntity>
			BARREL =
			create("barrel", BarrelBlockEntity::new, Blocks.BARREL);
	public static final BlockEntityType<SmokerBlockEntity>
			SMOKER =
			create("smoker", SmokerBlockEntity::new, Blocks.SMOKER);
	public static final BlockEntityType<BlastFurnaceBlockEntity>
			BLAST_FURNACE =
			create("blast_furnace", BlastFurnaceBlockEntity::new, Blocks.BLAST_FURNACE);
	public static final BlockEntityType<LecternBlockEntity>
			LECTERN =
			create("lectern", LecternBlockEntity::new, Blocks.LECTERN);
	...
	public static final BlockEntityType<JigsawBlockEntity>
			JIGSAW =
			create("jigsaw", JigsawBlockEntity::new, Blocks.JIGSAW);
	public static final BlockEntityType<CampfireBlockEntity>
			CAMPFIRE =
			create("campfire", CampfireBlockEntity::new, Blocks.CAMPFIRE, Blocks.SOUL_CAMPFIRE);
	public static final BlockEntityType<BeehiveBlockEntity>
			BEEHIVE =
			create("beehive", BeehiveBlockEntity::new, Blocks.BEE_NEST, Blocks.BEEHIVE);
	public static final BlockEntityType<SculkSensorBlockEntity>
			SCULK_SENSOR =
			create("sculk_sensor", SculkSensorBlockEntity::new, Blocks.SCULK_SENSOR);
	...
	public static final BlockEntityType<SculkCatalystBlockEntity>
			SCULK_CATALYST =
			create("sculk_catalyst", SculkCatalystBlockEntity::new, Blocks.SCULK_CATALYST);
	public static final BlockEntityType<SculkShriekerBlockEntity>
			SCULK_SHRIEKER =
			create("sculk_shrieker", SculkShriekerBlockEntity::new, Blocks.SCULK_SHRIEKER);
	...
	public static final BlockEntityType<ShelfBlockEntity> SHELF = create(
			"shelf",
	...
	public static final BlockEntityType<DecoratedPotBlockEntity>
			DECORATED_POT =
			create("decorated_pot", DecoratedPotBlockEntity::new, Blocks.DECORATED_POT);
	public static final BlockEntityType<CrafterBlockEntity>
			CRAFTER =
			create("crafter", CrafterBlockEntity::new, Blocks.CRAFTER);
	public static final BlockEntityType<TrialSpawnerBlockEntity>
			TRIAL_SPAWNER =
			create("trial_spawner", TrialSpawnerBlockEntity::new, Blocks.TRIAL_SPAWNER);
	public static final BlockEntityType<VaultBlockEntity> VAULT = create("vault", VaultBlockEntity::new, Blocks.VAULT);
	public static final BlockEntityType<TestBlockEntity>
			TEST_BLOCK =
			create("test_block", TestBlockEntity::new, Blocks.TEST_BLOCK);
	...
	public static final BlockEntityType<CopperGolemStatueBlockEntity> COPPER_GOLEM_STATUE = create(
			"copper_golem_statue",
	...
	private static final Set<BlockEntityType<?>>
			POTENTIALLY_EXECUTES_COMMANDS =
			Set.of(COMMAND_BLOCK, LECTERN, SIGN, HANGING_SIGN, MOB_SPAWNER, TRIAL_SPAWNER);
	...
	private final RegistryEntry.Reference<BlockEntityType<?>>
			registryEntry =
			Registries.BLOCK_ENTITY_TYPE.createEntry(this);
