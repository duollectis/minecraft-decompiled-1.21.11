...
public record BannerPattern(Identifier assetId, String translationKey) {
	...
	public static final PacketCodec<RegistryByteBuf, BannerPattern> PACKET_CODEC = PacketCodec.tuple(
			...
			PacketCodecs.STRING,
			BannerPattern::translationKey,
			BannerPattern::new
	);
	public static final Codec<RegistryEntry<BannerPattern>>
			ENTRY_CODEC =
			RegistryElementCodec.of(RegistryKeys.BANNER_PATTERN, CODEC);
	public static final PacketCodec<RegistryByteBuf, RegistryEntry<BannerPattern>>
			ENTRY_PACKET_CODEC =
