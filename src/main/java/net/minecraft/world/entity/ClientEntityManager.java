   ...
   class Listener implements EntityChangeListener {
         ...
         if (l != this.lastSectionPos) {
            ...
            if (!this.section.remove(this.entity)) {
               ClientEntityManager.LOGGER
                  .warn("Entity {} wasn't found in section {} (moving to {})", new Object[]{this.entity, ChunkSectionPos.from(this.lastSectionPos), l});
            }
      ...
      public void remove(Entity.RemovalReason reason) {
         if (!this.section.remove(this.entity)) {
            ClientEntityManager.LOGGER
               .warn(
                  "Entity {} wasn't found in section {} (destroying due to {})", new Object[]{this.entity, ChunkSectionPos.from(this.lastSectionPos), reason}
               );
         }
