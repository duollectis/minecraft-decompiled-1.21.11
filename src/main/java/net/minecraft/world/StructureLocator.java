...
public class StructureLocator {
   ...
   private @Nullable StructurePresence getStructurePresence(ChunkPos pos, Structure structure, boolean skipReferencedStructures, long posLong) {
      ...
      if (!(selectiveNbtCollector.getRoot() instanceof NbtCompound nbtCompound)) {
         ...
         if (i <= 1493) {
            ...
            VersionedChunkStorage.saveContextToNbt(nbtCompound, ServerChunkLoadingManager.getContextNbt(this.worldKey, this.chunkGenerator.getCodecKey()));
