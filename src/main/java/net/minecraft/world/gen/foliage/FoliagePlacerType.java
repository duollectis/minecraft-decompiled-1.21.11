...
public class FoliagePlacerType<P extends FoliagePlacer> {
	...
	public static final FoliagePlacerType<LargeOakFoliagePlacer>
			FANCY_FOLIAGE_PLACER =
			register("fancy_foliage_placer", LargeOakFoliagePlacer.CODEC);
	public static final FoliagePlacerType<JungleFoliagePlacer>
			JUNGLE_FOLIAGE_PLACER =
			register("jungle_foliage_placer", JungleFoliagePlacer.CODEC);
	...
	public static final FoliagePlacerType<CherryFoliagePlacer>
