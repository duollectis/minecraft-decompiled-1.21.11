   ...
   public static MaterialRules.MaterialRule createDefaultRule(boolean surface, boolean bedrockRoof, boolean bedrockFloor) {
      ...
      MaterialRules.MaterialRule materialRule8 = MaterialRules.sequence(
         ...
         MaterialRules.condition(
            ...
            MaterialRules.sequence(
               MaterialRules.condition(surfaceNoiseThreshold(1.75), STONE), MaterialRules.condition(surfaceNoiseThreshold(-0.5), COARSE_DIRT)
            )
         ),
         MaterialRules.condition(
            MaterialRules.biome(BiomeKeys.WINDSWEPT_GRAVELLY_HILLS),
         ...
         MaterialRules.condition(
            ...
            MaterialRules.sequence(
               MaterialRules.condition(surfaceNoiseThreshold(1.75), COARSE_DIRT), MaterialRules.condition(surfaceNoiseThreshold(-0.95), PODZOL)
            )
         ),
            ...
            MaterialRules.sequence(
               MaterialRules.condition(
                  ...
                  MaterialRules.sequence(
                     ...
                     MaterialRules.condition(
                        materialCondition8, MaterialRules.sequence(MaterialRules.condition(MaterialRules.STONE_DEPTH_CEILING, RED_SANDSTONE), RED_SAND)
                     ),
               ...
               MaterialRules.sequence(
                  MaterialRules.condition(
                     ...
                     MaterialRules.condition(
                        materialCondition11,
                        MaterialRules.sequence(
                           MaterialRules.condition(materialCondition9, AIR), MaterialRules.condition(MaterialRules.temperature(), ICE), WATER
                        )
                     )
                  ),
                  materialRule8
         ...
         MaterialRules.condition(
            ...
            MaterialRules.sequence(
               MaterialRules.condition(
                  ...
                  MaterialRules.sequence(MaterialRules.condition(materialCondition12, SOUL_SAND), SOUL_SOIL)
               ),
               MaterialRules.condition(
                  MaterialRules.STONE_DEPTH_FLOOR_WITH_SURFACE_DEPTH,
            ...
            MaterialRules.sequence(
               ...
               MaterialRules.condition(
                  ...
                  MaterialRules.condition(
                     ...
                     MaterialRules.condition(
                        materialCondition, MaterialRules.sequence(MaterialRules.condition(materialCondition11, WARPED_WART_BLOCK), WARPED_NYLIUM)
                     )
                  )
               ),
               MaterialRules.condition(
                  ...
                  MaterialRules.condition(
                     MaterialRules.not(materialCondition10),
                     MaterialRules.condition(
                        materialCondition, MaterialRules.sequence(MaterialRules.condition(materialCondition11, NETHER_WART_BLOCK), CRIMSON_NYLIUM)
                     )
                  )
               )
            )
                  ...
                  MaterialRules.condition(
                     ...
                     MaterialRules.sequence(
                        MaterialRules.condition(
                           ...
                           MaterialRules.condition(materialCondition3, MaterialRules.condition(materialCondition4, SOUL_SAND))
                        ),
                        NETHERRACK
                     )
                  )
                  ...
                  MaterialRules.condition(
                     ...
                     MaterialRules.condition(
                        ...
                        MaterialRules.condition(
                           materialCondition8,
                           MaterialRules.sequence(
                              MaterialRules.condition(materialCondition2, GRAVEL), MaterialRules.condition(MaterialRules.not(materialCondition6), GRAVEL)
                           )
                        )
                     )
                  )
