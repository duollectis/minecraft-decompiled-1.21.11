...
public interface PlacementModifierType<P extends PlacementModifier> {
	...
	PlacementModifierType<BlockFilterPlacementModifier>
			BLOCK_PREDICATE_FILTER =
			register("block_predicate_filter", BlockFilterPlacementModifier.MODIFIER_CODEC);

	PlacementModifierType<RarityFilterPlacementModifier>
			RARITY_FILTER =
			register("rarity_filter", RarityFilterPlacementModifier.MODIFIER_CODEC);
	...
	PlacementModifierType<NoiseBasedCountPlacementModifier>
			NOISE_BASED_COUNT =
			register("noise_based_count", NoiseBasedCountPlacementModifier.MODIFIER_CODEC);
	...
	PlacementModifierType<EnvironmentScanPlacementModifier>
			ENVIRONMENT_SCAN =
			register("environment_scan", EnvironmentScanPlacementModifier.MODIFIER_CODEC);

	PlacementModifierType<HeightmapPlacementModifier>
			HEIGHTMAP =
			register("heightmap", HeightmapPlacementModifier.MODIFIER_CODEC);

	PlacementModifierType<HeightRangePlacementModifier>
			HEIGHT_RANGE =
			register("height_range", HeightRangePlacementModifier.MODIFIER_CODEC);

	PlacementModifierType<SquarePlacementModifier>
			IN_SQUARE =
			register("in_square", SquarePlacementModifier.MODIFIER_CODEC);

	PlacementModifierType<RandomOffsetPlacementModifier>
			RANDOM_OFFSET =
			register("random_offset", RandomOffsetPlacementModifier.MODIFIER_CODEC);

	PlacementModifierType<FixedPlacementModifier>
			FIXED_PLACEMENT =
			register("fixed_placement", FixedPlacementModifier.CODEC);
