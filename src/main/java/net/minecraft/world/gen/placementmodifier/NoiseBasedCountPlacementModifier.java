...
/**
 * {@code NoiseBasedCountPlacementModifier}.
 */
	...
	public static final MapCodec<NoiseBasedCountPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(
			instance -> instance.group(
					                    Codec.INT
							                    ...
							                    .forGetter(placementModifier -> placementModifier.noiseToCountRatio),
					                    Codec.DOUBLE.fieldOf("noise_factor").forGetter(placementModifier -> placementModifier.noiseFactor),
					                    Codec.DOUBLE
							                    .fieldOf("noise_offset")
							                    .orElse(0.0)
							                    .forGetter(placementModifier -> placementModifier.noiseOffset)
			                    )
