...
public class EnvironmentScanPlacementModifier extends PlacementModifier {
   ...
   public static final MapCodec<EnvironmentScanPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.mapCodec(
      instance -> instance.group(
            Direction.VERTICAL_CODEC.fieldOf("direction_of_search").forGetter(placementModifier -> placementModifier.direction),
            BlockPredicate.BASE_CODEC.fieldOf("target_condition").forGetter(placementModifier -> placementModifier.targetPredicate),
            ...
            Codec.intRange(1, 32).fieldOf("max_steps").forGetter(placementModifier -> placementModifier.maxSteps)
         )
