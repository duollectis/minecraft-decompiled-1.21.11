...
public class EndConfiguredFeatures {
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			END_GATEWAY_RETURN =
			ConfiguredFeatures.of("end_gateway_return");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			END_GATEWAY_DELAYED =
			ConfiguredFeatures.of("end_gateway_delayed");
	...
	public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
		...
		ConfiguredFeatures.register(
				...
				END_SPIKE,
				Feature.END_SPIKE,
				new EndSpikeFeatureConfig(false, ImmutableList.of(), null)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				END_GATEWAY_RETURN,
				Feature.END_GATEWAY,
				EndGatewayFeatureConfig.createConfig(ServerWorld.END_SPAWN_POS, true)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				END_GATEWAY_DELAYED,
