...
public class OceanPlacedFeatures {
	...
	public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
		...
		RegistryEntry.Reference<ConfiguredFeature<?, ?>>
				reference =
				registryEntryLookup.getOrThrow(OceanConfiguredFeatures.SEAGRASS_SHORT);
		RegistryEntry.Reference<ConfiguredFeature<?, ?>>
				reference2 =
				registryEntryLookup.getOrThrow(OceanConfiguredFeatures.SEAGRASS_SLIGHTLY_LESS_SHORT);
		RegistryEntry.Reference<ConfiguredFeature<?, ?>>
				reference3 =
				registryEntryLookup.getOrThrow(OceanConfiguredFeatures.SEAGRASS_MID);
		RegistryEntry.Reference<ConfiguredFeature<?, ?>>
				reference4 =
				registryEntryLookup.getOrThrow(OceanConfiguredFeatures.SEAGRASS_TALL);
		RegistryEntry.Reference<ConfiguredFeature<?, ?>>
				reference5 =
				registryEntryLookup.getOrThrow(OceanConfiguredFeatures.SEA_PICKLE);
		RegistryEntry.Reference<ConfiguredFeature<?, ?>>
				reference6 =
				registryEntryLookup.getOrThrow(OceanConfiguredFeatures.KELP);
		RegistryEntry.Reference<ConfiguredFeature<?, ?>>
				reference7 =
				registryEntryLookup.getOrThrow(OceanConfiguredFeatures.WARM_OCEAN_VEGETATION);
