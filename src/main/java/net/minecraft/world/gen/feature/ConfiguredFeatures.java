...
public class ConfiguredFeatures {
		...
		if (!validGround.isEmpty()) {
			blockPredicate =
					BlockPredicate.bothOf(
							...
							BlockPredicate.matchingBlocks(Direction.DOWN.getVector(), validGround)
					);
		}
		else {
	...
	public static RandomPatchFeatureConfig createRandomPatchFeatureConfig(
			int tries,
	...
	public static <FC extends FeatureConfig, F extends Feature<FC>> RandomPatchFeatureConfig createRandomPatchFeatureConfig(
		...
		return createRandomPatchFeatureConfig(
				tries,
				PlacedFeatures.createEntry(feature, config, createBlockPredicate(predicateBlocks))
		);
	}
