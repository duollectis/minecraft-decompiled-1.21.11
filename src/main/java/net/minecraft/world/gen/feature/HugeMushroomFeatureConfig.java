...
/**
 * {@code HugeMushroomFeatureConfig}.
 */
public class HugeMushroomFeatureConfig implements FeatureConfig {
	...
	public static final Codec<HugeMushroomFeatureConfig> CODEC = RecordCodecBuilder.create(
			instance -> instance.group(
					                    BlockStateProvider.TYPE_CODEC
							                    ...
							                    .forGetter(hugeMushroomFeatureConfig -> hugeMushroomFeatureConfig.capProvider),
					                    BlockStateProvider.TYPE_CODEC
							                    .fieldOf("stem_provider")
							                    .forGetter(hugeMushroomFeatureConfig -> hugeMushroomFeatureConfig.stemProvider),
					                    Codec.INT
							                    .fieldOf("foliage_radius")
							                    .orElse(2)
							                    .forGetter(hugeMushroomFeatureConfig -> hugeMushroomFeatureConfig.foliageRadius)
			                    )
	...
	public HugeMushroomFeatureConfig(
