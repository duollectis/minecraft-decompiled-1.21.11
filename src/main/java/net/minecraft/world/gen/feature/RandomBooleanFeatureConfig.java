...
/**
 * {@code RandomBooleanFeatureConfig}.
 */
public class RandomBooleanFeatureConfig implements FeatureConfig {
	...
	public RandomBooleanFeatureConfig(
			RegistryEntry<PlacedFeature> featureTrue,
			RegistryEntry<PlacedFeature> featureFalse
	) {
	...
	public Stream<ConfiguredFeature<?, ?>> getDecoratedFeatures() {
		return Stream.concat(
				this.featureTrue.value().getDecoratedFeatures(),
				this.featureFalse.value().getDecoratedFeatures()
		);
	}
}
