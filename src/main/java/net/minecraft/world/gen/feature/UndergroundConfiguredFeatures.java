...
/**
 * {@code UndergroundConfiguredFeatures}.
 */
public class UndergroundConfiguredFeatures {
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			...
			ConfiguredFeatures.of("sculk_patch_deep_dark");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			SCULK_PATCH_ANCIENT_CITY =
			ConfiguredFeatures.of("sculk_patch_ancient_city");
				...
				new BlockColumnFeatureConfig(
						List.of(
								BlockColumnFeatureConfig.createLayer(
										new WeightedListIntProvider(Pool
												.<IntProvider>builder()
												.add(UniformIntProvider.create(0, 4), 2)
												.add(ConstantIntProvider.create(0), 1)
												.build()),
										BlockStateProvider.of(Blocks.BIG_DRIPLEAF_STEM
												.getDefaultState()
												.with(Properties.HORIZONTAL_FACING, direction))
								),
								BlockColumnFeatureConfig.createLayer(
										ConstantIntProvider.create(1),
										BlockStateProvider.of(Blocks.BIG_DRIPLEAF
												.getDefaultState()
												.with(Properties.HORIZONTAL_FACING, direction))
								)
						),
								...
								Pool.<BlockState>builder()
								    .add(
										    Blocks.SMALL_DRIPLEAF
												    .getDefaultState()
												    .with(SmallDripleafBlock.FACING, Direction.EAST), 1
								    )
								    .add(
										    Blocks.SMALL_DRIPLEAF
												    .getDefaultState()
												    .with(SmallDripleafBlock.FACING, Direction.WEST), 1
								    )
								    .add(
										    Blocks.SMALL_DRIPLEAF
												    .getDefaultState()
												    .with(SmallDripleafBlock.FACING, Direction.NORTH), 1
								    )
								    .add(
										    Blocks.SMALL_DRIPLEAF
												    .getDefaultState()
												    .with(SmallDripleafBlock.FACING, Direction.SOUTH), 1
								    )
						)
				)
		);
	...
	public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
		...
		RegistryEntryLookup<StructureProcessorList>
				...
				featureRegisterable.getRegistryLookup(RegistryKeys.PROCESSOR_LIST);
		...
		RegistryEntry<StructureProcessorList>
				registryEntry =
				registryEntryLookup2.getOrThrow(StructureProcessorLists.FOSSIL_ROT);
		ConfiguredFeatures.register(
				featureRegisterable,
				FOSSIL_COAL,
				Feature.FOSSIL,
				new FossilFeatureConfig(
						list,
						list2,
						registryEntry,
						registryEntryLookup2.getOrThrow(StructureProcessorLists.FOSSIL_COAL),
						4
				)
		);
		ConfiguredFeatures.register(
				...
				new FossilFeatureConfig(
						...
						list2,
						registryEntry,
						registryEntryLookup2.getOrThrow(StructureProcessorLists.FOSSIL_DIAMONDS),
						4
				)
		);
		ConfiguredFeatures.register(
		...
		ConfiguredFeatures.register(
				...
				new UnderwaterMagmaFeatureConfig(5, 1, 0.5F)
		);
				...
				new RootSystemFeatureConfig(
						...
						BlockPredicate.bothOf(
								BlockPredicate.eitherOf(
										BlockPredicate.matchingBlocks(List.of(
												Blocks.AIR,
												Blocks.CAVE_AIR,
												Blocks.VOID_AIR
										)),
		...
		ConfiguredFeatures.register(
				...
				SPORE_BLOSSOM,
				Feature.SIMPLE_BLOCK,
				new SimpleBlockFeatureConfig(BlockStateProvider.of(Blocks.SPORE_BLOSSOM))
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				AMETHYST_GEODE,
