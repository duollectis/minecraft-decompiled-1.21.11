...
public class OreConfiguredFeatures {
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			ORE_GRAVEL_NETHER =
			ConfiguredFeatures.of("ore_gravel_nether");
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			ORE_DIAMOND_SMALL =
			ConfiguredFeatures.of("ore_diamond_small");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			ORE_DIAMOND_MEDIUM =
			ConfiguredFeatures.of("ore_diamond_medium");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			ORE_DIAMOND_LARGE =
			ConfiguredFeatures.of("ore_diamond_large");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			ORE_DIAMOND_BURIED =
			ConfiguredFeatures.of("ore_diamond_buried");
	public static final RegistryKey<ConfiguredFeature<?, ?>> ORE_LAPIS = ConfiguredFeatures.of("ore_lapis");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			ORE_LAPIS_BURIED =
			ConfiguredFeatures.of("ore_lapis_buried");
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			...
			ConfiguredFeatures.of("ore_ancient_debris_large");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			ORE_ANCIENT_DEBRIS_SMALL =
			ConfiguredFeatures.of("ore_ancient_debris_small");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			ORE_COPPER_SMALL =
			ConfiguredFeatures.of("ore_copper_small");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			ORE_COPPER_LARGE =
	...
	public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
		...
		ConfiguredFeatures.register(
				...
				ORE_MAGMA,
				Feature.ORE,
				new OreFeatureConfig(ruleTest4, Blocks.MAGMA_BLOCK.getDefaultState(), 33)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_SOUL_SAND,
				Feature.ORE,
				new OreFeatureConfig(ruleTest4, Blocks.SOUL_SAND.getDefaultState(), 12)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_NETHER_GOLD,
				Feature.ORE,
				new OreFeatureConfig(ruleTest4, Blocks.NETHER_GOLD_ORE.getDefaultState(), 10)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_QUARTZ,
				Feature.ORE,
				new OreFeatureConfig(ruleTest4, Blocks.NETHER_QUARTZ_ORE.getDefaultState(), 14)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_GRAVEL_NETHER,
				Feature.ORE,
				new OreFeatureConfig(ruleTest4, Blocks.GRAVEL.getDefaultState(), 33)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_BLACKSTONE,
				Feature.ORE,
				new OreFeatureConfig(ruleTest4, Blocks.BLACKSTONE.getDefaultState(), 33)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_DIRT,
				Feature.ORE,
				new OreFeatureConfig(ruleTest, Blocks.DIRT.getDefaultState(), 33)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_GRAVEL,
				Feature.ORE,
				new OreFeatureConfig(ruleTest, Blocks.GRAVEL.getDefaultState(), 33)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_GRANITE,
				Feature.ORE,
				new OreFeatureConfig(ruleTest, Blocks.GRANITE.getDefaultState(), 64)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_DIORITE,
				Feature.ORE,
				new OreFeatureConfig(ruleTest, Blocks.DIORITE.getDefaultState(), 64)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_ANDESITE,
				Feature.ORE,
				new OreFeatureConfig(ruleTest, Blocks.ANDESITE.getDefaultState(), 64)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_TUFF,
				Feature.ORE,
				new OreFeatureConfig(ruleTest, Blocks.TUFF.getDefaultState(), 64)
		);
		...
		ConfiguredFeatures.register(
				...
				ORE_COAL_BURIED,
				Feature.ORE,
				new OreFeatureConfig(list6, 17, 0.5F)
		);
		...
		ConfiguredFeatures.register(
				...
				ORE_GOLD_BURIED,
				Feature.ORE,
				new OreFeatureConfig(list2, 9, 0.5F)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_REDSTONE,
		...
		ConfiguredFeatures.register(
				...
				ORE_DIAMOND_SMALL,
				Feature.ORE,
				new OreFeatureConfig(list3, 4, 0.5F)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_DIAMOND_LARGE,
				Feature.ORE,
				new OreFeatureConfig(list3, 12, 0.7F)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_DIAMOND_BURIED,
				Feature.ORE,
				new OreFeatureConfig(list3, 8, 1.0F)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_DIAMOND_MEDIUM,
				Feature.ORE,
				new OreFeatureConfig(list3, 8, 0.5F)
		);
		...
		ConfiguredFeatures.register(
				...
				ORE_LAPIS_BURIED,
				Feature.ORE,
				new OreFeatureConfig(list4, 7, 1.0F)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_INFESTED,
		...
		ConfiguredFeatures.register(
				...
				new OreFeatureConfig(ruleTest5, Blocks.ANCIENT_DEBRIS.getDefaultState(), 3, 1.0F)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_ANCIENT_DEBRIS_SMALL,
				Feature.SCATTERED_ORE,
				new OreFeatureConfig(ruleTest5, Blocks.ANCIENT_DEBRIS.getDefaultState(), 2, 1.0F)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_COPPER_SMALL,
				Feature.ORE,
				new OreFeatureConfig(list5, 10)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_COPPER_LARGE,
				Feature.ORE,
				new OreFeatureConfig(list5, 20)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ORE_CLAY,
				Feature.ORE,
				new OreFeatureConfig(ruleTest, Blocks.CLAY.getDefaultState(), 33)
		);
	}
}
