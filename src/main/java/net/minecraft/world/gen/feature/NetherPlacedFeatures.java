...
public class NetherPlacedFeatures {
   ...
   public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
      ...
      PlacedFeatures.register(
         featureRegisterable, CRIMSON_FOREST_VEGETATION, registryEntry7, CountMultilayerPlacementModifier.of(6), BiomePlacementModifier.of()
      );
      PlacedFeatures.register(
         featureRegisterable, WARPED_FOREST_VEGETATION, registryEntry8, CountMultilayerPlacementModifier.of(5), BiomePlacementModifier.of()
      );
