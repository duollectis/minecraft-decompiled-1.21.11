...
public class NetherPlacedFeatures {
	...
	public static final RegistryKey<PlacedFeature>
			...
			PlacedFeatures.of("crimson_forest_vegetation");
	public static final RegistryKey<PlacedFeature>
			WARPED_FOREST_VEGETATION =
			PlacedFeatures.of("warped_forest_vegetation");
	...
	public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
		...
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.DELTA);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry2 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.SMALL_BASALT_COLUMNS);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry3 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.SMALL_BASALT_COLUMNS_TEMP);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry4 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.BASALT_BLOBS);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry5 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.BLACKSTONE_BLOBS);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry6 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.GLOWSTONE_EXTRA);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry7 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.CRIMSON_FOREST_VEGETATION);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry8 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.WARPED_FOREST_VEGETATION);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry9 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.NETHER_SPROUTS);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry10 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.TWISTING_VINES);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry11 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.WEEPING_VINES);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry12 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.PATCH_CRIMSON_ROOTS);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry13 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.BASALT_PILLAR);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry14 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.SPRING_LAVA_NETHER);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry15 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.SPRING_NETHER_CLOSED);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry16 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.SPRING_NETHER_OPEN);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry17 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.PATCH_SOUL_FIRE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry18 =
				registryEntryLookup.getOrThrow(NetherConfiguredFeatures.PATCH_FIRE);
		PlacedFeatures.register(
				featureRegisterable,
				DELTA,
				registryEntry,
				CountMultilayerPlacementModifier.of(40),
