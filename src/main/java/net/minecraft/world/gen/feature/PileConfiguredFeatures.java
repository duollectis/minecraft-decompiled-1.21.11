...
public class PileConfiguredFeatures {
	...
	public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
		ConfiguredFeatures.register(
				...
				PILE_HAY,
				Feature.BLOCK_PILE,
				new BlockPileFeatureConfig(new PillarBlockStateProvider(Blocks.HAY_BLOCK))
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				PILE_MELON,
				Feature.BLOCK_PILE,
				new BlockPileFeatureConfig(BlockStateProvider.of(Blocks.MELON))
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				PILE_SNOW,
				Feature.BLOCK_PILE,
				new BlockPileFeatureConfig(BlockStateProvider.of(Blocks.SNOW))
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				PILE_ICE,
