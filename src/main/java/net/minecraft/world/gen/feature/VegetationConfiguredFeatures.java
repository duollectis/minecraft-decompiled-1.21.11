...
public class VegetationConfiguredFeatures {
   ...
   public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
      ...
      ConfiguredFeatures.register(
         ...
         createRandomPatchFeatureConfig(
            new WeightedBlockStateProvider(
               Pool.<BlockState>builder().add(Blocks.SHORT_DRY_GRASS.getDefaultState(), 1).add(Blocks.TALL_DRY_GRASS.getDefaultState(), 1)
            ),
            64
         )
      );
      ...
      ConfiguredFeatures.register(
         ...
         Feature.RANDOM_PATCH,
         new RandomPatchFeatureConfig(
            24, 5, 3, PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(BlockStateProvider.of(Blocks.BUSH)))
         )
      );
      ConfiguredFeatures.register(
         featureRegisterable,
                  ...
                  List.of(
                     ...
                     BlockColumnFeatureConfig.createLayer(
                        new WeightedListIntProvider(
                           Pool.<IntProvider>builder().add(ConstantIntProvider.create(0), 3).add(ConstantIntProvider.create(1), 1).build()
                        ),
      ...
      ConfiguredFeatures.register(
         ...
         new RandomPatchFeatureConfig(
            ...
            6,
            2,
            PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(new WeightedBlockStateProvider(flowerbed(Blocks.PINK_PETALS))))
         )
      );
      ConfiguredFeatures.register(
         featureRegisterable,
         ...
         new RandomPatchFeatureConfig(
            ...
            6,
            2,
            PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(new WeightedBlockStateProvider(flowerbed(Blocks.WILDFLOWERS))))
         )
      );
      ConfiguredFeatures.register(
         featureRegisterable,
      ...
      ConfiguredFeatures.register(
         ...
         new RandomFeatureConfig(
            List.of(
               new RandomFeatureEntry(registryEntry37, 0.0025F), new RandomFeatureEntry(registryEntry9, 0.2F), new RandomFeatureEntry(registryEntry10, 0.1F)
            ),
            registryEntry26
         )
      );
      ...
      ConfiguredFeatures.register(
         ...
         Feature.RANDOM_SELECTOR,
         new RandomFeatureConfig(
            List.of(new RandomFeatureEntry(registryEntry12, 0.33333334F), new RandomFeatureEntry(registryEntry40, 0.0125F)), registryEntry13
         )
      );
      ConfiguredFeatures.register(
         featureRegisterable,
      ...
      ConfiguredFeatures.register(
         ...
         new RandomFeatureConfig(
            List.of(
               new RandomFeatureEntry(registryEntry8, 0.1F), new RandomFeatureEntry(registryEntry20, 0.5F), new RandomFeatureEntry(registryEntry39, 0.0125F)
            ),
            registryEntry30
         )
      );
      ...
      ConfiguredFeatures.register(
         ...
         new RandomFeatureConfig(
            List.of(
               new RandomFeatureEntry(registryEntry8, 0.05F), new RandomFeatureEntry(registryEntry20, 0.15F), new RandomFeatureEntry(registryEntry23, 0.7F)
            ),
