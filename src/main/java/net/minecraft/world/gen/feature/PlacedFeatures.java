...
public class PlacedFeatures {
	...
	public static final PlacementModifier
			...
			HeightRangePlacementModifier.uniform(YOffset.aboveBottom(8), YOffset.belowTop(8));
	public static final PlacementModifier
			FOUR_ABOVE_AND_BELOW_RANGE =
			HeightRangePlacementModifier.uniform(YOffset.aboveBottom(4), YOffset.belowTop(4));
	public static final PlacementModifier
			BOTTOM_TO_120_RANGE =
	...
	public static RegistryEntry<PlacedFeature> createEntry(
			RegistryEntry<ConfiguredFeature<?, ?>> feature,
			PlacementModifier... modifiers
	) {
