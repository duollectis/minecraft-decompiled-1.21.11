...
public class MiscPlacedFeatures {
	...
	public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
		...
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.ICE_SPIKE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry2 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.ICE_PATCH);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry3 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.FOREST_ROCK);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry4 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.ICEBERG_PACKED);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry5 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.ICEBERG_BLUE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry6 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.BLUE_ICE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry7 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.LAKE_LAVA);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry8 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.DISK_CLAY);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry9 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.DISK_GRAVEL);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry10 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.DISK_SAND);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry11 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.DISK_GRASS);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry12 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.FREEZE_TOP_LAYER);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry13 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.VOID_START_PLATFORM);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry14 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.DESERT_WELL);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry15 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.SPRING_LAVA_OVERWORLD);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry16 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.SPRING_LAVA_FROZEN);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry17 =
				registryEntryLookup.getOrThrow(MiscConfiguredFeatures.SPRING_WATER);
