...
public class MiscConfiguredFeatures {
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			FREEZE_TOP_LAYER =
			ConfiguredFeatures.of("freeze_top_layer");
	...
	public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
		...
		ConfiguredFeatures.register(
				...
				ICEBERG_PACKED,
				Feature.ICEBERG,
				new SingleStateFeatureConfig(Blocks.PACKED_ICE.getDefaultState())
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				ICEBERG_BLUE,
				Feature.ICEBERG,
				new SingleStateFeatureConfig(Blocks.BLUE_ICE.getDefaultState())
		);
		...
		ConfiguredFeatures.register(
				...
				new LakeFeature.Config(
						BlockStateProvider.of(Blocks.LAVA.getDefaultState()),
		...
		ConfiguredFeatures.register(
				...
				new DiskFeatureConfig(
						...
						BlockPredicate.matchingBlocks(List.of(Blocks.DIRT, Blocks.CLAY)),
						UniformIntProvider.create(2, 3),
						1
				)
		);
						...
						new PredicatedStateProvider(
								...
								List.of(
										new PredicatedStateProvider.Rule(
												BlockPredicate.matchingBlocks(Direction.DOWN.getVector(), Blocks.AIR),
