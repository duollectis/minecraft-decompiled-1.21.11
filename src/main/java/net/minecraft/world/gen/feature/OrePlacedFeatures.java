...
public class OrePlacedFeatures {
	...
	public static final RegistryKey<PlacedFeature>
			...
			PlacedFeatures.of("ore_ancient_debris_large");
	...
	public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
		...
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_MAGMA);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry2 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_SOUL_SAND);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry3 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_NETHER_GOLD);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry4 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_QUARTZ);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry5 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_GRAVEL_NETHER);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry6 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_BLACKSTONE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry7 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_DIRT);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry8 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_GRAVEL);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry9 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_GRANITE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry10 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_DIORITE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry11 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_ANDESITE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry12 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_TUFF);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry13 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_COAL);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry14 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_COAL_BURIED);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry15 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_IRON);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry16 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_IRON_SMALL);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry17 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_GOLD);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry18 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_GOLD_BURIED);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry19 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_REDSTONE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry20 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_DIAMOND_SMALL);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry21 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_DIAMOND_MEDIUM);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry22 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_DIAMOND_LARGE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry23 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_DIAMOND_BURIED);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry24 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_LAPIS);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry25 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_LAPIS_BURIED);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry26 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_INFESTED);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry27 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_EMERALD);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry28 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_ANCIENT_DEBRIS_LARGE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry29 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_ANCIENT_DEBRIS_SMALL);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry30 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_COPPER_SMALL);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry31 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_COPPER_LARGE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry32 =
				registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_CLAY);
		PlacedFeatures.register(
				featureRegisterable,
				ORE_MAGMA,
				registryEntry,
				modifiersWithCount(4, HeightRangePlacementModifier.uniform(YOffset.fixed(27), YOffset.fixed(36)))
		);
		PlacedFeatures.register(
				featureRegisterable,
				ORE_SOUL_SAND,
				registryEntry2,
				modifiersWithCount(12, HeightRangePlacementModifier.uniform(YOffset.getBottom(), YOffset.fixed(31)))
		);
		PlacedFeatures.register(
				featureRegisterable,
				ORE_GOLD_DELTAS,
		...
		PlacedFeatures.register(
				...
				ORE_QUARTZ_DELTAS,
				registryEntry4,
				modifiersWithCount(32, PlacedFeatures.TEN_ABOVE_AND_BELOW_RANGE)
		);
		PlacedFeatures.register(
				featureRegisterable,
				ORE_GOLD_NETHER,
		...
		PlacedFeatures.register(
				...
				ORE_DIRT,
				registryEntry7,
				modifiersWithCount(7, HeightRangePlacementModifier.uniform(YOffset.fixed(0), YOffset.fixed(160)))
		);
		PlacedFeatures.register(
				featureRegisterable,
				ORE_GRAVEL,
				registryEntry8,
				modifiersWithCount(14, HeightRangePlacementModifier.uniform(YOffset.getBottom(), YOffset.getTop()))
		);
		PlacedFeatures.register(
				featureRegisterable,
				ORE_GRANITE_UPPER,
		...
		PlacedFeatures.register(
				...
				ORE_TUFF,
				registryEntry12,
				modifiersWithCount(2, HeightRangePlacementModifier.uniform(YOffset.getBottom(), YOffset.fixed(0)))
		);
		PlacedFeatures.register(
				featureRegisterable,
				ORE_COAL_UPPER,
				registryEntry13,
				modifiersWithCount(30, HeightRangePlacementModifier.uniform(YOffset.fixed(136), YOffset.getTop()))
		);
		PlacedFeatures.register(
				featureRegisterable,
				ORE_COAL_LOWER,
		...
		PlacedFeatures.register(
				...
				ORE_GOLD_EXTRA,
				registryEntry17,
				modifiersWithCount(50, HeightRangePlacementModifier.uniform(YOffset.fixed(32), YOffset.fixed(256)))
		);
		PlacedFeatures.register(
				featureRegisterable,
				ORE_GOLD,
				registryEntry18,
				modifiersWithCount(4, HeightRangePlacementModifier.trapezoid(YOffset.fixed(-64), YOffset.fixed(32)))
		);
		PlacedFeatures.register(
				featureRegisterable,
				ORE_GOLD_LOWER,
		...
		PlacedFeatures.register(
				...
				ORE_REDSTONE,
				registryEntry19,
				modifiersWithCount(4, HeightRangePlacementModifier.uniform(YOffset.getBottom(), YOffset.fixed(15)))
		);
		PlacedFeatures.register(
				featureRegisterable,
				ORE_REDSTONE_LOWER,
		...
		PlacedFeatures.register(
				...
				ORE_LAPIS,
				registryEntry24,
				modifiersWithCount(2, HeightRangePlacementModifier.trapezoid(YOffset.fixed(-32), YOffset.fixed(32)))
		);
		PlacedFeatures.register(
				featureRegisterable,
				ORE_LAPIS_BURIED,
		...
		PlacedFeatures.register(
				...
				ORE_INFESTED,
				registryEntry26,
				modifiersWithCount(14, HeightRangePlacementModifier.uniform(YOffset.getBottom(), YOffset.fixed(63)))
		);
		PlacedFeatures.register(
				featureRegisterable,
				ORE_EMERALD,
		...
		PlacedFeatures.register(
				...
				ORE_CLAY,
				registryEntry32,
				modifiersWithCount(46, PlacedFeatures.BOTTOM_TO_120_RANGE)
		);
	}
}
