...
public class NetherConfiguredFeatures {
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			...
			ConfiguredFeatures.of("small_basalt_columns");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			SMALL_BASALT_COLUMNS_TEMP =
			ConfiguredFeatures.of("large_basalt_columns");
	public static final RegistryKey<ConfiguredFeature<?, ?>> BASALT_BLOBS = ConfiguredFeatures.of("basalt_blobs");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			BLACKSTONE_BLOBS =
			ConfiguredFeatures.of("blackstone_blobs");
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			...
			ConfiguredFeatures.of("crimson_forest_vegetation");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			CRIMSON_FOREST_VEGETATION_BONEMEAL =
			ConfiguredFeatures.of("crimson_forest_vegetation_bonemeal");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			WARPED_FOREST_VEGETATION =
			ConfiguredFeatures.of("warped_forest_vegetation");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			WARPED_FOREST_VEGETATION_BONEMEAL =
			ConfiguredFeatures.of("warped_forest_vegetation_bonemeal");
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			...
			ConfiguredFeatures.of("nether_sprouts_bonemeal");
	...
	public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
		...
		ConfiguredFeatures.register(
				...
				new TwistingVinesFeatureConfig(8, 4, 8)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				TWISTING_VINES_BONEMEAL,
				Feature.TWISTING_VINES,
				new TwistingVinesFeatureConfig(3, 1, 2)
		);
		...
		ConfiguredFeatures.register(
				...
				new SpringFeatureConfig(
						...
						5,
						0,
						RegistryEntryList.of(Block::getRegistryEntry, Blocks.NETHERRACK)
				)
		);
		ConfiguredFeatures.register(
				featureRegisterable,
		...
		ConfiguredFeatures.register(
				...
				ConfiguredFeatures.createRandomPatchFeatureConfig(
						Feature.SIMPLE_BLOCK,
						new SimpleBlockFeatureConfig(BlockStateProvider.of(Blocks.FIRE)),
		...
		ConfiguredFeatures.register(
				...
				ConfiguredFeatures.createRandomPatchFeatureConfig(
						Feature.SIMPLE_BLOCK,
						new SimpleBlockFeatureConfig(BlockStateProvider.of(Blocks.SOUL_FIRE)),
