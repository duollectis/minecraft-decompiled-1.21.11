...
public class VillagePlacedFeatures {
	...
	public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
		...
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry =
				registryEntryLookup.getOrThrow(PileConfiguredFeatures.PILE_HAY);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry2 =
				registryEntryLookup.getOrThrow(PileConfiguredFeatures.PILE_MELON);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry3 =
				registryEntryLookup.getOrThrow(PileConfiguredFeatures.PILE_SNOW);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry4 =
				registryEntryLookup.getOrThrow(PileConfiguredFeatures.PILE_ICE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry5 =
				registryEntryLookup.getOrThrow(PileConfiguredFeatures.PILE_PUMPKIN);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry6 =
