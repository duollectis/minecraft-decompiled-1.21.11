...
public record ConfiguredFeature<FC extends FeatureConfig, F extends Feature<FC>>(F feature, FC config) {
	...
	public static final Codec<RegistryEntry<ConfiguredFeature<?, ?>>>
			REGISTRY_CODEC =
			RegistryElementCodec.of(RegistryKeys.CONFIGURED_FEATURE, CODEC);
	public static final Codec<RegistryEntryList<ConfiguredFeature<?, ?>>>
			LIST_CODEC =
