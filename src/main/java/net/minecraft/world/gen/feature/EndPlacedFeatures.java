...
public class EndPlacedFeatures {
	...
	public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
		...
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry =
				registryEntryLookup.getOrThrow(EndConfiguredFeatures.END_PLATFORM);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry2 =
				registryEntryLookup.getOrThrow(EndConfiguredFeatures.END_SPIKE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry3 =
				registryEntryLookup.getOrThrow(EndConfiguredFeatures.END_GATEWAY_RETURN);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry4 =
				registryEntryLookup.getOrThrow(EndConfiguredFeatures.CHORUS_PLANT);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry5 =
				registryEntryLookup.getOrThrow(EndConfiguredFeatures.END_ISLAND);
		PlacedFeatures.register(
				featureRegisterable,
				END_PLATFORM,
				registryEntry,
				FixedPlacementModifier.of(ServerWorld.END_SPAWN_POS.down()),
