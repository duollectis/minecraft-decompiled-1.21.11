...
/**
 * {@code UndergroundPlacedFeatures}.
 */
public class UndergroundPlacedFeatures {
	...
	public static final RegistryKey<PlacedFeature>
			...
			PlacedFeatures.of("sculk_patch_ancient_city");
	...
	public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
		...
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.MONSTER_ROOM);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry2 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.FOSSIL_COAL);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry3 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.FOSSIL_DIAMONDS);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry4 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.DRIPSTONE_CLUSTER);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry5 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.LARGE_DRIPSTONE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry6 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.POINTED_DRIPSTONE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry7 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.UNDERWATER_MAGMA);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry8 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.GLOW_LICHEN);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry9 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.ROOTED_AZALEA_TREE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry10 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.CAVE_VINE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry11 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.MOSS_PATCH);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry12 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.LUSH_CAVES_CLAY);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry13 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.MOSS_PATCH_CEILING);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry14 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.SPORE_BLOSSOM);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry15 =
				registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.VINES);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry16 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.AMETHYST_GEODE);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry17 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.SCULK_PATCH_DEEP_DARK);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry18 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.SCULK_PATCH_ANCIENT_CITY);
		RegistryEntry<ConfiguredFeature<?, ?>>
				registryEntry19 =
				registryEntryLookup.getOrThrow(UndergroundConfiguredFeatures.SCULK_VEIN);
