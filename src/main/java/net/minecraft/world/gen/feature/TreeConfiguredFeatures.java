...
public class TreeConfiguredFeatures {
   ...
   public static final RegistryKey<ConfiguredFeature<?, ?>> OAK_BEES_0002 = ConfiguredFeatures.of("oak_bees_0002_leaf_litter");
   ...
   public static final RegistryKey<ConfiguredFeature<?, ?>> BIRCH_BEES_0002_LEAF_LITTER = ConfiguredFeatures.of("birch_bees_0002_leaf_litter");
   ...
   public static final RegistryKey<ConfiguredFeature<?, ?>> FANCY_OAK_BEES_0002 = ConfiguredFeatures.of("fancy_oak_bees_0002_leaf_litter");
   ...
   public static final RegistryKey<ConfiguredFeature<?, ?>> DARK_OAK_LEAF_LITTER = ConfiguredFeatures.of("dark_oak_leaf_litter");
   public static final RegistryKey<ConfiguredFeature<?, ?>> BIRCH_LEAF_LITTER = ConfiguredFeatures.of("birch_leaf_litter");
   public static final RegistryKey<ConfiguredFeature<?, ?>> FANCY_OAK_LEAF_LITTER = ConfiguredFeatures.of("fancy_oak_leaf_litter");
   public static final RegistryKey<ConfiguredFeature<?, ?>> FALLEN_OAK_TREE = ConfiguredFeatures.of("fallen_oak_tree");
   public static final RegistryKey<ConfiguredFeature<?, ?>> FALLEN_JUNGLE_TREE = ConfiguredFeatures.of("fallen_jungle_tree");
   public static final RegistryKey<ConfiguredFeature<?, ?>> FALLEN_SPRUCE_TREE = ConfiguredFeatures.of("fallen_spruce_tree");
   public static final RegistryKey<ConfiguredFeature<?, ?>> FALLEN_BIRCH_TREE = ConfiguredFeatures.of("fallen_birch_tree");
   public static final RegistryKey<ConfiguredFeature<?, ?>> FALLEN_SUPER_BIRCH_TREE = ConfiguredFeatures.of("fallen_super_birch_tree");
   ...
   private static FallenTreeFeatureConfig.Builder fallen(Block log, int minLength, int maxLength) {
      return new FallenTreeFeatureConfig.Builder(BlockStateProvider.of(log), UniformIntProvider.create(minLength, maxLength))
         .logDecorators(
            ImmutableList.of(
               new AttachedToLogsTreeDecorator(
                  0.1F,
                  new WeightedBlockStateProvider(
                     Pool.<BlockState>builder().add(Blocks.RED_MUSHROOM.getDefaultState(), 2).add(Blocks.BROWN_MUSHROOM.getDefaultState(), 1)
                  ),
   ...
   public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
      ...
      ConfiguredFeatures.register(
         ...
         new TreeFeatureConfig.Builder(
               ...
               new WeightedBlockStateProvider(
                  Pool.<BlockState>builder().add(Blocks.AZALEA_LEAVES.getDefaultState(), 3).add(Blocks.FLOWERING_AZALEA_LEAVES.getDefaultState(), 1)
               ),
      ...
      ConfiguredFeatures.register(
         ...
         OAK_BEES_0002,
         Feature.TREE,
         oak().decorators(List.of(beehiveTreeDecorator, placeOnGroundTreeDecorator, placeOnGroundTreeDecorator2)).build()
      );
      ...
      ConfiguredFeatures.register(
         ...
         Feature.TREE,
         birch().decorators(List.of(beehiveTreeDecorator, placeOnGroundTreeDecorator, placeOnGroundTreeDecorator2)).build()
      );
      ...
      ConfiguredFeatures.register(
         ...
         FANCY_OAK_BEES_0002,
         Feature.TREE,
         fancyOak().decorators(List.of(beehiveTreeDecorator, placeOnGroundTreeDecorator, placeOnGroundTreeDecorator2)).build()
      );
      ...
      ConfiguredFeatures.register(
         ...
         Feature.TREE,
         darkOak().ignoreVines().decorators(ImmutableList.of(placeOnGroundTreeDecorator, placeOnGroundTreeDecorator2)).build()
      );
      ConfiguredFeatures.register(
         featureRegisterable,
         BIRCH_LEAF_LITTER,
