...
public class TreeConfiguredFeatures {
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			...
			ConfiguredFeatures.of("crimson_fungus_planted");
	public static final RegistryKey<ConfiguredFeature<?, ?>> WARPED_FUNGUS = ConfiguredFeatures.of("warped_fungus");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			WARPED_FUNGUS_PLANTED =
			ConfiguredFeatures.of("warped_fungus_planted");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			HUGE_BROWN_MUSHROOM =
			ConfiguredFeatures.of("huge_brown_mushroom");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			HUGE_RED_MUSHROOM =
			ConfiguredFeatures.of("huge_red_mushroom");
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			PALE_OAK_BONEMEAL =
			ConfiguredFeatures.of("pale_oak_bonemeal");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			PALE_OAK_CREAKING =
			ConfiguredFeatures.of("pale_oak_creaking");
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			JUNGLE_TREE_NO_VINE =
			ConfiguredFeatures.of("jungle_tree_no_vine");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			MEGA_JUNGLE_TREE =
			ConfiguredFeatures.of("mega_jungle_tree");
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			...
			ConfiguredFeatures.of("super_birch_bees_0002");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			SUPER_BIRCH_BEES =
			ConfiguredFeatures.of("super_birch_bees");
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			OAK_BEES_0002 =
			ConfiguredFeatures.of("oak_bees_0002_leaf_litter");
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			...
			ConfiguredFeatures.of("birch_bees_0002_leaf_litter");
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			FANCY_OAK_BEES_0002 =
			ConfiguredFeatures.of("fancy_oak_bees_0002_leaf_litter");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			FANCY_OAK_BEES_002 =
			ConfiguredFeatures.of("fancy_oak_bees_002");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			FANCY_OAK_BEES_005 =
			ConfiguredFeatures.of("fancy_oak_bees_005");
	...
	public static final RegistryKey<ConfiguredFeature<?, ?>> OAK_LEAF_LITTER = ConfiguredFeatures.of("oak_leaf_litter");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			DARK_OAK_LEAF_LITTER =
			ConfiguredFeatures.of("dark_oak_leaf_litter");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			BIRCH_LEAF_LITTER =
			ConfiguredFeatures.of("birch_leaf_litter");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			FANCY_OAK_LEAF_LITTER =
			ConfiguredFeatures.of("fancy_oak_leaf_litter");
	public static final RegistryKey<ConfiguredFeature<?, ?>> FALLEN_OAK_TREE = ConfiguredFeatures.of("fallen_oak_tree");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			FALLEN_JUNGLE_TREE =
			ConfiguredFeatures.of("fallen_jungle_tree");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			FALLEN_SPRUCE_TREE =
			ConfiguredFeatures.of("fallen_spruce_tree");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			FALLEN_BIRCH_TREE =
			ConfiguredFeatures.of("fallen_birch_tree");
	public static final RegistryKey<ConfiguredFeature<?, ?>>
			FALLEN_SUPER_BIRCH_TREE =
			ConfiguredFeatures.of("fallen_super_birch_tree");
	...
	private static FallenTreeFeatureConfig.Builder fallen(Block log, int minLength, int maxLength) {
		return new FallenTreeFeatureConfig.Builder(
				BlockStateProvider.of(log),
				UniformIntProvider.create(minLength, maxLength)
		)
				.logDecorators(
						ImmutableList.of(
	...
	public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
		...
		ConfiguredFeatures.register(
				...
				new HugeMushroomFeatureConfig(
						BlockStateProvider.of(Blocks.BROWN_MUSHROOM_BLOCK
								.getDefaultState()
		...
		ConfiguredFeatures.register(
				...
				new TreeFeatureConfig.Builder(
						...
						.decorators(ImmutableList.of(
								new PaleMossTreeDecorator(0.15F, 0.4F, 0.8F),
		...
		ConfiguredFeatures.register(
				...
				CHERRY_BEES_005,
				Feature.TREE,
				cherry().decorators(List.of(beehiveTreeDecorator4)).build()
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				SPRUCE,
		...
		ConfiguredFeatures.register(
				...
				SUPER_BIRCH_BEES_0002,
				Feature.TREE,
				superBirch().decorators(ImmutableList.of(beehiveTreeDecorator)).build()
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				SUPER_BIRCH_BEES,
				Feature.TREE,
				superBirch().decorators(ImmutableList.of(beehiveTreeDecorator5)).build()
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				SWAMP_OAK,
				Feature.TREE,
				builder(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 5, 3, 0, 3)
								...
								List.of(
										...
										new AttachedToLeavesTreeDecorator(
												...
												new RandomizedIntBlockStateProvider(
														BlockStateProvider.of(Blocks.MANGROVE_PROPAGULE
																.getDefaultState()
																.with(PropaguleBlock.HANGING, true)),
														PropaguleBlock.AGE,
		...
		ConfiguredFeatures.register(
				...
				OAK_BEES_002,
				Feature.TREE,
				oak().decorators(List.of(beehiveTreeDecorator3)).build()
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				OAK_BEES_005,
				Feature.TREE,
				oak().decorators(List.of(beehiveTreeDecorator4)).build()
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				BIRCH_BEES_0002,
				Feature.TREE,
				birch().decorators(List.of(beehiveTreeDecorator)).build()
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				BIRCH_BEES_0002_LEAF_LITTER,
		...
		ConfiguredFeatures.register(
				...
				BIRCH_BEES_002,
				Feature.TREE,
				birch().decorators(List.of(beehiveTreeDecorator3)).build()
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				BIRCH_BEES_005,
				Feature.TREE,
				birch().decorators(List.of(beehiveTreeDecorator4)).build()
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				FANCY_OAK_BEES_0002,
		...
		ConfiguredFeatures.register(
				...
				FANCY_OAK_BEES_002,
				Feature.TREE,
				fancyOak().decorators(List.of(beehiveTreeDecorator3)).build()
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				FANCY_OAK_BEES_005,
				Feature.TREE,
				fancyOak().decorators(List.of(beehiveTreeDecorator4)).build()
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				FANCY_OAK_BEES,
				Feature.TREE,
				fancyOak().decorators(List.of(beehiveTreeDecorator5)).build()
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				OAK_LEAF_LITTER,
				Feature.TREE,
				oak().decorators(ImmutableList.of(placeOnGroundTreeDecorator, placeOnGroundTreeDecorator2)).build()
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				DARK_OAK_LEAF_LITTER,
				...
				darkOak()
						.ignoreVines()
						.decorators(ImmutableList.of(placeOnGroundTreeDecorator, placeOnGroundTreeDecorator2))
						.build()
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				BIRCH_LEAF_LITTER,
				Feature.TREE,
				birch().decorators(ImmutableList.of(placeOnGroundTreeDecorator, placeOnGroundTreeDecorator2)).build()
		);
		ConfiguredFeatures.register(
				featureRegisterable,
				FANCY_OAK_LEAF_LITTER,
				Feature.TREE,
				fancyOak().decorators(List.of(placeOnGroundTreeDecorator, placeOnGroundTreeDecorator2)).build()
		);
