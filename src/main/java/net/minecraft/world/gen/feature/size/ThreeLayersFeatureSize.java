	...
	public static final MapCodec<ThreeLayersFeatureSize> CODEC = RecordCodecBuilder.mapCodec(
			instance -> instance.group(
					                    Codec
							                    ...
							                    .fieldOf("limit")
							                    .orElse(1)
							                    .forGetter(threeLayersFeatureSize -> threeLayersFeatureSize.limit),
					                    Codec
							                    .intRange(0, 80)
							                    .fieldOf("upper_limit")
							                    .orElse(1)
					                    ...
					                    Codec
							                    ...
							                    .fieldOf("lower_size")
							                    .orElse(0)
							                    .forGetter(threeLayersFeatureSize -> threeLayersFeatureSize.lowerSize),
					                    Codec
							                    .intRange(0, 16)
							                    .fieldOf("middle_size")
							                    .orElse(1)
							                    .forGetter(threeLayersFeatureSize -> threeLayersFeatureSize.middleSize),
					                    Codec
							                    .intRange(0, 16)
							                    .fieldOf("upper_size")
							                    .orElse(1)
							                    .forGetter(threeLayersFeatureSize -> threeLayersFeatureSize.upperSize),
					                    createCodec()
			                    )
