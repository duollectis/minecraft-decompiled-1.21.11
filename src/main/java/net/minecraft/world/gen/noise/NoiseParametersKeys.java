...
public class NoiseParametersKeys {
	...
	public static final RegistryKey<DoublePerlinNoiseSampler.NoiseParameters>
			TEMPERATURE_LARGE =
			of("temperature_large");
	...
	public static final RegistryKey<DoublePerlinNoiseSampler.NoiseParameters>
			...
			of("aquifer_fluid_level_floodedness");
	...
	public static final RegistryKey<DoublePerlinNoiseSampler.NoiseParameters>
			...
			of("spaghetti_2d_elevation");
	public static final RegistryKey<DoublePerlinNoiseSampler.NoiseParameters>
			SPAGHETTI_2D_MODULATOR =
			of("spaghetti_2d_modulator");
	public static final RegistryKey<DoublePerlinNoiseSampler.NoiseParameters>
			SPAGHETTI_2D_THICKNESS =
			of("spaghetti_2d_thickness");
	...
	public static final RegistryKey<DoublePerlinNoiseSampler.NoiseParameters>
			SPAGHETTI_3D_RARITY =
			of("spaghetti_3d_rarity");
	public static final RegistryKey<DoublePerlinNoiseSampler.NoiseParameters>
			SPAGHETTI_3D_THICKNESS =
			of("spaghetti_3d_thickness");
	public static final RegistryKey<DoublePerlinNoiseSampler.NoiseParameters>
			SPAGHETTI_ROUGHNESS =
			of("spaghetti_roughness");
	public static final RegistryKey<DoublePerlinNoiseSampler.NoiseParameters>
			SPAGHETTI_ROUGHNESS_MODULATOR =
			of("spaghetti_roughness_modulator");
	...
	public static final RegistryKey<DoublePerlinNoiseSampler.NoiseParameters>
			SURFACE_SECONDARY =
			of("surface_secondary");
	public static final RegistryKey<DoublePerlinNoiseSampler.NoiseParameters>
			CLAY_BANDS_OFFSET =
			of("clay_bands_offset");
	...
	public static DoublePerlinNoiseSampler createNoiseSampler(
		...
		return DoublePerlinNoiseSampler.create(
				splitter.split(registryEntry.getKey().orElseThrow().getValue()),
				registryEntry.value()
		);
	}
}
