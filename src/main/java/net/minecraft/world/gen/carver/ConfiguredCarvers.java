...
/**
 * Реестр всех зарегистрированных конфигураций карверов ванильного Майнкрафта.
 */
public class ConfiguredCarvers {
	...
	/**
	 * Регистрирует все ванильные карверы в реестре.
	 * Параметры вероятностей, диапазонов высот и радиусов подобраны
	 * для баланса между плотностью пещер и производительностью генерации.
	 */
	public static void bootstrap(Registerable<ConfiguredCarver<?>> carverRegisterable) {
		RegistryEntryLookup<Block> blockLookup = carverRegisterable.getRegistryLookup(RegistryKeys.BLOCK);
