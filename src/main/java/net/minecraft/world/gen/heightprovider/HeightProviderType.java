...
public interface HeightProviderType<P extends HeightProvider> {
	...
	HeightProviderType<BiasedToBottomHeightProvider>
			BIASED_TO_BOTTOM =
			register("biased_to_bottom", BiasedToBottomHeightProvider.BIASED_TO_BOTTOM_CODEC);

	HeightProviderType<VeryBiasedToBottomHeightProvider>
			VERY_BIASED_TO_BOTTOM =
			register("very_biased_to_bottom", VeryBiasedToBottomHeightProvider.CODEC);

	HeightProviderType<TrapezoidHeightProvider> TRAPEZOID = register("trapezoid", TrapezoidHeightProvider.CODEC);

	HeightProviderType<WeightedListHeightProvider>
			WEIGHTED_LIST =
			register("weighted_list", WeightedListHeightProvider.WEIGHTED_LIST_CODEC);
