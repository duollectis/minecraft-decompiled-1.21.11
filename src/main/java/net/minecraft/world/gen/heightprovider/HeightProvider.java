...
public abstract class HeightProvider {
	...
	private static final Codec<Either<YOffset, HeightProvider>> OFFSET_OR_HEIGHT_CODEC = Codec.either(
			...
			Registries.HEIGHT_PROVIDER_TYPE.getCodec().dispatch(HeightProvider::getType, HeightProviderType::codec)
	);
	public static final Codec<HeightProvider> CODEC = OFFSET_OR_HEIGHT_CODEC.xmap(
			either -> (HeightProvider) either.map(ConstantHeightProvider::create, provider -> provider),
