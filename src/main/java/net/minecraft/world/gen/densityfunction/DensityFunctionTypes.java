...
public final class DensityFunctionTypes {
	...
	public static MapCodec<? extends DensityFunction> registerAndGetDefault(Registry<MapCodec<? extends DensityFunction>> registry) {
		...
		register(registry, "y_clamped_gradient", DensityFunctionTypes.YClampedGradient.CODEC_HOLDER);
		return register(registry, "find_top_surface", DensityFunctionTypes.FindTopSurface.CODEC_HOLDER);
	}
	...
	static <O> CodecHolder<O> holderOf(
			Function<DensityFunction, O> creator,
			Function<O, DensityFunction> argumentGetter
	) {
		return holderOf(DensityFunction.FUNCTION_CODEC, creator, argumentGetter);
	}

	static <O> CodecHolder<O> holderOf(
			BiFunction<DensityFunction, DensityFunction, O> creator,
	...
	public static DensityFunction noiseInRange(
			RegistryEntry<DoublePerlinNoiseSampler.NoiseParameters> noiseParameters,
			@Deprecated double scaleXz,
			double scaleY,
			double min,
			double max
	) {
		return mapRange(
				new DensityFunctionTypes.Noise(new DensityFunction.Noise(noiseParameters), scaleXz, scaleY),
				min,
				max
		);
	}
	...
	public static DensityFunction shiftedNoise(
		...
		return new DensityFunctionTypes.ShiftedNoise(
				...
				xzScale,
				0.0,
				new DensityFunction.Noise(noiseParameters)
		);
	}
	...
	public interface Beardifying extends DensityFunction.Base {
		...
		CodecHolder<DensityFunction>
				CODEC_HOLDER =
				CodecHolder.of(MapCodec.unit(DensityFunctionTypes.Beardifier.INSTANCE));
	...
	record BinaryOperation(
		...
		public DensityFunction apply(DensityFunction.DensityFunctionVisitor visitor) {
			return visitor.apply(DensityFunctionTypes.BinaryOperationLike.create(
					this.type,
					this.argument1.apply(visitor),
					this.argument2.apply(visitor)
			));
		}
	}
	...
	interface BinaryOperationLike extends DensityFunction {
		...
		public static enum Type implements StringIdentifiable {
			...
			final CodecHolder<DensityFunctionTypes.BinaryOperationLike> codecHolder = DensityFunctionTypes.holderOf(
					(BiFunction<DensityFunction, DensityFunction, DensityFunctionTypes.BinaryOperationLike>) ((densityFunction, densityFunction2) -> DensityFunctionTypes.BinaryOperationLike.create(
							this, densityFunction, densityFunction2
					)
					),
		...
		private static final MapCodec<DensityFunctionTypes.Clamp> CLAMP_CODEC = RecordCodecBuilder.mapCodec(
				instance -> instance.group(
						                    ...
						                    DensityFunctionTypes.CONSTANT_RANGE
								                    .fieldOf("min")
								                    .forGetter(DensityFunctionTypes.Clamp::minValue),
						                    DensityFunctionTypes.CONSTANT_RANGE
								                    .fieldOf("max")
								                    .forGetter(DensityFunctionTypes.Clamp::maxValue)
				                    )
				                    .apply(instance, DensityFunctionTypes.Clamp::new)
		);
		public static final CodecHolder<DensityFunctionTypes.Clamp>
				CODEC_HOLDER =
				DensityFunctionTypes.holderOf(CLAMP_CODEC);
	...
	record Constant(double value) implements DensityFunction.Base {
		...
		static final CodecHolder<DensityFunctionTypes.Constant> CODEC_HOLDER = DensityFunctionTypes.holderOf(
				DensityFunctionTypes.CONSTANT_RANGE,
				DensityFunctionTypes.Constant::new,
				DensityFunctionTypes.Constant::value
		);
	...
	public static final class EndIslands implements DensityFunction.Base {
		...
		public static final CodecHolder<DensityFunctionTypes.EndIslands>
				CODEC_HOLDER =
				CodecHolder.of(MapCodec.unit(new DensityFunctionTypes.EndIslands(0L)));
		private static final float CAVES_THRESHOLD = -0.9F;
	...
	record FindTopSurface(
		...
		private static final MapCodec<DensityFunctionTypes.FindTopSurface>
				FIND_TOP_SURFACE_CODEC =
				RecordCodecBuilder.mapCodec(
						instance -> instance.group(
								                    DensityFunction.FUNCTION_CODEC
										                    .fieldOf("density")
										                    .forGetter(DensityFunctionTypes.FindTopSurface::density),
								                    DensityFunction.FUNCTION_CODEC
										                    .fieldOf("upper_bound")
										                    .forGetter(DensityFunctionTypes.FindTopSurface::upperBound),
								                    Codec.intRange(DimensionType.MIN_HEIGHT * 2, DimensionType.MAX_COLUMN_HEIGHT * 2)
								                         .fieldOf("lower_bound")
								                         .forGetter(DensityFunctionTypes.FindTopSurface::lowerBound),
								                    Codecs.POSITIVE_INT
										                    .fieldOf("cell_height")
										                    .forGetter(DensityFunctionTypes.FindTopSurface::cellHeight)
						                    )
						                    .apply(instance, DensityFunctionTypes.FindTopSurface::new)
				);
		public static final CodecHolder<DensityFunctionTypes.FindTopSurface>
				CODEC_HOLDER =
				DensityFunctionTypes.holderOf(FIND_TOP_SURFACE_CODEC);
		...
		public DensityFunction apply(DensityFunction.DensityFunctionVisitor visitor) {
			return visitor.apply(
					new DensityFunctionTypes.FindTopSurface(
							this.density.apply(visitor),
							this.upperBound.apply(visitor),
							this.lowerBound,
							this.cellHeight
					)
			);
	...
	protected record Noise(
		...
		public static final CodecHolder<DensityFunctionTypes.Noise>
				CODEC_HOLDER =
				DensityFunctionTypes.holderOf(NOISE_CODEC);

		@Override
		public double sample(DensityFunction.NoisePos pos) {
			return this.noise.sample(
					pos.blockX() * this.xzScale,
					pos.blockY() * this.yScale,
					pos.blockZ() * this.xzScale
			);
		}
	...
	record RangeChoice(
		...
		public static final CodecHolder<DensityFunctionTypes.RangeChoice>
				CODEC_HOLDER =
				DensityFunctionTypes.holderOf(RANGE_CHOICE_CODEC);

		@Override
		public double sample(DensityFunction.NoisePos pos) {
			double d = this.input.sample(pos);
			return d >= this.minInclusive && d < this.maxExclusive ? this.whenInRange.sample(pos)
		...
		public DensityFunction apply(DensityFunction.DensityFunctionVisitor visitor) {
			return visitor.apply(
					new DensityFunctionTypes.RangeChoice(
							...
							this.minInclusive,
							this.maxExclusive,
							this.whenInRange.apply(visitor),
							this.whenOutOfRange.apply(visitor)
					)
			);
		}
	...
	public record RegistryEntryHolder(RegistryEntry<DensityFunction> function) implements DensityFunction {
		...
		@Override
		public DensityFunction apply(DensityFunction.DensityFunctionVisitor visitor) {
			return visitor.apply(new DensityFunctionTypes.RegistryEntryHolder(new RegistryEntry.Direct<>(this.function
					.value()
					.apply(visitor))));
		}
	...
	protected record ShiftedNoise(
		...
		private static final MapCodec<DensityFunctionTypes.ShiftedNoise>
				SHIFTED_NOISE_CODEC =
				RecordCodecBuilder.mapCodec(
						instance -> instance.group(
								                    DensityFunction.FUNCTION_CODEC
										                    .fieldOf("shift_x")
										                    .forGetter(DensityFunctionTypes.ShiftedNoise::shiftX),
								                    DensityFunction.FUNCTION_CODEC
										                    .fieldOf("shift_y")
										                    .forGetter(DensityFunctionTypes.ShiftedNoise::shiftY),
								                    DensityFunction.FUNCTION_CODEC
										                    .fieldOf("shift_z")
										                    .forGetter(DensityFunctionTypes.ShiftedNoise::shiftZ),
								                    ...
								                    DensityFunction.Noise.CODEC
										                    .fieldOf("noise")
										                    .forGetter(DensityFunctionTypes.ShiftedNoise::noise)
						                    )
						                    .apply(instance, DensityFunctionTypes.ShiftedNoise::new)
				);
		public static final CodecHolder<DensityFunctionTypes.ShiftedNoise>
				CODEC_HOLDER =
				DensityFunctionTypes.holderOf(SHIFTED_NOISE_CODEC);
		...
		public DensityFunction apply(DensityFunction.DensityFunctionVisitor visitor) {
			return visitor.apply(
					new DensityFunctionTypes.ShiftedNoise(
							this.shiftX.apply(visitor),
							this.shiftY.apply(visitor),
							this.shiftZ.apply(visitor),
							this.xzScale,
							this.yScale,
							visitor.apply(this.noise)
					)
			);
		}
	...
	public record Spline(net.minecraft.util.math.Spline<DensityFunctionTypes.Spline.SplinePos, DensityFunctionTypes.Spline.DensityFunctionWrapper> spline)
		...
		private static final Codec<net.minecraft.util.math.Spline<DensityFunctionTypes.Spline.SplinePos, DensityFunctionTypes.Spline.DensityFunctionWrapper>>
				SPLINE_CODEC =
				net.minecraft.util.math.Spline.createCodec(
						DensityFunctionTypes.Spline.DensityFunctionWrapper.CODEC
				);
		private static final MapCodec<DensityFunctionTypes.Spline>
				SPLINE_FUNCTION_CODEC =
				SPLINE_CODEC.fieldOf("spline")
				            .xmap(DensityFunctionTypes.Spline::new, DensityFunctionTypes.Spline::spline);
		public static final CodecHolder<DensityFunctionTypes.Spline>
				CODEC_HOLDER =
				DensityFunctionTypes.holderOf(SPLINE_FUNCTION_CODEC);
		...
		@Override
		public DensityFunction apply(DensityFunction.DensityFunctionVisitor visitor) {
			return visitor.apply(new DensityFunctionTypes.Spline(this.spline.apply(densityFunctionWrapper -> densityFunctionWrapper.apply(
					visitor))));
		}
		...
		public record DensityFunctionWrapper(RegistryEntry<DensityFunction> function) implements ToFloatFunction<DensityFunctionTypes.Spline.SplinePos> {
			...
			public static final Codec<DensityFunctionTypes.Spline.DensityFunctionWrapper>
					...
					DensityFunction.REGISTRY_ENTRY_CODEC
							.xmap(
									DensityFunctionTypes.Spline.DensityFunctionWrapper::new,
			...
			@Override
			public float min() {
				return this.function.hasKeyAndValue() ? (float) this.function.value().minValue()
				                                      : Float.NEGATIVE_INFINITY;
			}

			@Override
			public float max() {
				return this.function.hasKeyAndValue() ? (float) this.function.value().maxValue()
				                                      : Float.POSITIVE_INFINITY;
			}

			public DensityFunctionTypes.Spline.DensityFunctionWrapper apply(DensityFunction.DensityFunctionVisitor visitor) {
				return new DensityFunctionTypes.Spline.DensityFunctionWrapper(new RegistryEntry.Direct<>(this.function
						.value()
						.apply(visitor)));
			}
		}
	...
	protected record UnaryOperation(
		...
		public static DensityFunctionTypes.UnaryOperation create(
				DensityFunctionTypes.UnaryOperation.Type type,
				DensityFunction input
		) {
		...
		static enum Type implements StringIdentifiable {
			...
			final CodecHolder<DensityFunctionTypes.UnaryOperation> codecHolder = DensityFunctionTypes.holderOf(
					input -> DensityFunctionTypes.UnaryOperation.create(this, input),
	...
	protected record WeirdScaledSampler(
		...
		private static final MapCodec<DensityFunctionTypes.WeirdScaledSampler>
				WEIRD_SCALED_SAMPLER_CODEC =
				RecordCodecBuilder.mapCodec(
						instance -> instance.group(
								                    DensityFunction.FUNCTION_CODEC
										                    .fieldOf("input")
										                    .forGetter(DensityFunctionTypes.WeirdScaledSampler::input),
								                    DensityFunction.Noise.CODEC
										                    .fieldOf("noise")
										                    .forGetter(DensityFunctionTypes.WeirdScaledSampler::noise),
		...
		public static final CodecHolder<DensityFunctionTypes.WeirdScaledSampler>
				CODEC_HOLDER =
				DensityFunctionTypes.holderOf(WEIRD_SCALED_SAMPLER_CODEC);
		...
		@Override
		public DensityFunction apply(DensityFunction.DensityFunctionVisitor visitor) {
			return visitor.apply(new DensityFunctionTypes.WeirdScaledSampler(
					this.input.apply(visitor),
					visitor.apply(this.noise),
		...
		public static enum RarityValueMapper implements StringIdentifiable {
			...
			public static final Codec<DensityFunctionTypes.WeirdScaledSampler.RarityValueMapper>
					CODEC =
	...
	public record Wrapping(
		...
		public static enum Type implements StringIdentifiable {
			...
			final CodecHolder<DensityFunctionTypes.Wrapper> codec = DensityFunctionTypes.holderOf(
					densityFunction -> new DensityFunctionTypes.Wrapping(this, densityFunction),
	...
	record YClampedGradient(int fromY, int toY, double fromValue, double toValue) implements DensityFunction.Base {
		...
		private static final MapCodec<DensityFunctionTypes.YClampedGradient>
				...
				RecordCodecBuilder.mapCodec(
						instance -> instance.group(
								                    ...
								                    DensityFunctionTypes.CONSTANT_RANGE
										                    .fieldOf("from_value")
										                    .forGetter(DensityFunctionTypes.YClampedGradient::fromValue),
								                    DensityFunctionTypes.CONSTANT_RANGE
										                    .fieldOf("to_value")
										                    .forGetter(DensityFunctionTypes.YClampedGradient::toValue)
						                    )
		...
		public static final CodecHolder<DensityFunctionTypes.YClampedGradient>
				CODEC_HOLDER =
				DensityFunctionTypes.holderOf(Y_CLAMPED_GRADIENT_CODEC);
