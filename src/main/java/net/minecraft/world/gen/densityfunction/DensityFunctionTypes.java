...
public final class DensityFunctionTypes {
   ...
   record FindTopSurface(DensityFunction density, DensityFunction upperBound, int lowerBound, int cellHeight) implements DensityFunction {
      private static final MapCodec<DensityFunctionTypes.FindTopSurface> FIND_TOP_SURFACE_CODEC = RecordCodecBuilder.mapCodec(
         instance -> instance.group(
               DensityFunction.FUNCTION_CODEC.fieldOf("density").forGetter(DensityFunctionTypes.FindTopSurface::density),
               DensityFunction.FUNCTION_CODEC.fieldOf("upper_bound").forGetter(DensityFunctionTypes.FindTopSurface::upperBound),
               ...
               Codecs.POSITIVE_INT.fieldOf("cell_height").forGetter(DensityFunctionTypes.FindTopSurface::cellHeight)
            )
            .apply(instance, DensityFunctionTypes.FindTopSurface::new)
      );
      public static final CodecHolder<DensityFunctionTypes.FindTopSurface> CODEC_HOLDER = DensityFunctionTypes.holderOf(FIND_TOP_SURFACE_CODEC);
      ...
      public DensityFunction apply(DensityFunction.DensityFunctionVisitor visitor) {
         return visitor.apply(
            new DensityFunctionTypes.FindTopSurface(this.density.apply(visitor), this.upperBound.apply(visitor), this.lowerBound, this.cellHeight)
         );
      }
