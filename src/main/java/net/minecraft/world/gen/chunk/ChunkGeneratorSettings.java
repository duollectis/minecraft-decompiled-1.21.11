...
public record ChunkGeneratorSettings(
	...
	public static final Codec<RegistryEntry<ChunkGeneratorSettings>>
			REGISTRY_CODEC =
	...
	public static void bootstrap(Registerable<ChunkGeneratorSettings> chunkGenerationSettingsRegisterable) {
		chunkGenerationSettingsRegisterable.register(
				OVERWORLD,
				createSurfaceSettings(chunkGenerationSettingsRegisterable, false, false)
		);
		chunkGenerationSettingsRegisterable.register(
				LARGE_BIOMES,
				createSurfaceSettings(chunkGenerationSettingsRegisterable, false, true)
		);
		chunkGenerationSettingsRegisterable.register(
				AMPLIFIED,
				createSurfaceSettings(chunkGenerationSettingsRegisterable, true, false)
		);
		...
		chunkGenerationSettingsRegisterable.register(
				FLOATING_ISLANDS,
				createFloatingIslandsSettings(chunkGenerationSettingsRegisterable)
		);
	}
