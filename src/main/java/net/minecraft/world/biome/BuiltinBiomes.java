...
public abstract class BuiltinBiomes {
   public static void bootstrap(Registerable<Biome> biomeRegisterable) {
      ...
      biomeRegisterable.register(
         BiomeKeys.FLOWER_FOREST, OverworldBiomeCreator.createNormalForest(registryEntryLookup, registryEntryLookup2, false, false, true)
      );
      biomeRegisterable.register(
         BiomeKeys.BIRCH_FOREST, OverworldBiomeCreator.createNormalForest(registryEntryLookup, registryEntryLookup2, true, false, false)
      );
      ...
      biomeRegisterable.register(
         BiomeKeys.WINDSWEPT_GRAVELLY_HILLS, OverworldBiomeCreator.createWindsweptHills(registryEntryLookup, registryEntryLookup2, false)
      );
