...
public class SpawnSettings {
   ...
   public static class Builder {
      ...
      public SpawnSettings build() {
         return new SpawnSettings(
            ...
            this.spawners.entrySet().stream().collect(ImmutableMap.toImmutableMap(Entry::getKey, spawner -> ((Pool.Builder)spawner.getValue()).build())),
   ...
   public record SpawnEntry(EntityType<?> type, int minGroupSize, int maxGroupSize) {
      public static final MapCodec<SpawnSettings.SpawnEntry> CODEC = RecordCodecBuilder.<SpawnSettings.SpawnEntry>mapCodec(
         ...
         .validate(
            (SpawnSettings.SpawnEntry spawnEntry) -> spawnEntry.minGroupSize > spawnEntry.maxGroupSize
