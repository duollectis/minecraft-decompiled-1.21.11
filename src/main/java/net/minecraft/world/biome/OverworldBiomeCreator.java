...
public class OverworldBiomeCreator {
	...
	public static Biome createOldGrowthTaiga(
		...
		lookupBackedBuilder.feature(
				...
				spruce ? VegetationPlacedFeatures.TREES_OLD_GROWTH_SPRUCE_TAIGA
		...
		return biome(spruce ? 0.25F : 0.3F, 0.8F)
				.setEnvironmentAttribute(
						...
						new BackgroundMusic(SoundEvents.MUSIC_OVERWORLD_OLD_GROWTH_TAIGA)
				)
	...
	public static Biome createSparseJungle(
		...
		return createJungleFeatures(featureLookup, carverLookup, 0.8F, false, true, false)
				...
				.setEnvironmentAttribute(
						EnvironmentAttributes.BACKGROUND_MUSIC_AUDIO,
						new BackgroundMusic(SoundEvents.MUSIC_OVERWORLD_SPARSE_JUNGLE)
				)
				.build();
	}
	...
	public static Biome createJungle(
		...
		return createJungleFeatures(featureLookup, carverLookup, 0.9F, false, false, true)
				...
				.setEnvironmentAttribute(
						EnvironmentAttributes.BACKGROUND_MUSIC_AUDIO,
						new BackgroundMusic(SoundEvents.MUSIC_OVERWORLD_JUNGLE)
				)
	...
	public static Biome createNormalBambooJungle(
		...
		return createJungleFeatures(featureLookup, carverLookup, 0.9F, true, false, true)
				...
				.setEnvironmentAttribute(
						EnvironmentAttributes.BACKGROUND_MUSIC_AUDIO,
						new BackgroundMusic(SoundEvents.MUSIC_OVERWORLD_BAMBOO_JUNGLE)
				)
				.setEnvironmentAttribute(EnvironmentAttributes.INCREASED_FIRE_BURNOUT_GAMEPLAY, true)
				.build();
	}
	...
	public static Biome createDesert(
		...
		return biome(2.0F, 0.0F)
				...
				.setEnvironmentAttribute(
						EnvironmentAttributes.BACKGROUND_MUSIC_AUDIO,
						new BackgroundMusic(SoundEvents.MUSIC_OVERWORLD_DESERT)
				)
	...
	public static Biome createPlains(
		...
		DefaultBiomeFeatures.addDefaultMushrooms(lookupBackedBuilder);
		DefaultBiomeFeatures.addDefaultVegetation(lookupBackedBuilder, true);
		return biome(snowy ? 0.0F : 0.8F, snowy ? 0.5F : 0.4F)
				.spawnSettings(builder.build())
				.generationSettings(lookupBackedBuilder.build())
				.build();
	}
	...
	public static Biome createBadlands(
			RegistryEntryLookup<PlacedFeature> featureLookup,
			RegistryEntryLookup<ConfiguredCarver<?>> carverLookup,
			boolean plateau
	) {
		...
		return biome(2.0F, 0.0F)
				...
				.setEnvironmentAttribute(
						EnvironmentAttributes.BACKGROUND_MUSIC_AUDIO,
						new BackgroundMusic(SoundEvents.MUSIC_OVERWORLD_BADLANDS)
				)
				.setEnvironmentAttribute(EnvironmentAttributes.SNOW_GOLEM_MELTS_GAMEPLAY, true)
	...
	public static Biome createColdOcean(
		...
		GenerationSettings.LookupBackedBuilder
				lookupBackedBuilder =
				createOceanGenerationSettings(featureLookup, carverLookup);
		lookupBackedBuilder.feature(
				GenerationStep.Feature.VEGETAL_DECORATION,
				deep ? OceanPlacedFeatures.SEAGRASS_DEEP_COLD : OceanPlacedFeatures.SEAGRASS_COLD
		);
	...
	public static Biome createNormalOcean(
			RegistryEntryLookup<PlacedFeature> featureLookup,
			RegistryEntryLookup<ConfiguredCarver<?>> carverLookup,
			boolean deep
	) {
		...
		lookupBackedBuilder.feature(
				GenerationStep.Feature.VEGETAL_DECORATION,
				deep ? OceanPlacedFeatures.SEAGRASS_DEEP : OceanPlacedFeatures.SEAGRASS_NORMAL
		);
		DefaultBiomeFeatures.addKelp(lookupBackedBuilder);
	...
	public static Biome createLukewarmOcean(
		...
		lookupBackedBuilder.feature(
				GenerationStep.Feature.VEGETAL_DECORATION,
				deep ? OceanPlacedFeatures.SEAGRASS_DEEP_WARM : OceanPlacedFeatures.SEAGRASS_WARM
		);
	...
	public static Biome createFrozenOcean(
			RegistryEntryLookup<PlacedFeature> featureLookup,
			RegistryEntryLookup<ConfiguredCarver<?>> carverLookup,
			boolean deep
	) {
	...
	public static Biome createTaiga(
			RegistryEntryLookup<PlacedFeature> featureLookup,
			RegistryEntryLookup<ConfiguredCarver<?>> carverLookup,
			boolean snowy
	) {
	...
	public static Biome createDenseForest(
		...
		lookupBackedBuilder.feature(
				GenerationStep.Feature.VEGETAL_DECORATION,
				paleGarden ? VegetationPlacedFeatures.PALE_GARDEN_VEGETATION
		...
		if (!paleGarden) {
			...
			lookupBackedBuilder.feature(
					GenerationStep.Feature.VEGETAL_DECORATION,
					VegetationPlacedFeatures.PALE_MOSS_PATCH
			);
			lookupBackedBuilder.feature(
					GenerationStep.Feature.VEGETAL_DECORATION,
					VegetationPlacedFeatures.PALE_GARDEN_FLOWERS
			);
		}
		...
		if (!paleGarden) {
			...
			lookupBackedBuilder.feature(
					GenerationStep.Feature.VEGETAL_DECORATION,
					VegetationPlacedFeatures.FLOWER_PALE_GARDEN
			);
		}
		...
		EnvironmentAttributeMap environmentAttributeMap = EnvironmentAttributeMap.builder()
		                                                                         ...
		                                                                         .with(
				                                                                         EnvironmentAttributes.WATER_FOG_COLOR_VISUAL,
				                                                                         -11179648
		                                                                         )
		                                                                         .with(
				                                                                         EnvironmentAttributes.BACKGROUND_MUSIC_AUDIO,
		                                                                         ...
		                                                                         .with(
				                                                                         EnvironmentAttributes.MUSIC_VOLUME_AUDIO,
				                                                                         0.0F
		                                                                         )
		                                                                         .build();
	...
	public static Biome createSwamp(
		...
		return biome(0.8F, 0.9F)
				...
				.setEnvironmentAttributeModifier(
						EnvironmentAttributes.WATER_FOG_END_DISTANCE_VISUAL,
						FloatModifier.MULTIPLY,
						0.85F
				)
				.setEnvironmentAttribute(
						EnvironmentAttributes.BACKGROUND_MUSIC_AUDIO,
						new BackgroundMusic(SoundEvents.MUSIC_OVERWORLD_SWAMP)
				)
				.setEnvironmentAttribute(EnvironmentAttributes.INCREASED_FIRE_BURNOUT_GAMEPLAY, true)
				.effects(
						new BiomeEffects.Builder()
	...
	public static Biome createRiver(
			RegistryEntryLookup<PlacedFeature> featureLookup,
			RegistryEntryLookup<ConfiguredCarver<?>> carverLookup,
			boolean frozen
	) {
	...
	public static Biome createMeadow(
		...
		builder
				.spawn(
						SpawnGroup.CREATURE,
						1,
						new SpawnSettings.SpawnEntry(cherryGrove ? EntityType.PIG : EntityType.DONKEY, 1, 2)
				)
	...
	public static Biome createFrozenPeaks(
		...
		return createPeaksBiomeBuilder(featureLookup, carverLookup)
				.setEnvironmentAttribute(
						EnvironmentAttributes.BACKGROUND_MUSIC_AUDIO,
						new BackgroundMusic(SoundEvents.MUSIC_OVERWORLD_FROZEN_PEAKS)
				)
				.build();
	}
	...
	public static Biome createJaggedPeaks(
		...
		return createPeaksBiomeBuilder(featureLookup, carverLookup)
				.setEnvironmentAttribute(
						EnvironmentAttributes.BACKGROUND_MUSIC_AUDIO,
						new BackgroundMusic(SoundEvents.MUSIC_OVERWORLD_JAGGED_PEAKS)
				)
				.build();
	}
	...
	public static Biome createStonyPeaks(
		...
		return biome(1.0F, 0.3F)
				.setEnvironmentAttribute(
						EnvironmentAttributes.BACKGROUND_MUSIC_AUDIO,
						new BackgroundMusic(SoundEvents.MUSIC_OVERWORLD_STONY_PEAKS)
				)
				.spawnSettings(builder.build())
				.generationSettings(lookupBackedBuilder.build())
				.build();
	...
	public static Biome createGrove(
		...
		return biome(-0.2F, 0.8F)
				.setEnvironmentAttribute(
						EnvironmentAttributes.BACKGROUND_MUSIC_AUDIO,
						new BackgroundMusic(SoundEvents.MUSIC_OVERWORLD_GROVE)
				)
				.spawnSettings(builder.build())
				.generationSettings(lookupBackedBuilder.build())
				.build();
	...
	public static Biome createLushCaves(
		...
		return biome(0.5F, 0.5F)
				.setEnvironmentAttribute(
						EnvironmentAttributes.BACKGROUND_MUSIC_AUDIO,
						new BackgroundMusic(SoundEvents.MUSIC_OVERWORLD_LUSH_CAVES)
				)
				.spawnSettings(builder.build())
				.generationSettings(lookupBackedBuilder.build())
				.build();
	...
	public static Biome createDripstoneCaves(
		...
		return biome(0.8F, 0.4F)
				.setEnvironmentAttribute(
						EnvironmentAttributes.BACKGROUND_MUSIC_AUDIO,
						new BackgroundMusic(SoundEvents.MUSIC_OVERWORLD_DRIPSTONE_CAVES)
				)
				.spawnSettings(builder.build())
				.generationSettings(lookupBackedBuilder.build())
				.build();
	...
	public static Biome createDeepDark(
		...
		return biome(0.8F, 0.4F)
				.setEnvironmentAttribute(
						EnvironmentAttributes.BACKGROUND_MUSIC_AUDIO,
						new BackgroundMusic(SoundEvents.MUSIC_OVERWORLD_DEEP_DARK)
				)
				.spawnSettings(builder.build())
				.generationSettings(lookupBackedBuilder.build())
				.build();
