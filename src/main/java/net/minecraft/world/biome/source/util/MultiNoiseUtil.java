...
public class MultiNoiseUtil {
         ...
         return Codecs.nonEmptyList(
               RecordCodecBuilder.<Pair<MultiNoiseUtil.NoiseHypercube, T>>create(
                     instance -> instance.group(
                           MultiNoiseUtil.NoiseHypercube.CODEC.fieldOf("parameters").forGetter((Pair<MultiNoiseUtil.NoiseHypercube, T> p) -> p.getFirst()),
   ...
   protected static final class SearchTree<T> {
      ...
      private final ThreadLocal<MultiNoiseUtil.SearchTree.@Nullable TreeLeafNode<T>> previousResultNode = new ThreadLocal<>();
      ...
      static final class TreeBranchNode<T> extends MultiNoiseUtil.SearchTree.TreeNode<T> {
         ...
         protected MultiNoiseUtil.SearchTree.TreeLeafNode<T> getResultingNode(
            long[] otherParameters, MultiNoiseUtil.SearchTree.@Nullable TreeLeafNode<T> alternative, MultiNoiseUtil.NodeDistanceFunction<T> distanceFunction
         ) {
