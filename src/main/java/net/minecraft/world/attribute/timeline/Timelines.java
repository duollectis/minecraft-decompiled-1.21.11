...
/**
 * Реестр встроенных временны́х шкал Minecraft.
 *
 * <p>Содержит четыре шкалы:
 * <ul>
 *   <li>{@link #DAY} — суточный цикл (24 000 тиков): освещение, цвета неба, туман,
 *       звёзды, восход/закат, игровые механики (пчёлы, черепашьи яйца, кошки и т.д.);</li>
 *   <li>{@link #MOON} — лунный цикл (24 000 × 8 тиков): фаза луны и шанс спавна слаймов;</li>
 *   <li>{@link #VILLAGER_SCHEDULE} — расписание жителей (24 000 тиков): смена активностей;</li>
 *   <li>{@link #EARLY_GAME} — ранняя игра (без периода): блокировка патрулей разбойников
 *       до 120 000 тиков.</li>
 * </ul>
 *
 * <p>Все цветовые константы заданы через {@link ColorHelper#fromFloats} для читаемости.
 * Тиковые значения соответствуют внутреннему формату времени Minecraft (0 = рассвет).
 */
public interface Timelines {
	...
	float DAY_SKY_LIGHT_INTENSITY = 15.0F;
	float NIGHT_SKY_LIGHT_INTENSITY = 4.0F;
	int NIGHT_SKY_LIGHT_COLOR = ColorHelper.fromFloats(1.0F, 0.48F, 0.48F, 1.0F);
	float NIGHT_FOG_DENSITY = 0.24F;
	int TRANSPARENT_COLOR = -16777216;
	...
	static void bootstrap(Registerable<Timeline> registry) {
		EasingType dayEasing = EasingType.cubicBezierSymmetric(0.362F, 0.241F);

		// Тиковые границы суточного цикла (0 = рассвет, 6000 = полдень, 12000 = закат, 18000 = полночь)
		int dawnEnd = 12600;
		int dawnStart = 23401;
		...
		registry.register(
				...
				Timeline.builder()
						...
						.entry(
								...
								track -> track.easingType(dayEasing).keyframe(6000, 360.0F).keyframe(6000, 0.0F)
						)
						.entry(
								EnvironmentAttributes.MOON_ANGLE_VISUAL,
								track -> track.easingType(dayEasing).keyframe(6000, 540.0F).keyframe(6000, 180.0F)
						)
						.entry(
								EnvironmentAttributes.STAR_ANGLE_VISUAL,
								track -> track.easingType(dayEasing).keyframe(6000, 360.0F).keyframe(6000, 0.0F)
						)
						.entry(
								EnvironmentAttributes.FIREFLY_BUSH_SOUNDS_AUDIO,
								BooleanModifier.OR,
								track -> track.keyframe(dawnEnd, true).keyframe(dawnStart, false)
						)
						.entry(
								...
								track -> track
										.keyframe(133, -1)
										.keyframe(11867, -1)
										.keyframe(13670, NIGHT_FOG_COLOR)
										.keyframe(22330, NIGHT_FOG_COLOR)
						)
						.entry(
								...
								track -> track
										.keyframe(133, -1)
										.keyframe(11867, -1)
										.keyframe(13670, -16777216)
										.keyframe(22330, -16777216)
						)
						.entry(
								...
								track -> track
										.keyframe(730, -1)
										.keyframe(11270, -1)
										.keyframe(13140, NIGHT_SKY_LIGHT_COLOR)
										.keyframe(22860, NIGHT_SKY_LIGHT_COLOR)
						)
						.entry(
								...
								track -> track
										.keyframe(730, 1.0F)
										.keyframe(11270, 1.0F)
										.keyframe(13140, 0.24F)
										.keyframe(22860, 0.24F)
						)
						.entry(
								...
								track -> track
										.keyframe(133, 1.0F)
										.keyframe(11867, 1.0F)
										.keyframe(13670, 0.26666668F)
										.keyframe(22330, 0.26666668F)
						)
						.entry(
								EnvironmentAttributes.SUNRISE_SUNSET_COLOR_VISUAL,
								track -> track
										.keyframe(71, 1609540403)
						...
						.entry(
								...
								track -> track
										.keyframe(133, -1)
										.keyframe(11867, -1)
										.keyframe(13670, NIGHT_CLOUD_COLOR)
										.keyframe(22330, NIGHT_CLOUD_COLOR)
						)
						.entry(
								EnvironmentAttributes.EYEBLOSSOM_OPEN_GAMEPLAY,
								track -> track.keyframe(dawnEnd, TriState.TRUE).keyframe(dawnStart, TriState.FALSE)
						)
						.entry(
								EnvironmentAttributes.CREAKING_ACTIVE_GAMEPLAY,
								BooleanModifier.OR,
								track -> track.keyframe(dawnEnd, true).keyframe(dawnStart, false)
						)
						.entry(
								...
								FloatModifier.MAXIMUM,
								track -> track
										.easingType(EasingType.CONSTANT)
										.keyframe(21062, 1.0F)
										.keyframe(21905, 0.002F)
						)
						.entry(
						...
						.entry(
								EnvironmentAttributes.BEES_STAY_IN_HIVE_GAMEPLAY,
								BooleanModifier.OR,
								track -> track.keyframe(12542, true).keyframe(23460, false)
						)
						.entry(
								EnvironmentAttributes.MONSTERS_BURN_GAMEPLAY,
								BooleanModifier.OR,
								track -> track.keyframe(12542, false).keyframe(23460, true)
						)
						.build()
		);

		Timeline.Builder moonBuilder = Timeline.builder()
				.period(24000 * MoonPhase.COUNT)
				.entry(
						EnvironmentAttributes.MOON_PHASE_VISUAL,
						track -> {
							for (MoonPhase phase : MoonPhase.values()) {
								track.keyframe(phase.phaseTicks(), phase);
							}
						}
				)
				.entry(
						EnvironmentAttributes.SURFACE_SLIME_SPAWN_CHANCE_GAMEPLAY,
						FloatModifier.MAXIMUM,
						track -> {
							track.easingType(EasingType.CONSTANT);

							for (MoonPhase phase : MoonPhase.values()) {
								track.keyframe(phase.phaseTicks(), DimensionType.MOON_SIZES[phase.getIndex()] * 0.5F);
							}
						}
				);

		registry.register(MOON, moonBuilder.build());
		...
		registry.register(
				...
				Timeline.builder()
						.entry(
								EnvironmentAttributes.CAN_PILLAGER_PATROL_SPAWN_GAMEPLAY,
								BooleanModifier.AND,
								track -> track.keyframe(0, false).keyframe(120000, true)
						)
						.build()
		);
	}
