...
public class ChunkStatus {
	...
	private static final EnumSet<Heightmap.Type>
			...
			EnumSet.of(Heightmap.Type.OCEAN_FLOOR_WG, Heightmap.Type.WORLD_SURFACE_WG);
	...
	public static final ChunkStatus
			STRUCTURE_STARTS =
			register("structure_starts", EMPTY, WORLD_GEN_HEIGHTMAP_TYPES, ChunkType.PROTOCHUNK);
	public static final ChunkStatus
			STRUCTURE_REFERENCES =
			register("structure_references", STRUCTURE_STARTS, WORLD_GEN_HEIGHTMAP_TYPES, ChunkType.PROTOCHUNK);
	public static final ChunkStatus
			BIOMES =
			register("biomes", STRUCTURE_REFERENCES, WORLD_GEN_HEIGHTMAP_TYPES, ChunkType.PROTOCHUNK);
	public static final ChunkStatus NOISE = register("noise", BIOMES, WORLD_GEN_HEIGHTMAP_TYPES, ChunkType.PROTOCHUNK);
	public static final ChunkStatus
			SURFACE =
			register("surface", NOISE, WORLD_GEN_HEIGHTMAP_TYPES, ChunkType.PROTOCHUNK);
	public static final ChunkStatus
			CARVERS =
			register("carvers", SURFACE, NORMAL_HEIGHTMAP_TYPES, ChunkType.PROTOCHUNK);
	public static final ChunkStatus
			FEATURES =
			register("features", CARVERS, NORMAL_HEIGHTMAP_TYPES, ChunkType.PROTOCHUNK);
	public static final ChunkStatus
			INITIALIZE_LIGHT =
			register("initialize_light", FEATURES, NORMAL_HEIGHTMAP_TYPES, ChunkType.PROTOCHUNK);
	public static final ChunkStatus
			LIGHT =
			register("light", INITIALIZE_LIGHT, NORMAL_HEIGHTMAP_TYPES, ChunkType.PROTOCHUNK);
