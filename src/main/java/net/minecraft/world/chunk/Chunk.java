...
public abstract class Chunk implements BiomeAccess.Storage, LightSourceView, StructureHolder, AttachmentTarget {
   ...
   public abstract @Nullable BlockState setBlockState(BlockPos pos, BlockState state, @Block.SetBlockStateFlag int flags);
   ...
   public abstract @Nullable NbtCompound getPackedBlockEntityNbt(BlockPos pos, RegistryWrapper.WrapperLookup registries);
