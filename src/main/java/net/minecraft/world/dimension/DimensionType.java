...
public record DimensionType(
	...
	public static final Codec<DimensionType>
			NETWORK_CODEC =
			createDimensionCodec(EnvironmentAttributeMap.NETWORK_CODEC);
	public static final PacketCodec<RegistryByteBuf, RegistryEntry<DimensionType>>
			PACKET_CODEC =
	...
	public static final Codec<RegistryEntry<DimensionType>>
			REGISTRY_CODEC =
		...
		return Codecs.exceptionCatching(
				RecordCodecBuilder.create(
						instance -> instance.group(
								                    ...
								                    DimensionType.Skybox.CODEC
										                    .optionalFieldOf("skybox", DimensionType.Skybox.OVERWORLD)
								                    ...
								                    RegistryCodecs
										                    .entryList(RegistryKeys.TIMELINE)
	...
	/**
	 * {@code CardinalLightType}.
	 */
	public static enum CardinalLightType implements StringIdentifiable {
		DEFAULT("default"),
		NETHER("nether");

		public static final Codec<DimensionType.CardinalLightType>
				CODEC =
				StringIdentifiable.createCodec(DimensionType.CardinalLightType::values);
	...
	public record MonsterSettings(IntProvider monsterSpawnLightTest, int monsterSpawnBlockLightLimit) {
		...
		public static final MapCodec<DimensionType.MonsterSettings> CODEC = RecordCodecBuilder.mapCodec(
				instance -> instance.group(
						                    IntProvider
								                    .createValidatingCodec(0, 15)
								                    .fieldOf("monster_spawn_light_level")
								                    .forGetter(DimensionType.MonsterSettings::monsterSpawnLightTest),
						                    Codec
								                    .intRange(0, 15)
								                    .fieldOf("monster_spawn_block_light_limit")
								                    .forGetter(DimensionType.MonsterSettings::monsterSpawnBlockLightLimit)
				                    )
	...
	public static enum Skybox implements StringIdentifiable {
		...
		public static final Codec<DimensionType.Skybox>
				CODEC =
				StringIdentifiable.createCodec(DimensionType.Skybox::values);
		private final String name;
