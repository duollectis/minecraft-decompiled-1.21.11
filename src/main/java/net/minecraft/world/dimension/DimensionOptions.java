...
/**
 * Параметры измерения, связывающие тип измерения с генератором чанков.
 * Используется при регистрации измерений в мире.
 */
public record DimensionOptions(RegistryEntry<DimensionType> dimensionTypeEntry, ChunkGenerator chunkGenerator) {
	...
	public static final RegistryKey<DimensionOptions> OVERWORLD =
		RegistryKey.of(RegistryKeys.DIMENSION, Identifier.ofVanilla("overworld"));
	public static final RegistryKey<DimensionOptions> NETHER =
		RegistryKey.of(RegistryKeys.DIMENSION, Identifier.ofVanilla("the_nether"));
	public static final RegistryKey<DimensionOptions> END =
		RegistryKey.of(RegistryKeys.DIMENSION, Identifier.ofVanilla("the_end"));
}
