...
public abstract class World implements WorldAccess, AutoCloseable, AttachmentTarget {
   ...
   public boolean method_76805(BlockPos blockPos) {
      return !this.isOutOfHeightLimit(blockPos) && method_76804(blockPos);
   }
