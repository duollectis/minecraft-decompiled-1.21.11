	...
	public void draw(GizmoDrawer consumer, float opacity) {
		...
		if (this.style.hasStroke()) {
			...
			consumer.addLine(
					new Vec3d(d, e, f),
					new Vec3d(g, e, f),
					this.coloredCornerStroke ? ColorHelper.mix(j, -34953) : j,
					this.style.strokeWidth()
			);
			consumer.addLine(
					new Vec3d(d, e, f),
					new Vec3d(d, h, f),
					this.coloredCornerStroke ? ColorHelper.mix(j, -8913033) : j,
					this.style.strokeWidth()
			);
			consumer.addLine(
					new Vec3d(d, e, f),
					new Vec3d(d, e, i),
					this.coloredCornerStroke ? ColorHelper.mix(j, -8947713) : j,
					this.style.strokeWidth()
			);
