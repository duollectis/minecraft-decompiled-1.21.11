...
public class PlayStateFactories {
	...
	public static final PacketCodecModifier<RegistryByteBuf, CreativeInventoryActionC2SPacket, PlayStateFactories.PacketCodecModifierContext>
			...
			(packetCodec, context) -> new PacketCodec<RegistryByteBuf, CreativeInventoryActionC2SPacket>(
				...
				public void encode(
						...
						CreativeInventoryActionC2SPacket creativeInventoryActionC2SPacket
				) {
					if (!context.isInCreativeMode()) {
	...
	public static final ContextAwareNetworkStateFactory<ServerPlayPacketListener, RegistryByteBuf, PlayStateFactories.PacketCodecModifierContext>
			C2S =
			NetworkStateBuilder.contextAwareC2S(
					NetworkPhase.PLAY,
					builder -> builder.add(PlayPackets.ACCEPT_TELEPORTATION, TeleportConfirmC2SPacket.CODEC)
					                  ...
					                  .add(
							                  PlayPackets.CONFIGURATION_ACKNOWLEDGED,
							                  AcknowledgeReconfigurationC2SPacket.CODEC
					                  )
					                  ...
					                  .add(
							                  PlayPackets.DEBUG_SUBSCRIPTION_REQUEST,
							                  DebugSubscriptionRequestC2SPacket.CODEC
					                  )
					                  ...
					                  .add(
							                  PlayPackets.RECIPE_BOOK_CHANGE_SETTINGS,
							                  RecipeCategoryOptionsC2SPacket.CODEC
					                  )
					                  ...
					                  .add(
							                  PlayPackets.TEST_INSTANCE_BLOCK_ACTION,
							                  TestInstanceBlockActionC2SPacket.CODEC
					                  )
	...
	public static final NetworkStateFactory<ClientPlayPacketListener, RegistryByteBuf> S2C = NetworkStateBuilder.s2c(
			...
			builder -> builder.addBundle(PlayPackets.BUNDLE, BundleS2CPacket::new, new BundleDelimiterS2CPacket())
			                  ...
			                  .add(
					                  ...
					                  WorldBorderWarningBlocksChangedS2CPacket.CODEC
			                  )
