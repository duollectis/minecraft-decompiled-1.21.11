...
public class QueryStates {
	...
	public static final NetworkStateFactory<ServerQueryPacketListener, ByteBuf> C2S_FACTORY = NetworkStateBuilder.c2s(
			NetworkPhase.STATUS,
			builder -> builder
					.add(StatusPackets.STATUS_REQUEST, QueryRequestC2SPacket.CODEC)
	...
	public static final NetworkStateFactory<ClientQueryPacketListener, PacketByteBuf>
			S2C_FACTORY =
			NetworkStateBuilder.s2c(
					NetworkPhase.STATUS,
					builder -> builder
							.add(StatusPackets.STATUS_RESPONSE, QueryResponseS2CPacket.CODEC)
