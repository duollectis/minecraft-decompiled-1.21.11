...
public class LoginStates {
   public static final NetworkStateFactory<ServerLoginPacketListener, PacketByteBuf> C2S_FACTORY = NetworkStateBuilder.c2s(
      NetworkPhase.LOGIN,
   ...
   public static final NetworkStateFactory<ClientLoginPacketListener, PacketByteBuf> S2C_FACTORY = NetworkStateBuilder.s2c(
      NetworkPhase.LOGIN,
