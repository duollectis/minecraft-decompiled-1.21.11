...
public class GameStateChangeS2CPacket implements Packet<ClientPlayPacketListener> {
	...
	public static final GameStateChangeS2CPacket.Reason
			THUNDER_GRADIENT_CHANGED =
			new GameStateChangeS2CPacket.Reason(8);
	...
	public static final GameStateChangeS2CPacket.Reason
			LIMITED_CRAFTING_TOGGLED =
			new GameStateChangeS2CPacket.Reason(12);
	...
	private GameStateChangeS2CPacket(PacketByteBuf buf) {
		this.reason =
				(GameStateChangeS2CPacket.Reason) GameStateChangeS2CPacket.Reason.REASONS.get(buf.readUnsignedByte());
