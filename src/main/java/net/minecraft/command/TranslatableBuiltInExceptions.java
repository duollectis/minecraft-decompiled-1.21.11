...
/**
 * {@code TranslatableBuiltInExceptions}.
 */
public class TranslatableBuiltInExceptions implements BuiltInExceptionProvider {
	...
	private static final SimpleCommandExceptionType
			...
			new SimpleCommandExceptionType(Text.translatable("parsing.quote.expected.end"));
	...
	private static final SimpleCommandExceptionType
			READER_EXPECTED_INT =
			new SimpleCommandExceptionType(Text.translatable("parsing.int.expected"));
	...
	private static final SimpleCommandExceptionType
			...
			new SimpleCommandExceptionType(Text.translatable("parsing.long.expected"));
	...
	private static final SimpleCommandExceptionType
			...
			new SimpleCommandExceptionType(Text.translatable("parsing.double.expected"));
	...
	private static final SimpleCommandExceptionType
			...
			new SimpleCommandExceptionType(Text.translatable("parsing.float.expected"));
	private static final SimpleCommandExceptionType
			READER_EXPECTED_BOOL =
			new SimpleCommandExceptionType(Text.translatable("parsing.bool.expected"));
	...
	private static final SimpleCommandExceptionType
			...
			new SimpleCommandExceptionType(Text.translatable("command.unknown.command"));
	private static final SimpleCommandExceptionType
			DISPATCHER_UNKNOWN_ARGUMENT =
			new SimpleCommandExceptionType(Text.translatable("command.unknown.argument"));
	private static final SimpleCommandExceptionType
