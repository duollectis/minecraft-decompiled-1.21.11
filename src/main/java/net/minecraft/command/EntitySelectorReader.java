...
public class EntitySelectorReader implements FabricEntitySelectorReader {
   ...
   public static <S> boolean shouldAllowAtSelectors(S source) {
      return source instanceof PermissionSource permissionSource && permissionSource.getPermissions().hasPermission(DefaultPermissions.ENTITY_SELECTORS);
   }
   ...
   private void buildPredicate() {
      ...
      if (this.levelRange != null) {
         this.predicates.add(entity -> entity instanceof ServerPlayerEntity serverPlayerEntity && this.levelRange.test(serverPlayerEntity.experienceLevel));
      }
   }
