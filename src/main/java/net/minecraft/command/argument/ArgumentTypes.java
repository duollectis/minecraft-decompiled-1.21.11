...
public class ArgumentTypes {
   ...
   public static ArgumentSerializer<?, ?> register(Registry<ArgumentSerializer<?, ?>> registry) {
      ...
      register(registry, "resource_or_tag", (Class) upcast(RegistryEntryPredicateArgumentType.class), new RegistryEntryPredicateArgumentType.Serializer());
      register(registry, "resource_or_tag_key", (Class) upcast(RegistryPredicateArgumentType.class), new RegistryPredicateArgumentType.Serializer());
      register(registry, "resource", (Class) upcast(RegistryEntryReferenceArgumentType.class), new RegistryEntryReferenceArgumentType.Serializer());
      register(registry, "resource_key", (Class) upcast(RegistryKeyArgumentType.class), new RegistryKeyArgumentType.Serializer());
      register(registry, "resource_selector", (Class) upcast(RegistrySelectorArgumentType.class), new RegistrySelectorArgumentType.Serializer());
