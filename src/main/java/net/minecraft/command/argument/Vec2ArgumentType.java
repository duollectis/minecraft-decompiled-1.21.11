...
public class Vec2ArgumentType implements ArgumentType<PosArgument> {
	...
	public static final SimpleCommandExceptionType
			...
			new SimpleCommandExceptionType(Text.translatable("argument.pos2d.incomplete"));
	...
	public static Vec2f getVec2(CommandContext<ServerCommandSource> context, String name) {
		Vec3d
				vec3d =
				((PosArgument) context.getArgument(
						name,
						PosArgument.class
				)
	...
	public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
		if (!(context.getSource() instanceof CommandSource)) {
			...
			return CommandSource.suggestColumnPositions(
					string,
					collection,
					builder,
