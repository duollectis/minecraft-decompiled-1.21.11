...
/**
 * {@code ScoreboardObjectiveArgumentType}.
 */
public class ScoreboardObjectiveArgumentType implements ArgumentType<String> {
	...
	public static ScoreboardObjective getObjective(CommandContext<ServerCommandSource> context, String name)
	...
	public static ScoreboardObjective getWritableObjective(CommandContext<ServerCommandSource> context, String name)
	throws CommandSyntaxException {
	...
	public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
		S object = (S) context.getSource();
		if (object instanceof ServerCommandSource serverCommandSource) {
			return CommandSource.suggestMatching(
					serverCommandSource.getServer().getScoreboard().getObjectiveNames(),
					builder
			);
		}
		else {
			return object instanceof CommandSource commandSource ? commandSource.getCompletions(context)
			                                                     : Suggestions.empty();
		}
	}
