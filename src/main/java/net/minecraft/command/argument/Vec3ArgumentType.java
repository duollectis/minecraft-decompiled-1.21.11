...
public class Vec3ArgumentType implements ArgumentType<PosArgument> {
	...
	public static final SimpleCommandExceptionType
			...
			new SimpleCommandExceptionType(Text.translatable("argument.pos3d.incomplete"));
	public static final SimpleCommandExceptionType
			MIXED_COORDINATE_EXCEPTION =
			new SimpleCommandExceptionType(Text.translatable("argument.pos.mixed"));
	...
	public static Vec3d getVec3(CommandContext<ServerCommandSource> context, String name) {
		...
		).getPos((ServerCommandSource) context.getSource());
	}
	...
	public PosArgument parse(StringReader stringReader) throws CommandSyntaxException {
		return (PosArgument) (stringReader.canRead() && stringReader.peek() == '^'
		                      ? LocalPosArgument.parse(stringReader)
