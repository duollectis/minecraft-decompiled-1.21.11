	...
	public Integer parse(StringReader stringReader) throws CommandSyntaxException {
		...
		return switch (string.length()) {
			case 3 -> ColorHelper.getArgb(
					expand(Integer.parseInt(string, 0, 1, 16)),
					expand(Integer.parseInt(string, 1, 2, 16)),
					expand(Integer.parseInt(string, 2, 3, 16))
			);
			case 6 -> ColorHelper.getArgb(
					Integer.parseInt(string, 0, 2, 16),
					Integer.parseInt(string, 2, 4, 16),
					Integer.parseInt(string, 4, 6, 16)
			);
