...
public abstract class AbstractTeam {
   ...
   public static enum CollisionRule implements StringIdentifiable {
      ...
      private static final IntFunction<AbstractTeam.CollisionRule> INDEX_MAPPER = ValueLists.<AbstractTeam.CollisionRule>createIndexToValueFunction(
   ...
   public static enum VisibilityRule implements StringIdentifiable {
      ...
      private static final IntFunction<AbstractTeam.VisibilityRule> INDEX_MAPPER = ValueLists.<AbstractTeam.VisibilityRule>createIndexToValueFunction(
