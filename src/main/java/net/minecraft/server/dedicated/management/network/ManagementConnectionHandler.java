...
public class ManagementConnectionHandler extends SimpleChannelInboundHandler<JsonElement> {
      ...
      try {
         ...
         if (string != null && jsonElement2 == null && jsonObject == null) {
            ...
            return string == null && jsonElement2 == null && jsonObject != null
               ...
               : ManagementError.INVALID_REQUEST.encode(Objects.requireNonNullElse(jsonElement, JsonNull.INSTANCE));
         }
   ...
   private @Nullable JsonObject handleRequest(@Nullable JsonElement json, String method, @Nullable JsonElement parameters) {
      ...
      try {
         ...
         LOGGER.debug("Invalid parameter invocation {}: {}, {}", new Object[]{method, parameters, var6.getMessage()});
   ...
   public @Nullable JsonElement processRequest(String method, @Nullable JsonElement json) {
      ...
      if (identifier == null) {
         ...
         if (optional.isEmpty()) {
            ...
            try {
               return this.handlerDispatcher.<JsonElement>submit(() -> optional.get().handle(this.handlerDispatcher, json, this.remote)).join();
