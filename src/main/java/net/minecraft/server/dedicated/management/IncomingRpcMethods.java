...
import net.minecraft.server.dedicated.management.dispatch.*;
...
public class IncomingRpcMethods {
	...
	public static IncomingRpcMethod<?, ?> registerAndGetDefault(Registry<IncomingRpcMethod<?, ?>> registry) {
		...
		return IncomingRpcMethod
				.<RpcDiscover.Document>createParameterlessBuilder(dispatcher -> RpcDiscover.handleRpcDiscover(RpcSchema.getRegisteredSchemas()))
				.noRequireMainThread()
				.notDiscoverable()
	...
	private static void registerAllowlist(Registry<IncomingRpcMethod<?, ?>> registry) {
		IncomingRpcMethod.createParameterlessBuilder(AllowlistRpcDispatcher::get)
	...
	private static void registerBans(Registry<IncomingRpcMethod<?, ?>> registry) {
		IncomingRpcMethod.createParameterlessBuilder(PlayerBansRpcDispatcher::get)
	...
	private static void registerIpBans(Registry<IncomingRpcMethod<?, ?>> registry) {
		IncomingRpcMethod.createParameterlessBuilder(IpBansRpcDispatcher::get)
	...
	private static void registerPlayers(Registry<IncomingRpcMethod<?, ?>> registry) {
		IncomingRpcMethod.createParameterlessBuilder(PlayersRpcDispatcher::get)
	...
	private static void registerOperators(Registry<IncomingRpcMethod<?, ?>> registry) {
		IncomingRpcMethod.createParameterlessBuilder(OperatorsRpcDispatcher::get)
	...
	private static void registerServer(Registry<IncomingRpcMethod<?, ?>> registry) {
		IncomingRpcMethod.createParameterlessBuilder(ServerRpcDispatcher::status)
	...
	private static void registerProperties(Registry<IncomingRpcMethod<?, ?>> registry) {
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getAutosave)
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getDifficulty)
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getEnforceAllowlist)
		                 .description(
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getUseAllowlist)
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getMaxPlayers)
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getPauseWhenEmptySeconds)
		                 .description(
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getPlayerIdleTimeout)
		                 .description(
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getAllowFlight)
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getMotd)
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getSpawnProtectionRadius)
		                 .description(
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getForceGameMode)
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getGameMode)
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getViewDistance)
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getSimulationDistance)
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getAcceptTransfers)
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getStatusHeartbeatInterval)
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getOperatorUserPermissionLevel)
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getHideOnlinePlayers)
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getStatusReplies)
		...
		IncomingRpcMethod.createParameterlessBuilder(PropertiesRpcDispatcher::getEntityBroadcastRange)
	...
	private static void registerGameRule(Registry<IncomingRpcMethod<?, ?>> registry) {
		IncomingRpcMethod.createParameterlessBuilder(GameRuleRpcDispatcher::get)
		...
		IncomingRpcMethod
				.<GameRuleRpcDispatcher.RuleEntry<?>, GameRuleRpcDispatcher.RuleEntry<?>>createParameterizedBuilder(
						IncomingRpcMethods::updateGameRule
				)
	...
	private static GameRuleRpcDispatcher.RuleEntry<?> updateGameRule(
			ManagementHandlerDispatcher dispatcher,
			GameRuleRpcDispatcher.RuleEntry<?> rule,
			ManagementConnectionId remote
	) {
		return GameRuleRpcDispatcher.updateRule(dispatcher, (GameRuleRpcDispatcher.RuleEntry) rule, remote);
	}
}
