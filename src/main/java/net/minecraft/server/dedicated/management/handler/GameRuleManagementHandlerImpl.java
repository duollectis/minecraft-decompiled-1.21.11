...
/**
 * Класс Game Rule Management Handler Impl.
 */
public class GameRuleManagementHandlerImpl implements GameRuleManagementHandler {
	...
	@Override
	public <T> GameRuleRpcDispatcher.RuleEntry<T> updateRule(
		...
		this.logger
				.logAction(
						remote,
						"Game rule '{}' updated from '{}' to '{}'",
						gameRule.toShortString(),
						gameRule.getValueName(object),
						gameRule.getValueName(object2)
				);
		return entry;
	}
