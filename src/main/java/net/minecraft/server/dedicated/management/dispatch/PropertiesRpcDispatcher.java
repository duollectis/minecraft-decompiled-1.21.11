...
public class PropertiesRpcDispatcher {
	...
	public static boolean setAutosave(
	...
	public static boolean setEnforceAllowlist(
			ManagementHandlerDispatcher dispatcher,
	...
	public static boolean setUseAllowlist(
			ManagementHandlerDispatcher dispatcher,
			boolean useAllowlist,
			ManagementConnectionId remote
	) {
	...
	public static int setPauseWhenEmptySeconds(
			ManagementHandlerDispatcher dispatcher,
	...
	public static int setPlayerIdleTimeout(
			ManagementHandlerDispatcher dispatcher,
	...
	public static boolean setAllowFlight(
			ManagementHandlerDispatcher dispatcher,
			boolean allowFlight,
			ManagementConnectionId remote
	) {
	...
	public static int setSpawnProtectionRadius(
			ManagementHandlerDispatcher dispatcher,
	...
	public static boolean setForceGameMode(
			ManagementHandlerDispatcher dispatcher,
	...
	public static int setViewDistance(
			ManagementHandlerDispatcher dispatcher,
			int viewDistance,
			ManagementConnectionId remote
	) {
	...
	public static int setSimulationDistance(
			ManagementHandlerDispatcher dispatcher,
	...
	public static boolean setAcceptTransfers(
			ManagementHandlerDispatcher dispatcher,
	...
	public static int setStatusHeartbeatInterval(
			ManagementHandlerDispatcher dispatcher,
			int statusHeartbeatInterval,
			ManagementConnectionId remote
	) {
	...
	public static PermissionLevel setOperatorUserPermissionLevel(
		...
		return dispatcher
				...
				.setOperatorUserPermissionLevel(LeveledPermissionPredicate.fromLevel(permissionLevel), remote)
				.getLevel();
	}
	...
	public static boolean setHideOnlinePlayers(
			ManagementHandlerDispatcher dispatcher,
	...
	public static boolean setStatusReplies(
			ManagementHandlerDispatcher dispatcher,
			boolean statusReplies,
			ManagementConnectionId remote
	) {
	...
	public static int setEntityBroadcastRange(
			ManagementHandlerDispatcher dispatcher,
			int entityBroadcastRange,
			ManagementConnectionId remote
	) {
