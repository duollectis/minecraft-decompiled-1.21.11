...
public class PropertiesManagementHandlerImpl implements PropertiesManagementHandler {
	...
	public int setStatusHeartbeatInterval(int statusHeartbeatInterval, ManagementConnectionId remote) {
		this.logger.logAction(
				...
				this.getStatusHeartbeatInterval(),
	...
	@Override
	public LeveledPermissionPredicate setOperatorUserPermissionLevel(
		...
		this.logger
				.logAction(
						...
						this.getOperatorUserPermissionLevel(),
						operatorUserPermissionLevel.getLevel()
				);
