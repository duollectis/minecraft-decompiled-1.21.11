...
public class ServerWaypointHandler implements WaypointHandler<ServerWaypoint> {
   ...
   public void onUpdate(ServerWaypoint serverWaypoint) {
      if (this.waypoints.contains(serverWaypoint)) {
         ...
         while (var4.hasNext()) {
            Entry<ServerPlayerEntity, ServerWaypoint.WaypointTracker> entry = (Entry<ServerPlayerEntity, ServerWaypoint.WaypointTracker>)var4.next();
   ...
   public void updatePlayerPos(ServerPlayerEntity player) {
      ...
      while (var4.hasNext()) {
         Entry<ServerWaypoint, ServerWaypoint.WaypointTracker> entry = (Entry<ServerWaypoint, ServerWaypoint.WaypointTracker>)var4.next();
