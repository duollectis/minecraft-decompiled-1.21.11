...
/**
 * Класс Synchronize Registries Task.
 */
public class SynchronizeRegistriesTask implements ServerPlayerConfigurationTask {
	...
	public static final ServerPlayerConfigurationTask.Key
			KEY =
			new ServerPlayerConfigurationTask.Key("synchronize_registries");
	...
	public SynchronizeRegistriesTask(
			List<VersionedIdentifier> knownPacks,
			CombinedDynamicRegistries<ServerDynamicRegistryType> registries
	) {
