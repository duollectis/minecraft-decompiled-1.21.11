...
public class StopSoundCommand {
	...
	public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
		RequiredArgumentBuilder<ServerCommandSource, EntitySelector>
				...
				(RequiredArgumentBuilder<ServerCommandSource, EntitySelector>) ((RequiredArgumentBuilder) CommandManager
						.argument(
						...
						.then(
								CommandManager.literal("*")
								              .then(
										              CommandManager
												              .argument("sound", IdentifierArgumentType.identifier())
	...
	private static int execute(
		...
		if (category != null) {
			...
			source.sendFeedback(
					() -> Text.translatable("commands.stopsound.success.sourceless.sound", Text.of(sound)),
					true
			);
		}
		else {
