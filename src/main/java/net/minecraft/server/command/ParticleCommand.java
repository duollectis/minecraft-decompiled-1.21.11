...
public class ParticleCommand {
	...
	private static final SimpleCommandExceptionType
			FAILED_EXCEPTION =
			new SimpleCommandExceptionType(Text.translatable("commands.particle.failed"));
				...
				(LiteralArgumentBuilder) ((LiteralArgumentBuilder) CommandManager.literal("particle")
						...
						.then(
								((RequiredArgumentBuilder) CommandManager
										.argument("name", ParticleEffectArgumentType.particleEffect(registryAccess))
										.executes(
												context -> execute(
										...
										.then(
												((RequiredArgumentBuilder) CommandManager
														...
														.then(
																CommandManager
																		.argument("delta", Vec3ArgumentType.vec3(false))
																		.then(
																				CommandManager
																						.argument(
																								"speed",
