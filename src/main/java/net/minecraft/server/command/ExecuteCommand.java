...
public class ExecuteCommand {
   ...
   public static void register(CommandDispatcher<ServerCommandSource> dispatcher, CommandRegistryAccess commandRegistryAccess) {
      LiteralCommandNode<ServerCommandSource> literalCommandNode = dispatcher.register(
         (LiteralArgumentBuilder)CommandManager.literal("execute").requires(CommandManager.requirePermissionLevel(CommandManager.GAMEMASTERS_CHECK))
      );
      dispatcher.register(
                                             ...
                                             CommandManager.argument("pos", BlockPosArgumentType.blockPos())
                                                .then(
                                                   addConditionLogic(
                                                      ...
                                                      positive,
                                                      context -> RegistryEntryPredicateArgumentType.getRegistryEntryPredicate(
                                                            context, "biome", RegistryKeys.BIOME
                                                         )
                                                         .test(
                                                            ((ServerCommandSource)context.getSource())
                                                               .getWorld()
                                    ...
                                    CommandManager.literal("loaded")
                                       .then(
                                          addConditionLogic(
                                             ...
                                             positive,
                                             context -> isLoaded(
                                                ((ServerCommandSource)context.getSource()).getWorld(), BlockPosArgumentType.getBlockPos(context, "pos")
                                             )
                                          )
                                       )
                                 ))
                  ...
                  .then(
                     CommandManager.literal("predicate")
                        .then(
                           addConditionLogic(
                              root,
                              CommandManager.argument("predicate", RegistryEntryArgumentType.lootCondition(commandRegistryAccess)),
                              positive,
                                                ...
                                                .fork(
                                                   ...
                                                   context -> getSourceOrEmptyForConditionFork(
                                                      ...
                                                      countMatchingItems(
                                                            ...
                                                            SlotRangeArgumentType.getSlotRange(context, "slots"),
                                                            ItemPredicateArgumentType.getItemStackPredicate(context, "item_predicate")
                                                         )
                                                         > 0
                                                   )
                                                ))
               ...
               .then(
                  CommandManager.argument("id", IdentifierArgumentType.identifier())
                     ...
                     .then(
                        addConditionLogic(
                           root,
                           CommandManager.argument("range", NumberRangeArgumentType.floatRange()),
                           positive,
                           context -> testStopwatchRange(context, NumberRangeArgumentType.FloatRangeArgumentType.getRangeArgument(context, "range"))
                        )
                     )
               )
         );
