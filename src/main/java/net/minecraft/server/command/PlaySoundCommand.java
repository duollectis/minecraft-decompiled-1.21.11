...
public class PlaySoundCommand {
   ...
   private static int execute(
      ...
      for (ServerPlayerEntity serverPlayerEntity : targets) {
         if (serverPlayerEntity.getEntityWorld() == serverWorld) {
            ...
            serverPlayerEntity.networkHandler
               .sendPacket(new PlaySoundS2CPacket(registryEntry, category, vec3d.getX(), vec3d.getY(), vec3d.getZ(), i, pitch, l));
      ...
      if (k == 0) {
         ...
         if (k == 1) {
            source.sendFeedback(() -> Text.translatable("commands.playsound.success.single", Text.of(sound), list.getFirst().getDisplayName()), true);
         } else {
