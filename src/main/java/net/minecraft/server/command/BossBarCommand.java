...
public class BossBarCommand {
	...
	public static void register(
		...
		dispatcher.register(
				(LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) ((LiteralArgumentBuilder) CommandManager
						.literal(
								"bossbar"
						)
								...
								CommandManager.literal("remove")
								              .then(
										              CommandManager.argument("id", IdentifierArgumentType.identifier())
										                            ...
										                            .executes(context -> removeBossBar(
												                            (ServerCommandSource) context.getSource(),
												                            getBossBar(context)
										                            ))
								              )
						...
						.then(CommandManager
								.literal("list")
								.executes(context -> listBossBars((ServerCommandSource) context.getSource())))
				)
						.then(
								CommandManager.literal("set")
								              .then(
										              ((RequiredArgumentBuilder) ((RequiredArgumentBuilder) ((RequiredArgumentBuilder) ((RequiredArgumentBuilder) ((RequiredArgumentBuilder) ((RequiredArgumentBuilder) CommandManager
												              .argument(
						...
						.then(
								CommandManager.literal("get")
								              .then(
										              ((RequiredArgumentBuilder) ((RequiredArgumentBuilder) ((RequiredArgumentBuilder) CommandManager
												              .argument(
														              "id", IdentifierArgumentType.identifier()
												              )
												              .suggests(SUGGESTION_PROVIDER)
	...
	private static int getPlayers(ServerCommandSource source, CommandBossBar bossBar) {
		if (bossBar.getPlayers().isEmpty()) {
			source.sendFeedback(
					() -> Text.translatable("commands.bossbar.get.players.none", bossBar.toHoverableText()),
					true
			);
		}
		else {
	...
	private static int setVisible(ServerCommandSource source, CommandBossBar bossBar, boolean visible)
	...
	private static int setValue(ServerCommandSource source, CommandBossBar bossBar, int value)
	throws CommandSyntaxException {
	...
	private static int setMaxValue(ServerCommandSource source, CommandBossBar bossBar, int value)
	throws CommandSyntaxException {
	...
	private static int setColor(ServerCommandSource source, CommandBossBar bossBar, BossBar.Color color)
	throws CommandSyntaxException {
	...
	private static int setStyle(ServerCommandSource source, CommandBossBar bossBar, BossBar.Style style)
	throws CommandSyntaxException {
	...
	private static int setName(ServerCommandSource source, CommandBossBar bossBar, Text name)
	throws CommandSyntaxException {
		...
		if (bossBar.getName().equals(text)) {
			...
			source.sendFeedback(
					() -> Text.translatable("commands.bossbar.set.name.success", bossBar.toHoverableText()),
					true
			);
			return 0;
		}
			...
			if (bossBar.getPlayers().isEmpty()) {
				...
				source.sendFeedback(
						() -> Text.translatable(
								...
								bossBar.toHoverableText(),
								players.size(),
								Texts.join(players, PlayerEntity::getDisplayName)
						),
						true
				);
			}
		...
		if (collection.isEmpty()) {
			...
			source.sendFeedback(
					() -> Text.translatable(
							...
							collection.size(),
							Texts.join(collection, CommandBossBar::toHoverableText)
					), false
			);
		}
	...
	private static int addBossBar(ServerCommandSource source, Identifier name, Text displayName)
	throws CommandSyntaxException {
	...
	private static int removeBossBar(ServerCommandSource source, CommandBossBar bossBar) {
		...
		source.sendFeedback(
				() -> Text.translatable("commands.bossbar.remove.success", bossBar.toHoverableText()),
				true
		);
		return bossBarManager.getAll().size();
	}
	...
	public static CommandBossBar getBossBar(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
		...
		CommandBossBar
				commandBossBar =
				((ServerCommandSource) context.getSource()).getServer().getBossBarManager().get(identifier);
