...
public class TeamMsgCommand {
	...
	private static final Style STYLE = Style.EMPTY
			.withHoverEvent(new HoverEvent.ShowText(Text.translatable("chat.type.team.hover")))
	...
	private static void execute(
		...
		MessageType.Parameters
				parameters =
				MessageType.params(MessageType.TEAM_MSG_COMMAND_INCOMING, source).withTargetName(text);
		MessageType.Parameters
				parameters2 =
				MessageType.params(MessageType.TEAM_MSG_COMMAND_OUTGOING, source).withTargetName(text);
