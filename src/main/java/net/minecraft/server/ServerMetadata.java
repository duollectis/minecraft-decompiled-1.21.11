...
public record ServerMetadata(
	...
	public static final Codec<ServerMetadata> CODEC = RecordCodecBuilder.create(
			instance -> instance.group(
					                    TextCodecs.CODEC
							                    .lenientOptionalFieldOf("description", ScreenTexts.EMPTY)
					                    ...
					                    Codec.BOOL
							                    .lenientOptionalFieldOf("enforcesSecureChat", false)
	...
	public record Favicon(byte[] iconBytes) {
		...
		public static final Codec<ServerMetadata.Favicon> CODEC = Codec.STRING.comapFlatMap(
				uri -> {
				...
				iconBytes -> "data:image/png;base64," + new String(
						Base64.getEncoder().encode(iconBytes.iconBytes),
	...
	public record Players(int max, int online, List<PlayerConfigEntry> sample) {
		...
		public static final Codec<ServerMetadata.Players> CODEC = RecordCodecBuilder.create(
				instance -> instance.group(
						                    ...
						                    PlayerConfigEntry.CODEC
								                    .listOf()
								                    .lenientOptionalFieldOf("sample", List.of())
								                    .forGetter(ServerMetadata.Players::sample)
				                    )
