...
public class Schema704 extends Schema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
      ...
      BlockEntityIdFix.RENAMED_BLOCK_ENTITIES
         .forEach((string, string2) -> map.put(string2, Objects.requireNonNull(map.remove(string), () -> "Didn't find " + string + " in schema")));
      return map;
   }
   ...
   public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> entityTypes, Map<String, Supplier<TypeTemplate>> blockEntityTypes) {
      ...
      schema.registerType(
         ...
         () -> DSL.hook(DSL.optionalFields("id", TypeReferences.ITEM_NAME.in(schema), "tag", Schema99.method_66195(schema)), field_5745, HookFunction.IDENTITY)
      );
   }
}
