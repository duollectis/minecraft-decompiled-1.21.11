...
public class Schema1460 extends IdentifierNormalizingSchema {
	...
	public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
		...
		schema.register(
				map,
				"minecraft:arrow",
				name -> DSL.optionalFields("inBlockState", TypeReferences.BLOCK_STATE.in(schema))
		);
		...
		schema.register(
				map,
				"minecraft:enderman",
				name -> DSL.optionalFields("carriedBlockState", TypeReferences.BLOCK_STATE.in(schema))
		);
		...
		schema.register(
				...
				name -> DSL.optionalFields("DisplayState", TypeReferences.BLOCK_STATE.in(schema))
		);
	...
	public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
		...
		schema.register(map, "minecraft:sign", () -> Schema99.createSignTypeTemplate(schema));
	...
	public void registerTypes(
		...
		schema.registerType(
				...
				() -> DSL.optionalFields(
						...
						DSL.taggedChoiceLazy("id", getIdentifierType(), blockEntityTypes)
				)
		);
		schema.registerType(
				true,
		...
		schema.registerType(
				...
				() -> DSL.hook(
						...
						), Schema705.ITEM_STACK_HOOK, HookFunction.IDENTITY
				)
		);
		schema.registerType(
				false,
				TypeReferences.HOTBAR,
				() -> DSL.compoundList(DSL.list(TypeReferences.ITEM_STACK.in(schema)))
		);
		...
		Map<String, Supplier<TypeTemplate>> map = Schema1451v6.createCriteriaTypeMap(schema);
		schema.registerType(
				false,
				...
				() -> DSL.hook(
						...
						Schema1451v6.CRITERIA_NAME_TO_TYPE_HOOK,
						Schema1451v6.CRITERIA_TYPE_TO_NAME_HOOK
				)
		);
		schema.registerType(
				false,
		...
		schema.registerType(
				...
				() -> DSL.optionalFields(
						"SpawnPotentials",
						DSL.list(DSL.fields("Entity", TypeReferences.ENTITY_TREE.in(schema))),
						"SpawnData",
