...
public class Schema1451v3 extends IdentifierNormalizingSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
      ...
      schema.register(map, "minecraft:enderman", () -> DSL.optionalFields("carriedBlockState", TypeReferences.BLOCK_STATE.in(schema)));
      schema.register(
         map,
      ...
      schema.register(
         ...
         () -> DSL.optionalFields("DisplayState", TypeReferences.BLOCK_STATE.in(schema), "LastOutput", TypeReferences.TEXT_COMPONENT.in(schema))
      );
