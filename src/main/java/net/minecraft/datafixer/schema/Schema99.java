...
public class Schema99 extends Schema {
   ...
   static final Map<String, String> BLOCKS_TO_BLOCK_ENTITIES = (Map<String, String>)DataFixUtils.make(Maps.<String, String>newHashMap(), map -> {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
      ...
      schema.register(
         ...
         () -> DSL.optionalFields("DisplayTile", TypeReferences.BLOCK_NAME.in(schema), "LastOutput", TypeReferences.TEXT_COMPONENT.in(schema))
      );
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
      ...
      schema.register(map, "Sign", () -> method_66194(schema));
