...
public class Schema705 extends IdentifierNormalizingSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
      ...
      schema.register(
         ...
         name -> DSL.optionalFields("DisplayTile", TypeReferences.BLOCK_NAME.in(schema), "LastOutput", TypeReferences.TEXT_COMPONENT.in(schema))
      );
      ...
      schema.register(
         map,
         "minecraft:donkey",
         name -> DSL.optionalFields("Items", DSL.list(TypeReferences.ITEM_STACK.in(schema)), "SaddleItem", TypeReferences.ITEM_STACK.in(schema))
      );
      ...
      schema.register(map, "minecraft:enderman", name -> DSL.optionalFields("carried", TypeReferences.BLOCK_NAME.in(schema)));
      ...
      schema.register(
         map,
         "minecraft:horse",
         string -> DSL.optionalFields("ArmorItem", TypeReferences.ITEM_STACK.in(schema), "SaddleItem", TypeReferences.ITEM_STACK.in(schema))
      );
      ...
      schema.register(map, "minecraft:skeleton_horse", string -> DSL.optionalFields("SaddleItem", TypeReferences.ITEM_STACK.in(schema)));
      ...
      schema.register(map, "minecraft:zombie_horse", string -> DSL.optionalFields("SaddleItem", TypeReferences.ITEM_STACK.in(schema)));
      targetEntityItems(schema, map, "minecraft:zombie_pigman");
      schema.register(
         map,
         "minecraft:zombie_villager",
         string -> DSL.optionalFields("Offers", DSL.optionalFields("Recipes", DSL.list(TypeReferences.VILLAGER_TRADE.in(schema))))
      );
   ...
   public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> entityTypes, Map<String, Supplier<TypeTemplate>> blockEntityTypes) {
      ...
      schema.registerType(
         ...
         () -> DSL.and(
            ...
            DSL.optionalFields("CustomName", DSL.constType(DSL.string()), DSL.taggedChoiceLazy("id", getIdentifierType(), entityTypes))
         )
      );
      schema.registerType(
         true,
         TypeReferences.ITEM_STACK,
         () -> DSL.hook(DSL.optionalFields("id", TypeReferences.ITEM_NAME.in(schema), "tag", Schema99.method_66195(schema)), field_5746, HookFunction.IDENTITY)
      );
   }
}
