...
public class Schema705 extends IdentifierNormalizingSchema {
	...
	public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
		...
		schema.register(
				map,
				"minecraft:enderman",
				name -> DSL.optionalFields("carried", TypeReferences.BLOCK_NAME.in(schema))
		);
		...
		schema.register(
				map,
				"minecraft:furnace_minecart",
				name -> DSL.optionalFields("DisplayTile", TypeReferences.BLOCK_NAME.in(schema))
		);
