...
public class Schemas {
   ...
   private static void build(DataFixerBuilder builder) {
      ...
      builder.addFixer(
         new DataFix(schema58, false) {
            protected TypeRewriteRule makeRule() {
               ...
               OpticFinder<Pair<String, String>> opticFinder3 = (OpticFinder<Pair<String, String>>) DSL.typeFinder(this.getInputSchema().getType(TypeReferences.TEXT_COMPONENT));
      ...
      builder.addFixer(
         new GameEventRenamesFix(schema124, "Nether biome rename", TypeReferences.BIOME, replacing("minecraft:nether", "minecraft:nether_wastes"))
      );
      ...
      builder.addFixer(new FancyGraphicsToGraphicsModeFix(schema126));
      Schema schema127 = builder.addSchema(2558, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new MissingDimensionFix(schema127, false));
      builder.addFixer(new OptionFix(schema127, false, "Rename swapHands setting", "key_key.swapHands", "key_key.swapOffhand"));
      Schema schema128 = builder.addSchema(2568, Schema2568::new);
      builder.addFixer(new ChoiceTypesFix(schema128, "Added Piglin Brute", TypeReferences.ENTITY));
      Schema schema129 = builder.addSchema(2571, Schema2571::new);
      builder.addFixer(new ChoiceTypesFix(schema129, "Added Goat", TypeReferences.ENTITY));
      Schema schema130 = builder.addSchema(2679, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new CauldronRenameFix(schema130, false));
      Schema schema131 = builder.addSchema(2680, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(ItemNameFix.create(schema131, "Renamed grass path item to dirt path", replacing("minecraft:grass_path", "minecraft:dirt_path")));
      builder.addFixer(BlockNameFix.create(schema131, "Renamed grass path block to dirt path", replacing("minecraft:grass_path", "minecraft:dirt_path")));
      Schema schema132 = builder.addSchema(2684, Schema2684::new);
      builder.addFixer(new ChoiceTypesFix(schema132, "Added Sculk Sensor", TypeReferences.BLOCK_ENTITY));
      Schema schema133 = builder.addSchema(2686, Schema2686::new);
      builder.addFixer(new ChoiceTypesFix(schema133, "Added Axolotl", TypeReferences.ENTITY));
      Schema schema134 = builder.addSchema(2688, Schema2688::new);
      builder.addFixer(new ChoiceTypesFix(schema134, "Added Glow Squid", TypeReferences.ENTITY));
      builder.addFixer(new ChoiceTypesFix(schema134, "Added Glow Item Frame", TypeReferences.ENTITY));
      ...
      ImmutableMap<String, String> immutableMap = ImmutableMap.<String, String>builder()
         ...
         .build();
      builder.addFixer(ItemNameFix.create(schema135, "Renamed copper block items to new oxidized terms", replacing(immutableMap)));
      builder.addFixer(BlockNameFix.create(schema135, "Renamed copper blocks to new oxidized terms", replacing(immutableMap)));
      ...
      ImmutableMap<String, String> immutableMap2 = ImmutableMap.<String, String>builder()
         ...
         .build();
      builder.addFixer(ItemNameFix.create(schema136, "Rename copper item suffixes", replacing(immutableMap2)));
      builder.addFixer(BlockNameFix.create(schema136, "Rename copper blocks suffixes", replacing(immutableMap2)));
      Schema schema137 = builder.addSchema(2693, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AddFlagIfNotPresentFix(schema137, TypeReferences.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
      ...
      ImmutableMap<String, String> immutableMap3 = ImmutableMap.<String, String>builder()
         ...
         .build();
      builder.addFixer(ItemNameFix.create(schema138, "Renamed grimstone block items to deepslate", replacing(immutableMap3)));
      builder.addFixer(BlockNameFix.create(schema138, "Renamed grimstone blocks to deepslate", replacing(immutableMap3)));
      ...
      builder.addFixer(new StructureFeatureChildrenPoolElementFix(schema140));
      Schema schema141 = builder.addSchema(2702, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new ArrowPickupFix(schema141));
      Schema schema142 = builder.addSchema(2704, Schema2704::new);
      builder.addFixer(new ChoiceTypesFix(schema142, "Added Goat", TypeReferences.ENTITY));
      Schema schema143 = builder.addSchema(2707, Schema2707::new);
      builder.addFixer(new ChoiceTypesFix(schema143, "Added Marker", TypeReferences.ENTITY));
      builder.addFixer(new AddFlagIfNotPresentFix(schema143, TypeReferences.WORLD_GEN_SETTINGS, "has_increased_height_already", true));
      Schema schema144 = builder.addSchema(2710, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(
         new StatsRenameFix(schema144, "Renamed play_one_minute stat to play_time", ImmutableMap.of("minecraft:play_one_minute", "minecraft:play_time"))
      );
      Schema schema145 = builder.addSchema(2717, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(
         ItemNameFix.create(
            schema145, "Rename azalea_leaves_flowers", replacing(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))
         )
      );
      builder.addFixer(
         BlockNameFix.create(
            schema145, "Rename azalea_leaves_flowers items", replacing(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves"))
         )
      );
      Schema schema146 = builder.addSchema(2825, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AddFlagIfNotPresentFix(schema146, TypeReferences.WORLD_GEN_SETTINGS, "has_increased_height_already", false));
      Schema schema147 = builder.addSchema(2831, Schema2831::new);
      builder.addFixer(new UntaggedSpawnerFix(schema147));
      Schema schema148 = builder.addSchema(2832, Schema2832::new);
      builder.addFixer(new WorldGenSettingsHeightAndBiomeFix(schema148));
      builder.addFixer(new ChunkHeightAndBiomeFix(schema148));
      Schema schema149 = builder.addSchema(2833, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new WorldGenSettingsDisallowOldCustomWorldsFix(schema149));
      Schema schema150 = builder.addSchema(2838, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new GameEventRenamesFix(schema150, "Caves and Cliffs biome renames", TypeReferences.BIOME, replacing(LegacyBiomeMapping.MAP)));
      Schema schema151 = builder.addSchema(2841, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new ProtoChunkTickListFix(schema151));
      Schema schema152 = builder.addSchema(2842, Schema2842::new);
      builder.addFixer(new ChunkLevelTagRenameFix(schema152));
      Schema schema153 = builder.addSchema(2843, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new TicksInWrongChunkFix(schema153));
      builder.addFixer(
         new GameEventRenamesFix(schema153, "Remove Deep Warm Ocean", TypeReferences.BIOME, replacing("minecraft:deep_warm_ocean", "minecraft:warm_ocean"))
      );
      ...
      builder.addFixer(new WorldGenSettingsDisallowOldCustomWorldsFix(schema155));
      Schema schema156 = builder.addSchema(2967, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new StructureSettingsFlattenFix(schema156));
      Schema schema157 = builder.addSchema(2970, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new StructuresToConfiguredStructuresFix(schema157));
      Schema schema158 = builder.addSchema(3076, Schema3076::new);
      builder.addFixer(new ChoiceTypesFix(schema158, "Added Sculk Catalyst", TypeReferences.BLOCK_ENTITY));
      Schema schema159 = builder.addSchema(3077, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new ChunkDeleteIgnoredLightDataFix(schema159));
      Schema schema160 = builder.addSchema(3078, Schema3078::new);
      builder.addFixer(new ChoiceTypesFix(schema160, "Added Frog", TypeReferences.ENTITY));
      builder.addFixer(new ChoiceTypesFix(schema160, "Added Tadpole", TypeReferences.ENTITY));
      builder.addFixer(new ChoiceTypesFix(schema160, "Added Sculk Shrieker", TypeReferences.BLOCK_ENTITY));
      Schema schema161 = builder.addSchema(3081, Schema3081::new);
      builder.addFixer(new ChoiceTypesFix(schema161, "Added Warden", TypeReferences.ENTITY));
      Schema schema162 = builder.addSchema(3082, Schema3082::new);
      builder.addFixer(new ChoiceTypesFix(schema162, "Added Chest Boat", TypeReferences.ENTITY));
      Schema schema163 = builder.addSchema(3083, Schema3083::new);
      builder.addFixer(new ChoiceTypesFix(schema163, "Added Allay", TypeReferences.ENTITY));
      ...
      builder.addFixer(
         new EntityVariantTypeFix(
            schema165, "Change cat variant type", TypeReferences.ENTITY, "minecraft:cat", "CatType", Util.make(new Int2ObjectOpenHashMap<String>(), catVariants -> {
      ...
      builder.addFixer(
         new EntityVariantTypeFix(
            schema166, "Change frog variant type", TypeReferences.ENTITY, "minecraft:frog", "Variant", Util.make(new Int2ObjectOpenHashMap<String>(), frogVariants -> {
      ...
      builder.addFixer(
         new RenameEntityNbtKeyFix(schema167, "EntityPaintingFieldsRenameFix", "minecraft:painting", Map.of("Motive", "variant", "Facing", "facing"))
      );
      Schema schema168 = builder.addSchema(3093, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new GoatMissingStateFix(schema168));
      Schema schema169 = builder.addSchema(3094, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new GoatHornIdFix(schema169));
      Schema schema170 = builder.addSchema(3097, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RemoveFilteredBookTextFix(schema170));
      builder.addFixer(new RemoveFilteredSignTextFix(schema170));
      Map<String, String> map = Map.of("minecraft:british", "minecraft:british_shorthair");
      builder.addFixer(new RenameVariantsFix(schema170, "Rename british shorthair", TypeReferences.ENTITY, "minecraft:cat", map));
      builder.addFixer(
         new AdvancementCriteriaRenameFix(
            schema170,
      ...
      builder.addFixer(
         new PointOfInterestRemoveFix(schema170, "Remove unpopulated villager PoI types", Set.of("minecraft:unemployed", "minecraft:nitwit")::contains)
      );
      Schema schema171 = builder.addSchema(3108, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new BlendingDataRemoveFromNetherEndFix(schema171));
      Schema schema172 = builder.addSchema(3201, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new OptionsProgrammerArtFix(schema172));
      Schema schema173 = builder.addSchema(3202, Schema3202::new);
      builder.addFixer(new ChoiceTypesFix(schema173, "Added Hanging Sign", TypeReferences.BLOCK_ENTITY));
      Schema schema174 = builder.addSchema(3203, Schema3203::new);
      builder.addFixer(new ChoiceTypesFix(schema174, "Added Camel", TypeReferences.ENTITY));
      Schema schema175 = builder.addSchema(3204, Schema3204::new);
      builder.addFixer(new ChoiceTypesFix(schema175, "Added Chiseled Bookshelf", TypeReferences.BLOCK_ENTITY));
      Schema schema176 = builder.addSchema(3209, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new ItemInstanceSpawnEggFix(schema176, false, "minecraft:pig_spawn_egg"));
      Schema schema177 = builder.addSchema(3214, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new OptionsAmbientOcclusionFix(schema177));
      Schema schema178 = builder.addSchema(3319, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new OptionsAccessibilityOnboardFix(schema178));
      Schema schema179 = builder.addSchema(3322, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new StatusEffectDurationFix(schema179));
      Schema schema180 = builder.addSchema(3325, Schema3325::new);
      builder.addFixer(new ChoiceTypesFix(schema180, "Added displays", TypeReferences.ENTITY));
      Schema schema181 = builder.addSchema(3326, Schema3326::new);
      builder.addFixer(new ChoiceTypesFix(schema181, "Added Sniffer", TypeReferences.ENTITY));
      Schema schema182 = builder.addSchema(3327, Schema3327::new);
      builder.addFixer(new ChoiceTypesFix(schema182, "Archaeology", TypeReferences.BLOCK_ENTITY));
      Schema schema183 = builder.addSchema(3328, Schema3328::new);
      builder.addFixer(new ChoiceTypesFix(schema183, "Added interaction", TypeReferences.ENTITY));
      Schema schema184 = builder.addSchema(3438, Schema3438::new);
      builder.addFixer(
         RenameBlockEntityFix.create(
            schema184, "Rename Suspicious Sand to Brushable Block", replacing("minecraft:suspicious_sand", "minecraft:brushable_block")
         )
      );
      builder.addFixer(new EntityBrushableBlockFieldsRenameFix(schema184));
      builder.addFixer(
         ItemNameFix.create(
            schema184,
      ...
      builder.addFixer(new ChoiceTypesFix(schema184, "Added calibrated sculk sensor", TypeReferences.BLOCK_ENTITY));
      Schema schema185 = builder.addSchema(3439, Schema3439::new);
      builder.addFixer(new UpdateSignTextFormatFix(schema185, "Updated sign text format for Signs", "minecraft:sign"));
      Schema schema186 = builder.addSchema(3439, 1, Schema3439_1::new);
      builder.addFixer(new UpdateSignTextFormatFix(schema186, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
      ...
      builder.addFixer(new RemoveFeatureTogglesFix(schema187, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
         ...
         ItemNameFix.create(
            ...
            replacing(
               Stream.of(
                  ...
                  .collect(Collectors.toMap(Function.identity(), id -> id.replace("_pottery_shard", "_pottery_sherd")))
            )
         )
      );
      Schema schema189 = builder.addSchema(3448, Schema3448::new);
      builder.addFixer(new DecoratedPotFieldRenameFix(schema189));
      ...
      builder.addFixer(new ChunkDeleteLightFix(schema191));
      Schema schema192 = builder.addSchema(3459, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new LegacyDragonFightFix(schema192));
      Schema schema193 = builder.addSchema(3564, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new DropInvalidSignDatafixDataFix(schema193, "minecraft:sign"));
      Schema schema194 = builder.addSchema(3564, 1, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new DropInvalidSignDatafixDataFix(schema194, "minecraft:hanging_sign"));
      Schema schema195 = builder.addSchema(3565, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RandomSequenceSettingsFix(schema195));
      Schema schema196 = builder.addSchema(3566, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RenameScoreboardDisplaySlotFix(schema196));
      Schema schema197 = builder.addSchema(3568, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new StatusEffectFix(schema197));
      Schema schema198 = builder.addSchema(3682, Schema3682::new);
      builder.addFixer(new ChoiceTypesFix(schema198, "Added Crafter", TypeReferences.BLOCK_ENTITY));
      Schema schema199 = builder.addSchema(3683, Schema3683::new);
      builder.addFixer(new PrimedTntBlockStateFix(schema199));
      Schema schema200 = builder.addSchema(3685, Schema3685::new);
      builder.addFixer(new ProjectileItemTypeFix(schema200));
      Schema schema201 = builder.addSchema(3689, Schema3689::new);
      builder.addFixer(new ChoiceTypesFix(schema201, "Added Breeze", TypeReferences.ENTITY));
      builder.addFixer(new ChoiceTypesFix(schema201, "Added Trial Spawner", TypeReferences.BLOCK_ENTITY));
      ...
      builder.addFixer(new ChoiceTypesFix(schema203, "Added Armadillo", TypeReferences.ENTITY));
      ...
      builder.addFixer(new RenameEnchantmentFix(schema205, "Rename sweeping enchant to sweeping_edge", Map.of("minecraft:sweeping", "minecraft:sweeping_edge")));
      Schema schema206 = builder.addSchema(3807, Schema3807::new);
      builder.addFixer(new ChoiceTypesFix(schema206, "Added Vault", TypeReferences.BLOCK_ENTITY));
      Schema schema207 = builder.addSchema(3807, 1, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new MapBannerBlockPosFormatFix(schema207));
      Schema schema208 = builder.addSchema(3808, Schema3808::new);
      builder.addFixer(new HorseArmorFix(schema208, "minecraft:horse", "ArmorItem", true));
      Schema schema209 = builder.addSchema(3808, 1, Schema3808_1::new);
      builder.addFixer(new HorseArmorFix(schema209, "minecraft:llama", "DecorItem", false));
      Schema schema210 = builder.addSchema(3808, 2, Schema3808_2::new);
      builder.addFixer(new HorseArmorFix(schema210, "minecraft:trader_llama", "DecorItem", false));
      Schema schema211 = builder.addSchema(3809, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new HorseChestIndexingFix(schema211));
      Schema schema212 = builder.addSchema(3812, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new WolfHealthFix(schema212));
      Schema schema213 = builder.addSchema(3813, Schema3813::new);
      builder.addFixer(new BlockPosFormatFix(schema213));
      Schema schema214 = builder.addSchema(3814, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(
         new RenameEntityAttributesFix(
            schema214, "Rename jump strength attribute", replacing("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")
         )
      );
      Schema schema215 = builder.addSchema(3816, Schema3816::new);
      builder.addFixer(new ChoiceTypesFix(schema215, "Added Bogged", TypeReferences.ENTITY));
      Schema schema216 = builder.addSchema(3818, Schema3818::new);
      builder.addFixer(new BeehiveFieldRenameFix(schema216));
      builder.addFixer(new EmptyItemInHotbarFix(schema216));
      Schema schema217 = builder.addSchema(3818, 1, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new BannerPatternFormatFix(schema217));
      Schema schema218 = builder.addSchema(3818, 2, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new TippedArrowPotionToItemFix(schema218));
      Schema schema219 = builder.addSchema(3818, 3, Schema3818_3::new);
      builder.addFixer(new WriteAndReadFix(schema219, "Inject data component types", TypeReferences.DATA_COMPONENTS));
      Schema schema220 = builder.addSchema(3818, 4, Schema3818_4::new);
      builder.addFixer(new ParticleUnflatteningFix(schema220));
      Schema schema221 = builder.addSchema(3818, 5, Schema3818_5::new);
      builder.addFixer(new ItemStackComponentizationFix(schema221));
      Schema schema222 = builder.addSchema(3818, 6, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AreaEffectCloudPotionFix(schema222));
      Schema schema223 = builder.addSchema(3820, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new PlayerHeadBlockProfileFix(schema223));
      builder.addFixer(new LodestoneCompassComponentFix(schema223));
      Schema schema224 = builder.addSchema(3825, Schema3825::new);
      builder.addFixer(new ItemStackCustomNameToItemNameFix(schema224));
      builder.addFixer(new BannerCustomNameToItemNameFix(schema224));
      builder.addFixer(new TrialSpawnerConfigTagFix(schema224));
      builder.addFixer(new ChoiceTypesFix(schema224, "Added Ominous Item Spawner", TypeReferences.ENTITY));
      Schema schema225 = builder.addSchema(3828, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new EmptyItemInVillagerTradeFix(schema225));
      Schema schema226 = builder.addSchema(3833, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RemoveEmptyItemInSuspiciousBlockFix(schema226));
      Schema schema227 = builder.addSchema(3938, Schema3938::new);
      builder.addFixer(new ArrowStoredWeaponFix(schema227));
      Schema schema228 = builder.addSchema(3939, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RemoveFeatureTogglesFix(schema228, "Remove 1.21 feature toggle", Set.of("minecraft:update_1_21")));
      Schema schema229 = builder.addSchema(3943, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new OptionsMenuBlurrinessFix(schema229));
      Schema schema230 = builder.addSchema(3945, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AttributeIdFix(schema230));
      builder.addFixer(new JukeboxTicksSinceSongStartedFix(schema230));
      Schema schema231 = builder.addSchema(4054, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new OminousBannerRarityFix(schema231));
      Schema schema232 = builder.addSchema(4055, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new AttributeIdPrefixFix(schema232));
      Schema schema233 = builder.addSchema(4057, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new CarvingStepRemoveFix(schema233));
      Schema schema234 = builder.addSchema(4059, Schema4059::new);
      builder.addFixer(new FoodToConsumableFix(schema234));
      Schema schema235 = builder.addSchema(4061, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new TrialSpawnerConfigInRegistryFix(schema235));
      Schema schema236 = builder.addSchema(4064, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new FireResistantToDamageResistantComponentFix(schema236));
      Schema schema237 = builder.addSchema(4067, Schema4067::new);
      builder.addFixer(new BoatSplitFix(schema237));
      builder.addFixer(new RemoveFeatureTogglesFix(schema237, "Remove Bundle experimental feature flag", Set.of("minecraft:bundle")));
      Schema schema238 = builder.addSchema(4068, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new LockComponentPredicateFix(schema238));
      builder.addFixer(new ContainerBlockEntityLockPredicateFix(schema238));
      Schema schema239 = builder.addSchema(4070, Schema4070::new);
      builder.addFixer(new ChoiceTypesFix(schema239, "Added Pale Oak Boat and Pale Oak Chest Boat", TypeReferences.ENTITY));
      Schema schema240 = builder.addSchema(4071, Schema4071::new);
      builder.addFixer(new ChoiceTypesFix(schema240, "Added Creaking", TypeReferences.ENTITY));
      builder.addFixer(new ChoiceTypesFix(schema240, "Added Creaking Heart", TypeReferences.BLOCK_ENTITY));
      Schema schema241 = builder.addSchema(4081, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new EntitySalmonSizeFix(schema241));
      Schema schema242 = builder.addSchema(4173, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RenameEntityNbtKeyFix(schema242, "Rename TNT Minecart fuse", "minecraft:tnt_minecart", Map.of("TNTFuse", "fuse")));
      Schema schema243 = builder.addSchema(4175, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new EquippableAssetRenameFix(schema243));
      builder.addFixer(new CustomModelDataExpansionFix(schema243));
      Schema schema244 = builder.addSchema(4176, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new BlockEntityLockToComponentFix(schema244));
      builder.addFixer(new InvalidLockComponentPredicateFix(schema244));
      Schema schema245 = builder.addSchema(4180, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RemoveFeatureTogglesFix(schema245, "Remove Winter Drop toggle", Set.of("minecraft:winter_drop")));
      Schema schema246 = builder.addSchema(4181, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema246, "minecraft:furnace"));
      builder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema246, "minecraft:smoker"));
      builder.addFixer(new BlockEntityFurnaceBurnTimeFix(schema246, "minecraft:blast_furnace"));
      ...
      builder.addFixer(
         new EntityAttributeBaseFix(
            schema247, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", followRange -> followRange == 48.0 ? 16.0 : followRange
         )
      );
      builder.addFixer(
         new EntityAttributeBaseFix(
            schema247, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", followRange -> followRange == 48.0 ? 16.0 : followRange
         )
      );
      builder.addFixer(
         new EntityAttributeBaseFix(
            schema247, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", followRange -> followRange == 40.0 ? 16.0 : followRange
         )
      );
      builder.addFixer(
         new EntityAttributeBaseFix(
      ...
      builder.addFixer(
         new EntityAttributeBaseFix(
            schema247, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", followRange -> followRange == 16.0 ? 24.0 : followRange
         )
      );
      Schema schema248 = builder.addSchema(4290, Schema4290::new);
      builder.addFixer(new UnflattenTextComponentFix(schema248));
      Schema schema249 = builder.addSchema(4291, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new LegacyHoverEventFix(schema249));
      builder.addFixer(new TextComponentStringyFlagsFix(schema249));
      Schema schema250 = builder.addSchema(4292, Schema4292::new);
      builder.addFixer(new TextComponentHoverAndClickEventFix(schema250));
      Schema schema251 = builder.addSchema(4293, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new DropChancesFormatFix(schema251));
      Schema schema252 = builder.addSchema(4294, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(
      ...
      Schema schema255 = builder.addSchema(4297, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new ForcedChunkToTicketFix(schema255));
      Schema schema256 = builder.addSchema(4299, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new ItemVariantComponentizationFix(schema256));
      Schema schema257 = builder.addSchema(4300, Schema4300::new);
      builder.addFixer(new SaddleEquipmentSlotFix(schema257));
      Schema schema258 = builder.addSchema(4301, Schema4301::new);
      builder.addFixer(new EquipmentFormatFix(schema258));
      Schema schema259 = builder.addSchema(4302, Schema4302::new);
      builder.addFixer(new ChoiceTypesFix(schema259, "Added Test and Test Instance Block Entities", TypeReferences.BLOCK_ENTITY));
      Schema schema260 = builder.addSchema(4303, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new EntityFallDistanceFloatToDoubleFix(schema260, TypeReferences.ENTITY));
      builder.addFixer(new EntityFallDistanceFloatToDoubleFix(schema260, TypeReferences.PLAYER));
      Schema schema261 = builder.addSchema(4305, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new SimpleBlockPropertyRenameFix(schema261, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", value -> value));
      Schema schema262 = builder.addSchema(4306, Schema4306::new);
      builder.addFixer(new ThrownPotionSplitFix(schema262));
      Schema schema263 = builder.addSchema(4307, Schema4307::new);
      builder.addFixer(new TooltipDisplayComponentFix(schema263));
      Schema schema264 = builder.addSchema(4309, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RaidRenamesDataFix(schema264));
      builder.addFixer(new ChunkTicketUnpackPosFix(schema264));
      Schema schema265 = builder.addSchema(4311, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(
         new AdvancementRenameFix(
            schema265, false, "Use lodestone category change", replacing("minecraft:nether/use_lodestone", "minecraft:adventure/use_lodestone")
         )
      );
      Schema schema266 = builder.addSchema(4312, Schema4312::new);
      builder.addFixer(new PlayerEquipmentFix(schema266));
      Schema schema267 = builder.addSchema(4314, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new InlineBlockPosFormatFix(schema267));
      Schema schema268 = builder.addSchema(4420, Schema4420::new);
      builder.addFixer(new TypeChangeFix(schema268, "AreaEffectCloudCustomParticleFix", TypeReferences.ENTITY, "minecraft:area_effect_cloud"));
      Schema schema269 = builder.addSchema(4421, Schema4421::new);
      builder.addFixer(new ChoiceTypesFix(schema269, "Added Happy Ghast", TypeReferences.ENTITY));
      Schema schema270 = builder.addSchema(4424, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new RemoveFeatureTogglesFix(schema270, "Remove Locator Bar experimental feature flag", Set.of("minecraft:locator_bar")));
      builder.addFixer(new AddFieldFix(schema270, TypeReferences.PLAYER, "style", dynamic -> dynamic.createString("minecraft:default"), "locator_bar_icon"));
      builder.addFixer(new AddFieldFix(schema270, TypeReferences.ENTITY, "style", dynamic -> dynamic.createString("minecraft:default"), "locator_bar_icon"));
      Schema schema271 = builder.addSchema(4531, Schema4531::new);
      builder.addFixer(new ChoiceTypesFix(schema271, "Added Copper Golem", TypeReferences.ENTITY));
      Schema schema272 = builder.addSchema(4532, Schema4532::new);
      builder.addFixer(new ChoiceTypesFix(schema272, "Added Copper Golem Statue Block Entity", TypeReferences.BLOCK_ENTITY));
      Schema schema273 = builder.addSchema(4533, Schema4533::new);
      builder.addFixer(new ChoiceTypesFix(schema273, "Added Shelf", TypeReferences.BLOCK_ENTITY));
      Schema schema274 = builder.addSchema(4535, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new CopperGolemWeatherStateFix(schema274));
      Schema schema275 = builder.addSchema(4537, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new ChunkDeleteLightFix(schema275));
      Schema schema276 = builder.addSchema(4541, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(BlockNameFix.create(schema276, "Rename chain to iron_chain", replacing("minecraft:chain", "minecraft:iron_chain")));
      builder.addFixer(ItemNameFix.create(schema276, "Rename chain to iron_chain", replacing("minecraft:chain", "minecraft:iron_chain")));
      Schema schema277 = builder.addSchema(4543, Schema4543::new);
      builder.addFixer(new ChoiceTypesFix(schema277, "Added Mannequin", TypeReferences.ENTITY));
      Schema schema278 = builder.addSchema(4544, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new LegacyWorldBorderFix(schema278));
      Schema schema279 = builder.addSchema(4548, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new WorldSpawnDataFix(schema279));
      builder.addFixer(new PlayerRespawnDataFix(schema279));
      Schema schema280 = builder.addSchema(4648, Schema4648::new);
      builder.addFixer(new ChoiceTypesFix(schema280, "Added Nautilus and Zombie Nautilus", TypeReferences.ENTITY));
      Schema schema281 = builder.addSchema(4649, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new TridentAnimationFix(schema281));
      Schema schema282 = builder.addSchema(4650, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new DebugProfileOverlayReferenceFix(schema282));
      Schema schema283 = builder.addSchema(4651, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new SplitGraphicsModeFix(schema283, "cutoutLeaves", "false", "true", "true"));
      builder.addFixer(new SplitGraphicsModeFix(schema283, "weatherRadius", "5", "10", "10"));
      builder.addFixer(new SplitGraphicsModeFix(schema283, "vignette", "false", "true", "true"));
      builder.addFixer(new SplitGraphicsModeFix(schema283, "improvedTransparency", "false", "false", "true"));
      builder.addFixer(new SetGraphicsPresetToCustomFix(schema283));
      Schema schema284 = builder.addSchema(4656, Schema4656::new);
      builder.addFixer(new ChoiceTypesFix(schema284, "Added Parched and Camel Husk", TypeReferences.ENTITY));
      Schema schema285 = builder.addSchema(4657, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new WorldBorderWarningTimeFix(schema285));
      Schema schema286 = builder.addSchema(4658, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new GameRuleRegistryFix(schema286));
      Schema schema287 = builder.addSchema(4661, EMPTY_IDENTIFIER_NORMALIZE);
      builder.addFixer(new OptionsMusicToastFix(schema287, false));
   }
