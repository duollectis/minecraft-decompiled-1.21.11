...
/**
 * Переименовывает устаревшие идентификаторы достижений, изменённые в процессе флаттенинга (1.13).
 * Охватывает рецепты, строительные блоки, декорации и транспорт.
 */
public class AdvancementsFix extends AdvancementRenameFix {
	...
	public AdvancementsFix(Schema schema, boolean changesType) {
		super(schema, changesType, "AdvancementsFix", key -> RENAMED_ADVANCEMENTS.getOrDefault(key, key));
	}
}
