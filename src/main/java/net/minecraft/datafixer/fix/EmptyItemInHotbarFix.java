...
public class EmptyItemInHotbarFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      OpticFinder<Pair<String, Pair<Either<Pair<String, String>, Unit>, Pair<Either<?, Unit>, Dynamic<?>>>>> opticFinder =
      ...
      return this.fixTypeEverywhereTyped(
         ...
         hotbarTyped -> hotbarTyped.update(opticFinder, itemPair -> itemPair.mapSecond(pairx -> {
            ...
            return isEmpty || hasNoCount
                    ? Pair.of(Either.right(Unit.INSTANCE), Pair.of(Either.right(Unit.INSTANCE), dynamic.emptyMap()))
                    : pairx;
         }))
      );
   }
