                     ...
                     map2x -> map2x.forEach(
                        (propertyName, spacing) -> {
                           ...
                           if ("stronghold".equals(string)) {
                              ...
                              switch (string2) {
                                 case "distance":
                                    mutableInt.setValue(parseInt(string3, mutableInt.intValue(), 1));
                                    return;
                                 case "spread":
                                    mutableInt2.setValue(parseInt(string3, mutableInt2.intValue(), 1));
                                    return;
                                 case "count":
                                    mutableInt3.setValue(parseInt(string3, mutableInt3.intValue(), 1));
                                    return;
                              }
                           } else {
                              switch (string2) {
