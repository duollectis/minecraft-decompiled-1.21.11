	...
	protected TypeRewriteRule makeRule() {
		...
		return this.fixTypeEverywhereTyped(
				...
				worldGenSettingsTyped -> {
					OptionalDynamic<?>
							optionalDynamic =
							((Dynamic) worldGenSettingsTyped.get(DSL.remainderFinder())).get(
					...
					return worldGenSettingsTyped.update(
							                            DSL.remainderFinder(),
							                            worldGenSettingsDynamic -> worldGenSettingsDynamic.remove("has_increased_height_already")
					                            )
					                            .updateTyped(
							                            opticFinder,
							                            type3,
																			                            ...
																			                            overworldBiomeSourceDynamic -> {
																				                            String
																						                            ...
																						                            overworldBiomeSourceDynamic
																								                            ...
																								                            .asString(
																										                            "");
																				                            if ("minecraft:vanilla_layered".equals(
																						                            stringx)
																						                            ||
																						                            bl
																								                            && "minecraft:multi_noise".equals(
																								                            stringx)) {
																					                            if (overworldBiomeSourceDynamic
																							                            .get("large_biomes")
																							                            .asBoolean(
																									                            false)) {
																					                            ...
																					                            return overworldBiomeSourceDynamic.createMap(
																							                            ImmutableMap.of(
																									                            overworldBiomeSourceDynamic.createString(
																											                            "preset"),
																									                            overworldBiomeSourceDynamic.createString(
																											                            "minecraft:overworld"),
																									                            overworldBiomeSourceDynamic.createString(
															                            ...
															                            return mutableBoolean.booleanValue()
															                                   ? overworldGeneratorDynamic.update(
																	                            ...
																	                            "minecraft:overworld".equals(
																			                            overworldGeneratorSettingsDynamic.asString(
																					                            ""))
																	                            ? overworldGeneratorSettingsDynamic.createString(
																			                            "minecraft:large_biomes")
																	                            : overworldGeneratorSettingsDynamic
															                            )
															                                   : overworldGeneratorDynamic;
														                            }
														                            else if ("minecraft:flat".equals(
																                            string)) {
															                            return bl2
															                                   ? overworldGeneratorDynamic
															                                   : overworldGeneratorDynamic.update(
																	                                   ...
																	                                   overworldGeneratorSettingsDynamic -> overworldGeneratorSettingsDynamic.update(
																			                                   "layers",
																			                                   WorldGenSettingsHeightAndBiomeFix::fillWithAir
																	                                   )
															                                   );
														                            }
														                            else {
