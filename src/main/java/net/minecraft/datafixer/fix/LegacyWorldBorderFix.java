						...
						level -> {
							Dynamic<?> dynamic = level.emptyMap()
							                          ...
							                          .set(
									                          ...
									                          level.createDouble(level
											                          .get("BorderSize")
											                          .asDouble(5.999997E7F))
							                          )
							                          .set(
									                          "lerp_time",
									                          level.createLong(level
											                          .get("BorderSizeLerpTime")
											                          .asLong(0L))
							                          )
							                          .set(
									                          "lerp_target",
									                          level.createDouble(level
											                          .get("BorderSizeLerpTarget")
											                          .asDouble(0.0))
							                          )
							                          .set(
									                          "safe_zone",
							                          ...
							                          .set(
									                          "damage_per_block",
									                          level.createDouble(level
											                          .get("BorderDamagePerBlock")
											                          .asDouble(0.2))
							                          )
							                          .set(
									                          "warning_blocks",
									                          level.createInt(level.get("BorderWarningBlocks").asInt(5))
							                          )
							                          .set(
									                          "warning_time",
									                          level.createInt(level.get("BorderWarningTime").asInt(15))
							                          );
