...
public class ItemSpawnEggFix extends DataFix {
   private static final @Nullable String[] DAMAGE_TO_ENTITY_IDS = (String[])DataFixUtils.make(new String[256], ids -> {
      ids[1] = "Item";
      ids[2] = "XPOrb";
      ids[7] = "ThrownEgg";
      ids[8] = "LeashKnot";
            ...
            if (optional.isPresent() && Objects.equals(optional.get().getSecond(), "minecraft:spawn_egg")) {
               ...
               if (string != null && (optional5.isEmpty() || !Objects.equals(optional5.get(), string))) {
                  ...
                  Dynamic<?> dynamic2 = (Dynamic<?>)DataFixUtils.orElse(
                     typed3.getOptionalTyped(opticFinder4).map(typedx -> (Dynamic)typedx.write().getOrThrow()), dynamic.emptyMap()
                  );
