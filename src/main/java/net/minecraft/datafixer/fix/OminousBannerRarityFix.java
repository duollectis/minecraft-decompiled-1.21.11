...
public class OminousBannerRarityFix extends DataFix {
	...
	private Typed<?> fixNameAndRarity(
			Typed<?> typed,
			OpticFinder<?> opticFinder,
			OpticFinder<?> opticFinder2,
			OpticFinder<Pair<String, String>> opticFinder3
	) {
					       ...
					       ? typedx.updateTyped(
							               ...
							               typedxx -> typedxx.set(
									               ...
									               Pair.of(
											               ...
											               TextFixes.translate("block.minecraft.ominous_banner")
									               )
							               )
					               )
					               .update(
							               DSL.remainderFinder(),
							               dynamic -> dynamic.set("minecraft:rarity", dynamic.createString("uncommon"))
					               )
					       : typedx;
				}
		);
