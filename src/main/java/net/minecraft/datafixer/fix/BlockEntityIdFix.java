...
/**
 * {@code BlockEntityIdFix}.
 */
public class BlockEntityIdFix extends DataFix {

	public static final Map<String, String> RENAMED_BLOCK_ENTITIES = DataFixUtils.make(
	...
	public TypeRewriteRule makeRule() {
		...
		return TypeRewriteRule.seq(
				...
				this.fixTypeEverywhere(
						...
						taggedChoiceType,
						taggedChoiceType2,
						dynamicOps -> pair -> pair.mapFirst(oldName -> RENAMED_BLOCK_ENTITIES.getOrDefault(
								oldName,
								oldName
						))
				)
