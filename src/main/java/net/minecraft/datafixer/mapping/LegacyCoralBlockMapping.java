...
public class LegacyCoralBlockMapping {
	...
	public static final Map<String, String> MAP = ImmutableMap.<String, String>builder()
	                                                          ...
	                                                          .put(
			                                                          "minecraft:blue_coral_fan",
			                                                          "minecraft:tube_coral_fan"
	                                                          )
	                                                          .put(
			                                                          "minecraft:pink_coral_fan",
			                                                          "minecraft:brain_coral_fan"
	                                                          )
	                                                          .put(
			                                                          "minecraft:purple_coral_fan",
			                                                          "minecraft:bubble_coral_fan"
	                                                          )
	                                                          .put(
			                                                          "minecraft:red_coral_fan",
			                                                          "minecraft:fire_coral_fan"
	                                                          )
	                                                          .put(
			                                                          "minecraft:yellow_coral_fan",
