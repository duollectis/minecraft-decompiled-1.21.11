...
public class SlotRanges {
   ...
   public static final Codec<SlotRange> CODEC = StringIdentifiable.createBasicCodec(() -> SLOT_RANGES.toArray(SlotRange[]::new));
   private static final Function<String, @Nullable SlotRange> FROM_NAME = StringIdentifiable.createMapper(SLOT_RANGES.toArray(SlotRange[]::new));
