...
public record PlayerPredicate(
	...
	public static final MapCodec<PlayerPredicate> CODEC = RecordCodecBuilder.mapCodec(
			instance -> instance.group(
					                    ...
					                    Codecs
							                    .object2BooleanMap(Recipe.KEY_CODEC)
		...
		if (!(entity instanceof ServerPlayerEntity serverPlayerEntity)) {
			...
			if (!this.advancements.isEmpty()) {
				...
				for (java.util.Map.Entry<Identifier, PlayerPredicate.AdvancementPredicate> entry2 : this.advancements.entrySet()) {
					...
					if (advancementEntry == null || !entry2
							.getValue()
	...
	/**
	 * {@code AdvancementCriteriaPredicate}.
	 */
	record AdvancementCriteriaPredicate(Object2BooleanMap<String> criteria) implements PlayerPredicate.AdvancementPredicate {

		public static final Codec<PlayerPredicate.AdvancementCriteriaPredicate>
				CODEC =
				Codecs.object2BooleanMap(Codec.STRING)
				      .xmap(
	...
	public static class Builder {
		...
		private final com.google.common.collect.ImmutableList.Builder<PlayerPredicate.StatMatcher<?>>
				stats =
		...
		public PlayerPredicate.Builder advancement(Identifier id, Map<String, Boolean> criteria) {
			this.advancements.put(
					id,
					new PlayerPredicate.AdvancementCriteriaPredicate(new Object2BooleanOpenHashMap(criteria))
			);
			return this;
		}
	...
	/**
	 * {@code CompletedAdvancementPredicate}.
	 */
