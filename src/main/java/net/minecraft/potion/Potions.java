...
public class Potions {
	...
	public static final RegistryEntry<Potion>
			LEAPING =
			register("leaping", new Potion("leaping", new StatusEffectInstance(StatusEffects.JUMP_BOOST, 3600)));
	...
	public static final RegistryEntry<Potion>
			SWIFTNESS =
			register("swiftness", new Potion("swiftness", new StatusEffectInstance(StatusEffects.SPEED, 3600)));
	...
	public static final RegistryEntry<Potion>
			SLOWNESS =
			register("slowness", new Potion("slowness", new StatusEffectInstance(StatusEffects.SLOWNESS, 1800)));
	...
	public static final RegistryEntry<Potion>
			HEALING =
			register("healing", new Potion("healing", new StatusEffectInstance(StatusEffects.INSTANT_HEALTH, 1)));
	...
	public static final RegistryEntry<Potion>
			HARMING =
			register("harming", new Potion("harming", new StatusEffectInstance(StatusEffects.INSTANT_DAMAGE, 1)));
	...
	public static final RegistryEntry<Potion>
			POISON =
			register("poison", new Potion("poison", new StatusEffectInstance(StatusEffects.POISON, 900)));
	public static final RegistryEntry<Potion>
			LONG_POISON =
	...
	public static final RegistryEntry<Potion>
			STRENGTH =
			register("strength", new Potion("strength", new StatusEffectInstance(StatusEffects.STRENGTH, 3600)));
	...
	public static final RegistryEntry<Potion>
			WEAKNESS =
			register("weakness", new Potion("weakness", new StatusEffectInstance(StatusEffects.WEAKNESS, 1800)));
	...
	public static final RegistryEntry<Potion>
			WEAVING =
			register("weaving", new Potion("weaving", new StatusEffectInstance(StatusEffects.WEAVING, 3600)));
	public static final RegistryEntry<Potion>
			OOZING =
			register("oozing", new Potion("oozing", new StatusEffectInstance(StatusEffects.OOZING, 3600)));
	public static final RegistryEntry<Potion>
			INFESTED =
			register("infested", new Potion("infested", new StatusEffectInstance(StatusEffects.INFESTED, 3600)));
