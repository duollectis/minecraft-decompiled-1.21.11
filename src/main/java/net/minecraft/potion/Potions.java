...
/**
 * Реестр всех стандартных зелий игры.
 * Каждое зелье регистрируется в {@link Registries#POTION} при загрузке класса.
 * Длительности эффектов указаны в тиках (20 тиков = 1 секунда).
 */
public class Potions {
	...
	public static final RegistryEntry<Potion> LEAPING = register(
			"leaping", new Potion("leaping", new StatusEffectInstance(StatusEffects.JUMP_BOOST, 3600))
	);
	...
	public static final RegistryEntry<Potion> FIRE_RESISTANCE = register(
			"fire_resistance",
			new Potion("fire_resistance", new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 3600))
	);
	...
	public static final RegistryEntry<Potion> SWIFTNESS = register(
			"swiftness", new Potion("swiftness", new StatusEffectInstance(StatusEffects.SPEED, 3600))
	);
	...
	public static final RegistryEntry<Potion> SLOWNESS = register(
			"slowness", new Potion("slowness", new StatusEffectInstance(StatusEffects.SLOWNESS, 1800))
	);
	...
	public static final RegistryEntry<Potion> LONG_TURTLE_MASTER = register(
			...
			new Potion(
					"turtle_master",
					new StatusEffectInstance(StatusEffects.SLOWNESS, 800, 3),
					new StatusEffectInstance(StatusEffects.RESISTANCE, 800, 2)
			)
	);
	...
	public static final RegistryEntry<Potion> WATER_BREATHING = register(
			"water_breathing",
			new Potion("water_breathing", new StatusEffectInstance(StatusEffects.WATER_BREATHING, 3600))
	);
	...
	public static final RegistryEntry<Potion> HEALING = register(
			"healing", new Potion("healing", new StatusEffectInstance(StatusEffects.INSTANT_HEALTH, 1))
	);
	...
	public static final RegistryEntry<Potion> HARMING = register(
			"harming", new Potion("harming", new StatusEffectInstance(StatusEffects.INSTANT_DAMAGE, 1))
	);
	...
	public static final RegistryEntry<Potion> POISON = register(
			"poison", new Potion("poison", new StatusEffectInstance(StatusEffects.POISON, 900))
	);
	public static final RegistryEntry<Potion> LONG_POISON = register(
			"long_poison", new Potion("poison", new StatusEffectInstance(StatusEffects.POISON, 1800))
	);
	...
	public static final RegistryEntry<Potion> STRENGTH = register(
			"strength", new Potion("strength", new StatusEffectInstance(StatusEffects.STRENGTH, 3600))
	);
	...
	public static final RegistryEntry<Potion> WEAKNESS = register(
			"weakness", new Potion("weakness", new StatusEffectInstance(StatusEffects.WEAKNESS, 1800))
	);
	...
	public static final RegistryEntry<Potion> LUCK = register(
			"luck", new Potion("luck", new StatusEffectInstance(StatusEffects.LUCK, 6000))
	);
	...
	public static final RegistryEntry<Potion> LONG_SLOW_FALLING = register(
			"long_slow_falling",
			new Potion("slow_falling", new StatusEffectInstance(StatusEffects.SLOW_FALLING, 4800))
	);
	...
	public static final RegistryEntry<Potion> WEAVING = register(
			"weaving", new Potion("weaving", new StatusEffectInstance(StatusEffects.WEAVING, 3600))
	);
	public static final RegistryEntry<Potion> OOZING = register(
			"oozing", new Potion("oozing", new StatusEffectInstance(StatusEffects.OOZING, 3600))
	);
	public static final RegistryEntry<Potion> INFESTED = register(
			"infested", new Potion("infested", new StatusEffectInstance(StatusEffects.INFESTED, 3600))
	);
