...
public record ArmorTrim(
	...
	private static final Text
			UPGRADE_TEXT =
			Text.translatable(Util.createTranslationKey("item", Identifier.ofVanilla("smithing_template.upgrade")))
	...
	public Identifier getTextureId(String trimsDirectory, RegistryKey<EquipmentAsset> equipmentAsset) {
		...
		return this
				...
				.value()
				.assetId()
				.withPath(patternId -> trimsDirectory + "/" + patternId + "_" + assetId.suffix());
	}
}
