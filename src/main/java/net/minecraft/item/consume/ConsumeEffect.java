...
public interface ConsumeEffect {
	...
	Codec<ConsumeEffect>
			CODEC =
			Registries.CONSUME_EFFECT_TYPE.getCodec().dispatch(ConsumeEffect::getType, ConsumeEffect.Type::codec);

	PacketCodec<RegistryByteBuf, ConsumeEffect>
			PACKET_CODEC =
			PacketCodecs.registryValue(RegistryKeys.CONSUME_EFFECT_TYPE)
