...
public class HoneycombItem extends Item implements SignChangingItem {
	...
	public static final Supplier<BiMap<Block, Block>>
			WAXED_TO_UNWAXED_BLOCKS =
	...
	public static final ImmutableMap<Block, Pair<RecipeCategory, String>>
			WAXED_RECIPE_GROUPS =
			(ImmutableMap<Block, Pair<RecipeCategory, String>>) (ImmutableMap<?, ?>) ImmutableMap
					...
					.put(
							...
							Pair.of(RecipeCategory.REDSTONE, "waxed_weathered_copper_bulb")
					)
					.put(
							Blocks.WAXED_EXPOSED_COPPER_BULB,
							Pair.of(RecipeCategory.REDSTONE, "waxed_exposed_copper_bulb")
					)
					.put(
							Blocks.WAXED_OXIDIZED_COPPER_BULB,
							Pair.of(RecipeCategory.REDSTONE, "waxed_oxidized_copper_bulb")
					)
					...
					.put(
							...
							Pair.of(RecipeCategory.REDSTONE, "waxed_copper_trapdoor")
					)
					.put(
					...
					.put(
							...
							Pair.of(RecipeCategory.BUILDING_BLOCKS, "waxed_copper_golem_statue")
					)
					.put(
					...
					.put(
							...
							Pair.of(RecipeCategory.BUILDING_BLOCKS, "waxed_copper_chest")
					)
					.put(
					...
					.put(
							...
							Pair.of(RecipeCategory.BUILDING_BLOCKS, "waxed_lightning_rod")
					)
					.put(
					...
					.put(
							...
							Pair.of(RecipeCategory.BUILDING_BLOCKS, "waxed_copper_bar")
					)
					...
					.put(
							...
							Pair.of(RecipeCategory.BUILDING_BLOCKS, "waxed_copper_chain")
					)
					.put(
					...
					.put(
							...
							Pair.of(RecipeCategory.BUILDING_BLOCKS, "waxed_copper_lantern")
					)
					.put(
		...
		return getWaxedState(blockState).map(state -> {
			...
			if (blockState.getBlock() instanceof ChestBlock
				...
				world.emitGameEvent(
						...
						blockPos2,
						GameEvent.Emitter.of(playerEntity, world.getBlockState(blockPos2))
				);
	...
	public static Optional<BlockState> getWaxedState(BlockState state) {
		return Optional
				.ofNullable((Block) UNWAXED_TO_WAXED_BLOCKS.get().get(state.getBlock()))
