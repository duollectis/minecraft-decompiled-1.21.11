...
public class HoneycombItem extends Item implements SignChangingItem {
   ...
   public static final ImmutableMap<Block, Pair<RecipeCategory, String>> WAXED_RECIPE_GROUPS = (ImmutableMap<Block, Pair<RecipeCategory, String>>) (ImmutableMap<?, ?>) ImmutableMap.<Block, Pair<RecipeCategory, String>>builder()
