...
public class Items {
   ...
   public static final Item ACACIA_SHELF = register(
      Blocks.ACACIA_SHELF, settings -> settings.component(DataComponentTypes.CONTAINER, ContainerComponent.DEFAULT)
   );
   public static final Item BAMBOO_SHELF = register(
      Blocks.BAMBOO_SHELF, settings -> settings.component(DataComponentTypes.CONTAINER, ContainerComponent.DEFAULT)
   );
   ...
   public static final Item CHERRY_SHELF = register(
      Blocks.CHERRY_SHELF, settings -> settings.component(DataComponentTypes.CONTAINER, ContainerComponent.DEFAULT)
   );
   ...
   public static final Item JUNGLE_SHELF = register(
      Blocks.JUNGLE_SHELF, settings -> settings.component(DataComponentTypes.CONTAINER, ContainerComponent.DEFAULT)
   );
   ...
   public static final Item SPRUCE_SHELF = register(
      Blocks.SPRUCE_SHELF, settings -> settings.component(DataComponentTypes.CONTAINER, ContainerComponent.DEFAULT)
   );
   public static final Item WARPED_SHELF = register(
      Blocks.WARPED_SHELF, settings -> settings.component(DataComponentTypes.CONTAINER, ContainerComponent.DEFAULT)
   );
   ...
   public static final Item SADDLE = register(
      "saddle", new Item.Settings().maxCount(1).component(DataComponentTypes.EQUIPPABLE, EquippableComponent.ofSaddle())
   );
