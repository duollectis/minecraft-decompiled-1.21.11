...
public class MapDecorationTypes {
	...
	public static final RegistryEntry<MapDecorationType>
			BLUE_MARKER =
			register("blue_marker", "blue_marker", false, true);
	public static final RegistryEntry<MapDecorationType> TARGET_X = register("target_x", "target_x", true, false);
	public static final RegistryEntry<MapDecorationType>
			TARGET_POINT =
			register("target_point", "target_point", true, false);
	public static final RegistryEntry<MapDecorationType>
			PLAYER_OFF_MAP =
			register("player_off_map", "player_off_map", false, true);
	public static final RegistryEntry<MapDecorationType>
			PLAYER_OFF_LIMITS =
			register("player_off_limits", "player_off_limits", false, true);
	public static final RegistryEntry<MapDecorationType>
			MANSION =
			register("mansion", "woodland_mansion", true, 5393476, false, true);
	public static final RegistryEntry<MapDecorationType>
			MONUMENT =
			register("monument", "ocean_monument", true, 3830373, false, true);
	public static final RegistryEntry<MapDecorationType>
			BANNER_WHITE =
			register("banner_white", "white_banner", true, true);
	public static final RegistryEntry<MapDecorationType>
			BANNER_ORANGE =
			register("banner_orange", "orange_banner", true, true);
	public static final RegistryEntry<MapDecorationType>
			BANNER_MAGENTA =
			register("banner_magenta", "magenta_banner", true, true);
	public static final RegistryEntry<MapDecorationType>
			BANNER_LIGHT_BLUE =
			register("banner_light_blue", "light_blue_banner", true, true);
	public static final RegistryEntry<MapDecorationType>
			BANNER_YELLOW =
			register("banner_yellow", "yellow_banner", true, true);
	public static final RegistryEntry<MapDecorationType>
			BANNER_LIME =
			register("banner_lime", "lime_banner", true, true);
	public static final RegistryEntry<MapDecorationType>
			BANNER_PINK =
			register("banner_pink", "pink_banner", true, true);
	public static final RegistryEntry<MapDecorationType>
			BANNER_GRAY =
			register("banner_gray", "gray_banner", true, true);
	public static final RegistryEntry<MapDecorationType>
			BANNER_LIGHT_GRAY =
			register("banner_light_gray", "light_gray_banner", true, true);
	public static final RegistryEntry<MapDecorationType>
			BANNER_CYAN =
			register("banner_cyan", "cyan_banner", true, true);
	public static final RegistryEntry<MapDecorationType>
			BANNER_PURPLE =
			register("banner_purple", "purple_banner", true, true);
	public static final RegistryEntry<MapDecorationType>
			BANNER_BLUE =
			register("banner_blue", "blue_banner", true, true);
	public static final RegistryEntry<MapDecorationType>
			BANNER_BROWN =
			register("banner_brown", "brown_banner", true, true);
	public static final RegistryEntry<MapDecorationType>
			BANNER_GREEN =
			register("banner_green", "green_banner", true, true);
	public static final RegistryEntry<MapDecorationType> BANNER_RED = register("banner_red", "red_banner", true, true);
	public static final RegistryEntry<MapDecorationType>
			BANNER_BLACK =
			register("banner_black", "black_banner", true, true);
	...
	public static final RegistryEntry<MapDecorationType>
			VILLAGE_SNOWY =
			register("village_snowy", "snowy_village", true, MapColor.LIGHT_GRAY.color, false, true);
	public static final RegistryEntry<MapDecorationType>
			VILLAGE_TAIGA =
			register("village_taiga", "taiga_village", true, MapColor.LIGHT_GRAY.color, false, true);
	public static final RegistryEntry<MapDecorationType>
			JUNGLE_TEMPLE =
			register("jungle_temple", "jungle_temple", true, MapColor.LIGHT_GRAY.color, false, true);
	public static final RegistryEntry<MapDecorationType>
			SWAMP_HUT =
	...
	private static RegistryEntry<MapDecorationType> register(
		...
		RegistryKey<MapDecorationType>
				registryKey =
				RegistryKey.of(RegistryKeys.MAP_DECORATION_TYPE, Identifier.ofVanilla(id));
		MapDecorationType
				mapDecorationType =
				new MapDecorationType(
						Identifier.ofVanilla(assetId),
						showOnItemFrame,
						mapColor,
