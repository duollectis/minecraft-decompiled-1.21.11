               ...
               AttributeModifiersComponent.builder()
                  .add(
                     ...
                     new EntityAttributeModifier(
                        Item.BASE_ATTACK_DAMAGE_MODIFIER_ID, 0.0F + material.attackDamageBonus(), EntityAttributeModifier.Operation.ADD_VALUE
                     ),
                  ...
                  .add(
                     ...
                     new EntityAttributeModifier(
                        Item.BASE_ATTACK_SPEED_MODIFIER_ID, 1.0F / swingAnimationSeconds - 4.0, EntityAttributeModifier.Operation.ADD_VALUE
                     ),
                     AttributeModifierSlot.MAINHAND
                  )
                  .build()
