...
public record AttributeModifiersComponent(List<AttributeModifiersComponent.Entry> modifiers) {
   ...
   public interface Display {
      ...
      public record OverrideDisplay(Text value) implements AttributeModifiersComponent.Display {
         static final MapCodec<AttributeModifiersComponent.Display.OverrideDisplay> CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(TextCodecs.CODEC.fieldOf("value").forGetter(AttributeModifiersComponent.Display.OverrideDisplay::value))
               .apply(instance, AttributeModifiersComponent.Display.OverrideDisplay::new)
         );
         static final PacketCodec<RegistryByteBuf, AttributeModifiersComponent.Display.OverrideDisplay> PACKET_CODEC = PacketCodec.tuple(
            TextCodecs.REGISTRY_PACKET_CODEC, AttributeModifiersComponent.Display.OverrideDisplay::value, AttributeModifiersComponent.Display.OverrideDisplay::new
         );
      ...
      public static enum Type implements StringIdentifiable {
         ...
         OVERRIDE("override", 2, AttributeModifiersComponent.Display.OverrideDisplay.CODEC, AttributeModifiersComponent.Display.OverrideDisplay.PACKET_CODEC);
