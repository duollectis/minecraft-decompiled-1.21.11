...
public record FireworkExplosionComponent(
	...
	public static enum Type implements StringIdentifiable {
		...
		private static final IntFunction<FireworkExplosionComponent.Type> BY_ID = ValueLists.createIndexToValueFunction(
		...
		public static final Codec<FireworkExplosionComponent.Type>
				CODEC =
				StringIdentifiable.createBasicCodec(FireworkExplosionComponent.Type::values);
