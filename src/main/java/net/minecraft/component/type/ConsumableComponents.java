...
public class ConsumableComponents {
	...
	public static final ConsumableComponent HONEY_BOTTLE = drink()
			...
			.build();
	public static final ConsumableComponent
			OMINOUS_BOTTLE =
			drink().finishSound(SoundEvents.ITEM_OMINOUS_BOTTLE_DISPOSE).build();
	...
	public static final ConsumableComponent
			MILK_BUCKET =
			drink().consumeEffect(ClearAllEffectsConsumeEffect.INSTANCE).build();
	public static final ConsumableComponent
			CHORUS_FRUIT =
