...
public enum CraftingRecipeCategory implements StringIdentifiable {
	...
	public static final Codec<CraftingRecipeCategory>
			CODEC =
			StringIdentifiable.createCodec(CraftingRecipeCategory::values);
	...
	public static final PacketCodec<ByteBuf, CraftingRecipeCategory>
			PACKET_CODEC =
			PacketCodecs.indexed(INDEX_TO_VALUE, CraftingRecipeCategory::getIndex);
