...
public class RecipeMatcher<T> {
   ...
   public boolean match(List<? extends RecipeMatcher.RawIngredient<T>> ingredients, int quantity, RecipeMatcher.@Nullable ItemCallback<T> itemCallback) {
      return new RecipeMatcher.Matcher(ingredients).match(quantity, itemCallback);
   }

   public int countCrafts(List<? extends RecipeMatcher.RawIngredient<T>> ingredients, int max, RecipeMatcher.@Nullable ItemCallback<T> itemCallback) {
