...
public interface SlotDisplay {
	...
	Codec<SlotDisplay>
			CODEC =
			Registries.SLOT_DISPLAY.getCodec().dispatch(SlotDisplay::serializer, SlotDisplay.Serializer::codec);

	PacketCodec<RegistryByteBuf, SlotDisplay> PACKET_CODEC = PacketCodecs.registryValue(RegistryKeys.SLOT_DISPLAY)
	                                                                     .dispatch(
			                                                                     SlotDisplay::serializer,
			                                                                     SlotDisplay.Serializer::streamCodec
	                                                                     );
	...
	default ItemStack getFirst(ContextParameterMap context) {
		return this
				.appendStacks(context, SlotDisplay.NoopDisplayedItemFactory.INSTANCE)
				.findFirst()
				.orElse(ItemStack.EMPTY);
	}

	/**
	 * {@code AnyFuelSlotDisplay}.
	 */
	public static class AnyFuelSlotDisplay implements SlotDisplay {
		...
		public static final PacketCodec<RegistryByteBuf, SlotDisplay.AnyFuelSlotDisplay>
				PACKET_CODEC =
				PacketCodec.unit(INSTANCE);
		public static final SlotDisplay.Serializer<SlotDisplay.AnyFuelSlotDisplay>
				SERIALIZER =
				new SlotDisplay.Serializer<>(CODEC, PACKET_CODEC);
	...
	public record CompositeSlotDisplay(List<SlotDisplay> contents) implements SlotDisplay {
		...
		public static final MapCodec<SlotDisplay.CompositeSlotDisplay> CODEC = RecordCodecBuilder.mapCodec(
				instance -> instance
						.group(SlotDisplay.CODEC
								.listOf()
								.fieldOf("contents")
								.forGetter(SlotDisplay.CompositeSlotDisplay::contents))
						.apply(instance, SlotDisplay.CompositeSlotDisplay::new)
		);
		public static final PacketCodec<RegistryByteBuf, SlotDisplay.CompositeSlotDisplay>
				PACKET_CODEC =
				PacketCodec.tuple(
						SlotDisplay.PACKET_CODEC.collect(PacketCodecs.toList()),
						SlotDisplay.CompositeSlotDisplay::contents,
						SlotDisplay.CompositeSlotDisplay::new
				);
		public static final SlotDisplay.Serializer<SlotDisplay.CompositeSlotDisplay>
				SERIALIZER =
				new SlotDisplay.Serializer<>(CODEC, PACKET_CODEC);
	...
	public static class EmptySlotDisplay implements SlotDisplay {
		...
		public static final PacketCodec<RegistryByteBuf, SlotDisplay.EmptySlotDisplay>
				PACKET_CODEC =
				PacketCodec.unit(INSTANCE);
		public static final SlotDisplay.Serializer<SlotDisplay.EmptySlotDisplay>
				SERIALIZER =
				new SlotDisplay.Serializer<>(CODEC, PACKET_CODEC);
	...
	public record ItemSlotDisplay(RegistryEntry<Item> item) implements SlotDisplay {
		...
		public static final MapCodec<SlotDisplay.ItemSlotDisplay> CODEC = RecordCodecBuilder.mapCodec(
				instance -> instance
						.group(Item.ENTRY_CODEC.fieldOf("item").forGetter(SlotDisplay.ItemSlotDisplay::item))
		...
		public static final PacketCodec<RegistryByteBuf, SlotDisplay.ItemSlotDisplay> PACKET_CODEC = PacketCodec.tuple(
				Item.ENTRY_PACKET_CODEC, SlotDisplay.ItemSlotDisplay::item, SlotDisplay.ItemSlotDisplay::new
		);
		public static final SlotDisplay.Serializer<SlotDisplay.ItemSlotDisplay>
				SERIALIZER =
				new SlotDisplay.Serializer<>(CODEC, PACKET_CODEC);
		...
		public <T> Stream<T> appendStacks(ContextParameterMap parameters, DisplayedItemFactory<T> factory) {
			return factory instanceof DisplayedItemFactory.FromStack<T> fromStack
			       ? Stream.of(fromStack.toDisplayed(this.item)) : Stream.empty();
		}
	...
	/**
	 * {@code SmithingTrimSlotDisplay}.
	 */
	public record SmithingTrimSlotDisplay(
			SlotDisplay base,
		...
		public static final MapCodec<SlotDisplay.SmithingTrimSlotDisplay> CODEC = RecordCodecBuilder.mapCodec(
				instance -> instance.group(
						                    ...
						                    ArmorTrimPattern.ENTRY_CODEC
								                    .fieldOf("pattern")
								                    .forGetter(SlotDisplay.SmithingTrimSlotDisplay::pattern)
				                    )
				                    .apply(instance, SlotDisplay.SmithingTrimSlotDisplay::new)
		);
		public static final PacketCodec<RegistryByteBuf, SlotDisplay.SmithingTrimSlotDisplay>
				PACKET_CODEC =
				PacketCodec.tuple(
		...
		public static final SlotDisplay.Serializer<SlotDisplay.SmithingTrimSlotDisplay>
				SERIALIZER =
				new SlotDisplay.Serializer<>(CODEC, PACKET_CODEC);
	...
	public record StackSlotDisplay(ItemStack stack) implements SlotDisplay {
		...
		public static final MapCodec<SlotDisplay.StackSlotDisplay> CODEC = RecordCodecBuilder.mapCodec(
				instance -> instance
						.group(ItemStack.VALIDATED_CODEC.fieldOf("item").forGetter(SlotDisplay.StackSlotDisplay::stack))
		...
		public static final SlotDisplay.Serializer<SlotDisplay.StackSlotDisplay>
				SERIALIZER =
				new SlotDisplay.Serializer<>(CODEC, PACKET_CODEC);
		...
		public <T> Stream<T> appendStacks(ContextParameterMap parameters, DisplayedItemFactory<T> factory) {
			return factory instanceof DisplayedItemFactory.FromStack<T> fromStack
			       ? Stream.of(fromStack.toDisplayed(this.stack)) : Stream.empty();
		}

		@Override
		public boolean equals(Object o) {
			return this == o || o instanceof SlotDisplay.StackSlotDisplay stackSlotDisplay && ItemStack.areEqual(
					this.stack,
					stackSlotDisplay.stack
			);
		}
	...
	public record TagSlotDisplay(TagKey<Item> tag) implements SlotDisplay {
		...
		public static final MapCodec<SlotDisplay.TagSlotDisplay> CODEC = RecordCodecBuilder.mapCodec(
				instance -> instance
						.group(TagKey
								.unprefixedCodec(RegistryKeys.ITEM)
								.fieldOf("tag")
								.forGetter(SlotDisplay.TagSlotDisplay::tag))
		...
		public static final SlotDisplay.Serializer<SlotDisplay.TagSlotDisplay>
				SERIALIZER =
				new SlotDisplay.Serializer<>(CODEC, PACKET_CODEC);
	...
	public record WithRemainderSlotDisplay(SlotDisplay input, SlotDisplay remainder) implements SlotDisplay {
		...
		public static final MapCodec<SlotDisplay.WithRemainderSlotDisplay> CODEC = RecordCodecBuilder.mapCodec(
				instance -> instance.group(
						                    ...
						                    SlotDisplay.CODEC
								                    .fieldOf("remainder")
								                    .forGetter(SlotDisplay.WithRemainderSlotDisplay::remainder)
				                    )
				                    .apply(instance, SlotDisplay.WithRemainderSlotDisplay::new)
		);
		public static final PacketCodec<RegistryByteBuf, SlotDisplay.WithRemainderSlotDisplay>
				PACKET_CODEC =
				PacketCodec.tuple(
						SlotDisplay.PACKET_CODEC,
		...
		public static final SlotDisplay.Serializer<SlotDisplay.WithRemainderSlotDisplay>
				SERIALIZER =
				new SlotDisplay.Serializer<>(CODEC, PACKET_CODEC);
		...
		public <T> Stream<T> appendStacks(ContextParameterMap parameters, DisplayedItemFactory<T> factory) {
			if (factory instanceof DisplayedItemFactory.FromRemainder<T> fromRemainder) {
				...
				return this.input
						.appendStacks(parameters, factory)
						.map(input -> fromRemainder.toDisplayed((T) input, list));
			}
			else {
