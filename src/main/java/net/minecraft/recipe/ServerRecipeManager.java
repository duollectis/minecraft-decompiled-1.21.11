...
public class ServerRecipeManager extends SinglePreparationResourceReloader<PreparedRecipes> implements RecipeManager, FabricServerRecipeManager {
   ...
   private static final Map<RegistryKey<RecipePropertySet>, ServerRecipeManager.SoleIngredientGetter> SOLE_INGREDIENT_GETTERS = Map.of(
      ...
      recipe -> recipe instanceof SmithingRecipe smithingRecipe ? Optional.of(smithingRecipe.base()) : Optional.empty(),
                  ...
                  if (recipe2 instanceof StonecuttingRecipe stonecuttingRecipe
                     ...
                     list.add(
                        new CuttingRecipeDisplay.GroupEntry<>(
                           ...
                           new CuttingRecipeDisplay<>(stonecuttingRecipe.createResultDisplay(), Optional.of((RecipeEntry<StonecuttingRecipe>)recipe))
                        )
                     );
                  }
               }
