...
public class ChunkPos {
   ...
   public boolean method_76802() {
      return method_76803(this.x, this.z);
   }

   public static boolean method_76803(int i, int j) {
      return MathHelper.method_76800(i, j) <= MAX_COORDINATE;
   }
   ...
   public int getChebyshevDistance(int x, int z) {
      return MathHelper.method_76801(x, z, this.x, this.z);
   }
