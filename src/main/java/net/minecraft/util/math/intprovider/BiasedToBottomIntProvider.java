...
/**
 * {@code BiasedToBottomIntProvider}.
 */
public class BiasedToBottomIntProvider extends IntProvider {

	public static final MapCodec<BiasedToBottomIntProvider>
			CODEC =
			RecordCodecBuilder.<BiasedToBottomIntProvider>mapCodec(
			                  ...
			                  .validate(
					                  (BiasedToBottomIntProvider provider) -> provider.max < provider.min
					                                                          ? DataResult.error(() ->
