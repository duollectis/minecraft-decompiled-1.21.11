...
public final class RandomSeed {
	...
	public static RandomSeed.XoroshiroSeed createXoroshiroSeed(String seed) {
		byte[] bs = MD5_HASH.hashString(seed, StandardCharsets.UTF_8).asBytes();
	...
	public static long getSeed() {
		return SEED_UNIQUIFIER.updateAndGet(seedUniquifier -> seedUniquifier * 1181783497276652981L)
				^ System.nanoTime();
	}
	...
	public record XoroshiroSeed(long seedLo, long seedHi) {
		...
		public RandomSeed.XoroshiroSeed mix() {
			return new RandomSeed.XoroshiroSeed(
					RandomSeed.mixStafford13(this.seedLo),
					RandomSeed.mixStafford13(this.seedHi)
			);
		}
	}
}
