...
/**
 * Иммутабельная позиция блока в трёхмерном пространстве (x, y, z).
 * Предоставляет утилиты для итерации, смещения, сериализации и работы
 * с упакованными long-координатами. Для изменяемой версии используй {@link Mutable}.
 */
@Unmodifiable
public class BlockPos extends Vec3i {
	...
	/** Результат обхода позиций: принять, пропустить или остановить итерацию. */
	...
	/** Изменяемая версия {@link BlockPos} для временных вычислений без лишних аллокаций. */
