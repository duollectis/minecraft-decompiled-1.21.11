...
/**
 * Бинарная булева функция, принимающая два {@code boolean} аргумента и возвращающая {@code boolean}.
 * Содержит все 16 возможных булевых операций над двумя переменными в виде готовых констант.
 */
