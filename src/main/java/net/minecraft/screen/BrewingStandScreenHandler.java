...
/**
 * {@code BrewingStandScreenHandler}.
 */
public class BrewingStandScreenHandler extends ScreenHandler {
	...
	private static final int FIRST_POTION_SLOT_ID = 0;
	private static final int LAST_POTION_SLOT_ID = 2;
	...
	public BrewingStandScreenHandler(
		...
		BrewingRecipeRegistry
				brewingRecipeRegistry =
				playerInventory.player.getEntityWorld().getBrewingRecipeRegistry();
		...
		this.ingredientSlot =
				this.addSlot(new BrewingStandScreenHandler.IngredientSlot(brewingRecipeRegistry, inventory, 3, 79, 17));
