         ...
         registries -> {
            ...
            if (optional.isPresent() || optional2.isPresent()) {
               BuiltinRegistries.validate(
                  (RegistryEntryLookup<PlacedFeature>)DataFixUtils.orElseGet(optional2, () -> registries.getOrThrow(RegistryKeys.PLACED_FEATURE)),
                  (RegistryWrapper<Biome>)DataFixUtils.orElseGet(optional, () -> registries.getOrThrow(RegistryKeys.BIOME))
               );
            }
