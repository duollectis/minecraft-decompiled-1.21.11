...
public class BiomeTags {
	...
	public static final TagKey<Biome>
			...
			of("allows_tropical_fish_spawns_at_any_height");
	public static final TagKey<Biome>
			POLAR_BEARS_SPAWN_ON_ALTERNATE_BLOCKS =
			of("polar_bears_spawn_on_alternate_blocks");
	...
	public static final TagKey<Biome> SPAWNS_CORAL_VARIANT_ZOMBIE_NAUTILUS = of("spawns_coral_variant_zombie_nautilus");
