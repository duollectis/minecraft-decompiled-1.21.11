...
public final class BlockTags {
   ...
   public static final TagKey<Block> WOODEN_SHELVES = of("wooden_shelves");
   ...
   public static final TagKey<Block> COPPER_CHESTS = of("copper_chests");
   public static final TagKey<Block> LIGHTNING_RODS = of("lightning_rods");
   public static final TagKey<Block> COPPER = of("copper");
   public static final TagKey<Block> CHAINS = of("chains");
   public static final TagKey<Block> COPPER_GOLEM_STATUES = of("copper_golem_statues");
   public static final TagKey<Block> LANTERNS = of("lanterns");
   public static final TagKey<Block> BARS = of("bars");
   ...
   public static final TagKey<Block> CAN_GLIDE_THROUGH = of("can_glide_through");
   ...
   public static final TagKey<Block> HAPPY_GHAST_AVOIDS = of("happy_ghast_avoids");
   ...
   public static final TagKey<Block> TRIGGERS_AMBIENT_DESERT_SAND_BLOCK_SOUNDS = of("triggers_ambient_desert_sand_block_sounds");
   public static final TagKey<Block> TRIGGERS_AMBIENT_DESERT_DRY_VEGETATION_BLOCK_SOUNDS = of("triggers_ambient_desert_dry_vegetation_block_sounds");
   public static final TagKey<Block> TRIGGERS_AMBIENT_DRIED_GHAST_BLOCK_SOUNDS = of("triggers_ambient_dried_ghast_block_sounds");
