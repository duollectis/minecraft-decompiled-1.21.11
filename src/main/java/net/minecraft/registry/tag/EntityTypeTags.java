...
public interface EntityTypeTags {
	...
	TagKey<EntityType<?>> BURN_IN_DAYLIGHT = of("burn_in_daylight");
	...
	TagKey<EntityType<?>> CAN_EQUIP_HARNESS = of("can_equip_harness");

	TagKey<EntityType<?>> CAN_WEAR_HORSE_ARMOR = of("can_wear_horse_armor");

	TagKey<EntityType<?>> CAN_WEAR_NAUTILUS_ARMOR = of("can_wear_nautilus_armor");

	TagKey<EntityType<?>> FOLLOWABLE_FRIENDLY_MOBS = of("followable_friendly_mobs");

	TagKey<EntityType<?>> CANNOT_BE_PUSHED_ONTO_BOATS = of("cannot_be_pushed_onto_boats");

	TagKey<EntityType<?>> ACCEPTS_IRON_GOLEM_GIFT = of("accepts_iron_golem_gift");

	TagKey<EntityType<?>> CANDIDATE_FOR_IRON_GOLEM_GIFT = of("candidate_for_iron_golem_gift");

	TagKey<EntityType<?>> NAUTILUS_HOSTILES = of("nautilus_hostiles");

	TagKey<EntityType<?>> CAN_FLOAT_WHILE_RIDDEN = of("can_float_while_ridden");
