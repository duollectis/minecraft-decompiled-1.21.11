...
/**
 * Реестр тегов предметов ванильного Minecraft.
 * <p>
 * Теги группируют предметы по функциональным категориям: материалы, инструменты,
 * броня, еда для мобов, зачаровываемые предметы и т.д. Это позволяет рецептам,
 * поведению мобов и игровой логике работать с группами предметов без жёсткой
...
public final class ItemTags {
	...
	public static final TagKey<Item> ZOMBIE_HORSE_FOOD = of("zombie_horse_food");
	...
	public static final TagKey<Item> CAMEL_HUSK_FOOD = of("camel_husk_food");
	...
	public static final TagKey<Item> NAUTILUS_BUCKET_FOOD = of("nautilus_bucket_food");
	public static final TagKey<Item> NAUTILUS_FOOD = of("nautilus_food");
	public static final TagKey<Item> NAUTILUS_TAMING_ITEMS = of("nautilus_taming_items");
	...
	public static final TagKey<Item> MELEE_WEAPON_ENCHANTABLE = of("enchantable/melee_weapon");
	public static final TagKey<Item> SWEEPING_ENCHANTABLE = of("enchantable/sweeping");
	...
	public static final TagKey<Item> LUNGE_ENCHANTABLE = of("enchantable/lunge");
