...
public class Registries {
   ...
   public static final Registry<GameRule<?>> GAME_RULE = create(RegistryKeys.GAME_RULE, GameRules::registerAndGetDefault);
   ...
   public static final Registry<MapCodec<? extends Permission>> PERMISSION_TYPE = create(RegistryKeys.PERMISSION_TYPE, Permissions::registerAndGetDefault);
   ...
   public static final Registry<MapCodec<? extends SlotSource>> SLOT_SOURCE_TYPE = create(RegistryKeys.SLOT_SOURCE_TYPE, SlotSources::registerAndGetDefault);
