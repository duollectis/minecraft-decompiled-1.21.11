...
public class Stats {
	...
	public static final Identifier
			...
			register("walk_under_water_one_cm", StatFormatter.DISTANCE);
	...
	public static final Identifier
			...
			register("damage_dealt_absorbed", StatFormatter.DIVIDE_BY_TEN);
	public static final Identifier
			DAMAGE_DEALT_RESISTED =
			register("damage_dealt_resisted", StatFormatter.DIVIDE_BY_TEN);
	public static final Identifier DAMAGE_TAKEN = register("damage_taken", StatFormatter.DIVIDE_BY_TEN);
	public static final Identifier
			DAMAGE_BLOCKED_BY_SHIELD =
			register("damage_blocked_by_shield", StatFormatter.DIVIDE_BY_TEN);
	...
	public static final Identifier
			...
			register("interact_with_brewingstand", StatFormatter.DEFAULT);
	...
	public static final Identifier
			...
			register("interact_with_crafting_table", StatFormatter.DEFAULT);
	...
	public static final Identifier
			...
			register("interact_with_blast_furnace", StatFormatter.DEFAULT);
	...
	public static final Identifier
			...
			register("interact_with_cartography_table", StatFormatter.DEFAULT);
	public static final Identifier INTERACT_WITH_LOOM = register("interact_with_loom", StatFormatter.DEFAULT);
	public static final Identifier
			INTERACT_WITH_STONECUTTER =
			register("interact_with_stonecutter", StatFormatter.DEFAULT);
	...
	public static final Identifier
			...
			register("interact_with_grindstone", StatFormatter.DEFAULT);
	public static final Identifier TARGET_HIT = register("target_hit", StatFormatter.DEFAULT);
	public static final Identifier
			INTERACT_WITH_SMITHING_TABLE =
			register("interact_with_smithing_table", StatFormatter.DEFAULT);
