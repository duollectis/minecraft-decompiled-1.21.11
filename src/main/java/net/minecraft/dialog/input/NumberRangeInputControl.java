...
/**
 * {@code NumberRangeInputControl}.
 */
public record NumberRangeInputControl(
		int width,
		Text label,
		String labelFormat,
		NumberRangeInputControl.RangeInfo rangeInfo
	...
	public static final MapCodec<NumberRangeInputControl> CODEC = RecordCodecBuilder.<NumberRangeInputControl>mapCodec(
			instance -> instance.group(
					                    ...
					                    Codec.STRING
							                    .optionalFieldOf("label_format", "options.generic_value")
							                    .forGetter(NumberRangeInputControl::labelFormat),
	...
	public record RangeInfo(float start, float end, Optional<Float> initial, Optional<Float> step) {
		...
		public static final MapCodec<NumberRangeInputControl.RangeInfo>
				CODEC =
				RecordCodecBuilder.<NumberRangeInputControl.RangeInfo>mapCodec(
						                  instance -> instance.group(
								                                      ...
								                                      Codec.FLOAT
										                                      .optionalFieldOf("initial")
										                                      .forGetter(NumberRangeInputControl.RangeInfo::initial),
								                                      Codecs.POSITIVE_FLOAT
										                                      .optionalFieldOf("step")
										                                      .forGetter(NumberRangeInputControl.RangeInfo::step)
						                                      )
				                  ...
				                  .validate(rangeInfo -> {
					                  if (rangeInfo.initial.isPresent()) {
						                  ...
						                  if (d < e || d > f) {
							                  return DataResult.error(() -> "Initial value " + d
									                  + " is outside of range [" + e + ", " + f + "]");
						                  }
					                  }
