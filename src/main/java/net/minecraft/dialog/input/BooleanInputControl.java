...
/**
 * Элемент управления вводом булевого значения (переключатель).
 *
 * @param label   текст метки переключателя
 * @param initial начальное состояние переключателя
 * @param onTrue  строковое значение, передаваемое при состоянии {@code true}
 * @param onFalse строковое значение, передаваемое при состоянии {@code false}
 */
