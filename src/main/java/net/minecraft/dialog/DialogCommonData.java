...
public record DialogCommonData(
	...
	public static final MapCodec<DialogCommonData> CODEC = RecordCodecBuilder.<DialogCommonData>mapCodec(
			                                                                         instance -> instance.group(
					                                                                                             ...
					                                                                                             Codec.BOOL
							                                                                                             .optionalFieldOf("can_close_with_escape", true)
							                                                                                             .forGetter(DialogCommonData::canCloseWithEscape),
					                                                                                             Codec.BOOL.optionalFieldOf("pause", true).forGetter(DialogCommonData::pause),
					                                                                                             AfterAction.CODEC
							                                                                                             .optionalFieldOf("after_action", AfterAction.CLOSE)
							                                                                                             .forGetter(DialogCommonData::afterAction),
