...
public class SharedConstants {
	...
	public static final boolean
			...
			debugProperty("SHOW_LOCAL_SERVER_ENTITY_HIT_BOXES");
	...
	public static final boolean
			...
			debugProperty("EXPERIMENTAL_REDSTONEWIRE_UPDATE_ORDER");
	...
	public static final boolean
			...
			debugProperty("KEEP_JIGSAW_BLOCKS_DURING_STRUCTURE_GEN");
	...
	public static final boolean
			...
			debugProperty("TRIAL_SPAWNER_DETECTS_SHEEP_AS_PLAYERS");
	...
	public static final boolean
			...
			debugProperty("JFR_PROFILING_ENABLE_LEVEL_LOADING");
	...
	public static final boolean
			...
			debugProperty("DISABLE_BELOW_ZERO_RETROGENERATION");
