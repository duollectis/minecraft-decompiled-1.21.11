...
public abstract class PlayerEntity extends PlayerLikeEntity implements ContainerUser {
   ...
   public void travel(Vec3d movementInput) {
      if (this.hasVehicle()) {
         ...
         if (this.isSwimming()) {
            ...
            if (d <= 0.0
               || this.jumping
               || !this.getEntityWorld().getFluidState(BlockPos.ofFloored(this.getX(), this.getY() + 1.0 - 0.1, this.getZ())).isEmpty()) {
   ...
   public void addExperienceLevels(int levels) {
      ...
      if (levels > 0 && this.experienceLevel % 5 == 0 && this.lastPlayedLevelUpSoundTime < this.age - 100.0F) {
         ...
         this.getEntityWorld()
            .playSound(null, this.getX(), this.getY(), this.getZ(), SoundEvents.ENTITY_PLAYER_LEVELUP, this.getSoundCategory(), f * 0.75F, 1.0F);
