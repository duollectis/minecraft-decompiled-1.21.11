...
public class PhaseType<T extends Phase> {
	...
	public static final PhaseType<HoldingPatternPhase>
			HOLDING_PATTERN =
			register(HoldingPatternPhase.class, "HoldingPattern");
	...
	public static final PhaseType<LandingApproachPhase>
			LANDING_APPROACH =
			register(LandingApproachPhase.class, "LandingApproach");
	...
	public static final PhaseType<SittingFlamingPhase>
			SITTING_FLAMING =
			register(SittingFlamingPhase.class, "SittingFlaming");
	public static final PhaseType<SittingScanningPhase>
			SITTING_SCANNING =
			register(SittingScanningPhase.class, "SittingScanning");
	public static final PhaseType<SittingAttackingPhase>
			SITTING_ATTACKING =
			register(SittingAttackingPhase.class, "SittingAttacking");
	public static final PhaseType<ChargingPlayerPhase>
			CHARGING_PLAYER =
			register(ChargingPlayerPhase.class, "ChargingPlayer");
