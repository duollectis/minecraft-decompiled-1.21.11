         ...
         if (bl || bl2) {
            ...
            if (j < list.size()) {
               ...
               if (bl) {
                  ...
                  world.createExplosion(null, spike.getCenterX() + 0.5F, spike.getHeight(), spike.getCenterZ() + 0.5F, 5.0F, World.ExplosionSourceType.BLOCK);
         ...
         if (tick >= 100) {
            ...
            for (EndCrystalEntity endCrystalEntity : crystals) {
               ...
               world.createExplosion(
                  endCrystalEntity, endCrystalEntity.getX(), endCrystalEntity.getY(), endCrystalEntity.getZ(), 6.0F, World.ExplosionSourceType.NONE
               );
