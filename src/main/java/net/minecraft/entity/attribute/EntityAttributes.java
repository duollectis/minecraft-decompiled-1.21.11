...
public class EntityAttributes {
	...
	public static final RegistryEntry<EntityAttribute> BLOCK_BREAK_SPEED = register(
			"block_break_speed",
			new ClampedEntityAttribute("attribute.name.block_break_speed", 1.0, 0.0, 1024.0).setTracked(true)
	);
	public static final RegistryEntry<EntityAttribute> BLOCK_INTERACTION_RANGE = register(
			"block_interaction_range",
			new ClampedEntityAttribute("attribute.name.block_interaction_range", 4.5, 0.0, 64.0).setTracked(true)
	);
	public static final RegistryEntry<EntityAttribute> BURNING_TIME = register(
			"burning_time",
			new ClampedEntityAttribute("attribute.name.burning_time", 1.0, 0.0, 1024.0)
					.setTracked(true)
					.setCategory(EntityAttribute.Category.NEGATIVE)
	);
	public static final RegistryEntry<EntityAttribute> CAMERA_DISTANCE = register(
			"camera_distance",
			new ClampedEntityAttribute("attribute.name.camera_distance", 4.0, 0.0, 32.0).setTracked(true)
	);
	public static final RegistryEntry<EntityAttribute> EXPLOSION_KNOCKBACK_RESISTANCE = register(
			"explosion_knockback_resistance",
			new ClampedEntityAttribute("attribute.name.explosion_knockback_resistance", 0.0, 0.0, 1.0).setTracked(true)
	);
	public static final RegistryEntry<EntityAttribute> ENTITY_INTERACTION_RANGE = register(
			"entity_interaction_range",
			new ClampedEntityAttribute("attribute.name.entity_interaction_range", 3.0, 0.0, 64.0).setTracked(true)
	);
	public static final RegistryEntry<EntityAttribute> FALL_DAMAGE_MULTIPLIER = register(
			"fall_damage_multiplier",
			new ClampedEntityAttribute("attribute.name.fall_damage_multiplier", 1.0, 0.0, 100.0)
					.setTracked(true)
					.setCategory(EntityAttribute.Category.NEGATIVE)
	);
	...
	public static final RegistryEntry<EntityAttribute> GRAVITY = register(
			"gravity",
			new ClampedEntityAttribute("attribute.name.gravity", 0.08, -1.0, 1.0)
					.setTracked(true)
	...
	public static final RegistryEntry<EntityAttribute> MINING_EFFICIENCY = register(
			"mining_efficiency",
			new ClampedEntityAttribute("attribute.name.mining_efficiency", 0.0, 0.0, 1024.0).setTracked(true)
	);
	public static final RegistryEntry<EntityAttribute> MOVEMENT_EFFICIENCY = register(
			"movement_efficiency",
			new ClampedEntityAttribute("attribute.name.movement_efficiency", 0.0, 0.0, 1.0).setTracked(true)
	);
	...
	public static final RegistryEntry<EntityAttribute> SAFE_FALL_DISTANCE = register(
			"safe_fall_distance",
			new ClampedEntityAttribute("attribute.name.safe_fall_distance", 3.0, -1024.0, 1024.0).setTracked(true)
	);
	public static final RegistryEntry<EntityAttribute> SCALE = register(
			"scale",
			new ClampedEntityAttribute("attribute.name.scale", 1.0, 0.0625, 16.0)
					.setTracked(true)
					.setCategory(EntityAttribute.Category.NEUTRAL)
	);
	...
	public static final RegistryEntry<EntityAttribute> SUBMERGED_MINING_SPEED = register(
			...
			new ClampedEntityAttribute("attribute.name.submerged_mining_speed", 0.2, 0.0, 20.0).setTracked(true)
	);
	...
	public static final RegistryEntry<EntityAttribute> WATER_MOVEMENT_EFFICIENCY = register(
			...
			new ClampedEntityAttribute("attribute.name.water_movement_efficiency", 0.0, 0.0, 1.0).setTracked(true)
	);
