...
public class EntityAttributes {
   ...
   public static final RegistryEntry<EntityAttribute> CAMERA_DISTANCE = register(
      "camera_distance", new ClampedEntityAttribute("attribute.name.camera_distance", 4.0, 0.0, 32.0).setTracked(true)
   );
   ...
   public static final RegistryEntry<EntityAttribute> WAYPOINT_TRANSMIT_RANGE = register(
      ...
      new ClampedEntityAttribute("attribute.name.waypoint_transmit_range", 0.0, 0.0, 6.0E7).setCategory(EntityAttribute.Category.NEUTRAL)
   );
   public static final RegistryEntry<EntityAttribute> WAYPOINT_RECEIVE_RANGE = register(
      "waypoint_receive_range",
      new ClampedEntityAttribute("attribute.name.waypoint_receive_range", 0.0, 0.0, 6.0E7).setCategory(EntityAttribute.Category.NEUTRAL)
   );
