...
public class TrackedDataHandlerRegistry {
   ...
   public static final TrackedDataHandler<Optional<LazyEntityReference<LivingEntity>>> LAZY_ENTITY_REFERENCE = TrackedDataHandler.create(
      ((PacketCodec<ByteBuf, LazyEntityReference<LivingEntity>>)(PacketCodec<ByteBuf, ?>)LazyEntityReference.createPacketCodec()).collect(PacketCodecs::optional)
   );
   ...
   public static final TrackedDataHandler<RegistryEntry<ZombieNautilusVariant>> ZOMBIE_NAUTILUS_VARIANT = TrackedDataHandler.create(
