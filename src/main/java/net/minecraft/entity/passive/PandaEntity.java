...
public class PandaEntity extends AnimalEntity {
   ...
   protected void readCustomData(ReadView view) {
      ...
      this.setMainGene(view.<PandaEntity.Gene>read("MainGene", PandaEntity.Gene.CODEC).orElse(PandaEntity.Gene.NORMAL));
      this.setHiddenGene(view.<PandaEntity.Gene>read("HiddenGene", PandaEntity.Gene.CODEC).orElse(PandaEntity.Gene.NORMAL));
   }
