         ...
         ImmutableList.<Task<? super ArmadilloEntity>>of(
            ...
            new MoveToTargetTask() {
               ...
               protected boolean shouldRun(ServerWorld serverWorld, MobEntity mobEntity) {
                  return mobEntity instanceof ArmadilloEntity armadilloEntity && armadilloEntity.isNotIdle()
                     ? false
            ...
            Pair.of(
               ...
               new RandomTask(
                  ImmutableList.of(
                     ...
                     Pair.of(WalkTowardsEntityTask.createNearestVisibleAdult(WALK_TOWARDS_CLOSEST_ADULT_RANGE, 1.25F), 1)
                  )
               )
            ),
