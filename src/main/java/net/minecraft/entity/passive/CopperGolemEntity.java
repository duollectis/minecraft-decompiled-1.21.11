...
public class CopperGolemEntity extends GolemEntity implements ContainerUser, Shearable {
   ...
   public void readCustomData(ReadView view) {
      ...
      this.setOxidationLevel(
         view.<Oxidizable.OxidationLevel>read("weather_state", Oxidizable.OxidationLevel.CODEC).orElse(Oxidizable.OxidationLevel.UNAFFECTED)
      );
   }
      ...
      world.setBlockState(
         ...
         Blocks.OXIDIZED_COPPER_GOLEM_STATUE
            ...
            .with(
               ...
               CopperGolemStatueBlock.Pose.values()[this.random.nextBetweenExclusive(0, CopperGolemStatueBlock.Pose.values().length)]
            )
