...
public class CopperGolemEntity extends GolemEntity implements ContainerUser, Shearable {
	...
	private static final long OXIDATION_AGE_UNSET = -2L;
	private static final long OXIDATION_AGE_PAUSED = -1L;
	private static final int MIN_OXIDATION_AGE_TICKS = 504000;
	private static final int MAX_OXIDATION_AGE_TICKS = 552000;
	private static final int TRANSPORT_COOLDOWN_MIN = 200;
	private static final int TRANSPORT_COOLDOWN_MAX = 240;
	private static final float NAVIGATION_FOLLOW_RANGE = 10.0F;
	private static final float OXIDATION_CHANCE_PER_TICK = 0.0058F;
	private static final int SPIN_HEAD_COOLDOWN_MIN = 60;
	private static final int SPIN_HEAD_COOLDOWN_MAX = 100;
	...
	public void readCustomData(ReadView view) {
		...
		this.setOxidationLevel(
				view
						.<Oxidizable.OxidationLevel>read("weather_state", Oxidizable.OxidationLevel.CODEC)
		...
		world.setBlockState(
				...
				Blocks.OXIDIZED_COPPER_GOLEM_STATUE
						...
						.with(
								...
								CopperGolemStatueBlock.Pose.values()[this.random.nextBetweenExclusive(
										0,
										CopperGolemStatueBlock.Pose.values().length
								)]
						)
