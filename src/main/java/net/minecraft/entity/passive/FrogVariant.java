...
public record FrogVariant(AssetInfo.TextureAssetInfo assetInfo, SpawnConditionSelectors spawnConditions)
	...
	public static final Codec<FrogVariant> NETWORK_CODEC = RecordCodecBuilder.create(
			instance -> instance
					.group(AssetInfo.TextureAssetInfo.MAP_CODEC.forGetter(FrogVariant::assetInfo))
					.apply(instance, FrogVariant::new)
	);
	public static final Codec<RegistryEntry<FrogVariant>>
			ENTRY_CODEC =
			RegistryFixedCodec.of(RegistryKeys.FROG_VARIANT);
	public static final PacketCodec<RegistryByteBuf, RegistryEntry<FrogVariant>>
			PACKET_CODEC =
