...
public class AxolotlEntity extends AnimalEntity implements Bucketable {
   ...
   protected static final ImmutableList<? extends MemoryModuleType<?>> MEMORY_MODULES = ImmutableList.<MemoryModuleType<?>>of(
   ...
   protected void readCustomData(ReadView view) {
      ...
      this.setVariant(view.<AxolotlEntity.Variant>read("Variant", AxolotlEntity.Variant.INDEX_CODEC).orElse(AxolotlEntity.Variant.DEFAULT));
