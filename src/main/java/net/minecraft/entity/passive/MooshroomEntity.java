...
public class MooshroomEntity extends AbstractCowEntity implements Shearable {
   ...
   protected void readCustomData(ReadView view) {
      ...
      this.setVariant(view.<MooshroomEntity.Variant>read("Type", MooshroomEntity.Variant.CODEC).orElse(MooshroomEntity.Variant.DEFAULT));
      this.stewEffects = view.<SuspiciousStewEffectsComponent>read("stew_effects", SuspiciousStewEffectsComponent.CODEC).orElse(null);
   }
