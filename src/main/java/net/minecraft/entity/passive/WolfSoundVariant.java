...
public record WolfSoundVariant(
	...
	public static final Codec<RegistryEntry<WolfSoundVariant>>
			ENTRY_CODEC =
			RegistryFixedCodec.of(RegistryKeys.WOLF_SOUND_VARIANT);
	public static final PacketCodec<RegistryByteBuf, RegistryEntry<WolfSoundVariant>>
			PACKET_CODEC =
			PacketCodecs.registryEntry(RegistryKeys.WOLF_SOUND_VARIANT);
