...
public class WolfEntity extends TameableEntity implements Angerable {
   ...
   protected void initDataTracker(DataTracker.Builder builder) {
      ...
      builder.add(SOUND_VARIANT, registry.getOptional(WolfSoundVariants.CLASSIC).or(registry::getDefaultEntry).orElseThrow());
   ...
   protected void writeCustomData(WriteView view) {
      ...
      this.getSoundVariant()
         .getKey()
         .ifPresent(soundVariant -> view.put("sound_variant", RegistryKey.createCodec(RegistryKeys.WOLF_SOUND_VARIANT), soundVariant));
   }
   ...
   protected void readCustomData(ReadView view) {
      ...
      view.<RegistryKey<WolfSoundVariant>>read("sound_variant", RegistryKey.createCodec(RegistryKeys.WOLF_SOUND_VARIANT))
         .flatMap(
