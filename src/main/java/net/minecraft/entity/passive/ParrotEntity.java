...
public class ParrotEntity extends TameableShoulderEntity implements Flutterer {
   ...
   protected void readCustomData(ReadView view) {
      ...
      this.setVariant(view.<ParrotEntity.Variant>read("Variant", ParrotEntity.Variant.INDEX_CODEC).orElse(ParrotEntity.Variant.DEFAULT));
   }
      ...
      private @Nullable Vec3d locateTree() {
         ...
         for (BlockPos blockPos2 : BlockPos.iterate(
            ...
            if (!blockPos.equals(blockPos2)) {
               BlockState blockState = this.mob.getEntityWorld().getBlockState(mutable2.set(blockPos2, Direction.DOWN));
               boolean bl = blockState.getBlock() instanceof LeavesBlock || blockState.isIn(BlockTags.LOGS);
               if (bl && this.mob.getEntityWorld().isAir(blockPos2) && this.mob.getEntityWorld().isAir(mutable.set(blockPos2, Direction.UP))) {
