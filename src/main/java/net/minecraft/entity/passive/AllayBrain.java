...
public class AllayBrain {
	...
	private static final float FLY_SPEED = 2.25F;
	private static final float WALK_TO_ITEM_SPEED = 1.75F;
	private static final float FLEE_SPEED = 2.5F;
	private static final int MIN_WAIT_TICKS = 4;
	private static final int MAX_WAIT_TICKS = 16;
	private static final int TASK_COOLDOWN_TICKS = 6;
	private static final int ITEM_PICKUP_COOLDOWN_TICKS = 30;
	private static final int LIKED_NOTEBLOCK_COOLDOWN_TICKS = 60;
