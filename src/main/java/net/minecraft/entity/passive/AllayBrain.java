   ...
   private static void addIdleActivities(Brain<AllayEntity> brain) {
      brain.setTaskList(
         ...
         ImmutableList.of(
            ...
            Pair.of(1, new GiveInventoryToLookTargetTask(allay -> AllayBrain.getLookTarget((AllayEntity) allay), 2.25F, 20)),
            Pair.of(2, WalkTowardsLookTargetTask.create(allay -> AllayBrain.getLookTarget((AllayEntity) allay), AllayBrain::hasNearestVisibleWantedItem, 4, 16, 2.25F)),
