...
public class ZombieNautilusBrain {
   ...
   private static void addCoreActivities(Brain<ZombieNautilusEntity> brain) {
      brain.setTaskList(
         Activity.CORE,
         0,
         ImmutableList.<Task<? super ZombieNautilusEntity>>of(
   ...
   private static void addIdleActivities(Brain<ZombieNautilusEntity> brain) {
      brain.setTaskList(
         ...
         ImmutableList.of(
            ...
            Pair.of(2, UpdateAttackTargetTask.<ZombieNautilusEntity>create((world, nautilus) -> NautilusBrain.findAttackTarget(world, nautilus))),
            Pair.of(
               3,
               new CompositeTask(
   ...
   private static void addFightActivities(Brain<ZombieNautilusEntity> brain) {
      brain.setTaskList(
         Activity.FIGHT,
         ImmutableList.of(
            Pair.of(0, new DashAttackTask(80, NautilusBrain.FIGHT_TARGET_PREDICATE, 0.5F, 2.0F, 12.0, 11.0, SoundEvents.ENTITY_ZOMBIE_NAUTILUS_DASH))
         ),
         ImmutableSet.of(
