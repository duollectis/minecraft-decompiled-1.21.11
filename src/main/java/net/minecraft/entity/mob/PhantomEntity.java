...
public class PhantomEntity extends MobEntity implements Monster {
   ...
   public void tick() {
      ...
      if (this.getEntityWorld().isClient()) {
         ...
         this.getEntityWorld().addParticleClient(ParticleTypes.MYCELIUM, this.getX() + i, this.getY() + k, this.getZ() + j, 0.0, 0.0, 0.0);
         this.getEntityWorld().addParticleClient(ParticleTypes.MYCELIUM, this.getX() - i, this.getY() + k, this.getZ() - j, 0.0, 0.0, 0.0);
      }
   }
   ...
   class FindTargetGoal extends Goal {
      ...
      public boolean shouldContinue() {
         ...
         return livingEntity != null
            ? PhantomEntity.this.testTargetPredicate(castToServerWorld(PhantomEntity.this.getEntityWorld()), livingEntity, TargetPredicate.DEFAULT)
            : false;
      }
   }
         ...
         if (PhantomEntity.this.circlingCenter != null) {
            ...
            if (PhantomEntity.this.circlingCenter.getY() < PhantomEntity.this.getEntityWorld().getSeaLevel()) {
               PhantomEntity.this.circlingCenter = new BlockPos(
                  PhantomEntity.this.circlingCenter.getX(), PhantomEntity.this.getEntityWorld().getSeaLevel() + 1, PhantomEntity.this.circlingCenter.getZ()
               );
            }
         }
      }
