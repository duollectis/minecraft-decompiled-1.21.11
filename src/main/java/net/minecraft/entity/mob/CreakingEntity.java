   ...
   public boolean damage(ServerWorld world, DamageSource source, float amount) {
      ...
      if (blockPos == null || source.isIn(DamageTypeTags.BYPASSES_INVULNERABILITY)) {
         ...
         if (!(entity instanceof LivingEntity) && !(entity instanceof ProjectileEntity) && playerEntity == null) {
            ...
            if (this.getEntityWorld().getBlockEntity(blockPos) instanceof CreakingHeartBlockEntity creakingHeartBlockEntity
      ...
      if (this.getEntityWorld() instanceof ServerWorld serverWorld) {
         ...
         serverWorld.spawnParticles(
            new BlockStateParticleEffect(
               ParticleTypes.BLOCK_CRUMBLE, Blocks.CREAKING_HEART.getDefaultState().with(CreakingHeartBlock.ACTIVE, CreakingHeartState.AWAKE)
            ),
            vec3d.x,
            vec3d.y,
            vec3d.z,
