      ...
      private void conjureFangs(double x, double z, double maxY, double y, float yaw, int warmup) {
         ...
         do {
            ...
            if (blockState.isSideSolidFullSquare(EvokerEntity.this.getEntityWorld(), blockPos2, Direction.UP)) {
               if (!EvokerEntity.this.getEntityWorld().isAir(blockPos)) {
                  ...
                  VoxelShape voxelShape = blockState2.getCollisionShape(EvokerEntity.this.getEntityWorld(), blockPos);
         ...
         if (bl) {
            EvokerEntity.this.getEntityWorld()
               .spawnEntity(new EvokerFangsEntity(EvokerEntity.this.getEntityWorld(), x, blockPos.getY() + d, z, yaw, warmup, EvokerEntity.this));
            EvokerEntity.this.getEntityWorld()
               .emitGameEvent(GameEvent.ENTITY_PLACE, new Vec3d(x, blockPos.getY() + d, z), GameEvent.Emitter.of(EvokerEntity.this));
         }
      }
