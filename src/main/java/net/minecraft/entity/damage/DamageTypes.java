...
public interface DamageTypes {
	...
	RegistryKey<DamageType>
			LIGHTNING_BOLT =
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("lightning_bolt"));
	...
	RegistryKey<DamageType>
			FLY_INTO_WALL =
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("fly_into_wall"));

	RegistryKey<DamageType>
			OUT_OF_WORLD =
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("out_of_world"));
	...
	RegistryKey<DamageType>
			SWEET_BERRY_BUSH =
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("sweet_berry_bush"));
	...
	RegistryKey<DamageType>
			FALLING_BLOCK =
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("falling_block"));

	RegistryKey<DamageType>
			FALLING_ANVIL =
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("falling_anvil"));

	RegistryKey<DamageType>
			FALLING_STALACTITE =
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("falling_stalactite"));
	...
	RegistryKey<DamageType>
			MOB_ATTACK_NO_AGGRO =
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("mob_attack_no_aggro"));

	RegistryKey<DamageType>
			PLAYER_ATTACK =
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("player_attack"));

	RegistryKey<DamageType> SPEAR = RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("spear"));
	...
	RegistryKey<DamageType>
			MOB_PROJECTILE =
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("mob_projectile"));
	...
	RegistryKey<DamageType>
			...
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("unattributed_fireball"));

	RegistryKey<DamageType>
			WITHER_SKULL =
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("wither_skull"));
	...
	RegistryKey<DamageType>
			PLAYER_EXPLOSION =
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("player_explosion"));

	RegistryKey<DamageType> SONIC_BOOM = RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("sonic_boom"));

	RegistryKey<DamageType>
			BAD_RESPAWN_POINT =
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("bad_respawn_point"));

	RegistryKey<DamageType>
			OUTSIDE_BORDER =
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("outside_border"));

	RegistryKey<DamageType>
			GENERIC_KILL =
			RegistryKey.of(RegistryKeys.DAMAGE_TYPE, Identifier.ofVanilla("generic_kill"));
	...
	static void bootstrap(Registerable<DamageType> damageTypeRegisterable) {
		...
		damageTypeRegisterable.register(
				PLAYER_EXPLOSION,
				new DamageType("explosion.player", DamageScaling.ALWAYS, 0.1F)
		);
