...
public class SpawnRestriction {
   ...
   public static <T extends Entity> boolean canSpawn(EntityType<T> type, ServerWorldAccess world, SpawnReason spawnReason, BlockPos pos, Random random) {
      SpawnRestriction.Entry entry = RESTRICTIONS.get(type);
      return entry == null || ((SpawnRestriction.SpawnPredicate<T>)(SpawnRestriction.SpawnPredicate<?>)entry.predicate).test(type, world, spawnReason, pos, random);
   }
   ...
   static {
      ...
      register(EntityType.CAMEL_HUSK, SpawnLocationTypes.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, HostileEntity::canSpawnInDarkUnderSky);
      ...
      register(EntityType.GLOW_SQUID, SpawnLocationTypes.IN_WATER, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, SpawnRestriction::canGlowSquidSpawn);
      ...
      register(EntityType.HUSK, SpawnLocationTypes.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, HostileEntity::canSpawnInDarkUnderSky);
      ...
      register(EntityType.NAUTILUS, SpawnLocationTypes.IN_WATER, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AbstractNautilusEntity::canSpawn);
      ...
      register(EntityType.PARCHED, SpawnLocationTypes.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, HostileEntity::canSpawnInDarkUnderSky);
      ...
      register(EntityType.ZOMBIE_HORSE, SpawnLocationTypes.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, HostileEntity::canSpawnInDark);
   ...
   private static boolean canGlowSquidSpawn(
      ...
      return GlowSquidEntity.canSpawn((EntityType<? extends LivingEntity>) (EntityType<?>) type, world, reason, pos, random);
   }
