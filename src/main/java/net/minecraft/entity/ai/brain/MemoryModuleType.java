...
public class MemoryModuleType<U> {
	...
	public static final MemoryModuleType<GlobalPos>
			POTENTIAL_JOB_SITE =
			register("potential_job_site", GlobalPos.CODEC);
	...
	public static final MemoryModuleType<List<LivingEntity>>
			...
			register("visible_villager_babies");
	...
	public static final MemoryModuleType<PlayerEntity>
			NEAREST_VISIBLE_TARGETABLE_PLAYER =
			register("nearest_visible_targetable_player");
	public static final MemoryModuleType<List<PlayerEntity>>
			NEAREST_VISIBLE_TARGETABLE_PLAYERS =
			register("nearest_visible_targetable_players");
	...
	public static final MemoryModuleType<Boolean>
			...
			register("golem_detected_recently", Codec.BOOL);
	public static final MemoryModuleType<Boolean>
			DANGER_DETECTED_RECENTLY =
			register("danger_detected_recently", Codec.BOOL);
	...
	public static final MemoryModuleType<ItemEntity>
			...
			register("nearest_visible_wanted_item");
	...
	public static final MemoryModuleType<Integer>
			...
			register("temptation_cooldown_ticks", Codec.INT);
	...
	public static final MemoryModuleType<Integer>
			...
			register("long_jump_cooling_down", Codec.INT);
	...
	public static final MemoryModuleType<List<UUID>>
			...
			register("unreachable_tongue_targets");
	...
	public static final MemoryModuleType<Integer>
			...
			register("transport_items_cooldown_ticks");
	...
	public static final MemoryModuleType<Integer>
			...
			register("attack_target_cooldown", Codec.INT);
	public static final MemoryModuleType<Integer> SPEAR_FLEEING_TIME = register("spear_fleeing_time");
	public static final MemoryModuleType<Vec3d> SPEAR_FLEEING_POSITION = register("spear_fleeing_position");
	public static final MemoryModuleType<Vec3d> SPEAR_CHARGE_POSITION = register("spear_charge_position");
	public static final MemoryModuleType<Integer> SPEAR_ENGAGE_TIME = register("spear_engage_time");
	public static final MemoryModuleType<SpearChargeTask.AdvanceState> SPEAR_STATUS = register("spear_status");
	...
	public static final MemoryModuleType<Integer>
			...
			register("time_trying_to_reach_admire_item");
	...
	public static final MemoryModuleType<HoglinEntity>
			NEAREST_VISIBLE_HUNTABLE_HOGLIN =
			register("nearest_visible_huntable_hoglin");
	public static final MemoryModuleType<HoglinEntity>
			NEAREST_VISIBLE_BABY_HOGLIN =
			register("nearest_visible_baby_hoglin");
	public static final MemoryModuleType<PlayerEntity>
			NEAREST_TARGETABLE_PLAYER_NOT_WEARING_GOLD =
			register("nearest_targetable_player_not_wearing_gold");
	public static final MemoryModuleType<List<AbstractPiglinEntity>>
			NEARBY_ADULT_PIGLINS =
			register("nearby_adult_piglins");
	public static final MemoryModuleType<List<AbstractPiglinEntity>>
			NEAREST_VISIBLE_ADULT_PIGLINS =
			register("nearest_visible_adult_piglins");
	public static final MemoryModuleType<List<HoglinEntity>>
			NEAREST_VISIBLE_ADULT_HOGLINS =
			register("nearest_visible_adult_hoglins");
	public static final MemoryModuleType<AbstractPiglinEntity>
			NEAREST_VISIBLE_ADULT_PIGLIN =
			register("nearest_visible_adult_piglin");
	public static final MemoryModuleType<LivingEntity>
			NEAREST_VISIBLE_ZOMBIFIED =
			register("nearest_visible_zombified");
	...
	public static final MemoryModuleType<PlayerEntity>
			...
			register("nearest_player_holding_wanted_item");
	...
	public static final MemoryModuleType<Unit>
			...
			register("sonic_boom_sound_cooldown", Unit.CODEC);
	...
	public static final MemoryModuleType<Integer>
			...
			register("liked_noteblock_cooldown_ticks", Codec.INT);
	public static final MemoryModuleType<Integer>
			ITEM_PICKUP_COOLDOWN_TICKS =
			register("item_pickup_cooldown_ticks", Codec.INT);
	public static final MemoryModuleType<List<GlobalPos>>
			SNIFFER_EXPLORED_POSITIONS =
			register("sniffer_explored_positions", Codec.list(GlobalPos.CODEC));
