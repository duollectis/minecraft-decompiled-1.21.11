      ...
      return TaskTriggerer.task(
         context -> context.group(
            ...
            .apply(context, (targetValue, lookTarget, walkTarget, visibleMobs) -> (world, entity, time) -> {
               ...
               if (entityPredicate.test((E)entity) && livingTargetCache.anyMatch(predicate)) {
                  Optional<LivingEntity> optional = livingTargetCache.findFirst(target -> target.squaredDistanceTo(entity) <= i && predicate.test(target));
