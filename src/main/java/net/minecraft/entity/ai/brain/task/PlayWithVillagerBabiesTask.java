...
/**
 * {@code PlayWithVillagerBabiesTask}.
 */
						                  ...
						                  (visibleVillagerBabies, walkTarget, lookTarget, interactionTarget) -> (world, entity, time) -> {
							                  if (world.getRandom().nextInt(10) != 0) {
								                  ...
								                  if (!optional.isPresent()) {
									                  Optional<LivingEntity>
											                  optional2 =
											                  getLeastPopularBabyInteractionTarget(list);
									                  ...
									                  for (int i = 0; i < 10; i++) {
										                  ...
										                  if (vec3d != null && world.isNearOccupiedPointOfInterest(
