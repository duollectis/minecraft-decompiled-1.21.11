...
public class VillagerTaskListProvider {
	...
	public static final int CORE_TASK_PRIORITY = 5;
	public static final int SECONDARY_TASK_PRIORITY = 2;
	public static final float TASK_SPEED_MODIFIER = 0.5F;
		...
		return ImmutableList.of(
				...
				Pair.of(
						...
						ForgetCompletedPointOfInterestTask.create(
								profession.value().heldWorkstation(),
	...
	public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> createWorkTasks(
			RegistryEntry<VillagerProfession> profession,
			float speed
	) {
				...
				Pair.of(
						...
						new RandomTask(
								ImmutableList.of(
										...
										Pair.of(
												new FarmerVillagerTask(),
												profession.matchesKey(VillagerProfession.FARMER) ? 2 : 5
										),
										Pair.of(
												new BoneMealTask(),
												profession.matchesKey(VillagerProfession.FARMER) ? 4 : 7
										)
								)
						)
				),
	...
	public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> createRestTasks(
	...
	public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> createMeetTasks(
			RegistryEntry<VillagerProfession> registryEntry, float speed
	) {
		return ImmutableList.of(
				Pair.of(
	...
	public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> createIdleTasks(
			RegistryEntry<VillagerProfession> registryEntry, float speed
	) {
		return ImmutableList.of(
				Pair.of(
	...
	public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> createPanicTasks(
			RegistryEntry<VillagerProfession> registryEntry, float speed
	) {
		float f = speed * 1.5F;
		return ImmutableList.of(
	...
	public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> createPreRaidTasks(
			RegistryEntry<VillagerProfession> registryEntry, float speed
	) {
		return ImmutableList.of(
	...
	public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> createRaidTasks(
			RegistryEntry<VillagerProfession> registryEntry, float speed
	) {
		return ImmutableList.of(
				Pair.of(
						...
						TaskTriggerer.runIf(
								...
								Tasks.pickRandomly(ImmutableList.of(
										Pair.of(SeekSkyTask.create(speed), 5),
										Pair.of(GoToPointOfInterestTask.create(speed * 1.1F), 2)
								))
						)
				),
				...
				Pair.of(
						2,
						TaskTriggerer.runIf(
								TaskTriggerer.predicate(VillagerTaskListProvider::hasActiveRaid),
								HideInHomeTask.create(24, speed * 1.4F, 1)
						)
				),
				createBusyFollowTask(),
				Pair.of(99, EndRaidTask.create())
