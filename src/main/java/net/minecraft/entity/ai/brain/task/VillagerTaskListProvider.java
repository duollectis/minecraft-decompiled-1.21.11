         ...
         Pair.of(
            ...
            new RandomTask(
               ImmutableList.of(
                  ...
                  Pair.of(new FarmerVillagerTask(), profession.matchesKey(VillagerProfession.FARMER) ? 2 : 5),
                  Pair.of(new BoneMealTask(), profession.matchesKey(VillagerProfession.FARMER) ? 4 : 7)
               )
            )
         ),
