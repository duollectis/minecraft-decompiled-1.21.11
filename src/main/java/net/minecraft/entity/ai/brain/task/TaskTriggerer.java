...
public class TaskTriggerer<E extends LivingEntity, M> implements App<TaskTriggerer.K1<E>, M> {
   ...
   public static final class TaskContext<E extends LivingEntity> implements Applicative<TaskTriggerer.K1<E>, TaskTriggerer.TaskContext.Mu<E>> {
      ...
      public <A, R> Function<App<TaskTriggerer.K1<E>, A>, App<TaskTriggerer.K1<E>, R>> lift1(App<TaskTriggerer.K1<E>, Function<A, R>> app) {
         return app2 -> {
            final TaskTriggerer.TaskFunction<E, A> taskFunction = (TaskTriggerer.TaskFunction<E, A>)TaskTriggerer.getFunction((App<TaskTriggerer.K1<E>, ?>)app2);
      ...
      public <T, R> TaskTriggerer<E, R> map(Function<? super T, ? extends R> function, App<TaskTriggerer.K1<E>, T> app) {
         final TaskTriggerer.TaskFunction<E, T> taskFunction = (TaskTriggerer.TaskFunction<E, T>)TaskTriggerer.getFunction((App<TaskTriggerer.K1<E>, ?>)app);
         return TaskTriggerer.of(new TaskTriggerer.TaskFunction<E, R>() {
            @Override
            public R run(ServerWorld world, E entity, long time) {
      ...
      public <A, B, R> TaskTriggerer<E, R> ap2(
         ...
         final TaskTriggerer.TaskFunction<E, A> taskFunction = (TaskTriggerer.TaskFunction<E, A>)TaskTriggerer.getFunction((App<TaskTriggerer.K1<E>, ?>)app2);
         final TaskTriggerer.TaskFunction<E, B> taskFunction2 = (TaskTriggerer.TaskFunction<E, B>)TaskTriggerer.getFunction((App<TaskTriggerer.K1<E>, ?>)app3);
      ...
      public <T1, T2, T3, R> TaskTriggerer<E, R> ap3(
         ...
         final TaskTriggerer.TaskFunction<E, T1> taskFunction = (TaskTriggerer.TaskFunction<E, T1>)TaskTriggerer.getFunction((App<TaskTriggerer.K1<E>, ?>)app2);
         final TaskTriggerer.TaskFunction<E, T2> taskFunction2 = (TaskTriggerer.TaskFunction<E, T2>)TaskTriggerer.getFunction((App<TaskTriggerer.K1<E>, ?>)app3);
         final TaskTriggerer.TaskFunction<E, T3> taskFunction3 = (TaskTriggerer.TaskFunction<E, T3>)TaskTriggerer.getFunction((App<TaskTriggerer.K1<E>, ?>)app4);
      ...
      public <T1, T2, T3, T4, R> TaskTriggerer<E, R> ap4(
         ...
         final TaskTriggerer.TaskFunction<E, T2> taskFunction2 = (TaskTriggerer.TaskFunction<E, T2>)TaskTriggerer.getFunction((App<TaskTriggerer.K1<E>, ?>)app3);
         final TaskTriggerer.TaskFunction<E, T3> taskFunction3 = (TaskTriggerer.TaskFunction<E, T3>)TaskTriggerer.getFunction((App<TaskTriggerer.K1<E>, ?>)app4);
         final TaskTriggerer.TaskFunction<E, T4> taskFunction4 = (TaskTriggerer.TaskFunction<E, T4>)TaskTriggerer.getFunction((App<TaskTriggerer.K1<E>, ?>)app5);
