...
public class LandPathNodeMaker extends PathNodeMaker {
   ...
   public int getSuccessors(PathNode[] successors, PathNode node) {
      ...
      for (Direction directionx : Direction.Type.HORIZONTAL) {
         ...
         if (this.isValidDiagonalSuccessor(
            node, this.successors[directionx.getHorizontalQuarterTurns()], this.successors[direction2.getHorizontalQuarterTurns()]
         )) {
   ...
   private @Nullable PathNode getJumpOnTopNode(
      int x, int y, int z, int maxYStep, double lastFeetY, Direction direction, PathNodeType nodeType, BlockPos.Mutable mutablePos
   ) {
