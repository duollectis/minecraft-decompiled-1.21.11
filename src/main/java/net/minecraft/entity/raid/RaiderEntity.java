...
public abstract class RaiderEntity extends PatrolEntity {
   ...
   public boolean hasRaid() {
      return !(this.getEntityWorld() instanceof ServerWorld serverWorld) ? false : this.getRaid() != null || serverWorld.getRaidAt(this.getBlockPos()) != null;
   }
         ...
         if (this.shouldStop()) {
            ...
            for (ItemEntity itemEntity : this.actor
               ...
               if (RaiderEntity.this.getEntityWorld().getTime() < l) {
                  ...
                  int2LongOpenHashMap.put(itemEntity.getId(), RaiderEntity.this.getEntityWorld().getTime() + 600L);
               }
            }
