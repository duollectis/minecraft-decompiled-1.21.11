...
public class WorldEventHandler {
	...
	public void processWorldEvent(int eventId, BlockPos pos, int data) {
		...
		switch (eventId) {
			case 1000:
				this.world.playSoundAtBlockCenterClient(
						pos,
			...
			case 1010:
				this.world
						.getRegistryManager()
						.getOrThrow(RegistryKeys.JUKEBOX_SONG)
						.getEntry(data)
						.ifPresent(song -> this.playJukeboxSong(song, pos));
				break;
			case 1011:
			...
			case 1032:
				this.client
						.getSoundManager()
						.play(PositionedSoundInstance.ambient(
			...
			case 1051:
				this.world
						.playSoundAtBlockCenterClient(
								...
								SoundCategory.BLOCKS,
								0.5F,
								0.4F / (this.world.getRandom().nextFloat() * 0.4F + 0.8F),
								false
						);
				break;
			case 1500:
			...
			case 2007:
				...
				ParticleType<EffectParticleEffect>
						particleType =
						eventId == 2007 ? ParticleTypes.INSTANT_EFFECT : ParticleTypes.EFFECT;
				...
				for (int m = 0; m < 100; m++) {
					...
					EffectParticleEffect
							effectParticleEffect =
							EffectParticleEffect.of(particleType, h * r, k * r, l * r, (float) g);
			...
			case 2006:
				for (int m = 0; m < 200; m++) {
					...
					this.world
							.addParticleClient(
									DragonBreathParticleEffect.of(ParticleTypes.DRAGON_BREATH, ab),
									pos.getX() + n * 0.1,
									pos.getY() + 0.3,
									pos.getZ() + p * 0.1,
									n,
			...
			case 2013:
				...
				break;
			case 3000:
				this.world.addImportantParticleClient(
			...
			case 3001:
				this.world
						.playSoundAtBlockCenterClient(
								...
								SoundCategory.HOSTILE,
								64.0F,
								0.8F + this.world.random.nextFloat() * 0.3F,
								false
						);
				break;
			case 3002:
				if (data >= 0 && data < Direction.Axis.VALUES.length) {
					ParticleUtil.spawnParticle(
							Direction.Axis.VALUES[data],
							this.world,
							pos,
							0.125,
							ParticleTypes.ELECTRIC_SPARK,
							UniformIntProvider.create(10, 19)
					);
				}
				else {
					ParticleUtil.spawnParticle(
					...
					if (b == 0) {
						for (Direction direction : Direction.values()) {
							...
							ParticleUtil.spawnParticles(
									this.world,
									pos,
									new SculkChargeParticleEffect(y),
									intProvider,
									direction,
									supplier,
									p
						...
						for (Direction direction2 : MultifaceBlock.flagToDirections(b)) {
							...
							ParticleUtil.spawnParticles(
									this.world,
									pos,
									new SculkChargeParticleEffect(z),
									intProvider,
									direction2,
									supplier,
									0.35
			...
			case 3008:
				...
				if (blockState2.getBlock() instanceof BrushableBlock brushableBlock) {
					this.world.playSoundAtBlockCenterClient(
							pos,
							brushableBlock.getBrushingCompleteSound(),
			...
			case 3009:
				...
				break;
			case 3011:
				TrialSpawnerLogic.addMobSpawnParticles(
						this.world,
						pos,
						random,
						TrialSpawnerLogic.Type.fromIndex(data).particle
				);
				break;
			case 3012:
				this.world
