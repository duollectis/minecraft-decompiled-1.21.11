...
public class WorldEventHandler {
   ...
   public void processWorldEvent(int eventId, BlockPos pos, int data) {
      ...
      switch (eventId) {
         ...
         case 1031:
            this.world
               .playSoundAtBlockCenterClient(pos, SoundEvents.BLOCK_ANVIL_LAND, SoundCategory.BLOCKS, 0.3F, this.world.random.nextFloat() * 0.1F + 0.9F, false);
            break;
         case 1032:
         ...
         case 1039:
            this.world
               .playSoundAtBlockCenterClient(
                  pos, SoundEvents.ENTITY_PHANTOM_BITE, SoundCategory.HOSTILE, 0.3F, this.world.random.nextFloat() * 0.1F + 0.9F, false
               );
            break;
         case 1040:
            this.world
         ...
         case 1042:
            this.world
               .playSoundAtBlockCenterClient(
                  pos, SoundEvents.BLOCK_GRINDSTONE_USE, SoundCategory.BLOCKS, 1.0F, this.world.random.nextFloat() * 0.1F + 0.9F, false
               );
            break;
         case 1043:
            this.world
               .playSoundAtBlockCenterClient(
                  pos, SoundEvents.ITEM_BOOK_PAGE_TURN, SoundCategory.BLOCKS, 1.0F, this.world.random.nextFloat() * 0.1F + 0.9F, false
               );
            break;
         case 1044:
            this.world
         ...
         case 2007:
            ...
            this.world
               .playSoundAtBlockCenterClient(pos, SoundEvents.ENTITY_SPLASH_POTION_BREAK, SoundCategory.NEUTRAL, 1.0F, random.nextFloat() * 0.1F + 0.9F, false);
            break;
         case 2003:
            ...
            for (double g = 0.0; g < Math.PI * 2; g += Math.PI / 20) {
               this.world
                  .addParticleClient(ParticleTypes.PORTAL, d + Math.cos(g) * 5.0, e - 0.4, f + Math.sin(g) * 5.0, Math.cos(g) * -5.0, 0.0, Math.sin(g) * -5.0);
               this.world
                  .addParticleClient(ParticleTypes.PORTAL, d + Math.cos(g) * 5.0, e - 0.4, f + Math.sin(g) * 5.0, Math.cos(g) * -7.0, 0.0, Math.sin(g) * -7.0);
            }
            break;
         case 2004:
         ...
         case 2006:
            for (int m = 0; m < 200; m++) {
               ...
               this.world
                  .addParticleClient(
                     DragonBreathParticleEffect.of(ParticleTypes.DRAGON_BREATH, ab), pos.getX() + n * 0.1, pos.getY() + 0.3, pos.getZ() + p * 0.1, n, o, p
                  );
            }
            ...
            if (data == 1) {
               this.world
                  .playSoundAtBlockCenterClient(
                     pos, SoundEvents.ENTITY_DRAGON_FIREBALL_EXPLODE, SoundCategory.HOSTILE, 1.0F, random.nextFloat() * 0.1F + 0.9F, false
                  );
            }
            break;
         case 2008:
         ...
         case 2009:
            for (int m = 0; m < 8; m++) {
               this.world
                  .addParticleClient(ParticleTypes.CLOUD, pos.getX() + random.nextDouble(), pos.getY() + 1.2, pos.getZ() + random.nextDouble(), 0.0, 0.0, 0.0);
            }
            break;
         case 2010:
         ...
         case 3006:
            ...
            if (s > 0) {
               if (random.nextFloat() < 0.3F + s * 0.1F) {
                  float sculkVolume = 0.15F + 0.02F * s * s * random.nextFloat();
                  float sculkPitch = 0.4F + 0.3F * s * random.nextFloat();
                  this.world.playSoundAtBlockCenterClient(pos, SoundEvents.BLOCK_SCULK_CHARGE, SoundCategory.BLOCKS, sculkVolume, sculkPitch, false);
               }
         ...
         case 3007:
            for (int af = 0; af < 10; af++) {
               this.world
                  .addParticleClient(new ShriekParticleEffect(af * 5), pos.getX() + 0.5, pos.getY() + SculkShriekerBlock.TOP, pos.getZ() + 0.5, 0.0, 0.0, 0.0);
            }
