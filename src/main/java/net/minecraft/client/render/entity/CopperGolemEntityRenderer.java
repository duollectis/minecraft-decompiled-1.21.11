...
/**
 * {@code CopperGolemEntityRenderer}.
 */
public class CopperGolemEntityRenderer extends MobEntityRenderer<CopperGolemEntity, CopperGolemEntityRenderState, CopperGolemEntityModel> {
	...
	public CopperGolemEntityRenderer(EntityRendererFactory.Context context) {
		...
		this.addFeature(new CopperGolemHeadBlockFeatureRenderer<>(
				...
				this.model::transformMatricesForBlock
		));
	...
	public void updateRenderState(
		...
		copperGolemEntityRenderState.headBlockItemStack =
				Optional.of(copperGolemEntity.getEquippedStack(CopperGolemEntity.POPPY_SLOT)).flatMap(stack -> {
