...
public class LargeTropicalFishEntityModel extends EntityModel<TropicalFishEntityRenderState> {
   ...
   public static TexturedModelData getTexturedModelData(Dilation dilation) {
      ...
      modelPartData.addChild(
         "body", ModelPartBuilder.create().uv(0, 20).cuboid(-1.0F, -3.0F, -3.0F, 2.0F, 6.0F, 6.0F, dilation), ModelTransform.origin(0.0F, 19.0F, 0.0F)
      );
      modelPartData.addChild(
         "tail", ModelPartBuilder.create().uv(21, 16).cuboid(0.0F, -3.0F, 0.0F, 0.0F, 6.0F, 5.0F, dilation), ModelTransform.origin(0.0F, 19.0F, 3.0F)
      );
      modelPartData.addChild(
         "right_fin",
      ...
      modelPartData.addChild(
         "top_fin", ModelPartBuilder.create().uv(20, 11).cuboid(0.0F, -4.0F, 0.0F, 0.0F, 4.0F, 6.0F, dilation), ModelTransform.origin(0.0F, 16.0F, -3.0F)
      );
      modelPartData.addChild(
         "bottom_fin", ModelPartBuilder.create().uv(20, 21).cuboid(0.0F, 0.0F, 0.0F, 0.0F, 4.0F, 6.0F, dilation), ModelTransform.origin(0.0F, 22.0F, -3.0F)
      );
