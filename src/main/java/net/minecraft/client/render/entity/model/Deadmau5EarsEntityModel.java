...
/**
 * {@code Deadmau5EarsEntityModel}.
 */
public class Deadmau5EarsEntityModel extends PlayerEntityModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartBuilder
				modelPartBuilder =
				ModelPartBuilder.create().uv(24, 0).cuboid(-3.0F, -6.0F, -1.0F, 6.0F, 6.0F, 1.0F, new Dilation(1.0F));
