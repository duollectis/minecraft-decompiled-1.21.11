...
public class EntityModelLayers {
	...
	public static final EquipmentModelData<EntityModelLayer>
			SMALL_ARMOR_STAND_EQUIPMENT =
			registerEquipment("armor_stand_small");
	...
	public static final EquipmentModelData<EntityModelLayer> PLAYER_SLIM_EQUIPMENT = registerEquipment("player_slim");
	...
	public static final EquipmentModelData<EntityModelLayer>
			WITHER_SKELETON_EQUIPMENT =
			registerEquipment("wither_skeleton");
	...
	public static final EquipmentModelData<EntityModelLayer>
			...
			registerEquipment("zombie_villager_baby");
	public static final EquipmentModelData<EntityModelLayer>
			ZOMBIE_VILLAGER_EQUIPMENT =
			registerEquipment("zombie_villager");
	...
	public static final EquipmentModelData<EntityModelLayer>
			ZOMBIFIED_PIGLIN_BABY_EQUIPMENT =
			registerEquipment("zombified_piglin_baby");
	public static final EquipmentModelData<EntityModelLayer>
			ZOMBIFIED_PIGLIN_EQUIPMENT =
			registerEquipment("zombified_piglin");
	...
	private static EquipmentModelData<EntityModelLayer> registerEquipment(String id) {
		return new EquipmentModelData<>(
				register(id, "helmet"),
				register(id, "chestplate"),
				register(id, "leggings"),
				register(id, "boots")
		);
	}
	...
	public static EntityModelLayer createHangingSign(
			WoodType type,
