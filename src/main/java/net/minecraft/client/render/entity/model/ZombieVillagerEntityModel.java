...
/**
 * {@code ZombieVillagerEntityModel}.
 */
public class ZombieVillagerEntityModel<S extends ZombieVillagerRenderState> extends BipedEntityModel<S> implements ModelWithHat<S> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData modelPartData3 = modelPartData2.addChild(
				"hat",
				ModelPartBuilder.create().uv(32, 0).cuboid(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, new Dilation(0.5F)),
				ModelTransform.NONE
		);
	...
	public static EquipmentModelData<TexturedModelData> getEquipmentModelData(
			Dilation hatDilation,
			Dilation armorDilation
	) {
		return createEquipmentModelData(
				ZombieVillagerEntityModel::getArmorTexturedModelData,
				hatDilation,
				armorDilation
		)
	...
	private static ModelData getArmorTexturedModelData(Dilation dilation) {
		...
		ModelPartData modelPartData2 = modelPartData.addChild(
				"head",
				ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -10.0F, -4.0F, 8.0F, 8.0F, 8.0F, dilation),
				ModelTransform.NONE
		);
		modelPartData.addChild(
				"body",
				ModelPartBuilder.create().uv(16, 16).cuboid(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, dilation.add(0.1F)),
				ModelTransform.NONE
		);
		modelPartData.addChild(
				"right_leg",
	...
	public void setAngles(S zombieVillagerRenderState) {
		...
		ArmPosing.zombieArms(
				this.leftArm,
				this.rightArm,
				zombieVillagerRenderState.attacking,
