		...
		this.cape
				.rotate(
						new Quaternionf()
								...
								.rotateX((6.0F + playerEntityRenderState.capeForwardTilt / 2.0F
										+ playerEntityRenderState.capeFlap
								) * (float) (Math.PI / 180.0))
								.rotateZ(playerEntityRenderState.capeSideTilt / 2.0F * (float) (Math.PI / 180.0))
								.rotateY((180.0F - playerEntityRenderState.capeSideTilt / 2.0F) * (float) (Math.PI
										/ 180.0
								))
				);
	}
