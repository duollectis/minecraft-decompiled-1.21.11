...
/**
 * {@code TropicalFishColorFeatureRenderer}.
 */
public class TropicalFishColorFeatureRenderer extends FeatureRenderer<TropicalFishEntityRenderState, EntityModel<TropicalFishEntityRenderState>> {
	...
	public TropicalFishColorFeatureRenderer(
			FeatureRendererContext<TropicalFishEntityRenderState, EntityModel<TropicalFishEntityRenderState>> context,
			LoadedEntityModels loader
	) {
		super(context);
		this.smallModel =
				new SmallTropicalFishEntityModel(loader.getModelPart(EntityModelLayers.TROPICAL_FISH_SMALL_PATTERN));
		this.largeModel =
				new LargeTropicalFishEntityModel(loader.getModelPart(EntityModelLayers.TROPICAL_FISH_LARGE_PATTERN));
	}
	...
	public void render(
		...
		EntityModel<TropicalFishEntityRenderState>
				entityModel =
				(EntityModel<TropicalFishEntityRenderState>) (switch (pattern.getSize()) {
		...
		render(
				...
				i,
				tropicalFishEntityRenderState,
				tropicalFishEntityRenderState.patternColor,
				1
		);
	}
}
