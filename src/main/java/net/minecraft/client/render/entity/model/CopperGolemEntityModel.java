...
public class CopperGolemEntityModel extends EntityModel<CopperGolemEntityRenderState> implements ModelWithArms<CopperGolemEntityRenderState>, ModelWithHead {
   ...
   public static TexturedModelData getTexturedModelData() {
      ModelData modelData = new ModelData().transform((UnaryOperator<ModelTransform>) transform -> transform.moveOrigin(0.0F, 24.0F, 0.0F));
      ModelPartData modelPartData = modelData.getRoot();
      ModelPartData modelPartData2 = modelPartData.addChild(
         "body", ModelPartBuilder.create().uv(0, 15).cuboid(-4.0F, -6.0F, -3.0F, 8.0F, 6.0F, 6.0F, Dilation.NONE), ModelTransform.origin(0.0F, -5.0F, 0.0F)
      );
      ...
      modelPartData.addChild(
         "right_leg", ModelPartBuilder.create().uv(0, 27).cuboid(-4.0F, 0.0F, -2.0F, 4.0F, 5.0F, 4.0F, Dilation.NONE), ModelTransform.origin(0.0F, -5.0F, 0.0F)
      );
      modelPartData.addChild(
         "left_leg", ModelPartBuilder.create().uv(16, 27).cuboid(0.0F, 0.0F, -2.0F, 4.0F, 5.0F, 4.0F, Dilation.NONE), ModelTransform.origin(0.0F, -5.0F, 0.0F)
      );
      return TexturedModelData.of(modelData, 64, 64);
   }

   public static TexturedModelData getRunningTexturedModelData() {
      ModelData modelData = new ModelData().transform((UnaryOperator<ModelTransform>) transform -> transform.moveOrigin(0.0F, 0.0F, 0.0F));
      ModelPartData modelPartData = modelData.getRoot();
