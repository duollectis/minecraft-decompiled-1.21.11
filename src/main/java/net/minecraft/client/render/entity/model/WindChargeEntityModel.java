...
public class WindChargeEntityModel extends EntityModel<EntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData
				modelPartData2 =
				modelPartData.addChild("bone", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));
	...
	public void setAngles(EntityRenderState entityRenderState) {
		...
		this.windCharge.yaw = -entityRenderState.age * 16.0F * (float) (Math.PI / 180.0);
		this.wind.yaw = entityRenderState.age * 16.0F * (float) (Math.PI / 180.0);
	}
}
