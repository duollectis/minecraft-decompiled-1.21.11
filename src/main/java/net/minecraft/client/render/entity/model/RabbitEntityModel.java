...
public class RabbitEntityModel extends EntityModel<RabbitEntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData(boolean baby) {
		...
		modelPartData2.addChild(
				...
				ModelTransform.rotation(0.36651915F, 0.0F, 0.0F)
		);
		...
		ModelPartData modelPartData4 = modelPartData.addChild(
				"head",
				ModelPartBuilder.create().uv(32, 0).cuboid(-2.5F, -4.0F, -5.0F, 5.0F, 4.0F, 5.0F),
				ModelTransform.origin(0.0F, 16.0F, -1.0F)
		);
		...
		modelPartData4.addChild(
				"nose",
				ModelPartBuilder.create().uv(32, 9).cuboid(-0.5F, -2.5F, -5.5F, 1.0F, 1.0F, 1.0F),
				ModelTransform.NONE
		);
