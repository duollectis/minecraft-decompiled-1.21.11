 ...
 * {@code VexEntityModel}.
 */
public class VexEntityModel extends EntityModel<VexEntityRenderState> implements ModelWithArms<VexEntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData
				modelPartData2 =
				modelPartData.addChild("root", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -2.5F, 0.0F));
		...
		modelPartData3.addChild(
				...
				ModelPartBuilder
						...
						.uv(16, 14)
						.mirrored()
						.cuboid(0.0F, 0.0F, 0.0F, 0.0F, 5.0F, 8.0F, new Dilation(0.0F))
						.mirrored(false),
	...
	public void setAngles(VexEntityRenderState vexEntityRenderState) {
		...
		if (vexEntityRenderState.charging) {
			...
			this.setChargingArmAngles(
					!vexEntityRenderState.rightHandItemState.isEmpty(),
					!vexEntityRenderState.leftHandItemState.isEmpty(),
					f
			);
		}
		else {
		...
		this.leftWing.yaw =
				1.0995574F
						+ MathHelper.cos(vexEntityRenderState.age * 45.836624F * (float) (Math.PI / 180.0)) * (float) (
						Math.PI / 180.0
				) * 16.2F;
