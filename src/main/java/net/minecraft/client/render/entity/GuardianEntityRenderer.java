...
public class GuardianEntityRenderer extends MobEntityRenderer<GuardianEntity, GuardianEntityRenderState, GuardianEntityModel> {
   ...
   private static void renderBeam(MatrixStack matrixStack, OrderedRenderCommandQueue orderedRenderCommandQueue, Vec3d vec3d, float beamTicks, float f, float g) {
