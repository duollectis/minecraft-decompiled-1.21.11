...
public class RavagerEntityRenderer extends MobEntityRenderer<RavagerEntity, RavagerEntityRenderState, RavagerEntityModel> {
	 ...
	 *
	 * @return RavagerEntityRenderState — результат операции
	 */
	...
	public void updateRenderState(
			...
			RavagerEntityRenderState ravagerEntityRenderState,
			float f
	) {
		...
		ravagerEntityRenderState.attackTick =
				ravagerEntity.getAttackTick() > 0.0F ? ravagerEntity.getAttackTick() - f : 0.0F;
