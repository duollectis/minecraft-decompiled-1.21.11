...
/**
 * {@code SheepWoolUndercoatFeatureRenderer}.
 */
public class SheepWoolUndercoatFeatureRenderer extends FeatureRenderer<SheepEntityRenderState, SheepEntityModel> {
	...
	public SheepWoolUndercoatFeatureRenderer(
			FeatureRendererContext<SheepEntityRenderState, SheepEntityModel> context,
	...
	public void render(
			...
			int i,
			SheepEntityRenderState sheepEntityRenderState,
			float f,
			float g
	) {
		if (!sheepEntityRenderState.invisible && (sheepEntityRenderState.rainbow
			...
			render(
					...
					sheepEntityRenderState.getRgbColor(),
					1
			);
		}
	}
