...
/**
 * {@code FishingBobberEntityRenderer}.
 */
public class FishingBobberEntityRenderer extends EntityRenderer<FishingBobberEntity, FishingBobberEntityState> {
	...
	private static final double MAX_RENDER_DISTANCE_SQ = 960.0;
	...
	public boolean shouldRender(
		...
		return super.shouldRender(fishingBobberEntity, frustum, d, e, f)
				&& fishingBobberEntity.getPlayerOwner() != null;
	}
	...
	public void render(
		...
		orderedRenderCommandQueue.submitCustom(
				matrixStack, LAYER, (matricesEntry, vertexConsumer) -> {
		...
		orderedRenderCommandQueue.submitCustom(
				matrixStack, RenderLayers.lines(), (matricesEntry, vertexConsumer) -> {
					int j = 16;
	...
	public static Arm getArmHoldingRod(PlayerEntity player) {
		return player.getMainHandStack().getItem() instanceof FishingRodItem ? player.getMainArm()
