...
public class SkeletonEntityModel<S extends SkeletonEntityRenderState> extends BipedEntityModel<S> {
   ...
   protected static void addLimbs(ModelPartData data) {
      ...
      data.addChild(
         "left_arm", ModelPartBuilder.create().uv(40, 16).mirrored().cuboid(-1.0F, -2.0F, -1.0F, 2.0F, 12.0F, 2.0F), ModelTransform.origin(5.0F, 2.0F, 0.0F)
      );
      ...
      data.addChild(
         "left_leg", ModelPartBuilder.create().uv(0, 16).mirrored().cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 12.0F, 2.0F), ModelTransform.origin(2.0F, 12.0F, 0.0F)
      );
   }
   ...
   public static TexturedModelData getParchedTexturedModelData() {
      ...
      modelPartData.addChild(
         ...
         .addChild("hat", ModelPartBuilder.create(), ModelTransform.NONE);
      modelPartData.addChild(
         "right_arm",
