...
/**
 * {@code EntityRendererFactories}.
 */
public class EntityRendererFactories {

	private static final Logger LOGGER = LogUtils.getLogger();
	private static final Map<EntityType<?>, EntityRendererFactory<?>>
			RENDERER_FACTORIES =
		...
		RENDERER_FACTORIES.forEach((entityType, factory) -> {
			try {
				...
				throw new IllegalArgumentException(
						"Failed to create model for " + Registries.ENTITY_TYPE.getId((EntityType<?>) entityType),
						var5
				);
			}
		});
	...
	public static <T extends PlayerLikeEntity & ClientPlayerLikeEntity> Map<PlayerSkinType, PlayerEntityRenderer<T>> reloadPlayerRenderers(
			EntityRendererFactory.Context ctx
	) {
		try {
			return Map.of(
					PlayerSkinType.WIDE,
					new PlayerEntityRenderer<>(ctx, false),
					PlayerSkinType.SLIM,
					new PlayerEntityRenderer<>(ctx, true)
			);
		}
	...
	public static boolean isMissingRendererFactories() {
		...
		for (EntityType<?> entityType : Registries.ENTITY_TYPE) {
			if (entityType != EntityType.PLAYER && entityType != EntityType.MANNEQUIN
					&& !RENDERER_FACTORIES.containsKey(entityType)) {
	...
	static {
		...
		register(
				...
				context -> new BoatEntityRenderer(context, EntityModelLayers.ACACIA_CHEST_BOAT)
		);
		...
		register(
				...
				context -> new RaftEntityRenderer(context, EntityModelLayers.BAMBOO_CHEST_BOAT)
		);
		...
		register(
				...
				context -> new BoatEntityRenderer(context, EntityModelLayers.BIRCH_CHEST_BOAT)
		);
		...
		register(EntityType.CAMEL_HUSK, CamelHuskEntityRenderer::new);
		...
		register(
				...
				context -> new BoatEntityRenderer(context, EntityModelLayers.CHERRY_CHEST_BOAT)
		);
		register(
				EntityType.CHEST_MINECART,
				context -> new MinecartEntityRenderer(context, EntityModelLayers.CHEST_MINECART)
		);
		register(EntityType.CHICKEN, ChickenEntityRenderer::new);
		register(EntityType.COD, CodEntityRenderer::new);
		register(
				EntityType.COMMAND_BLOCK_MINECART,
				context -> new MinecartEntityRenderer(context, EntityModelLayers.COMMAND_BLOCK_MINECART)
		);
		register(EntityType.COPPER_GOLEM, CopperGolemEntityRenderer::new);
		...
		register(
				...
				context -> new BoatEntityRenderer(context, EntityModelLayers.DARK_OAK_CHEST_BOAT)
		);
		register(EntityType.DOLPHIN, DolphinEntityRenderer::new);
		register(
				EntityType.DONKEY,
				context -> new AbstractDonkeyEntityRenderer<>(context, AbstractDonkeyEntityRenderer.Type.DONKEY)
		);
		...
		register(
				...
				context -> new BoatEntityRenderer(context, EntityModelLayers.JUNGLE_CHEST_BOAT)
		);
		...
		register(
				EntityType.LLAMA,
				context -> new LlamaEntityRenderer(context, EntityModelLayers.LLAMA, EntityModelLayers.LLAMA_BABY)
		);
		...
		register(
				...
				context -> new BoatEntityRenderer(context, EntityModelLayers.MANGROVE_CHEST_BOAT)
		);
		...
		register(
				EntityType.MULE,
				context -> new AbstractDonkeyEntityRenderer<>(context, AbstractDonkeyEntityRenderer.Type.MULE)
		);
		register(EntityType.NAUTILUS, NautilusEntityRenderer::new);
		register(EntityType.OAK_BOAT, context -> new BoatEntityRenderer(context, EntityModelLayers.OAK_BOAT));
		register(
				EntityType.OAK_CHEST_BOAT,
				context -> new BoatEntityRenderer(context, EntityModelLayers.OAK_CHEST_BOAT)
		);
		...
		register(
				...
				context -> new BoatEntityRenderer(context, EntityModelLayers.PALE_OAK_CHEST_BOAT)
		);
		register(EntityType.PANDA, PandaEntityRenderer::new);
		register(EntityType.PARCHED, ParchedEntityRenderer::new);
		...
		register(
				...
				context -> new PiglinEntityRenderer(
						...
						EntityModelLayers.PIGLIN_EQUIPMENT,
		...
		register(
				...
				context -> new UndeadHorseEntityRenderer(context, UndeadHorseEntityRenderer.Type.SKELETON)
		);
		...
		register(
				...
				context -> new MinecartEntityRenderer(context, EntityModelLayers.SPAWNER_MINECART)
		);
		...
		register(
				...
				context -> new BoatEntityRenderer(context, EntityModelLayers.SPRUCE_CHEST_BOAT)
		);
		register(
				EntityType.SQUID,
				context -> new SquidEntityRenderer<>(
						context,
						new SquidEntityModel(context.getPart(EntityModelLayers.SQUID)),
						new SquidEntityModel(context.getPart(EntityModelLayers.SQUID_BABY))
				)
		);
		...
		register(
				...
				context -> new LlamaEntityRenderer(
						context,
						EntityModelLayers.TRADER_LLAMA,
		...
		register(
				...
				context -> new UndeadHorseEntityRenderer(context, UndeadHorseEntityRenderer.Type.ZOMBIE)
		);
		register(EntityType.ZOMBIE_NAUTILUS, ZombieNautilusEntityRenderer::new);
		...
		register(
				...
				context -> new ZombifiedPiglinEntityRenderer(
						...
						EntityModelLayers.ZOMBIFIED_PIGLIN_EQUIPMENT,
