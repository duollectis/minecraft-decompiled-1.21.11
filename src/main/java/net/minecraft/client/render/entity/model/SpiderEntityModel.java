...
public class SpiderEntityModel extends EntityModel<LivingEntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		modelPartData.addChild(
				"head",
				ModelPartBuilder.create().uv(32, 4).cuboid(-4.0F, -4.0F, -8.0F, 8.0F, 8.0F, 8.0F),
				ModelTransform.origin(0.0F, 15.0F, -3.0F)
		);
		modelPartData.addChild(
				"body0",
		...
		modelPartData.addChild(
				"body1",
				ModelPartBuilder.create().uv(0, 12).cuboid(-5.0F, -4.0F, -6.0F, 10.0F, 8.0F, 12.0F),
				ModelTransform.origin(0.0F, 15.0F, 9.0F)
		);
		ModelPartBuilder
				modelPartBuilder =
				ModelPartBuilder.create().uv(18, 0).cuboid(-15.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F);
		ModelPartBuilder
				modelPartBuilder2 =
				ModelPartBuilder.create().uv(18, 0).mirrored().cuboid(-1.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F);
		float f = (float) (Math.PI / 4);
		float g = (float) (Math.PI / 8);
		modelPartData.addChild(
				"right_hind_leg",
				modelPartBuilder,
				ModelTransform.of(-4.0F, 15.0F, 2.0F, 0.0F, (float) (Math.PI / 4), (float) (-Math.PI / 4))
		);
		modelPartData.addChild(
				"left_hind_leg",
				modelPartBuilder2,
		...
		modelPartData.addChild(
				...
				modelPartBuilder,
				ModelTransform.of(-4.0F, 15.0F, 1.0F, 0.0F, (float) (Math.PI / 8), -0.58119464F)
		);
		modelPartData.addChild(
		...
		modelPartData.addChild(
				...
				modelPartBuilder,
				ModelTransform.of(-4.0F, 15.0F, 0.0F, 0.0F, (float) (-Math.PI / 8), -0.58119464F)
		);
		modelPartData.addChild(
		...
		modelPartData.addChild(
				"right_front_leg",
				modelPartBuilder,
				ModelTransform.of(-4.0F, 15.0F, -1.0F, 0.0F, (float) (-Math.PI / 4), (float) (-Math.PI / 4))
		);
		modelPartData.addChild(
				"left_front_leg",
				modelPartBuilder2,
