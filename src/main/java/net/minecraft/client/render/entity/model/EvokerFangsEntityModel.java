...
public class EvokerFangsEntityModel extends EntityModel<EvokerFangsEntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData modelPartData2 = modelPartData.addChild(
				"base",
				ModelPartBuilder.create().uv(0, 0).cuboid(0.0F, 0.0F, 0.0F, 10.0F, 12.0F, 10.0F),
				ModelTransform.origin(-5.0F, 24.0F, -5.0F)
		);
		ModelPartBuilder
				modelPartBuilder =
				ModelPartBuilder.create().uv(40, 0).cuboid(0.0F, 0.0F, 0.0F, 4.0F, 14.0F, 8.0F);
		modelPartData2.addChild(
				"upper_jaw",
				modelPartBuilder,
				ModelTransform.of(6.5F, 0.0F, 1.0F, 0.0F, 0.0F, 2.042035F)
		);
		modelPartData2.addChild(
				"lower_jaw",
				modelPartBuilder,
				ModelTransform.of(3.5F, 0.0F, 9.0F, 0.0F, (float) Math.PI, 4.2411504F)
		);
	...
	public void setAngles(EvokerFangsEntityRenderState evokerFangsEntityRenderState) {
		...
		this.base.originY = this.base.originY - (f + MathHelper.sin(f * 2.7F)) * 7.2F;
		float h = 1.0F;
		if (f > 0.9F) {
			h *= (1.0F - f) / 0.1F;
		}
