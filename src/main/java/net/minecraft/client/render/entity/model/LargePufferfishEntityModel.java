...
public class LargePufferfishEntityModel extends EntityModel<EntityRenderState> {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData.addChild(
         "right_blue_fin", ModelPartBuilder.create().uv(24, 0).cuboid(-2.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F), ModelTransform.origin(-4.0F, 15.0F, -2.0F)
      );
      modelPartData.addChild(
         "left_blue_fin", ModelPartBuilder.create().uv(24, 3).cuboid(0.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F), ModelTransform.origin(4.0F, 15.0F, -2.0F)
      );
      modelPartData.addChild(
         "top_front_fin",
