...
public class CamelEntityModel extends EntityModel<CamelEntityRenderState> {
   ...
   protected static ModelData getModelData() {
      ...
      ModelPartData modelPartData2 = modelPartData.addChild(
         "body", ModelPartBuilder.create().uv(0, 25).cuboid(-7.5F, -12.0F, -23.5F, 15.0F, 12.0F, 27.0F), ModelTransform.origin(0.0F, 4.0F, 9.5F)
      );
      modelPartData2.addChild(
         "hump", ModelPartBuilder.create().uv(74, 0).cuboid(-4.5F, -5.0F, -5.5F, 9.0F, 5.0F, 11.0F), ModelTransform.origin(0.0F, -12.0F, -10.0F)
      );
      modelPartData2.addChild(
         "tail", ModelPartBuilder.create().uv(122, 0).cuboid(-1.5F, 0.0F, 0.0F, 3.0F, 14.0F, 0.0F), ModelTransform.origin(0.0F, -9.0F, 3.5F)
      );
      ...
      modelPartData3.addChild(
         "left_ear", ModelPartBuilder.create().uv(45, 0).cuboid(-0.5F, 0.5F, -1.0F, 3.0F, 1.0F, 2.0F), ModelTransform.origin(2.5F, -21.0F, -9.5F)
      );
      modelPartData3.addChild(
         "right_ear", ModelPartBuilder.create().uv(67, 0).cuboid(-2.5F, 0.5F, -1.0F, 3.0F, 1.0F, 2.0F), ModelTransform.origin(-2.5F, -21.0F, -9.5F)
      );
      modelPartData.addChild(
         "left_hind_leg", ModelPartBuilder.create().uv(58, 16).cuboid(-2.5F, 2.0F, -2.5F, 5.0F, 21.0F, 5.0F), ModelTransform.origin(4.9F, 1.0F, 9.5F)
      );
      modelPartData.addChild(
         "right_hind_leg", ModelPartBuilder.create().uv(94, 16).cuboid(-2.5F, 2.0F, -2.5F, 5.0F, 21.0F, 5.0F), ModelTransform.origin(-4.9F, 1.0F, 9.5F)
      );
      modelPartData.addChild(
         "left_front_leg", ModelPartBuilder.create().uv(0, 0).cuboid(-2.5F, 2.0F, -2.5F, 5.0F, 21.0F, 5.0F), ModelTransform.origin(4.9F, 1.0F, -10.5F)
      );
      modelPartData.addChild(
         "right_front_leg", ModelPartBuilder.create().uv(0, 26).cuboid(-2.5F, 2.0F, -2.5F, 5.0F, 21.0F, 5.0F), ModelTransform.origin(-4.9F, 1.0F, -10.5F)
      );
      return modelData;
   }
