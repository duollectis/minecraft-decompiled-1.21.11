...
/**
 * {@code ChickenEntityModel}.
 */
public class ChickenEntityModel extends EntityModel<ChickenEntityRenderState> {

	public static final String RED_THING = "red_thing";
	public static final float TEXTURE_SIZE = 16.0F;
	public static final ModelTransformer
			BABY_TRANSFORMER =
			new BabyModelTransformer(false, 5.0F, 2.0F, 2.0F, 1.99F, 24.0F, Set.of("head", "beak", "red_thing"));
	...
	protected static ModelData getModelData() {
		...
		ModelPartBuilder
				modelPartBuilder =
				ModelPartBuilder.create().uv(26, 0).cuboid(-1.0F, 0.0F, -3.0F, 3.0F, 5.0F, 3.0F);
	...
	public void setAngles(ChickenEntityRenderState chickenEntityRenderState) {
		...
		float
				f =
				(MathHelper.sin(chickenEntityRenderState.flapProgress) + 1.0F)
