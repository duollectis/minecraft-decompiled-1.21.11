...
public class SilverfishEntityModel extends EntityModel<EntityRenderState> {
	...
	private static final int[][]
			SEGMENT_LOCATIONS =
			new int[][]{{3, 2, 2}, {4, 3, 2}, {6, 4, 3}, {3, 3, 3}, {2, 2, 3}, {2, 1, 2}, {1, 1, 2}};
	private static final int[][]
			SEGMENT_SIZES =
			new int[][]{{0, 0}, {0, 4}, {0, 9}, {0, 16}, {0, 22}, {11, 0}, {13, 4}};
	...
	public static TexturedModelData getTexturedModelData() {
		...
		modelPartData.addChild(
				...
				ModelPartBuilder
						.create()
						.uv(20, 0)
						.cuboid(-5.0F, 0.0F, SEGMENT_LOCATIONS[2][2] * -0.5F, 10.0F, 8.0F, SEGMENT_LOCATIONS[2][2]),
		...
		modelPartData.addChild(
				...
				ModelPartBuilder
						.create()
						.uv(20, 11)
						.cuboid(-3.0F, 0.0F, SEGMENT_LOCATIONS[4][2] * -0.5F, 6.0F, 4.0F, SEGMENT_LOCATIONS[4][2]),
		...
		modelPartData.addChild(
				...
				ModelPartBuilder
						.create()
						.uv(20, 18)
						.cuboid(-3.0F, 0.0F, SEGMENT_LOCATIONS[4][2] * -0.5F, 6.0F, 5.0F, SEGMENT_LOCATIONS[1][2]),
	...
	public void setAngles(EntityRenderState entityRenderState) {
		...
		for (int i = 0; i < this.body.length; i++) {
			this.body[i].yaw =
					MathHelper.cos(entityRenderState.age * 0.9F + i * 0.15F * (float) Math.PI) * (float) Math.PI * 0.05F
							* (1 + Math.abs(i - 2));
			this.body[i].originX =
					MathHelper.sin(entityRenderState.age * 0.9F + i * 0.15F * (float) Math.PI) * (float) Math.PI * 0.2F
							* Math.abs(i - 2);
		}
