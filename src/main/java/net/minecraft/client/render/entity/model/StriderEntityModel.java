...
public class StriderEntityModel extends EntityModel<StriderEntityRenderState> {
   ...
   public static TexturedModelData getTexturedModelData() {
      ...
      modelPartData.addChild(
         "right_leg", ModelPartBuilder.create().uv(0, 32).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 16.0F, 4.0F), ModelTransform.origin(-4.0F, 8.0F, 0.0F)
      );
      modelPartData.addChild(
         "left_leg", ModelPartBuilder.create().uv(0, 55).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 16.0F, 4.0F), ModelTransform.origin(4.0F, 8.0F, 0.0F)
      );
      ModelPartData modelPartData2 = modelPartData.addChild(
         "body", ModelPartBuilder.create().uv(0, 0).cuboid(-8.0F, -6.0F, -8.0F, 16.0F, 14.0F, 16.0F), ModelTransform.origin(0.0F, 1.0F, 0.0F)
      );
