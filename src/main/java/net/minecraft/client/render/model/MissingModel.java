...
public class MissingModel {
	...
	public static UnbakedModel create() {
		...
		Map<Direction, ModelElementFace>
				...
				Util.mapEnum(
						Direction.class,
						direction -> new ModelElementFace(direction, -1, "missingno", uV, AxisRotation.R0)
				);
		ModelElement
				modelElement =
				new ModelElement(new Vector3f(0.0F, 0.0F, 0.0F), new Vector3f(16.0F, 16.0F, 16.0F), map);
