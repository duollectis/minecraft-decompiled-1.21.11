...
public class ChunkRenderData implements AbstractChunkRenderData {
	...
	private final BuiltBuffer.@Nullable SortState translucencySortingData;
		...
		if (buffers != null) {
			...
			Buffers
					...
					new Buffers(
							...
							builtBuffer.getDrawParameters().indexType()
					);
	...
	public BuiltBuffer.@Nullable SortState getTranslucencySortingData() {
