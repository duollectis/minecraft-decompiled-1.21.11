...
public class FrameGraphBuilder {
   ...
   <T> FrameGraphBuilder.ResourceNode<T> createResourceNode(String name, ClosableFactory<T> factory, FrameGraphBuilder.@Nullable FramePassImpl stageNode) {
   ...
   static class ResourceNode<T> extends FrameGraphBuilder.Node<T> {
      ...
      public ResourceNode(int id, String name, FrameGraphBuilder.@Nullable FramePassImpl from, ClosableFactory<T> factory) {
         super(name, from);
         this.id = id;
