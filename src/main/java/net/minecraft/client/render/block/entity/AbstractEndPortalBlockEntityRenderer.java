...
/**
 * {@code AbstractEndPortalBlockEntityRenderer}.
 */
public abstract class AbstractEndPortalBlockEntityRenderer<T extends EndPortalBlockEntity, S extends EndPortalBlockEntityRenderState>
	...
	public void updateRenderState(
		...
		BlockEntityRenderer.super.updateRenderState(
				...
				endPortalBlockEntityRenderState,
				f,
				vec3d,
	...
	public void render(
		...
		orderedRenderCommandQueue.submitCustom(
				matrixStack,
				this.getLayer(),
				(matricesEntry, vertexConsumer) -> this.renderSides(
						endPortalBlockEntityRenderState.sides,
