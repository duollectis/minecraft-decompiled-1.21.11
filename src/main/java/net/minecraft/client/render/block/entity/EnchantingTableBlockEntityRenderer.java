...
/**
 * {@code EnchantingTableBlockEntityRenderer}.
 */
public class EnchantingTableBlockEntityRenderer implements BlockEntityRenderer<EnchantingTableBlockEntity, EnchantingTableBlockEntityRenderState> {
	...
	public void updateRenderState(
		...
		BlockEntityRenderer.super.updateRenderState(
				...
				enchantingTableBlockEntityRenderState,
				f,
				vec3d,
				crumblingOverlayCommand
		);
		enchantingTableBlockEntityRenderState.pageAngle =
				MathHelper.lerp(f, enchantingTableBlockEntity.pageAngle, enchantingTableBlockEntity.nextPageAngle);
	...
	public void render(
		...
		matrixStack.translate(
				0.0F,
				0.1F + MathHelper.sin(enchantingTableBlockEntityRenderState.ticks * 0.1F) * 0.01F,
				0.0F
		);
