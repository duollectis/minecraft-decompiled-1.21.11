...
/**
 * {@code BannerBlockModel}.
 */
public class BannerBlockModel extends Model<Unit> {

	public static final int WAVE_AMPLITUDE = 20;
	public static final int WAVE_PERIOD = 40;
	...
	public static TexturedModelData getTexturedModelData(boolean standing) {
		...
		if (standing) {
			modelPartData.addChild(
					"pole",
					ModelPartBuilder.create().uv(44, 0).cuboid(-1.0F, -42.0F, -1.0F, 2.0F, 42.0F, 2.0F),
					ModelTransform.NONE
			);
		}
		...
		modelPartData.addChild(
				...
				ModelPartBuilder
						.create()
						.uv(0, 42)
						.cuboid(-10.0F, standing ? -44.0F : -20.5F, standing ? -1.0F : 9.5F, 20.0F, 2.0F, 2.0F),
				ModelTransform.NONE
		);
