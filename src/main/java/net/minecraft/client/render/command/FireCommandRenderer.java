...
public class FireCommandRenderer {
	...
	public void render(
		...
		for (OrderedRenderCommandQueueImpl.FireCommand fireCommand : queue.getFireCommands()) {
			this.render(
					fireCommand.matricesEntry(),
					vertexConsumers,
					fireCommand.renderState(),
	...
	private void render(
		...
		for (VertexConsumer vertexConsumer = vertexConsumers.getBuffer(TexturedRenderLayers.getEntityCutout());
		     i > 0.0F;
		     l++) {
