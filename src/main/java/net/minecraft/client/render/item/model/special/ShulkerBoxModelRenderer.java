...
public class ShulkerBoxModelRenderer implements SimpleSpecialModelRenderer {
	...
	public ShulkerBoxModelRenderer(
			ShulkerBoxBlockEntityRenderer blockEntityRenderer,
			float openness,
			Direction facing,
	...
	public record Unbaked(
		...
		public static final MapCodec<ShulkerBoxModelRenderer.Unbaked> CODEC = RecordCodecBuilder.mapCodec(
				instance -> instance.group(
						                    ...
						                    Codec.FLOAT
								                    ...
								                    .forGetter(ShulkerBoxModelRenderer.Unbaked::openness),
						                    Direction.CODEC
								                    .optionalFieldOf("orientation", Direction.UP)
								                    .forGetter(ShulkerBoxModelRenderer.Unbaked::facing)
				                    )
		...
		public SpecialModelRenderer<?> bake(SpecialModelRenderer.BakeContext context) {
			return new ShulkerBoxModelRenderer(
					new ShulkerBoxBlockEntityRenderer(context),
					this.openness,
					this.facing,
					TexturedRenderLayers.SHULKER_SPRITE_MAPPER.map(this.texture)
			);
		}
	}
}
