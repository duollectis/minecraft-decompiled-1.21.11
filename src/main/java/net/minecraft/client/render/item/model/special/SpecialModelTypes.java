...
/**
 * {@code SpecialModelTypes}.
 */
public class SpecialModelTypes {

	public static final Codecs.IdMapper<Identifier, MapCodec<? extends SpecialModelRenderer.Unbaked>>
			ID_MAPPER =
			new Codecs.IdMapper<>();
	public static final Codec<SpecialModelRenderer.Unbaked> CODEC = ID_MAPPER.getCodec(Identifier.CODEC)
	                                                                         .dispatch(
			                                                                         SpecialModelRenderer.Unbaked::getCodec,
			                                                                         codec -> codec
	                                                                         );
	private static final Map<Block, SpecialModelRenderer.Unbaked>
			BLOCK_TO_MODEL_TYPE =
			ImmutableMap.<Block, SpecialModelRenderer.Unbaked>builder()
			            ...
			            .put(
					            ...
					            new HeadModelRenderer.Unbaked(SkullBlock.Type.WITHER_SKELETON)
			            )
			            ...
			            .put(
					            ...
					            new ChestModelRenderer.Unbaked(ChestModelRenderer.EXPOSED_COPPER_ID)
			            )
			            .put(
					            Blocks.WEATHERED_COPPER_CHEST,
					            new ChestModelRenderer.Unbaked(ChestModelRenderer.WEATHERED_COPPER_ID)
			            )
			            .put(
					            Blocks.OXIDIZED_COPPER_CHEST,
					            new ChestModelRenderer.Unbaked(ChestModelRenderer.OXIDIZED_COPPER_ID)
			            )
			            ...
			            .build();
	private static final ChestModelRenderer.Unbaked
			CHRISTMAS_CHEST =
