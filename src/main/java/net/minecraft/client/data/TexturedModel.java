...
public class TexturedModel {
	...
	public static final TexturedModel.Factory
			...
			makeFactory(TextureMap::all, Models.CUBE_ALL_INNER_FACES);
	public static final TexturedModel.Factory
			CUBE_MIRRORED_ALL =
			makeFactory(TextureMap::all, Models.CUBE_MIRRORED_ALL);
	...
	public static final TexturedModel.Factory
			...
			makeFactory(TextureMap::sideEnd, Models.CUBE_COLUMN_HORIZONTAL);
	public static final TexturedModel.Factory
			CUBE_BOTTOM_TOP =
			makeFactory(TextureMap::sideTopBottom, Models.CUBE_BOTTOM_TOP);
	...
	public static final TexturedModel.Factory
			...
			makeFactory(TextureMap::sideFrontTopBottom, Models.ORIENTABLE_WITH_BOTTOM);
	public static final TexturedModel.Factory CARPET = makeFactory(TextureMap::wool, Models.CARPET);
	public static final TexturedModel.Factory
			MOSSY_CARPET_SIDE =
			makeFactory(TextureMap::side, Models.MOSSY_CARPET_SIDE);
	...
	public static final TexturedModel.Factory
			...
			makeFactory(TextureMap::texture, Models.TEMPLATE_LEAF_LITTER_1);
	public static final TexturedModel.Factory
			TEMPLATE_LEAF_LITTER_2 =
			makeFactory(TextureMap::texture, Models.TEMPLATE_LEAF_LITTER_2);
	public static final TexturedModel.Factory
			TEMPLATE_LEAF_LITTER_3 =
			makeFactory(TextureMap::texture, Models.TEMPLATE_LEAF_LITTER_3);
	public static final TexturedModel.Factory
			TEMPLATE_LEAF_LITTER_4 =
			makeFactory(TextureMap::texture, Models.TEMPLATE_LEAF_LITTER_4);
	public static final TexturedModel.Factory
			TEMPLATE_GLAZED_TERRACOTTA =
			makeFactory(TextureMap::pattern, Models.TEMPLATE_GLAZED_TERRACOTTA);
	...
	public static final TexturedModel.Factory
			TEMPLATE_LANTERN =
			makeFactory(TextureMap::lantern, Models.TEMPLATE_LANTERN);
	public static final TexturedModel.Factory
			TEMPLATE_HANGING_LANTERN =
			makeFactory(TextureMap::lantern, Models.TEMPLATE_HANGING_LANTERN);
	public static final TexturedModel.Factory TEMPLATE_CHAIN = makeFactory(TextureMap::texture, Models.TEMPLATE_CHAIN);
	public static final TexturedModel.Factory
			TEMPLATE_SEAGRASS =
			makeFactory(TextureMap::texture, Models.TEMPLATE_SEAGRASS);
	public static final TexturedModel.Factory
			END_FOR_TOP_CUBE_COLUMN =
			makeFactory(TextureMap::sideAndEndForTop, Models.CUBE_COLUMN);
	public static final TexturedModel.Factory
			END_FOR_TOP_CUBE_COLUMN_HORIZONTAL =
			makeFactory(TextureMap::sideAndEndForTop, Models.CUBE_COLUMN_HORIZONTAL);
	public static final TexturedModel.Factory
			SIDE_TOP_BOTTOM_WALL =
			makeFactory(TextureMap::wallSideTopBottom, Models.CUBE_BOTTOM_TOP);
