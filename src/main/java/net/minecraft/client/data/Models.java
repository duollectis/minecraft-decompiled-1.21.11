...
public class Models {
	...
	public static final Model
			...
			block("cube_north_west_mirrored_all", "_north_west_mirrored", TextureKey.ALL);
	public static final Model
			CUBE_COLUMN_UV_LOCKED_X =
			block("cube_column_uv_locked_x", "_x", TextureKey.END, TextureKey.SIDE);
	public static final Model
			CUBE_COLUMN_UV_LOCKED_Y =
			block("cube_column_uv_locked_y", "_y", TextureKey.END, TextureKey.SIDE);
	public static final Model
			CUBE_COLUMN_UV_LOCKED_Z =
			block("cube_column_uv_locked_z", "_z", TextureKey.END, TextureKey.SIDE);
	public static final Model CUBE_COLUMN = block("cube_column", TextureKey.END, TextureKey.SIDE);
	public static final Model
			CUBE_COLUMN_HORIZONTAL =
			block("cube_column_horizontal", "_horizontal", TextureKey.END, TextureKey.SIDE);
	public static final Model
			CUBE_COLUMN_MIRRORED =
			block("cube_column_mirrored", "_mirrored", TextureKey.END, TextureKey.SIDE);
	public static final Model CUBE_TOP = block("cube_top", TextureKey.TOP, TextureKey.SIDE);
	public static final Model
			CUBE_BOTTOM_TOP =
			block("cube_bottom_top", TextureKey.TOP, TextureKey.BOTTOM, TextureKey.SIDE);
	public static final Model
			CUBE_BOTTOM_TOP_INNER_FACES =
			block("cube_bottom_top_inner_faces", TextureKey.TOP, TextureKey.BOTTOM, TextureKey.SIDE);
	...
	public static final Model
			...
			block("orientable_with_bottom", TextureKey.TOP, TextureKey.BOTTOM, TextureKey.SIDE, TextureKey.FRONT);
	public static final Model
			ORIENTABLE_VERTICAL =
			block("orientable_vertical", "_vertical", TextureKey.FRONT, TextureKey.SIDE);
	...
	public static final Model
			DOOR_BOTTOM_LEFT =
			block("door_bottom_left", "_bottom_left", TextureKey.TOP, TextureKey.BOTTOM);
	public static final Model
			DOOR_BOTTOM_LEFT_OPEN =
			block("door_bottom_left_open", "_bottom_left_open", TextureKey.TOP, TextureKey.BOTTOM);
	public static final Model
			DOOR_BOTTOM_RIGHT =
			block("door_bottom_right", "_bottom_right", TextureKey.TOP, TextureKey.BOTTOM);
	public static final Model
			DOOR_BOTTOM_RIGHT_OPEN =
			block("door_bottom_right_open", "_bottom_right_open", TextureKey.TOP, TextureKey.BOTTOM);
	public static final Model DOOR_TOP_LEFT = block("door_top_left", "_top_left", TextureKey.TOP, TextureKey.BOTTOM);
	public static final Model
			DOOR_TOP_LEFT_OPEN =
			block("door_top_left_open", "_top_left_open", TextureKey.TOP, TextureKey.BOTTOM);
	public static final Model DOOR_TOP_RIGHT = block("door_top_right", "_top_right", TextureKey.TOP, TextureKey.BOTTOM);
	public static final Model
			DOOR_TOP_RIGHT_OPEN =
			block("door_top_right_open", "_top_right_open", TextureKey.TOP, TextureKey.BOTTOM);
	public static final Model
			CUSTOM_FENCE_POST =
			block("custom_fence_post", "_post", TextureKey.TEXTURE, TextureKey.PARTICLE);
	public static final Model
			CUSTOM_FENCE_SIDE_NORTH =
			block("custom_fence_side_north", "_side_north", TextureKey.TEXTURE);
	public static final Model
			CUSTOM_FENCE_SIDE_EAST =
			block("custom_fence_side_east", "_side_east", TextureKey.TEXTURE);
	public static final Model
			CUSTOM_FENCE_SIDE_SOUTH =
			block("custom_fence_side_south", "_side_south", TextureKey.TEXTURE);
	public static final Model
			CUSTOM_FENCE_SIDE_WEST =
			block("custom_fence_side_west", "_side_west", TextureKey.TEXTURE);
	public static final Model
			CUSTOM_FENCE_INVENTORY =
			block("custom_fence_inventory", "_inventory", TextureKey.TEXTURE);
	...
	public static final Model
			...
			block("template_custom_fence_gate", TextureKey.TEXTURE, TextureKey.PARTICLE);
	public static final Model
			TEMPLATE_CUSTOM_FENCE_GATE_OPEN =
			block("template_custom_fence_gate_open", "_open", TextureKey.TEXTURE, TextureKey.PARTICLE);
	public static final Model
			TEMPLATE_CUSTOM_FENCE_GATE_WALL =
			block("template_custom_fence_gate_wall", "_wall", TextureKey.TEXTURE, TextureKey.PARTICLE);
	...
	public static final Model
			...
			block("template_fence_gate_wall_open", "_wall_open", TextureKey.TEXTURE);
	...
	public static final Model
			INNER_STAIRS =
			block("inner_stairs", "_inner", TextureKey.BOTTOM, TextureKey.TOP, TextureKey.SIDE);
	public static final Model
			OUTER_STAIRS =
			block("outer_stairs", "_outer", TextureKey.BOTTOM, TextureKey.TOP, TextureKey.SIDE);
	...
	public static final Model
			...
			block("template_trapdoor_bottom", "_bottom", TextureKey.TEXTURE);
	...
	public static final Model
			...
			block("template_orientable_trapdoor_top", "_top", TextureKey.TEXTURE);
	public static final Model
			TEMPLATE_ORIENTABLE_TRAPDOOR_BOTTOM =
			block("template_orientable_trapdoor_bottom", "_bottom", TextureKey.TEXTURE);
	public static final Model
			TEMPLATE_ORIENTABLE_TRAPDOOR_OPEN =
			block("template_orientable_trapdoor_open", "_open", TextureKey.TEXTURE);
	...
	public static final Model
			...
			block("flower_pot_cross_emissive", TextureKey.PLANT, TextureKey.CROSS_EMISSIVE);
	...
	public static final Model
			...
			block("template_daylight_detector", TextureKey.TOP, TextureKey.SIDE);
	public static final Model
			TEMPLATE_GLASS_PANE_NOSIDE =
			block("template_glass_pane_noside", "_noside", TextureKey.PANE);
	public static final Model
			TEMPLATE_GLASS_PANE_NOSIDE_ALT =
			block("template_glass_pane_noside_alt", "_noside_alt", TextureKey.PANE);
	public static final Model
			TEMPLATE_GLASS_PANE_POST =
			block("template_glass_pane_post", "_post", TextureKey.PANE, TextureKey.EDGE);
	public static final Model
			TEMPLATE_GLASS_PANE_SIDE =
			block("template_glass_pane_side", "_side", TextureKey.PANE, TextureKey.EDGE);
	public static final Model
			TEMPLATE_GLASS_PANE_SIDE_ALT =
			block("template_glass_pane_side_alt", "_side_alt", TextureKey.PANE, TextureKey.EDGE);
	public static final Model
			TEMPLATE_COMMAND_BLOCK =
			block("template_command_block", TextureKey.FRONT, TextureKey.BACK, TextureKey.SIDE);
	...
	public static final Model
			...
			block("template_chiseled_bookshelf_slot_top_mid", "_slot_top_mid", TextureKey.TEXTURE);
	...
	public static final Model TEMPLATE_SHELF_BODY = block("template_shelf_body", TextureKey.ALL, TextureKey.PARTICLE);
	public static final Model
			TEMPLATE_SHELF_INVENTORY =
			block("template_shelf_inventory", "_inventory", TextureKey.ALL, TextureKey.PARTICLE);
	public static final Model
			TEMPLATE_SHELF_UNPOWERED =
			block("template_shelf_unpowered", "_unpowered", TextureKey.ALL, TextureKey.PARTICLE);
	public static final Model
			TEMPLATE_SHELF_UNCONNECTED =
			block("template_shelf_unconnected", "_unconnected", TextureKey.ALL, TextureKey.PARTICLE);
	public static final Model
			TEMPLATE_SHELF_LEFT =
			block("template_shelf_left", "_left", TextureKey.ALL, TextureKey.PARTICLE);
	public static final Model
			TEMPLATE_SHELF_CENTER =
			block("template_shelf_center", "_center", TextureKey.ALL, TextureKey.PARTICLE);
	public static final Model
			TEMPLATE_SHELF_RIGHT =
			block("template_shelf_right", "_right", TextureKey.ALL, TextureKey.PARTICLE);
	...
	public static final Model
			...
			block("template_hanging_lantern", "_hanging", TextureKey.LANTERN);
	public static final Model TEMPLATE_CHAIN = block("template_chain", TextureKey.TEXTURE);
	public static final Model TEMPLATE_BARS_CAP = block("template_bars_cap", "_cap", TextureKey.BARS, TextureKey.EDGE);
	public static final Model
			TEMPLATE_BARS_CAP_ALT =
			block("template_bars_cap_alt", "_cap_alt", TextureKey.BARS, TextureKey.EDGE);
	public static final Model
			TEMPLATE_BARS_POST =
			block("template_bars_post", "_post", TextureKey.BARS, TextureKey.EDGE);
	public static final Model
			TEMPLATE_BARS_POST_ENDS =
			block("template_bars_post_ends", "_post_ends", TextureKey.BARS, TextureKey.EDGE);
	public static final Model
			TEMPLATE_BARS_SIDE =
			block("template_bars_side", "_side", TextureKey.BARS, TextureKey.EDGE);
	public static final Model
			TEMPLATE_BARS_SIDE_ALT =
			block("template_bars_side_alt", "_side_alt", TextureKey.BARS, TextureKey.EDGE);
	...
	public static final Model
			TEMPLATE_PISTON =
			block("template_piston", TextureKey.PLATFORM, TextureKey.BOTTOM, TextureKey.SIDE);
	public static final Model
			TEMPLATE_PISTON_HEAD =
			block("template_piston_head", TextureKey.PLATFORM, TextureKey.SIDE, TextureKey.UNSTICKY);
	public static final Model
			TEMPLATE_PISTON_HEAD_SHORT =
			block("template_piston_head_short", TextureKey.PLATFORM, TextureKey.SIDE, TextureKey.UNSTICKY);
	...
	public static final Model DRIED_GHAST = block(
			"dried_ghast",
			TextureKey.PARTICLE,
			TextureKey.TOP,
			TextureKey.BOTTOM,
	...
	public static final Model
			...
			block("template_potted_azalea_bush", TextureKey.PLANT, TextureKey.TOP, TextureKey.SIDE);
	public static final Model
			TEMPLATE_POTTED_FLOWERING_AZALEA_BUSH =
			block("template_potted_azalea_bush", TextureKey.PLANT, TextureKey.TOP, TextureKey.SIDE);
	...
	public static final Model
			GENERATED_THREE_LAYERS =
			item("generated", TextureKey.LAYER0, TextureKey.LAYER1, TextureKey.LAYER2);
	...
	public static final Model
			TEMPLATE_BUNDLE_OPEN_FRONT =
			openBundle("template_bundle_open_front", "_open_front", TextureKey.LAYER0);
	public static final Model
			TEMPLATE_BUNDLE_OPEN_BACK =
			openBundle("template_bundle_open_back", "_open_back", TextureKey.LAYER0);
	...
	public static final Model SPEAR_IN_HAND = openBundle("spear_in_hand", "_in_hand", TextureKey.LAYER0);
	...
	public static final Model
			...
			block("template_three_candles", TextureKey.ALL, TextureKey.PARTICLE);
	public static final Model
			TEMPLATE_FOUR_CANDLES =
			block("template_four_candles", TextureKey.ALL, TextureKey.PARTICLE);
	...
	public static final Model
			TEMPLATE_VAULT =
			block("template_vault", TextureKey.TOP, TextureKey.BOTTOM, TextureKey.SIDE, TextureKey.FRONT);
	public static final Model HANDHELD_MACE = item("handheld_mace", TextureKey.LAYER0);
	public static final Model TEMPLATE_LIGHTNING_ROD = block("template_lightning_rod", TextureKey.TEXTURE);
	...
	private static Model block(String parent, String variant, TextureKey... requiredTextureKeys) {
		return new Model(
				Optional.of(Identifier.ofVanilla("block/" + parent)),
				Optional.of(variant),
				requiredTextureKeys
		);
	}
