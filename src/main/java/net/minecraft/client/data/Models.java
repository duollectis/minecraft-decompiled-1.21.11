...
public class Models {
   ...
   public static final Model TEMPLATE_SHELF_INVENTORY = block("template_shelf_inventory", "_inventory", TextureKey.ALL, TextureKey.PARTICLE);
   public static final Model TEMPLATE_SHELF_UNPOWERED = block("template_shelf_unpowered", "_unpowered", TextureKey.ALL, TextureKey.PARTICLE);
   public static final Model TEMPLATE_SHELF_UNCONNECTED = block("template_shelf_unconnected", "_unconnected", TextureKey.ALL, TextureKey.PARTICLE);
   public static final Model TEMPLATE_SHELF_LEFT = block("template_shelf_left", "_left", TextureKey.ALL, TextureKey.PARTICLE);
   public static final Model TEMPLATE_SHELF_CENTER = block("template_shelf_center", "_center", TextureKey.ALL, TextureKey.PARTICLE);
   public static final Model TEMPLATE_SHELF_RIGHT = block("template_shelf_right", "_right", TextureKey.ALL, TextureKey.PARTICLE);
   ...
   public static final Model TEMPLATE_BARS_CAP_ALT = block("template_bars_cap_alt", "_cap_alt", TextureKey.BARS, TextureKey.EDGE);
   public static final Model TEMPLATE_BARS_POST = block("template_bars_post", "_post", TextureKey.BARS, TextureKey.EDGE);
   public static final Model TEMPLATE_BARS_POST_ENDS = block("template_bars_post_ends", "_post_ends", TextureKey.BARS, TextureKey.EDGE);
   public static final Model TEMPLATE_BARS_SIDE = block("template_bars_side", "_side", TextureKey.BARS, TextureKey.EDGE);
   public static final Model TEMPLATE_BARS_SIDE_ALT = block("template_bars_side_alt", "_side_alt", TextureKey.BARS, TextureKey.EDGE);
