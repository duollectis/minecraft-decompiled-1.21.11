...
public class BlockStateModelGenerator {
	...
	static final List<Block>
			...
			List.of(Blocks.OAK_TRAPDOOR, Blocks.DARK_OAK_TRAPDOOR, Blocks.IRON_TRAPDOOR);
	...
	public static final ModelVariantOperator
			ROTATE_X_180 =
			ModelVariantOperator.ROTATION_X.withValue(AxisRotation.R180);
	public static final ModelVariantOperator
			ROTATE_X_270 =
			ModelVariantOperator.ROTATION_X.withValue(AxisRotation.R270);
	public static final ModelVariantOperator ROTATE_Y_90 = ModelVariantOperator.ROTATION_Y.withValue(AxisRotation.R90);
	public static final ModelVariantOperator
			ROTATE_Y_180 =
			ModelVariantOperator.ROTATION_Y.withValue(AxisRotation.R180);
	public static final ModelVariantOperator
			ROTATE_Y_270 =
			ModelVariantOperator.ROTATION_Y.withValue(AxisRotation.R270);
	private static final Function<MultipartModelConditionBuilder, MultipartModelConditionBuilder>
	...
	private static final BlockStateVariantMap<ModelVariantOperator>
			NORTH_DEFAULT_ROTATION_OPERATIONS =
			BlockStateVariantMap.operations(Properties.FACING)
	...
	static final Map<Block, TexturedModel> TEXTURED_MODELS = ImmutableMap.<Block, TexturedModel>builder()
	                                                                     .put(
			                                                                     Blocks.SANDSTONE,
			                                                                     TexturedModel.SIDE_TOP_BOTTOM_WALL.get(
					                                                                     Blocks.SANDSTONE)
	                                                                     )
	                                                                     .put(
	                                                                     ...
	                                                                     .put(
			                                                                     ...
			                                                                     TexturedModel.getCubeAll(TextureMap.getSubId(
					                                                                     Blocks.SANDSTONE,
					                                                                     "_top"
			                                                                     ))
	                                                                     )
	                                                                     ...
	                                                                     .put(
			                                                                     ...
			                                                                     TexturedModel.CUBE_COLUMN
					                                                                     ...
					                                                                     .textures(textureMap -> textureMap.put(
							                                                                     TextureKey.SIDE,
							                                                                     TextureMap.getId(Blocks.CUT_SANDSTONE)
					                                                                     ))
	                                                                     )
	                                                                     .put(
			                                                                     ...
			                                                                     TexturedModel.CUBE_COLUMN
					                                                                     ...
					                                                                     .textures(textureMap -> textureMap.put(
							                                                                     TextureKey.SIDE,
							                                                                     TextureMap.getId(Blocks.CUT_RED_SANDSTONE)
					                                                                     ))
	                                                                     )
	                                                                     .put(
			                                                                     Blocks.QUARTZ_BLOCK,
			                                                                     TexturedModel.CUBE_COLUMN.get(Blocks.QUARTZ_BLOCK)
	                                                                     )
	                                                                     .put(
	                                                                     ...
	                                                                     .put(
			                                                                     Blocks.BLACKSTONE,
			                                                                     TexturedModel.SIDE_END_WALL.get(Blocks.BLACKSTONE)
	                                                                     )
	                                                                     .put(
			                                                                     Blocks.DEEPSLATE,
			                                                                     TexturedModel.SIDE_END_WALL.get(Blocks.DEEPSLATE)
	                                                                     )
	                                                                     .put(
			                                                                     ...
			                                                                     TexturedModel.CUBE_COLUMN
					                                                                     ...
					                                                                     .textures(textureMap -> textureMap.put(
							                                                                     TextureKey.SIDE,
							                                                                     TextureMap.getId(Blocks.CHISELED_QUARTZ_BLOCK)
					                                                                     ))
	                                                                     )
	                                                                     .put(
			                                                                     Blocks.CHISELED_SANDSTONE,
			                                                                     TexturedModel.CUBE_COLUMN
					                                                                     .get(Blocks.CHISELED_SANDSTONE)
					                                                                     .textures(textureMap -> {
						                                                                     textureMap.put(
								                                                                     TextureKey.END,
								                                                                     TextureMap.getSubId(
	                                                                     ...
	                                                                     .put(
			                                                                     ...
			                                                                     TexturedModel.CUBE_COLUMN
					                                                                     .get(Blocks.CHISELED_RED_SANDSTONE)
					                                                                     .textures(textureMap -> {
						                                                                     textureMap.put(
								                                                                     TextureKey.END,
								                                                                     TextureMap.getSubId(
	                                                                     ...
	                                                                     .put(
			                                                                     ...
			                                                                     TexturedModel.SIDE_END_WALL.get(Blocks.CHISELED_TUFF_BRICKS)
	                                                                     )
	                                                                     .put(
			                                                                     Blocks.CHISELED_TUFF,
			                                                                     TexturedModel.SIDE_END_WALL.get(Blocks.CHISELED_TUFF)
	                                                                     )
	                                                                     .build();
	static final Map<BlockFamily.Variant, BiConsumer<BlockStateModelGenerator.BlockTexturePool, Block>>
			VARIANT_POOL_FUNCTIONS =
			ImmutableMap.<BlockFamily.Variant, BiConsumer<BlockStateModelGenerator.BlockTexturePool, Block>>builder()
			            ...
			            .put(
					            ...
					            BlockStateModelGenerator.BlockTexturePool::customFenceGate
			            )
	...
	private static final Map<BlockStateModelGenerator.ChiseledBookshelfModelCacheKey, Identifier>
	...
	public static WeightedVariant createWeightedVariant(ModelVariant... variants) {
		return new WeightedVariant(Pool.of(Arrays
				.stream(variants)
				.map(variant -> new Weighted<>(variant, 1))
				.toList()));
	}
	...
	public static MultipartModelConditionBuilder createMultipartConditionBuilderWith(
	...
	public static MultipartModelCondition or(MultipartModelConditionBuilder... conditionBuilders) {
		return new MultipartModelCombinedCondition(
				...
				Stream.of(conditionBuilders).map(MultipartModelConditionBuilder::build).toList()
		);
	}
	...
	public static BlockModelDefinitionCreator createStoneState(
		...
		ModelVariant
				modelVariant =
				createModelVariant(Models.CUBE_MIRRORED_ALL.upload(block, textures, modelCollector));
	...
	public static BlockModelDefinitionCreator createMudBrickState(
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.CUBE_NORTH_WEST_MIRRORED_ALL.upload(block, textures, modelCollector));
	...
	public static BlockModelDefinitionCreator createDeepslateState(
		...
		ModelVariant
				modelVariant =
				createModelVariant(Models.CUBE_COLUMN_MIRRORED.upload(block, textures, modelCollector));
		return VariantsBlockModelDefinitionCreator
				.of(block, modelWithMirroring(variant, modelVariant))
				.apply(createAxisRotatedVariantMap());
	}
	...
	public final Identifier uploadBlockItemModel(Item item, Block block, String textureSuffix) {
		return Models.GENERATED.upload(
				...
				TextureMap.layer0(TextureMap.getSubId(block, textureSuffix)),
				this.modelCollector
		);
	}
	...
	public Identifier uploadTwoLayerBlockItemModel(Item item, Block block, String layer1Suffix) {
		...
		return Models.GENERATED_TWO_LAYERS.upload(
				ModelIds.getItemModelId(item),
	...
	public static WeightedVariant modelWithYRotation(ModelVariant variant) {
		return createWeightedVariant(
				variant,
				variant.with(ROTATE_Y_90),
				variant.with(ROTATE_Y_180),
				variant.with(ROTATE_Y_270)
		);
	}
	...
	public static WeightedVariant modelWithMirroring(ModelVariant variant, ModelVariant mirroredVariant) {
		return createWeightedVariant(
				...
				mirroredVariant,
				variant.with(ROTATE_Y_180),
				mirroredVariant.with(ROTATE_Y_180)
		);
	}

	public static BlockStateVariantMap<WeightedVariant> createBooleanModelMap(
			BooleanProperty property,
			WeightedVariant trueModel,
			WeightedVariant falseModel
	) {
	...
	public final void registerMirrorable(Block block) {
		...
		ModelVariant
				modelVariant2 =
				createModelVariant(TexturedModel.CUBE_MIRRORED_ALL.upload(block, this.modelCollector));
		this.blockStateCollector.accept(VariantsBlockModelDefinitionCreator.of(
				block,
				modelWithMirroring(modelVariant, modelVariant2)
		));
	}
	...
	public final void registerRotatable(Block block) {
		...
		this.blockStateCollector.accept(VariantsBlockModelDefinitionCreator.of(
				block,
				modelWithYRotation(modelVariant)
		));
	}
	...
	public final void registerBrushableBlock(Block block) {
		this.blockStateCollector.accept(VariantsBlockModelDefinitionCreator
				.of(block)
				.with(BlockStateVariantMap.models(Properties.DUSTED).generate(dusted -> {
					...
					Identifier
							...
							Models.CUBE_ALL.upload(
									block,
									string,
									new TextureMap().put(TextureKey.ALL, identifier),
									this.modelCollector
							);
	...
	public static BlockModelDefinitionCreator createButtonBlockState(
			Block buttonBlock,
			WeightedVariant unpressedModel,
			WeightedVariant pressedModel
	) {
		return VariantsBlockModelDefinitionCreator.of(buttonBlock)
		                                          .with(BlockStateVariantMap
				                                          .models(Properties.POWERED)
				                                          .register(false, unpressedModel)
				                                          .register(true, pressedModel))
		                                          .apply(
				                                          BlockStateVariantMap
						                                          ...
						                                          .register(
								                                          BlockFace.WALL,
								                                          Direction.EAST,
								                                          ROTATE_Y_90.then(ROTATE_X_90).then(UV_LOCK)
						                                          )
						                                          .register(
								                                          BlockFace.WALL,
								                                          Direction.WEST,
								                                          ROTATE_Y_270.then(ROTATE_X_90).then(UV_LOCK)
						                                          )
						                                          .register(
								                                          BlockFace.WALL,
								                                          Direction.SOUTH,
								                                          ROTATE_Y_180.then(ROTATE_X_90).then(UV_LOCK)
						                                          )
						                                          .register(
								                                          BlockFace.WALL,
								                                          Direction.NORTH,
						                                          ...
						                                          .register(
								                                          BlockFace.CEILING,
								                                          Direction.EAST,
								                                          ROTATE_Y_270.then(ROTATE_X_180)
						                                          )
						                                          .register(
								                                          BlockFace.CEILING,
								                                          Direction.WEST,
								                                          ROTATE_Y_90.then(ROTATE_X_180)
						                                          )
						                                          .register(
								                                          BlockFace.CEILING,
								                                          Direction.SOUTH,
		                                          ...
		                                          .with(
				                                          BlockStateVariantMap
						                                          ...
						                                          .register(
								                                          ...
								                                          DoorHinge.RIGHT,
								                                          false,
								                                          bottomRightClosedModel.apply(ROTATE_Y_180)
						                                          )
						                                          .register(
								                                          Direction.NORTH,
								                                          DoubleBlockHalf.LOWER,
								                                          DoorHinge.RIGHT,
								                                          false,
								                                          bottomRightClosedModel.apply(ROTATE_Y_270)
						                                          )
						                                          .register(
								                                          Direction.EAST,
								                                          DoubleBlockHalf.LOWER,
								                                          DoorHinge.LEFT,
								                                          true,
								                                          bottomLeftOpenModel.apply(ROTATE_Y_90)
						                                          )
						                                          .register(
								                                          Direction.SOUTH,
								                                          DoubleBlockHalf.LOWER,
								                                          DoorHinge.LEFT,
								                                          true,
								                                          bottomLeftOpenModel.apply(ROTATE_Y_180)
						                                          )
						                                          .register(
								                                          Direction.WEST,
								                                          DoubleBlockHalf.LOWER,
								                                          DoorHinge.LEFT,
								                                          true,
								                                          bottomLeftOpenModel.apply(ROTATE_Y_270)
						                                          )
						                                          .register(
								                                          Direction.NORTH,
								                                          DoubleBlockHalf.LOWER,
						                                          ...
						                                          .register(
								                                          ...
								                                          DoorHinge.RIGHT,
								                                          true,
								                                          bottomRightOpenModel.apply(ROTATE_Y_270)
						                                          )
						                                          .register(
								                                          Direction.SOUTH,
								                                          DoubleBlockHalf.LOWER,
						                                          ...
						                                          .register(
								                                          ...
								                                          DoorHinge.RIGHT,
								                                          true,
								                                          bottomRightOpenModel.apply(ROTATE_Y_90)
						                                          )
						                                          .register(
								                                          Direction.NORTH,
								                                          DoubleBlockHalf.LOWER,
								                                          DoorHinge.RIGHT,
								                                          true,
								                                          bottomRightOpenModel.apply(ROTATE_Y_180)
						                                          )
						                                          .register(
								                                          Direction.EAST,
						                                          ...
						                                          .register(
								                                          ...
								                                          DoorHinge.LEFT,
								                                          false,
								                                          topLeftClosedModel.apply(ROTATE_Y_90)
						                                          )
						                                          .register(
								                                          Direction.WEST,
								                                          DoubleBlockHalf.UPPER,
								                                          DoorHinge.LEFT,
								                                          false,
								                                          topLeftClosedModel.apply(ROTATE_Y_180)
						                                          )
						                                          .register(
								                                          Direction.NORTH,
								                                          DoubleBlockHalf.UPPER,
								                                          DoorHinge.LEFT,
								                                          false,
								                                          topLeftClosedModel.apply(ROTATE_Y_270)
						                                          )
						                                          .register(
								                                          Direction.EAST,
								                                          DoubleBlockHalf.UPPER,
						                                          ...
						                                          .register(
								                                          ...
								                                          DoorHinge.RIGHT,
								                                          false,
								                                          topRightClosedModel.apply(ROTATE_Y_90)
						                                          )
						                                          .register(
								                                          Direction.WEST,
								                                          DoubleBlockHalf.UPPER,
								                                          DoorHinge.RIGHT,
								                                          false,
								                                          topRightClosedModel.apply(ROTATE_Y_180)
						                                          )
						                                          .register(
								                                          Direction.NORTH,
								                                          DoubleBlockHalf.UPPER,
								                                          DoorHinge.RIGHT,
								                                          false,
								                                          topRightClosedModel.apply(ROTATE_Y_270)
						                                          )
						                                          .register(
								                                          Direction.EAST,
								                                          DoubleBlockHalf.UPPER,
								                                          DoorHinge.LEFT,
								                                          true,
								                                          topLeftOpenModel.apply(ROTATE_Y_90)
						                                          )
						                                          .register(
								                                          Direction.SOUTH,
								                                          DoubleBlockHalf.UPPER,
								                                          DoorHinge.LEFT,
								                                          true,
								                                          topLeftOpenModel.apply(ROTATE_Y_180)
						                                          )
						                                          .register(
								                                          Direction.WEST,
								                                          DoubleBlockHalf.UPPER,
								                                          DoorHinge.LEFT,
								                                          true,
								                                          topLeftOpenModel.apply(ROTATE_Y_270)
						                                          )
						                                          .register(
								                                          Direction.NORTH,
								                                          DoubleBlockHalf.UPPER,
						                                          ...
						                                          .register(
								                                          ...
								                                          DoorHinge.RIGHT,
								                                          true,
								                                          topRightOpenModel.apply(ROTATE_Y_270)
						                                          )
						                                          .register(
								                                          Direction.SOUTH,
								                                          DoubleBlockHalf.UPPER,
						                                          ...
						                                          .register(
								                                          ...
								                                          DoorHinge.RIGHT,
								                                          true,
								                                          topRightOpenModel.apply(ROTATE_Y_90)
						                                          )
						                                          .register(
								                                          Direction.NORTH,
								                                          DoubleBlockHalf.UPPER,
	...
	public static BlockModelDefinitionCreator createCustomFenceBlockState(
		...
		return MultipartBlockModelDefinitionCreator.create(customFenceBlock)
		                                           .with(postModel)
		                                           .with(
				                                           createMultipartConditionBuilder().put(
						                                           Properties.NORTH,
						                                           true
				                                           ),
				                                           northSideModel
		                                           ...
		                                           .with(
				                                           createMultipartConditionBuilder().put(Properties.EAST, true),
				                                           eastSideModel
		                                           )
		                                           .with(
				                                           createMultipartConditionBuilder().put(
		                                           ...
		                                           .with(
				                                           createMultipartConditionBuilder().put(Properties.WEST, true),
				                                           westSideModel
		                                           );
	}

	public static BlockModelDefinitionCreator createFenceBlockState(
			Block fenceBlock,
			WeightedVariant postModel,
		...
		return MultipartBlockModelDefinitionCreator.create(fenceBlock)
		                                           ...
		                                           .with(
				                                           ...
				                                           sideModel.apply(UV_LOCK)
		                                           )
		                                           .with(
				                                           createMultipartConditionBuilder().put(Properties.EAST, true),
				                                           sideModel.apply(ROTATE_Y_90).apply(UV_LOCK)
		                                           )
		                                           .with(
				                                           createMultipartConditionBuilder().put(
						                                           Properties.SOUTH,
				                                           ...
				                                           sideModel.apply(ROTATE_Y_180).apply(UV_LOCK)
		                                           )
		                                           .with(
				                                           createMultipartConditionBuilder().put(Properties.WEST, true),
				                                           sideModel.apply(ROTATE_Y_270).apply(UV_LOCK)
		                                           );
	}
	...
	public static BlockModelDefinitionCreator createWallBlockState(
		...
		return MultipartBlockModelDefinitionCreator.create(wallBlock)
		                                           .with(
				                                           createMultipartConditionBuilder().put(Properties.UP, true),
				                                           postModel
		                                           )
		                                           .with(
				                                           createMultipartConditionBuilder().put(
						                                           ...
						                                           WallShape.LOW
				                                           ), lowSideModel.apply(UV_LOCK)
		                                           )
		                                           .with(
				                                           createMultipartConditionBuilder().put(
						                                           Properties.EAST_WALL_SHAPE,
						                                           WallShape.LOW
				                                           ), lowSideModel.apply(ROTATE_Y_90).apply(UV_LOCK)
		                                           )
		                                           .with(
				                                           createMultipartConditionBuilder().put(
						                                           Properties.SOUTH_WALL_SHAPE,
						                                           WallShape.LOW
				                                           ), lowSideModel.apply(ROTATE_Y_180).apply(UV_LOCK)
		                                           )
		                                           .with(
				                                           createMultipartConditionBuilder().put(
						                                           Properties.WEST_WALL_SHAPE,
						                                           WallShape.LOW
				                                           ), lowSideModel.apply(ROTATE_Y_270).apply(UV_LOCK)
		                                           )
		                                           .with(
				                                           createMultipartConditionBuilder().put(
						                                           Properties.NORTH_WALL_SHAPE,
	...
	public static BlockModelDefinitionCreator createFenceGateBlockState(
			...
			WeightedVariant openModel,
			WeightedVariant closedModel,
			WeightedVariant openWallModel,
			WeightedVariant closedWallModel,
			boolean uvlock
	) {
		return VariantsBlockModelDefinitionCreator.of(fenceGateBlock)
		                                          .with(
				                                          BlockStateVariantMap
						                                          .models(Properties.IN_WALL, Properties.OPEN)
		                                          ...
		                                          .with(
				                                          BlockStateVariantMap
						                                          ...
						                                          .register(
								                                          ...
								                                          BlockHalf.BOTTOM,
								                                          StairShape.OUTER_RIGHT,
								                                          outerModel.apply(ROTATE_Y_180).apply(UV_LOCK)
						                                          )
						                                          .register(
								                                          Direction.SOUTH,
								                                          BlockHalf.BOTTOM,
								                                          StairShape.OUTER_RIGHT,
								                                          outerModel.apply(ROTATE_Y_90).apply(UV_LOCK)
						                                          )
						                                          .register(
								                                          Direction.NORTH,
								                                          BlockHalf.BOTTOM,
								                                          StairShape.OUTER_RIGHT,
								                                          outerModel.apply(ROTATE_Y_270).apply(UV_LOCK)
						                                          )
						                                          .register(
								                                          Direction.EAST,
								                                          BlockHalf.BOTTOM,
						                                          ...
						                                          .register(
								                                          ...
								                                          BlockHalf.BOTTOM,
								                                          StairShape.INNER_RIGHT,
								                                          innerModel.apply(ROTATE_Y_180).apply(UV_LOCK)
						                                          )
						                                          .register(
								                                          Direction.SOUTH,
								                                          BlockHalf.BOTTOM,
								                                          StairShape.INNER_RIGHT,
								                                          innerModel.apply(ROTATE_Y_90).apply(UV_LOCK)
						                                          )
						                                          .register(
								                                          Direction.NORTH,
								                                          BlockHalf.BOTTOM,
								                                          StairShape.INNER_RIGHT,
								                                          innerModel.apply(ROTATE_Y_270).apply(UV_LOCK)
						                                          )
						                                          .register(
								                                          Direction.EAST,
								                                          BlockHalf.BOTTOM,
						                                          ...
						                                          .register(
								                                          ...
								                                          BlockHalf.TOP,
								                                          StairShape.OUTER_RIGHT,
								                                          outerModel.apply(ROTATE_X_180).apply(UV_LOCK)
						                                          )
						                                          .register(
								                                          Direction.EAST,
								                                          BlockHalf.TOP,
						                                          ...
						                                          .register(
								                                          ...
								                                          BlockHalf.TOP,
								                                          StairShape.INNER_RIGHT,
								                                          innerModel.apply(ROTATE_X_180).apply(UV_LOCK)
						                                          )
						                                          .register(
								                                          Direction.EAST,
								                                          BlockHalf.TOP,
		                                          ...
		                                          .with(
				                                          BlockStateVariantMap
						                                          ...
						                                          .register(
								                                          ...
								                                          BlockHalf.BOTTOM,
								                                          false,
								                                          bottomModel.apply(ROTATE_Y_180)
						                                          )
						                                          .register(
								                                          Direction.EAST,
								                                          BlockHalf.BOTTOM,
								                                          false,
								                                          bottomModel.apply(ROTATE_Y_90)
						                                          )
						                                          .register(
								                                          Direction.WEST,
								                                          BlockHalf.BOTTOM,
								                                          false,
								                                          bottomModel.apply(ROTATE_Y_270)
						                                          )
						                                          .register(
								                                          Direction.NORTH,
								                                          BlockHalf.TOP,
						                                          ...
						                                          .register(
								                                          ...
								                                          BlockHalf.TOP,
								                                          false,
								                                          topModel.apply(ROTATE_Y_180)
						                                          )
						                                          .register(
								                                          Direction.EAST,
								                                          BlockHalf.TOP,
								                                          false,
								                                          topModel.apply(ROTATE_Y_90)
						                                          )
						                                          .register(
								                                          Direction.WEST,
								                                          BlockHalf.TOP,
								                                          false,
								                                          topModel.apply(ROTATE_Y_270)
						                                          )
						                                          .register(
								                                          Direction.NORTH,
								                                          BlockHalf.BOTTOM,
						                                          ...
						                                          .register(
								                                          ...
								                                          BlockHalf.BOTTOM,
								                                          true,
								                                          openModel.apply(ROTATE_Y_180)
						                                          )
						                                          .register(
								                                          Direction.EAST,
								                                          BlockHalf.BOTTOM,
								                                          true,
								                                          openModel.apply(ROTATE_Y_90)
						                                          )
						                                          .register(
								                                          Direction.WEST,
								                                          BlockHalf.BOTTOM,
								                                          true,
								                                          openModel.apply(ROTATE_Y_270)
						                                          )
						                                          .register(
								                                          Direction.NORTH,
								                                          BlockHalf.TOP,
	...
	public static BlockModelDefinitionCreator createUvLockedColumnBlockState(
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.CUBE_COLUMN_UV_LOCKED_X.upload(block, textureMap, modelCollector));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.CUBE_COLUMN_UV_LOCKED_Y.upload(block, textureMap, modelCollector));
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(Models.CUBE_COLUMN_UV_LOCKED_Z.upload(block, textureMap, modelCollector));
	...
	public final void registerNorthDefaultHorizontalRotatable(Block block, TexturedModel.Factory modelFactory) {
		WeightedVariant weightedVariant = createWeightedVariant(modelFactory.upload(block, this.modelCollector));
		this.blockStateCollector.accept(VariantsBlockModelDefinitionCreator
				.of(block, weightedVariant)
				.apply(NORTH_DEFAULT_HORIZONTAL_ROTATION_OPERATIONS));
	}

	public static BlockModelDefinitionCreator createAxisRotatedBlockState(
			Block block,
			WeightedVariant verticalModel,
			WeightedVariant horizontalModel
	) {
		return VariantsBlockModelDefinitionCreator.of(block)
		                                          .with(
				                                          BlockStateVariantMap.models(Properties.AXIS)
				                                                              ...
				                                                              .register(
						                                                              Direction.Axis.Z,
						                                                              horizontalModel.apply(ROTATE_X_90)
				                                                              )
				                                                              .register(
						                                                              Direction.Axis.X,
						                                                              horizontalModel
	...
	public final void registerAxisRotated(
			Block block,
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(verticalModelFactory.upload(block, this.modelCollector));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(horizontalModelFactory.upload(block, this.modelCollector));
	...
	public final void registerCreakingHeart(Block block) {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(TexturedModel.END_FOR_TOP_CUBE_COLUMN.upload(block, this.modelCollector));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(TexturedModel.END_FOR_TOP_CUBE_COLUMN_HORIZONTAL.upload(
						block,
						this.modelCollector
				));
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(this.createCreakingHeartModel(
		...
		WeightedVariant weightedVariant6 = createWeightedVariant(
				this.createCreakingHeartModel(TexturedModel.END_FOR_TOP_CUBE_COLUMN_HORIZONTAL, block, "_dormant")
		);
						                                   ...
						                                   .with(
								                                   BlockStateVariantMap
										                                   ...
										                                   .register(
												                                   Direction.Axis.Z,
												                                   CreakingHeartState.UPROOTED,
												                                   weightedVariant2.apply(ROTATE_X_90)
										                                   )
										                                   .register(
												                                   Direction.Axis.X,
												                                   CreakingHeartState.UPROOTED,
										                                   ...
										                                   .register(
												                                   Direction.Axis.Z,
												                                   CreakingHeartState.DORMANT,
												                                   weightedVariant6.apply(ROTATE_X_90)
										                                   )
										                                   .register(
												                                   Direction.Axis.X,
												                                   CreakingHeartState.DORMANT,
										                                   ...
										                                   .register(
												                                   Direction.Axis.Z,
												                                   CreakingHeartState.AWAKE,
												                                   weightedVariant4.apply(ROTATE_X_90)
										                                   )
										                                   .register(
												                                   Direction.Axis.X,
												                                   CreakingHeartState.AWAKE,
	...
	public final Identifier createCreakingHeartModel(
			TexturedModel.Factory texturedModelFactory,
			Block block,
			String suffix
	) {
		return texturedModelFactory.andThen(
				                           textureMap -> textureMap
						                           .put(TextureKey.SIDE, TextureMap.getSubId(block, suffix))
						                           .put(TextureKey.END, TextureMap.getSubId(block, "_top" + suffix))
		                           )
		                           .upload(block, suffix, this.modelCollector);
	}

	public final Identifier createSubModel(
			Block block,
			String suffix,
			Model model,
			Function<Identifier, TextureMap> texturesFactory
	) {
		return model.upload(
				block,
				suffix,
				texturesFactory.apply(TextureMap.getSubId(block, suffix)),
				this.modelCollector
		);
	}

	public static BlockModelDefinitionCreator createPressurePlateBlockState(
			Block pressurePlateBlock,
			WeightedVariant upModel,
			WeightedVariant downModel
	) {
		return VariantsBlockModelDefinitionCreator
				.of(pressurePlateBlock)
				.with(createBooleanModelMap(Properties.POWERED, downModel, upModel));
	}
	...
	public void registerSingleton(Block block, TexturedModel.Factory modelFactory) {
		this.blockStateCollector.accept(createSingletonBlockState(
				block,
				createWeightedVariant(modelFactory.upload(block, this.modelCollector))
		));
	}
	...
	public final BlockStateModelGenerator.BlockTexturePool registerCubeAllModelTexturePool(Block block) {
		...
		return new BlockStateModelGenerator.BlockTexturePool(texturedModel.getTextures()).base(
				block,
	...
	public void registerDoor(Block doorBlock) {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.DOOR_BOTTOM_LEFT.upload(doorBlock, textureMap, this.modelCollector));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.DOOR_BOTTOM_LEFT_OPEN.upload(doorBlock, textureMap, this.modelCollector));
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(Models.DOOR_BOTTOM_RIGHT.upload(doorBlock, textureMap, this.modelCollector));
		WeightedVariant
				weightedVariant4 =
				createWeightedVariant(Models.DOOR_BOTTOM_RIGHT_OPEN.upload(doorBlock, textureMap, this.modelCollector));
		WeightedVariant
				weightedVariant5 =
				createWeightedVariant(Models.DOOR_TOP_LEFT.upload(doorBlock, textureMap, this.modelCollector));
		WeightedVariant
				weightedVariant6 =
				createWeightedVariant(Models.DOOR_TOP_LEFT_OPEN.upload(doorBlock, textureMap, this.modelCollector));
		WeightedVariant
				weightedVariant7 =
				createWeightedVariant(Models.DOOR_TOP_RIGHT.upload(doorBlock, textureMap, this.modelCollector));
		WeightedVariant
				weightedVariant8 =
				createWeightedVariant(Models.DOOR_TOP_RIGHT_OPEN.upload(doorBlock, textureMap, this.modelCollector));
	...
	public final void registerParentedDoor(Block parent, Block doorBlock) {
		...
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.DOOR_BOTTOM_LEFT_OPEN.getBlockSubModelId(parent));
		WeightedVariant weightedVariant3 = createWeightedVariant(Models.DOOR_BOTTOM_RIGHT.getBlockSubModelId(parent));
		WeightedVariant
				weightedVariant4 =
				createWeightedVariant(Models.DOOR_BOTTOM_RIGHT_OPEN.getBlockSubModelId(parent));
	...
	public void registerOrientableTrapdoor(Block trapdoorBlock) {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.TEMPLATE_ORIENTABLE_TRAPDOOR_TOP.upload(
						trapdoorBlock,
						textureMap,
						this.modelCollector
				));
		Identifier
				identifier =
				Models.TEMPLATE_ORIENTABLE_TRAPDOOR_BOTTOM.upload(trapdoorBlock, textureMap, this.modelCollector);
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.TEMPLATE_ORIENTABLE_TRAPDOOR_OPEN.upload(
						trapdoorBlock,
						textureMap,
						this.modelCollector
				));
		this.blockStateCollector.accept(createOrientableTrapdoorBlockState(
				trapdoorBlock,
				weightedVariant,
				createWeightedVariant(identifier),
				weightedVariant2
		));
	...
	public void registerTrapdoor(Block trapdoorBlock) {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.TEMPLATE_TRAPDOOR_TOP.upload(
						trapdoorBlock,
						textureMap,
						this.modelCollector
				));
		...
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.TEMPLATE_TRAPDOOR_OPEN.upload(
						trapdoorBlock,
						textureMap,
						this.modelCollector
				));
		this.blockStateCollector.accept(createTrapdoorBlockState(
				trapdoorBlock,
				weightedVariant,
				createWeightedVariant(identifier),
				weightedVariant2
	...
	public final void registerParentedTrapdoor(Block parent, Block trapdoorBlock) {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.TEMPLATE_TRAPDOOR_TOP.getBlockSubModelId(parent));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.TEMPLATE_TRAPDOOR_BOTTOM.getBlockSubModelId(parent));
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(Models.TEMPLATE_TRAPDOOR_OPEN.getBlockSubModelId(parent));
	...
	private void registerBigDripleaf() {
		...
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.BIG_DRIPLEAF, "_partial_tilt"));
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.BIG_DRIPLEAF, "_full_tilt"));
		this.blockStateCollector
				.accept(
	...
	public final void registerStateWithModelReference(Block block, Block modelReference) {
		this.blockStateCollector.accept(createSingletonBlockState(
				block,
				createWeightedVariant(ModelIds.getBlockModelId(modelReference))
		));
	}
	...
	public final void registerTintableCross(
			Block block,
			BlockStateModelGenerator.CrossType tintType,
			TextureMap texture
	) {
	...
	public final void registerTintableCrossBlockState(
			Block block,
			BlockStateModelGenerator.CrossType tintType,
			TextureMap crossTexture
	) {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(tintType.getCrossModel().upload(block, crossTexture, this.modelCollector));
	...
	public final void registerTintableCrossBlockStateWithStages(
		...
		if (stageProperty.getValues().size() != stages.length) {
			...
			this.blockStateCollector.accept(VariantsBlockModelDefinitionCreator
					.of(block)
					.with(BlockStateVariantMap.models(stageProperty).generate(stage -> {
						String string = "_stage" + stages[stage];
						TextureMap textureMap = TextureMap.cross(TextureMap.getSubId(block, string));
						return createWeightedVariant(tintType
								.getCrossModel()
								.upload(block, string, textureMap, this.modelCollector));
					})));
		}
	}

	public final void registerFlowerPotPlantAndItem(
			Block block,
			Block flowerPotBlock,
			BlockStateModelGenerator.CrossType crossType
	) {
		this.registerItemModel(block.asItem(), crossType.registerItemModel(this, block));
		this.registerFlowerPotPlant(block, flowerPotBlock, crossType);
	}

	public final void registerFlowerPotPlant(
			Block plantBlock,
			Block flowerPotBlock,
			BlockStateModelGenerator.CrossType tintType
	) {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(tintType
						.getFlowerPotCrossModel()
						.upload(flowerPotBlock, textureMap, this.modelCollector));
	...
	public final void registerCoralFan(Block coralFanBlock, Block coralWallFanBlock) {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(texturedModel.upload(coralFanBlock, this.modelCollector));
		...
		WeightedVariant weightedVariant2 = createWeightedVariant(
				Models.CORAL_WALL_FAN.upload(coralWallFanBlock, texturedModel.getTextures(), this.modelCollector)
		);
		this.blockStateCollector
				.accept(VariantsBlockModelDefinitionCreator
						.of(coralWallFanBlock, weightedVariant2)
						.apply(NORTH_DEFAULT_HORIZONTAL_ROTATION_OPERATIONS));
	...
	public final void registerGourd(Block stemBlock, Block attachedStemBlock) {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.STEM_FRUIT.upload(attachedStemBlock, textureMap2, this.modelCollector));
		this.blockStateCollector
				.accept(
						...
						VariantsBlockModelDefinitionCreator.of(stemBlock)
						                                   .with(
								                                   BlockStateVariantMap.models(Properties.AGE_7)
								                                                       .generate(age -> createWeightedVariant(
										                                                       Models.STEM_GROWTH_STAGES[age].upload(
												                                                       stemBlock,
												                                                       textureMap,
												                                                       this.modelCollector
										                                                       )))
						...
						VariantsBlockModelDefinitionCreator.of(block)
						                                   .with(BlockStateVariantMap
								                                   ...
								                                   .generate((age, half) -> {
									                                   return switch (half) {
										                                   case UPPER ->
												                                   createWeightedVariant(ModelIds.getBlockSubModelId(
														                                   block,
														                                   "_top_stage_" + age
												                                   ));
										                                   case LOWER ->
	...
	public final void registerDoubleBlock(Block doubleBlock, BlockStateModelGenerator.CrossType tintType) {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(this.createSubModel(
						doubleBlock,
						"_top",
	...
	private void registerSunflower() {
		...
		WeightedVariant weightedVariant2 = createWeightedVariant(
				this.createSubModel(
						Blocks.SUNFLOWER,
						"_bottom",
						BlockStateModelGenerator.CrossType.NOT_TINTED.getCrossModel(),
						TextureMap::cross
				)
		);
	...
	private void registerTallSeagrass() {
		...
		WeightedVariant weightedVariant2 = createWeightedVariant(
				this.createSubModel(Blocks.TALL_SEAGRASS, "_bottom", Models.TEMPLATE_SEAGRASS, TextureMap::texture)
		);
	...
	private void registerSmallDripleaf() {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.SMALL_DRIPLEAF, "_top"));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.SMALL_DRIPLEAF, "_bottom"));
		this.blockStateCollector
				.accept(
				...
				.accept(
						VariantsBlockModelDefinitionCreator.of(block)
						                                   .with(
								                                   BlockStateVariantMap
										                                   .models(Properties.DOUBLE_BLOCK_HALF)
										                                   .register(DoubleBlockHalf.LOWER, lowerModel)
										                                   .register(DoubleBlockHalf.UPPER, upperModel)
						                                   )
				);
	}
	...
	public final void registerTurnableRail(Block rail) {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.RAIL_FLAT.upload(rail, textureMap, this.modelCollector));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.RAIL_CURVED.upload(rail, textureMap2, this.modelCollector));
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(Models.TEMPLATE_RAIL_RAISED_NE.upload(rail, textureMap, this.modelCollector));
		WeightedVariant
				weightedVariant4 =
				createWeightedVariant(Models.TEMPLATE_RAIL_RAISED_SW.upload(rail, textureMap, this.modelCollector));
						...
						VariantsBlockModelDefinitionCreator.of(rail)
						                                   .with(
								                                   BlockStateVariantMap.models(Properties.RAIL_SHAPE)
								                                                       ...
								                                                       .register(
										                                                       RailShape.EAST_WEST,
										                                                       weightedVariant.apply(
												                                                       ROTATE_Y_90)
								                                                       )
								                                                       .register(
										                                                       RailShape.ASCENDING_EAST,
										                                                       weightedVariant3.apply(
												                                                       ROTATE_Y_90)
								                                                       )
								                                                       .register(
										                                                       RailShape.ASCENDING_WEST,
										                                                       weightedVariant4.apply(
												                                                       ROTATE_Y_90)
								                                                       )
								                                                       .register(
	...
	public final void registerStraightRail(Block rail) {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(this.createSubModel(rail, "", Models.RAIL_FLAT, TextureMap::rail));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(this.createSubModel(rail, "", Models.TEMPLATE_RAIL_RAISED_NE, TextureMap::rail));
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(this.createSubModel(rail, "", Models.TEMPLATE_RAIL_RAISED_SW, TextureMap::rail));
		WeightedVariant
				weightedVariant4 =
				createWeightedVariant(this.createSubModel(rail, "_on", Models.RAIL_FLAT, TextureMap::rail));
		WeightedVariant
				weightedVariant5 =
				createWeightedVariant(this.createSubModel(
						rail,
						...
						VariantsBlockModelDefinitionCreator.of(rail)
						                                   .with(BlockStateVariantMap
								                                   ...
								                                   .generate((powered, shape) -> {
									                                   return switch (shape) {
										                                   case NORTH_SOUTH ->
												                                   powered ? weightedVariant4
												                                           : weightedVariant;
										                                   case EAST_WEST -> (powered ? weightedVariant4
										                                                              : weightedVariant
										                                   ).apply(ROTATE_Y_90);
										                                   case ASCENDING_EAST ->
												                                   (powered ? weightedVariant5
												                                            : weightedVariant2
												                                   ).apply(ROTATE_Y_90);
										                                   case ASCENDING_WEST ->
												                                   (powered ? weightedVariant6
												                                            : weightedVariant3
												                                   ).apply(ROTATE_Y_90);
	...
	public final void registerBuiltinWithParticle(Block block, Item particleSource) {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.PARTICLE.upload(
						block,
						TextureMap.particle(particleSource),
						this.modelCollector
				));
		this.blockStateCollector.accept(createSingletonBlockState(block, weightedVariant));
	}
	...
	public void registerBuiltinWithParticle(Block block, Block particleSource) {
		this.blockStateCollector.accept(createSingletonBlockState(
				block,
				this.uploadParticleModel(block, particleSource)
		));
	}
	...
	public final void registerWoolAndCarpet(Block wool, Block carpet) {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(TexturedModel.CARPET.get(wool).upload(carpet, this.modelCollector));
	...
	public final void registerLeafLitter(Block leafLitter) {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(TexturedModel.TEMPLATE_LEAF_LITTER_1.upload(leafLitter, this.modelCollector));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(TexturedModel.TEMPLATE_LEAF_LITTER_2.upload(leafLitter, this.modelCollector));
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(TexturedModel.TEMPLATE_LEAF_LITTER_3.upload(leafLitter, this.modelCollector));
		WeightedVariant
				weightedVariant4 =
				createWeightedVariant(TexturedModel.TEMPLATE_LEAF_LITTER_4.upload(leafLitter, this.modelCollector));
	...
	public final void registerFlowerbed(Block flowerbed) {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(TexturedModel.FLOWERBED_1.upload(flowerbed, this.modelCollector));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(TexturedModel.FLOWERBED_2.upload(flowerbed, this.modelCollector));
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(TexturedModel.FLOWERBED_3.upload(flowerbed, this.modelCollector));
		WeightedVariant
				weightedVariant4 =
				createWeightedVariant(TexturedModel.FLOWERBED_4.upload(flowerbed, this.modelCollector));
	...
	public final void registerGlassAndPane(Block glassBlock, Block glassPane) {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.TEMPLATE_GLASS_PANE_POST.upload(
						glassPane,
						textureMap,
						this.modelCollector
				));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.TEMPLATE_GLASS_PANE_SIDE.upload(
						glassPane,
						textureMap,
						this.modelCollector
				));
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(Models.TEMPLATE_GLASS_PANE_SIDE_ALT.upload(
						glassPane,
						textureMap,
						this.modelCollector
				));
		WeightedVariant
				weightedVariant4 =
				createWeightedVariant(Models.TEMPLATE_GLASS_PANE_NOSIDE.upload(
						glassPane,
						textureMap,
						this.modelCollector
				));
		WeightedVariant
				weightedVariant5 =
				createWeightedVariant(Models.TEMPLATE_GLASS_PANE_NOSIDE_ALT.upload(
						glassPane,
						textureMap,
						this.modelCollector
				));
						...
						MultipartBlockModelDefinitionCreator.create(glassPane)
						                                    ...
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.EAST,
										                                    true
								                                    ), weightedVariant2.apply(ROTATE_Y_90)
						                                    )
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.SOUTH,
						                                    ...
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.SOUTH,
										                                    false
								                                    ), weightedVariant5.apply(ROTATE_Y_90)
						                                    )
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.WEST,
										                                    false
								                                    ), weightedVariant4.apply(ROTATE_Y_270)
						                                    )
				);
	}
	...
	public final void registerCommandBlock(Block commandBlock) {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.TEMPLATE_COMMAND_BLOCK.upload(
						commandBlock,
						textureMap,
						this.modelCollector
				));
		WeightedVariant weightedVariant2 = createWeightedVariant(
				this.createSubModel(
						...
						id -> textureMap.copyAndAdd(TextureKey.SIDE, id)
				)
		);
		this.blockStateCollector
				.accept(
	...
	public final void registerAnvil(Block anvil) {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(TexturedModel.TEMPLATE_ANVIL.upload(anvil, this.modelCollector));
		this.blockStateCollector.accept(createSingletonBlockState(anvil, weightedVariant).apply(
				SOUTH_DEFAULT_HORIZONTAL_ROTATION_OPERATIONS));
	}
	...
	public static WeightedVariant getBambooBlockStateVariants(int age) {
		...
		return new WeightedVariant(
				Pool.of(
						IntStream.range(1, 5)
						         .mapToObj(i -> new Weighted<>(
								         createModelVariant(ModelIds.getBlockSubModelId(
										         Blocks.BAMBOO,
										         i + string
								         )), 1
						         ))
	...
	private void registerBarrel() {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(TexturedModel.CUBE_BOTTOM_TOP.upload(Blocks.BARREL, this.modelCollector));
		WeightedVariant weightedVariant2 = createWeightedVariant(
	...
	public final void registerBeehive(Block beehive, Function<Block, TextureMap> texturesFactory) {
		...
		Identifier
				identifier =
				Models.ORIENTABLE_WITH_BOTTOM.upload(beehive, "_empty", textureMap, this.modelCollector);
		Identifier
				identifier2 =
				Models.ORIENTABLE_WITH_BOTTOM.upload(beehive, "_honey", textureMap2, this.modelCollector);
		this.itemModelOutput
				.accept(
						...
						ItemModels.select(
								...
								Map.of(5, ItemModels.basic(identifier2))
						)
				);
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(beehive)
						                                   .with(createValueFencedModelMap(
								                                   BeehiveBlock.HONEY_LEVEL,
								                                   5,
								                                   createWeightedVariant(identifier2),
								                                   createWeightedVariant(identifier)
						                                   ))
						                                   .apply(NORTH_DEFAULT_HORIZONTAL_ROTATION_OPERATIONS)
				);
									                                   ...
									                                   BlockStateVariantMap.models(ageProperty)
									                                                       .generate(
											                                                       age -> {
												                                                       int
														                                                       i =
														                                                       ageTextureIndices[age];
												                                                       return createWeightedVariant(
														                                                       (Identifier) int2ObjectMap.computeIfAbsent(
																                                                       i,
																                                                       stage -> this.createSubModel(
																		                                                       crop,
																		                                                       "_stage"
																				                                                       + stage,
																		                                                       Models.CROP,
	...
	private void registerBell() {
		...
		WeightedVariant
				weightedVariant4 =
				createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.BELL, "_between_walls"));
						                                   ...
						                                   .with(
								                                   BlockStateVariantMap
										                                   ...
										                                   .register(
												                                   Direction.SOUTH,
												                                   Attachment.FLOOR,
												                                   weightedVariant.apply(ROTATE_Y_180)
										                                   )
										                                   .register(
												                                   Direction.EAST,
												                                   Attachment.FLOOR,
												                                   weightedVariant.apply(ROTATE_Y_90)
										                                   )
										                                   .register(
												                                   Direction.WEST,
												                                   Attachment.FLOOR,
												                                   weightedVariant.apply(ROTATE_Y_270)
										                                   )
										                                   .register(
												                                   Direction.NORTH,
												                                   Attachment.CEILING,
										                                   ...
										                                   .register(
												                                   Direction.SOUTH,
												                                   Attachment.CEILING,
												                                   weightedVariant2.apply(ROTATE_Y_180)
										                                   )
										                                   .register(
												                                   Direction.EAST,
												                                   Attachment.CEILING,
										                                   ...
										                                   .register(
												                                   Direction.WEST,
												                                   Attachment.CEILING,
												                                   weightedVariant2.apply(ROTATE_Y_270)
										                                   )
										                                   .register(
												                                   Direction.NORTH,
												                                   Attachment.SINGLE_WALL,
												                                   weightedVariant3.apply(ROTATE_Y_270)
										                                   )
										                                   .register(
												                                   Direction.SOUTH,
												                                   Attachment.SINGLE_WALL,
										                                   ...
										                                   .register(
												                                   Direction.WEST,
												                                   Attachment.SINGLE_WALL,
												                                   weightedVariant3.apply(ROTATE_Y_180)
										                                   )
										                                   .register(
												                                   Direction.SOUTH,
										                                   ...
										                                   .register(
												                                   Direction.WEST,
												                                   Attachment.DOUBLE_WALL,
												                                   weightedVariant4.apply(ROTATE_Y_180)
										                                   )
						                                   )
				);
	}
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator
								.of(
										Blocks.GRINDSTONE,
										createWeightedVariant(ModelIds.getBlockModelId(Blocks.GRINDSTONE))
								)
								.apply(
										BlockStateVariantMap
												...
												.register(
														BlockFace.WALL,
														Direction.SOUTH,
														ROTATE_X_90.then(ROTATE_Y_180)
												)
												.register(
														BlockFace.WALL,
														Direction.WEST,
														ROTATE_X_90.then(ROTATE_Y_270)
												)
												.register(BlockFace.CEILING, Direction.SOUTH, ROTATE_X_180)
												.register(
														BlockFace.CEILING,
														Direction.WEST,
														ROTATE_X_180.then(ROTATE_Y_90)
												)
												.register(
														BlockFace.CEILING,
														Direction.NORTH,
														ROTATE_X_180.then(ROTATE_Y_180)
												)
												.register(
														BlockFace.CEILING,
														Direction.EAST,
	...
	public final void registerCooker(Block cooker, TexturedModel.Factory modelFactory) {
		...
		WeightedVariant weightedVariant2 = createWeightedVariant(
				modelFactory
						.get(cooker)
						.textures(textures -> textures.put(TextureKey.FRONT, identifier))
	...
	public final void registerCampfire(Block... blocks) {
		...
		for (Block block : blocks) {
			WeightedVariant
					weightedVariant2 =
					createWeightedVariant(Models.TEMPLATE_CAMPFIRE.upload(
							block,
							TextureMap.campfire(block),
							this.modelCollector
					));
			this.registerItemModel(block.asItem());
			this.blockStateCollector
	...
	public final void registerAzalea(Block block) {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.TEMPLATE_AZALEA.upload(
						block,
						TextureMap.sideAndTop(block),
						this.modelCollector
				));
		this.blockStateCollector.accept(createSingletonBlockState(block, weightedVariant));
	}
	...
	public final void registerPottedAzaleaBush(Block block) {
		...
		if (block == Blocks.POTTED_FLOWERING_AZALEA_BUSH) {
			weightedVariant = createWeightedVariant(
					Models.TEMPLATE_POTTED_FLOWERING_AZALEA_BUSH.upload(
							block,
							TextureMap.pottedAzaleaBush(block),
							this.modelCollector
					)
			);
		}
			...
			weightedVariant =
					createWeightedVariant(Models.TEMPLATE_POTTED_AZALEA_BUSH.upload(
							block,
							TextureMap.pottedAzaleaBush(block),
							this.modelCollector
					));
	...
	private void registerBookshelf() {
		TextureMap
				textureMap =
				TextureMap.sideEnd(TextureMap.getId(Blocks.BOOKSHELF), TextureMap.getId(Blocks.OAK_PLANKS));
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.CUBE_COLUMN.upload(Blocks.BOOKSHELF, textureMap, this.modelCollector));
				...
				.accept(
						MultipartBlockModelDefinitionCreator.create(Blocks.REDSTONE_WIRE)
						                                    .with(
								                                    ...
								                                    createWeightedVariant(ModelIds.getMinecraftNamespacedBlock(
										                                    "redstone_dust_dot"))
						                                    )
						                                    .with(
								                                    createMultipartConditionBuilder().put(
						                                    ...
						                                    .with(
								                                    ...
								                                    createWeightedVariant(ModelIds.getMinecraftNamespacedBlock(
										                                    "redstone_dust_side1")).apply(ROTATE_Y_270)
						                                    )
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.NORTH_WIRE_CONNECTION,
						                                    ...
						                                    .with(
								                                    ...
								                                    createWeightedVariant(ModelIds.getMinecraftNamespacedBlock(
										                                    "redstone_dust_up")).apply(ROTATE_Y_90)
						                                    )
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.SOUTH_WIRE_CONNECTION,
								                                    ...
								                                    createWeightedVariant(ModelIds.getMinecraftNamespacedBlock(
										                                    "redstone_dust_up")).apply(ROTATE_Y_180)
						                                    )
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.WEST_WIRE_CONNECTION,
						                                   ...
						                                   .with(
								                                   BlockStateVariantMap
										                                   ...
										                                   .register(
												                                   ...
												                                   false,
												                                   createWeightedVariant(ModelIds.getBlockModelId(
														                                   Blocks.COMPARATOR))
										                                   )
										                                   .register(
												                                   ComparatorMode.COMPARE,
	...
	private void registerSmoothStone() {
		...
		TextureMap
				textureMap2 =
				TextureMap.sideEnd(
						TextureMap.getSubId(Blocks.SMOOTH_STONE_SLAB, "_side"),
						textureMap.getTexture(TextureKey.TOP)
				);
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.SLAB.upload(Blocks.SMOOTH_STONE_SLAB, textureMap2, this.modelCollector));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.SLAB_TOP.upload(
						Blocks.SMOOTH_STONE_SLAB,
						textureMap2,
						this.modelCollector
				));
		WeightedVariant weightedVariant3 = createWeightedVariant(
				Models.CUBE_COLUMN.uploadWithoutVariant(
						Blocks.SMOOTH_STONE_SLAB,
						"_double",
						textureMap2,
						this.modelCollector
		...
		this.blockStateCollector.accept(createSlabBlockState(
				Blocks.SMOOTH_STONE_SLAB,
				weightedVariant,
				weightedVariant2,
				weightedVariant3
		...
		this.blockStateCollector
				.accept(
						createSingletonBlockState(
								Blocks.SMOOTH_STONE,
								createWeightedVariant(Models.CUBE_ALL.upload(
										Blocks.SMOOTH_STONE,
										textureMap,
										this.modelCollector
								))
				...
				.accept(
						MultipartBlockModelDefinitionCreator.create(Blocks.BREWING_STAND)
						                                    ...
						                                    .with(
								                                    ...
								                                    createWeightedVariant(TextureMap.getSubId(
	...
	public final void registerMushroomBlock(Block mushroomBlock) {
		...
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(ModelIds.getMinecraftNamespacedBlock("mushroom_block_inside"));
		this.blockStateCollector
				.accept(
						MultipartBlockModelDefinitionCreator.create(mushroomBlock)
						                                    ...
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.EAST,
										                                    true
								                                    ), weightedVariant.apply(ROTATE_Y_90).apply(UV_LOCK)
						                                    )
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.SOUTH,
								                                    ...
								                                    weightedVariant.apply(ROTATE_Y_180).apply(UV_LOCK)
						                                    )
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.WEST,
								                                    ...
								                                    weightedVariant.apply(ROTATE_Y_270).apply(UV_LOCK)
						                                    )
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.UP,
								                                    ...
								                                    weightedVariant.apply(ROTATE_X_270).apply(UV_LOCK)
						                                    )
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.DOWN,
										                                    true
								                                    ), weightedVariant.apply(ROTATE_X_90).apply(UV_LOCK)
						                                    )
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.NORTH,
						                                    ...
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.UP,
										                                    false
								                                    ), weightedVariant2.apply(ROTATE_X_270)
						                                    )
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.DOWN,
		...
		this.registerParentedItemModel(
				mushroomBlock,
				TexturedModel.CUBE_ALL.upload(mushroomBlock, "_inventory", this.modelCollector)
		);
	}
		...
		this.blockStateCollector
				.accept(
						createSingletonBlockState(
								...
								createWeightedVariant(Models.CUBE.upload(
										Blocks.CARTOGRAPHY_TABLE,
										textureMap,
										this.modelCollector
								))
	...
	public final void registerCubeWithCustomTextures(
			Block block,
			Block otherTextureSource,
			BiFunction<Block, Block, TextureMap> texturesFactory
	) {
		TextureMap textureMap = texturesFactory.apply(block, otherTextureSource);
		this.blockStateCollector.accept(createSingletonBlockState(
				block,
				createWeightedVariant(Models.CUBE.upload(block, textureMap, this.modelCollector))
		));
	}
	...
	private void registerPumpkins() {
		...
		this.blockStateCollector.accept(createSingletonBlockState(
				Blocks.PUMPKIN,
				createWeightedVariant(ModelIds.getBlockModelId(Blocks.PUMPKIN))
		));
	...
	public final void registerNorthDefaultHorizontalRotatable(Block block, TextureMap texture) {
		WeightedVariant weightedVariant = createWeightedVariant(
				Models.ORIENTABLE.upload(
						block,
						texture.copyAndAdd(TextureKey.FRONT, TextureMap.getId(block)),
						this.modelCollector
				)
		);
		this.blockStateCollector.accept(VariantsBlockModelDefinitionCreator
						...
						createSingletonBlockState(
								...
								createWeightedVariant(
										Models.TEMPLATE_CAULDRON_FULL
												.upload(
														Blocks.LAVA_CAULDRON,
														TextureMap.cauldron(TextureMap.getSubId(Blocks.LAVA, "_still")),
														this.modelCollector
												)
								)
						)
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(Blocks.WATER_CAULDRON)
						                                   .with(
								                                   BlockStateVariantMap
										                                   .models(LeveledCauldronBlock.LEVEL)
										                                   .register(
												                                   1,
												                                   createWeightedVariant(
	...
	private void registerChorusFlower() {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.TEMPLATE_CHORUS_FLOWER.upload(
		...
		WeightedVariant weightedVariant2 = createWeightedVariant(
				this.createSubModel(
						...
						id -> textureMap.copyAndAdd(TextureKey.TEXTURE, id)
				)
		);
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(Blocks.CHORUS_FLOWER)
						                                   .with(createValueFencedModelMap(
								                                   Properties.AGE_5,
								                                   5,
								                                   weightedVariant2,
	...
	private void registerCrafter() {
		...
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.CRAFTER, "_triggered"));
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.CRAFTER, "_crafting"));
		WeightedVariant
				weightedVariant4 =
				createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.CRAFTER, "_crafting_triggered"));
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(Blocks.CRAFTER)
						                                   ...
						                                   .apply(BlockStateVariantMap
								                                   .operations(Properties.ORIENTATION)
								                                   .generate(BlockStateModelGenerator::addJigsawOrientationToVariant))
				);
	}
	...
	public final void registerDispenserLikeOrientable(Block block) {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.ORIENTABLE.upload(block, textureMap, this.modelCollector));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.ORIENTABLE_VERTICAL.upload(block, textureMap2, this.modelCollector));
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(block)
						                                   .with(
	...
	private void registerEndPortalFrame() {
		...
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.END_PORTAL_FRAME, "_filled"));
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(Blocks.END_PORTAL_FRAME)
						                                   .with(BlockStateVariantMap
								                                   .models(Properties.EYE)
								                                   .register(false, weightedVariant)
								                                   .register(true, weightedVariant2))
						                                   .apply(SOUTH_DEFAULT_HORIZONTAL_ROTATION_OPERATIONS)
				);
	...
	private void registerChorusPlant() {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.CHORUS_PLANT, "_side"));
				...
				.accept(
						MultipartBlockModelDefinitionCreator.create(Blocks.CHORUS_PLANT)
						                                    ...
						                                    .with(
								                                    ...
								                                    new WeightedVariant(
										                                    Pool.of(
												                                    new Weighted<>(modelVariant, 2),
												                                    new Weighted<>(modelVariant2, 1),
												                                    new Weighted<>(modelVariant3, 1),
												                                    new Weighted<>(modelVariant4, 1)
										                                    )
								                                    )
						                                    )
						                                    .with(
	...
	public final void registerCopperBulb(Block copperBulbBlock) {
		WeightedVariant
				...
				createWeightedVariant(Models.CUBE_ALL.upload(
						copperBulbBlock,
						TextureMap.all(copperBulbBlock),
						this.modelCollector
				));
		WeightedVariant
				weightedVariant2 =
		...
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(this.createSubModel(copperBulbBlock, "_lit", Models.CUBE_ALL, TextureMap::all));
		WeightedVariant
				weightedVariant4 =
				createWeightedVariant(this.createSubModel(
						copperBulbBlock,
		...
		this.blockStateCollector.accept(createCopperBulbBlockState(
				copperBulbBlock,
				weightedVariant,
				weightedVariant3,
				weightedVariant2,
	...
	public static BlockModelDefinitionCreator createCopperBulbBlockState(
			Block block,
			WeightedVariant unlitUnpoweredModel,
			WeightedVariant litUnpoweredModel,
			WeightedVariant unlitPoweredModel,
			WeightedVariant litPoweredModel
	) {
		return VariantsBlockModelDefinitionCreator
				.of(block)
				.with(BlockStateVariantMap.models(Properties.LIT, Properties.POWERED).generate((lit, powered) -> {
					if (lit) {
	...
	public final void registerWaxedCopperBulb(Block unwaxedCopperBulbBlock, Block waxedCopperBulbBlock) {
		...
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(ModelIds.getBlockSubModelId(unwaxedCopperBulbBlock, "_powered"));
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(ModelIds.getBlockSubModelId(unwaxedCopperBulbBlock, "_lit"));
		WeightedVariant
				weightedVariant4 =
				createWeightedVariant(ModelIds.getBlockSubModelId(unwaxedCopperBulbBlock, "_lit_powered"));
	...
	public final void registerAmethyst(Block block) {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.CROSS.upload(block, TextureMap.cross(block), this.modelCollector));
		this.blockStateCollector.accept(VariantsBlockModelDefinitionCreator
				.of(block, weightedVariant)
				.apply(UP_DEFAULT_ROTATION_OPERATIONS));
	}
	...
	private void registerPointedDripstone() {
		BlockStateVariantMap.DoubleProperty<WeightedVariant, Direction, Thickness>
				doubleProperty =
	...
	public final WeightedVariant getDripstoneVariant(Direction direction, Thickness thickness) {
		...
		return createWeightedVariant(Models.POINTED_DRIPSTONE.upload(
	...
	public final void registerNetherrackBottomCustomTop(Block block) {
		...
		this.blockStateCollector
				.accept(createSingletonBlockState(
						block,
						createWeightedVariant(Models.CUBE_BOTTOM_TOP.upload(block, textureMap, this.modelCollector))
				));
	}
	...
	private void registerDaylightDetector() {
		...
		TextureMap
				textureMap =
				new TextureMap()
						.put(TextureKey.TOP, TextureMap.getSubId(Blocks.DAYLIGHT_DETECTOR, "_top"))
						                                   ...
						                                   .with(
								                                   BlockStateVariantMap.models(Properties.INVERTED)
								                                                       .register(
										                                                       false,
										                                                       createWeightedVariant(
												                                                       Models.TEMPLATE_DAYLIGHT_DETECTOR.upload(
	...
	public final void registerRod(Block block) {
		this.blockStateCollector
				.accept(VariantsBlockModelDefinitionCreator
						.of(block, createWeightedVariant(ModelIds.getBlockModelId(block)))
						.apply(UP_DEFAULT_ROTATION_OPERATIONS));
	}
	...
	public final void registerLightningRod(Block unwaxed, Block waxed) {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.LIGHTNING_ROD, "_on"));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.TEMPLATE_LIGHTNING_ROD.upload(
						unwaxed,
						TextureMap.texture(unwaxed),
						this.modelCollector
				));
		this.blockStateCollector
				.accept(
	...
	private void registerFarmland() {
		TextureMap
				...
				new TextureMap()
						...
						.put(TextureKey.TOP, TextureMap.getId(Blocks.FARMLAND));
		TextureMap textureMap2 = new TextureMap()
				.put(TextureKey.DIRT, TextureMap.getId(Blocks.DIRT))
				.put(TextureKey.TOP, TextureMap.getSubId(Blocks.FARMLAND, "_moist"));
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.TEMPLATE_FARMLAND.upload(
						Blocks.FARMLAND,
						textureMap,
						this.modelCollector
				));
		WeightedVariant weightedVariant2 = createWeightedVariant(
				Models.TEMPLATE_FARMLAND.upload(
						TextureMap.getSubId(Blocks.FARMLAND, "_moist"),
						textureMap2,
						this.modelCollector
				)
		);
	...
	public final WeightedVariant getFireFloorModels(Block texture) {
		return createWeightedVariant(
				createModelVariant(Models.TEMPLATE_FIRE_FLOOR.upload(
						ModelIds.getBlockSubModelId(texture, "_floor0"),
						TextureMap.fire0(texture),
						this.modelCollector
				)),
				createModelVariant(Models.TEMPLATE_FIRE_FLOOR.upload(
						ModelIds.getBlockSubModelId(texture, "_floor1"),
						TextureMap.fire1(texture),
						this.modelCollector
				))
		);
	}
	...
	public final WeightedVariant getFireSideModels(Block texture) {
		return createWeightedVariant(
				createModelVariant(Models.TEMPLATE_FIRE_SIDE.upload(
						ModelIds.getBlockSubModelId(texture, "_side0"),
						TextureMap.fire0(texture),
						this.modelCollector
				)),
				createModelVariant(Models.TEMPLATE_FIRE_SIDE.upload(
						ModelIds.getBlockSubModelId(texture, "_side1"),
						TextureMap.fire1(texture),
						this.modelCollector
				)),
				createModelVariant(
						Models.TEMPLATE_FIRE_SIDE_ALT.upload(
								ModelIds.getBlockSubModelId(texture, "_side_alt0"),
								TextureMap.fire0(texture),
								this.modelCollector
						)
				),
	...
	public final WeightedVariant getFireUpModels(Block texture) {
		return createWeightedVariant(
				createModelVariant(Models.TEMPLATE_FIRE_UP.upload(
						ModelIds.getBlockSubModelId(texture, "_up0"),
						TextureMap.fire0(texture),
						this.modelCollector
				)),
				createModelVariant(Models.TEMPLATE_FIRE_UP.upload(
						ModelIds.getBlockSubModelId(texture, "_up1"),
						TextureMap.fire1(texture),
						this.modelCollector
				)),
				createModelVariant(
						Models.TEMPLATE_FIRE_UP_ALT.upload(
								ModelIds.getBlockSubModelId(texture, "_up_alt0"),
								TextureMap.fire0(texture),
								this.modelCollector
						)
				),
				createModelVariant(
						Models.TEMPLATE_FIRE_UP_ALT.upload(
								ModelIds.getBlockSubModelId(texture, "_up_alt1"),
								TextureMap.fire1(texture),
								this.modelCollector
						)
				)
	...
	public final void registerLantern(Block lantern) {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(TexturedModel.TEMPLATE_LANTERN.upload(lantern, this.modelCollector));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(TexturedModel.TEMPLATE_HANGING_LANTERN.upload(lantern, this.modelCollector));
	...
	public final void registerCopperChain(Block unwaxed, Block waxed) {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(TexturedModel.TEMPLATE_CHAIN.upload(unwaxed, this.modelCollector));
	...
	private void registerMuddyMangroveRoots() {
		TextureMap textureMap = TextureMap.sideEnd(
				TextureMap.getSubId(Blocks.MUDDY_MANGROVE_ROOTS, "_side"),
				TextureMap.getSubId(Blocks.MUDDY_MANGROVE_ROOTS, "_top")
		);
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.CUBE_COLUMN.upload(
				...
				.accept(
						VariantsBlockModelDefinitionCreator.of(Blocks.MANGROVE_PROPAGULE)
						                                   .with(
								                                   BlockStateVariantMap
										                                   .models(
												                                   PropaguleBlock.HANGING,
												                                   PropaguleBlock.AGE
										                                   )
										                                   .generate((hanging, age) -> hanging
										                                                               ? createWeightedVariant(
												                                   ModelIds.getBlockSubModelId(
														                                   block,
														                                   "_hanging_" + age
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(topSoil)
						                                   .with(BlockStateVariantMap
								                                   .models(Properties.SNOWY)
								                                   .register(true, snowyVariant)
								                                   .register(false, regularVariant))
				);
	}
	...
	public final void registerWeightedPressurePlate(Block weightedPressurePlate, Block textureSource) {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.PRESSURE_PLATE_UP.upload(
		...
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.PRESSURE_PLATE_DOWN.upload(
						weightedPressurePlate,
						textureMap,
						this.modelCollector
				));
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(weightedPressurePlate)
						                                   .with(createValueFencedModelMap(
								                                   Properties.POWER,
								                                   1,
								                                   weightedVariant2,
						...
						MultipartBlockModelDefinitionCreator.create(block)
						                                    ...
						                                    .with(
								                                    createMultipartConditionBuilder().put(
										                                    Properties.WEST,
										                                    true
								                                    ), weightedVariant6.apply(ROTATE_Y_90)
						                                    )
				);
	}
	...
	private void registerFrogspawn() {
		...
		this.blockStateCollector.accept(createSingletonBlockState(
				Blocks.FROGSPAWN,
				createWeightedVariant(ModelIds.getBlockModelId(Blocks.FROGSPAWN))
		));
	}
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(Blocks.NETHER_PORTAL)
						                                   .with(
								                                   BlockStateVariantMap
										                                   .models(Properties.HORIZONTAL_AXIS)
										                                   .register(
												                                   Direction.Axis.X,
												                                   createWeightedVariant(ModelIds.getBlockSubModelId(
	...
	private void registerNetherrack() {
		ModelVariant
				modelVariant =
				createModelVariant(TexturedModel.CUBE_ALL.upload(Blocks.NETHERRACK, this.modelCollector));
		this.blockStateCollector
				.accept(
	...
	private void registerPistons() {
		...
		Identifier identifier3 = Models.CUBE_BOTTOM_TOP
				.upload(
						Blocks.PISTON,
						"_inventory",
						textureMap.copyAndAdd(TextureKey.TOP, identifier2),
						this.modelCollector
				);
		Identifier identifier4 = Models.CUBE_BOTTOM_TOP
				.upload(
						...
						"_inventory",
						textureMap.copyAndAdd(TextureKey.TOP, identifier),
						this.modelCollector
				);
	...
	public final void registerPiston(Block piston, WeightedVariant weightedVariant, TextureMap textures) {
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.TEMPLATE_PISTON.upload(piston, textures, this.modelCollector));
		this.blockStateCollector
				.accept(
	...
	private void registerPistonHead() {
		...
		TextureMap
				textureMap2 =
				textureMap.copyAndAdd(TextureKey.PLATFORM, TextureMap.getSubId(Blocks.PISTON, "_top_sticky"));
						                                   ...
						                                   .with(
								                                   BlockStateVariantMap
										                                   ...
										                                   .register(
												                                   false,
												                                   PistonType.DEFAULT,
												                                   createWeightedVariant(Models.TEMPLATE_PISTON_HEAD.upload(
														                                   Blocks.PISTON,
														                                   "_head",
														                                   textureMap3,
														                                   this.modelCollector
										                                   ...
										                                   .register(
												                                   true,
												                                   PistonType.DEFAULT,
												                                   createWeightedVariant(Models.TEMPLATE_PISTON_HEAD_SHORT.upload(
														                                   Blocks.PISTON,
														                                   "_head_short",
														                                   textureMap3,
														                                   this.modelCollector
	...
	private void registerTrialSpawner() {
		...
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.CUBE_BOTTOM_TOP_INNER_FACES.upload(
						block,
						"_active",
						textureMap2,
						this.modelCollector
				...
				.accept(
						VariantsBlockModelDefinitionCreator.of(block)
						                                   .with(BlockStateVariantMap
								                                   ...
								                                   .generate((state, ominous) -> {
									                                   return switch (state) {
										                                   case INACTIVE, COOLDOWN ->
												                                   ominous ? weightedVariant4
												                                           : weightedVariant;
										                                   case WAITING_FOR_PLAYERS,
										                                        ACTIVE,
										                                        WAITING_FOR_REWARD_EJECTION ->
												                                   ominous ? weightedVariant5
												                                           : weightedVariant2;
										                                   case EJECTING_REWARD ->
												                                   ominous ? weightedVariant6
												                                           : weightedVariant3;
									                                   };
								                                   }))
				);
	...
	private void registerVault() {
		...
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.TEMPLATE_VAULT.upload(block, "_active", textureMap2, this.modelCollector));
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(Models.TEMPLATE_VAULT.upload(
						block,
						"_unlocking",
						textureMap3,
						this.modelCollector
		...
		TextureMap
				textureMap5 =
				TextureMap.vault(block, "_front_off_ominous", "_side_off_ominous", "_top_ominous", "_bottom_ominous");
		TextureMap
				textureMap6 =
				TextureMap.vault(block, "_front_on_ominous", "_side_on_ominous", "_top_ominous", "_bottom_ominous");
		TextureMap
				textureMap7 =
				TextureMap.vault(
						block,
						"_front_ejecting_ominous",
						"_side_on_ominous",
						"_top_ominous",
						"_bottom_ominous"
				);
		...
		WeightedVariant weightedVariant8 = createWeightedVariant(
				Models.TEMPLATE_VAULT.upload(block, "_ejecting_reward_ominous", textureMap8, this.modelCollector)
		);
		this.registerParentedItemModel(block, identifier);
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(block)
						                                   .with(BlockStateVariantMap
								                                   .models(VaultBlock.VAULT_STATE, VaultBlock.OMINOUS)
								                                   .generate((state, ominous) -> {
									                                   return switch (state) {
										                                   case INACTIVE -> ominous ? weightedVariant5
										                                                            : weightedVariant;
										                                   case ACTIVE -> ominous ? weightedVariant6
										                                                          : weightedVariant2;
										                                   case UNLOCKING -> ominous ? weightedVariant7
										                                                             : weightedVariant3;
										                                   case EJECTING -> ominous ? weightedVariant8
										                                                            : weightedVariant4;
									                                   };
								                                   }))
						                                   .apply(NORTH_DEFAULT_HORIZONTAL_ROTATION_OPERATIONS)
	...
	private void registerSculkSensor() {
		...
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.SCULK_SENSOR, "_active"));
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(Blocks.SCULK_SENSOR)
						                                   .with(
								                                   BlockStateVariantMap
										                                   .models(Properties.SCULK_SENSOR_PHASE)
										                                   .generate(phase ->
												                                   phase != SculkSensorPhase.ACTIVE
														                                   && phase
														                                   != SculkSensorPhase.COOLDOWN
												                                   ? weightedVariant : weightedVariant2)
						                                   )
				);
	}
	...
	private void registerCalibratedSculkSensor() {
		...
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.CALIBRATED_SCULK_SENSOR, "_active"));
	...
	private void registerSculkShrieker() {
		Identifier
				identifier =
				Models.TEMPLATE_SCULK_SHRIEKER.upload(
						Blocks.SCULK_SHRIEKER,
						TextureMap.sculkShrieker(false),
						this.modelCollector
				);
		WeightedVariant weightedVariant = createWeightedVariant(identifier);
		WeightedVariant weightedVariant2 = createWeightedVariant(
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator
								...
								.with(createBooleanModelMap(Properties.CAN_SUMMON, weightedVariant2, weightedVariant))
				);
	}
	...
	private void registerScaffolding() {
		...
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.SCAFFOLDING, "_unstable"));
		this.registerParentedItemModel(Blocks.SCAFFOLDING, identifier);
		this.blockStateCollector
				.accept(VariantsBlockModelDefinitionCreator
						.of(Blocks.SCAFFOLDING)
						.with(createBooleanModelMap(Properties.BOTTOM, weightedVariant2, weightedVariant)));
	}

	private void registerCaveVines() {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(this.createSubModel(Blocks.CAVE_VINES, "", Models.CROSS, TextureMap::cross));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(this.createSubModel(Blocks.CAVE_VINES, "_lit", Models.CROSS, TextureMap::cross));
		this.blockStateCollector
				.accept(VariantsBlockModelDefinitionCreator
						.of(Blocks.CAVE_VINES)
						.with(createBooleanModelMap(Properties.BERRIES, weightedVariant2, weightedVariant)));
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(this.createSubModel(
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator
								.of(Blocks.CAVE_VINES_PLANT)
								.with(createBooleanModelMap(Properties.BERRIES, weightedVariant4, weightedVariant3))
				);
	}
	...
	private void registerRedstoneLamp() {
		WeightedVariant
				weightedVariant =
				createWeightedVariant(TexturedModel.CUBE_ALL.upload(Blocks.REDSTONE_LAMP, this.modelCollector));
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(this.createSubModel(
	...
	public final void registerTorch(Block torch, Block wallTorch) {
		...
		this.blockStateCollector
				.accept(createSingletonBlockState(
						torch,
						createWeightedVariant(Models.TEMPLATE_TORCH.upload(torch, textureMap, this.modelCollector))
				));
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(
								                                   wallTorch,
								                                   createWeightedVariant(Models.TEMPLATE_TORCH_WALL.upload(
										                                   wallTorch,
										                                   textureMap,
										                                   this.modelCollector
								                                   ))
	...
	private void registerRedstoneTorch() {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.TEMPLATE_REDSTONE_TORCH.upload(
						Blocks.REDSTONE_TORCH,
						textureMap,
						this.modelCollector
				));
		WeightedVariant weightedVariant2 = createWeightedVariant(
				Models.TEMPLATE_TORCH_UNLIT.upload(Blocks.REDSTONE_TORCH, "_off", textureMap2, this.modelCollector)
		);
		this.blockStateCollector
				.accept(VariantsBlockModelDefinitionCreator
						.of(Blocks.REDSTONE_TORCH)
						.with(createBooleanModelMap(Properties.LIT, weightedVariant, weightedVariant2)));
		WeightedVariant weightedVariant3 = createWeightedVariant(
				Models.TEMPLATE_REDSTONE_TORCH_WALL.upload(Blocks.REDSTONE_WALL_TORCH, textureMap, this.modelCollector)
		);
		WeightedVariant weightedVariant4 = createWeightedVariant(
				Models.TEMPLATE_TORCH_WALL_UNLIT.upload(
						...
						VariantsBlockModelDefinitionCreator.of(Blocks.REPEATER)
						                                   .with(BlockStateVariantMap
								                                   ...
								                                   .generate((tick, locked, on) -> {
									                                   ...
									                                   return createWeightedVariant(TextureMap.getSubId(
											                                   Blocks.REPEATER,
						                                   ...
						                                   .with(
								                                   BlockStateVariantMap
										                                   ...
										                                   .register(
												                                   1,
												                                   false,
												                                   modelWithYRotation(createModelVariant(
	...
	private void registerSnows() {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.CUBE_ALL.upload(Blocks.SNOW_BLOCK, textureMap, this.modelCollector));
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(Blocks.SNOW)
						                                   .with(
								                                   BlockStateVariantMap.models(Properties.LAYERS)
								                                                       .generate(layers -> layers < 8
								                                                                           ? createWeightedVariant(
										                                                       ModelIds.getBlockSubModelId(
												                                                       Blocks.SNOW,
												                                                       "_height"
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator
								.of(
										Blocks.STONECUTTER,
										createWeightedVariant(ModelIds.getBlockModelId(Blocks.STONECUTTER))
								)
								.apply(NORTH_DEFAULT_HORIZONTAL_ROTATION_OPERATIONS)
				);
	}
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(Blocks.STRUCTURE_BLOCK)
						                                   .with(
								                                   BlockStateVariantMap
										                                   .models(Properties.STRUCTURE_BLOCK_MODE)
										                                   .generate(
												                                   mode -> createWeightedVariant(this.createSubModel(
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(Blocks.TEST_BLOCK)
						                                   .with(BlockStateVariantMap
								                                   .models(Properties.TEST_BLOCK_MODE)
								                                   .generate(mode -> createWeightedVariant(map.get(mode))))
				);
		this.itemModelOutput
				.accept(
						Items.TEST_BLOCK,
						ItemModels.select(
								TestBlock.MODE,
								ItemModels.basic(map.get(TestBlockMode.START)),
								Map.of(
										TestBlockMode.FAIL,
										ItemModels.basic(map.get(TestBlockMode.FAIL)),
										TestBlockMode.LOG,
										ItemModels.basic(map.get(TestBlockMode.LOG)),
										TestBlockMode.ACCEPT,
										ItemModels.basic(map.get(TestBlockMode.ACCEPT))
								)
						)
				);
	}
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(Blocks.SWEET_BERRY_BUSH)
						                                   .with(
								                                   BlockStateVariantMap.models(Properties.AGE_3)
								                                                       .generate(stage -> createWeightedVariant(
										                                                       this.createSubModel(
						...
						VariantsBlockModelDefinitionCreator.of(Blocks.TRIPWIRE_HOOK)
						                                   .with(
								                                   BlockStateVariantMap
										                                   ...
										                                   .generate(
												                                   (attached, on) -> createWeightedVariant(
														                                   ModelIds.getBlockSubModelId(
	...
	public final ModelVariant getTurtleEggModel(int eggs, String prefix, TextureMap textures) {
		return switch (eggs) {
			case 1 -> createModelVariant(
					Models.TEMPLATE_TURTLE_EGG.upload(
							ModelIds.getMinecraftNamespacedBlock(prefix + "turtle_egg"),
							textures,
							this.modelCollector
					)
			);
			case 2 -> createModelVariant(
					Models.TEMPLATE_TWO_TURTLE_EGGS.upload(
							ModelIds.getMinecraftNamespacedBlock("two_" + prefix + "turtle_eggs"),
							textures,
							this.modelCollector
					)
			);
			case 3 -> createModelVariant(
					Models.TEMPLATE_THREE_TURTLE_EGGS.upload(
							ModelIds.getMinecraftNamespacedBlock("three_" + prefix + "turtle_eggs"),
							textures,
							this.modelCollector
					)
			);
			case 4 -> createModelVariant(
					Models.TEMPLATE_FOUR_TURTLE_EGGS.upload(
							ModelIds.getMinecraftNamespacedBlock("four_" + prefix + "turtle_eggs"),
							textures,
							this.modelCollector
					)
			);
	...
	public final ModelVariant getTurtleEggModel(int eggs, int cracks) {
		return switch (cracks) {
			...
			case 1 -> this.getTurtleEggModel(
					eggs,
					"slightly_cracked_",
					TextureMap.all(TextureMap.getSubId(Blocks.TURTLE_EGG, "_slightly_cracked"))
			);
			case 2 -> this.getTurtleEggModel(
					eggs,
					"very_cracked_",
					TextureMap.all(TextureMap.getSubId(Blocks.TURTLE_EGG, "_very_cracked"))
			);
			default -> throw new UnsupportedOperationException();
		};
	}
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(Blocks.TURTLE_EGG)
						                                   .with(
								                                   BlockStateVariantMap
										                                   .models(Properties.EGGS, Properties.HATCH)
										                                   .generate((eggs, hatch) -> modelWithYRotation(
												                                   this.getTurtleEggModel(eggs, hatch)))
						                                   )
				);
	}
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(Blocks.DRIED_GHAST)
						                                   .with(BlockStateVariantMap
								                                   .models(DriedGhastBlock.HYDRATION)
								                                   .generate(hydration -> createWeightedVariant(function.apply(
										                                   hydration))))
						                                   .apply(NORTH_DEFAULT_HORIZONTAL_ROTATION_OPERATIONS)
				);
	}
	...
	private void registerSnifferEgg() {
		...
		this.blockStateCollector
				.accept(VariantsBlockModelDefinitionCreator
						.of(Blocks.SNIFFER_EGG)
						.with(BlockStateVariantMap.models(SnifferEggBlock.HATCH).generate(hatch -> {
							...
							return createWeightedVariant(Models.SNIFFER_EGG.upload(
									Blocks.SNIFFER_EGG,
									string,
									textureMap,
									this.modelCollector
	...
	public static <T extends Property<?>> Map<T, ModelVariantOperator> collectMultifaceOperators(
			State<?, ?> state,
			Function<Direction, T> propertyGetter
	) {
		Builder<T, ModelVariantOperator>
				builder =
				ImmutableMap.builderWithExpectedSize(CONNECTION_VARIANT_FUNCTIONS.size());
		CONNECTION_VARIANT_FUNCTIONS.forEach((direction, operator) -> {
			T property = propertyGetter.apply(direction);
	...
	public final void registerMultifaceBlockModel(Block block) {
		Map<Property<Boolean>, ModelVariantOperator>
				map =
				collectMultifaceOperators(block.getDefaultState(), MultifaceBlock::getProperty);
		MultipartModelConditionBuilder multipartModelConditionBuilder = createMultipartConditionBuilder();
		map.forEach((property, operator) -> multipartModelConditionBuilder.put((Property<Boolean>) property, false));
		WeightedVariant weightedVariant = createWeightedVariant(ModelIds.getBlockModelId(block));
		...
		map.forEach((property, operator) -> {
			multipartBlockModelDefinitionCreator.with(
					createMultipartConditionBuilder().put(
							...
							true
					), weightedVariant.apply(operator)
			);
	...
	public final void registerPaleMossCarpet(Block block) {
		Map<Property<WallShape>, ModelVariantOperator>
				map =
				collectMultifaceOperators(block.getDefaultState(), PaleMossCarpetBlock::getWallShape);
		MultipartModelConditionBuilder
				multipartModelConditionBuilder =
				createMultipartConditionBuilder().put(PaleMossCarpetBlock.BOTTOM, false);
		map.forEach((property, operator) -> multipartModelConditionBuilder.put(
				(Property<WallShape>) property,
				WallShape.NONE
		));
		WeightedVariant
				weightedVariant =
				createWeightedVariant(TexturedModel.CARPET.upload(block, this.modelCollector));
		WeightedVariant weightedVariant2 = createWeightedVariant(
				TexturedModel.MOSSY_CARPET_SIDE
						.get(block)
						.textures(textureMap -> textureMap.put(
								TextureKey.SIDE,
								TextureMap.getSubId(block, "_side_tall")
						))
		...
		WeightedVariant weightedVariant3 = createWeightedVariant(
				TexturedModel.MOSSY_CARPET_SIDE
						...
						.textures(textureMap -> textureMap.put(
								TextureKey.SIDE,
								TextureMap.getSubId(block, "_side_small")
						))
		...
		map.forEach(
				(property, operator) -> {
					multipartBlockModelDefinitionCreator.with(
							createMultipartConditionBuilder().put((Property<WallShape>) property, WallShape.TALL),
							weightedVariant2.apply(operator)
					);
					multipartBlockModelDefinitionCreator.with(
							createMultipartConditionBuilder().put((Property<WallShape>) property, WallShape.LOW),
							weightedVariant3.apply(operator)
					);
					multipartBlockModelDefinitionCreator.with(
							multipartModelConditionBuilder,
							weightedVariant2.apply(operator)
	...
	public final void registerHangingMoss(Block block) {
		...
		this.blockStateCollector.accept(VariantsBlockModelDefinitionCreator
				.of(block)
				.with(BlockStateVariantMap.models(HangingMossBlock.TIP).generate(tip -> {
					String string = tip ? "_tip" : "";
					TextureMap textureMap = TextureMap.cross(TextureMap.getSubId(block, string));
					return createWeightedVariant(BlockStateModelGenerator.CrossType.NOT_TINTED
							.getCrossModel()
							.upload(block, string, textureMap, this.modelCollector));
				})));
	}
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(Blocks.SCULK_CATALYST)
						                                   .with(BlockStateVariantMap
								                                   .models(Properties.BLOOM)
								                                   .generate(bloom -> bloom ? weightedVariant2
								                                                            : weightedVariant))
				);
	...
	public final void registerShelf(Block block, Block block2) {
		TextureMap
				...
				new TextureMap()
						...
						.put(TextureKey.PARTICLE, TextureMap.getId(block2));
		MultipartBlockModelDefinitionCreator
				multipartBlockModelDefinitionCreator =
				MultipartBlockModelDefinitionCreator.create(block);
		this.registerShelf(
		...
		this.registerShelf(
				...
				textureMap,
				multipartBlockModelDefinitionCreator,
				Models.TEMPLATE_SHELF_UNPOWERED,
				false,
				null
		);
		this.registerShelf(
				...
				textureMap,
				multipartBlockModelDefinitionCreator,
				Models.TEMPLATE_SHELF_UNCONNECTED,
				true,
		...
		this.registerParentedItemModel(
				block,
				Models.TEMPLATE_SHELF_INVENTORY.upload(block, textureMap, this.modelCollector)
		);
	}
	...
	public final void registerShelf(
		...
		forEachHorizontalDirection(
				(facing, operator) -> definitionCreator.with(
						createSideChainModelCondition(facing, powered, sideChain),
						weightedVariant.apply(operator)
				)
		);
	}
	...
	public static void forEachHorizontalDirection(BiConsumer<Direction, ModelVariantOperator> biConsumer) {
		List.of(
				    ...
				    Pair.of(Direction.EAST, ROTATE_Y_90),
				    Pair.of(Direction.SOUTH, ROTATE_Y_180),
				    Pair.of(Direction.WEST, ROTATE_Y_270)
		    )
		    .forEach(pair -> {
	...
	public static MultipartModelCondition createSideChainModelCondition(
			Direction facing,
			@Nullable Boolean powered,
			@Nullable SideChainPart sideChain
	) {
		MultipartModelConditionBuilder
				multipartModelConditionBuilder =
				createMultipartConditionBuilderWith(Properties.HORIZONTAL_FACING, facing);
		if (powered == null) {
			return multipartModelConditionBuilder.build();
		}
		else {
			MultipartModelConditionBuilder
					multipartModelConditionBuilder2 =
					createMultipartConditionBuilderWith(Properties.POWERED, powered);
			return sideChain != null
			       ? and(
					multipartModelConditionBuilder,
					multipartModelConditionBuilder2,
					createMultipartConditionBuilderWith(Properties.SIDE_CHAIN, sideChain)
			)
	...
	private void registerChiseledBookshelf() {
		...
		forEachHorizontalDirection((facing, operator) -> {
			MultipartModelCondition
					multipartModelCondition =
					createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, facing).build();
			multipartBlockModelDefinitionCreator.with(
					multipartModelCondition,
					weightedVariant.apply(operator).apply(UV_LOCK)
			);
	...
	public final void supplyChiseledBookshelfModels(
		...
		List.of(
		    ...
		    .forEach(pair -> {
			    ...
			    this.supplyChiseledBookshelfModel(
					    blockStateSupplier,
					    facingCondition,
					    rotation,
					    booleanProperty,
	...
	public final void supplyChiseledBookshelfModel(
		...
		TextureMap
				textureMap =
				new TextureMap().put(TextureKey.TEXTURE, TextureMap.getSubId(Blocks.CHISELED_BOOKSHELF, string));
		BlockStateModelGenerator.ChiseledBookshelfModelCacheKey
				chiseledBookshelfModelCacheKey =
				new BlockStateModelGenerator.ChiseledBookshelfModelCacheKey(
						model, string
				);
		WeightedVariant weightedVariant = createWeightedVariant(
				CHISELED_BOOKSHELF_MODEL_CACHE.computeIfAbsent(
						chiseledBookshelfModelCacheKey,
						key -> model.upload(Blocks.CHISELED_BOOKSHELF, string, textureMap, this.modelCollector)
				)
		);
		blockStateSupplier.with(
				new MultipartModelCombinedCondition(
						MultipartModelCombinedCondition.LogicalOperator.AND,
						List.of(facingCondition, createMultipartConditionBuilder().put(property, occupied).build())
				),
	...
	private void registerMagmaBlock() {
		WeightedVariant weightedVariant = createWeightedVariant(
				Models.CUBE_ALL.upload(
						Blocks.MAGMA_BLOCK,
						TextureMap.all(ModelIds.getMinecraftNamespacedBlock("magma")),
						this.modelCollector
				)
		);
	...
	public final void registerShulkerBox(Block shulkerBox, @Nullable DyeColor color) {
		...
		Identifier
				identifier =
				Models.TEMPLATE_SHULKER_BOX.upload(item, TextureMap.particle(shulkerBox), this.modelCollector);
	...
	private void registerInfestedDeepslate() {
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator
								.of(Blocks.INFESTED_DEEPSLATE, modelWithMirroring(modelVariant, modelVariant2))
								.apply(createAxisRotatedVariantMap())
				);
	...
	public final void registerRoots(Block root, Block pottedRoot) {
		...
		WeightedVariant weightedVariant = createWeightedVariant(
				BlockStateModelGenerator.CrossType.NOT_TINTED
						.getFlowerPotCrossModel()
						.upload(pottedRoot, textureMap, this.modelCollector)
		);
	...
	private void registerRespawnAnchor() {
		...
		for (int i = 0; i < 5; i++) {
			...
			identifiers[i] =
					Models.CUBE_BOTTOM_TOP.upload(Blocks.RESPAWN_ANCHOR, "_" + i, textureMap, this.modelCollector);
		}
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(Blocks.RESPAWN_ANCHOR)
						                                   .with(BlockStateVariantMap
								                                   .models(Properties.CHARGES)
								                                   .generate(charges -> createWeightedVariant(
										                                   identifiers[charges])))
				);
	...
	private void registerJigsaw() {
		...
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(
								                                   Blocks.JIGSAW,
								                                   createWeightedVariant(Models.CUBE_DIRECTIONAL.upload(
										                                   Blocks.JIGSAW,
										                                   textureMap,
										                                   this.modelCollector
								                                   ))
	...
	private void registerPetrifiedOakSlab() {
		...
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.SLAB.upload(block2, textureMap, this.modelCollector));
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(Models.SLAB_TOP.upload(block2, textureMap, this.modelCollector));
		this.blockStateCollector.accept(createSlabBlockState(
				block2,
				weightedVariant2,
				weightedVariant3,
	...
	public final void registerSkull(Block block, Block wallBlock, SkullBlock.SkullType type, Identifier baseModelId) {
		...
		if (type == SkullBlock.Type.PLAYER) {
			this.itemModelOutput.accept(
					block.asItem(),
					ItemModels.special(baseModelId, new PlayerHeadModelRenderer.Unbaked())
			);
		}
		else {
			this.itemModelOutput.accept(
					block.asItem(),
					ItemModels.special(baseModelId, new HeadModelRenderer.Unbaked(type))
			);
		}
	}
	...
	private void registerSkulls() {
		...
		this.registerSkull(
				...
				SkullBlock.Type.WITHER_SKELETON,
				identifier
		);
		...
		this.registerSkull(
				...
				ModelIds.getItemModelId(Items.DRAGON_HEAD)
		);
	}

	private void registerCopperGolemStatues() {
		this.registerCopperGolemStatue(
	...
	public final void registerCopperGolemStatue(
			Block block,
			Block particleBlock,
		...
		this.itemModelOutput
				.accept(
						...
						ItemModels.select(
								...
								ItemModels.special(
										identifier,
										new CopperGolemStatueModelRenderer.Unbaked(
												oxidationLevel,
	...
	public final void registerChest(Block block, Block particleSource, Identifier texture, boolean christmas) {
		...
		Identifier
				identifier =
				Models.TEMPLATE_CHEST.upload(item, TextureMap.particle(particleSource), this.modelCollector);
		ItemModel.Unbaked unbaked = ItemModels.special(identifier, new ChestModelRenderer.Unbaked(texture));
		if (christmas) {
			ItemModel.Unbaked
					unbaked2 =
					ItemModels.special(identifier, new ChestModelRenderer.Unbaked(ChestModelRenderer.CHRISTMAS_ID));
	...
	private void registerCopperChests() {
		...
		this.registerChest(
				...
				Blocks.EXPOSED_COPPER,
				ChestModelRenderer.EXPOSED_COPPER_ID,
				false
		);
		this.registerChest(
				Blocks.WEATHERED_COPPER_CHEST,
				Blocks.WEATHERED_COPPER,
				ChestModelRenderer.WEATHERED_COPPER_ID,
				false
		);
		this.registerChest(
				Blocks.OXIDIZED_COPPER_CHEST,
				Blocks.OXIDIZED_COPPER,
				ChestModelRenderer.OXIDIZED_COPPER_ID,
				false
		);
	...
	public void register() {
		...
		this.registerTintableCrossBlockState(
				Blocks.FIREFLY_BUSH,
				BlockStateModelGenerator.CrossType.EMISSIVE_NOT_TINTED
		);
		...
		this.registerCubeWithCustomTextures(
		...
		this.registerAxisRotated(
				Blocks.IRON_CHAIN,
				createWeightedVariant(TexturedModel.TEMPLATE_CHAIN.upload(Blocks.IRON_CHAIN, this.modelCollector))
		);
		...
		this.registerTintableCrossBlockStateWithStages(
		...
		this.registerFlowerPotPlantAndItem(
				Blocks.DANDELION,
		...
		this.registerTintableCross(
				...
				BlockStateModelGenerator.CrossType.TINTED,
				TextureMap.cross(TextureMap.getSubId(Blocks.BAMBOO, "_stage0"))
		);
		this.registerBamboo();
		...
		this
				.createLogTexturePool(Blocks.STRIPPED_MANGROVE_LOG)
				.log(Blocks.STRIPPED_MANGROVE_LOG)
				.wood(Blocks.STRIPPED_MANGROVE_WOOD);
		this.registerHangingSign(
		...
		this
				.createLogTexturePool(Blocks.STRIPPED_ACACIA_LOG)
				.log(Blocks.STRIPPED_ACACIA_LOG)
				.wood(Blocks.STRIPPED_ACACIA_WOOD);
		this.registerHangingSign(
		...
		this
				.createLogTexturePool(Blocks.STRIPPED_CHERRY_LOG)
				.uvLockedLog(Blocks.STRIPPED_CHERRY_LOG)
				.wood(Blocks.STRIPPED_CHERRY_WOOD);
		this.registerHangingSign(
		...
		this
				.createLogTexturePool(Blocks.STRIPPED_BIRCH_LOG)
				.log(Blocks.STRIPPED_BIRCH_LOG)
				.wood(Blocks.STRIPPED_BIRCH_WOOD);
		...
		this
				.createLogTexturePool(Blocks.STRIPPED_SPRUCE_LOG)
		...
		this
				.createLogTexturePool(Blocks.STRIPPED_DARK_OAK_LOG)
				.log(Blocks.STRIPPED_DARK_OAK_LOG)
				.wood(Blocks.STRIPPED_DARK_OAK_WOOD);
		this.registerHangingSign(
		...
		this
				.createLogTexturePool(Blocks.STRIPPED_PALE_OAK_LOG)
				.log(Blocks.STRIPPED_PALE_OAK_LOG)
				.wood(Blocks.STRIPPED_PALE_OAK_WOOD);
		this.registerHangingSign(
		...
		this
				.createLogTexturePool(Blocks.STRIPPED_JUNGLE_LOG)
				.log(Blocks.STRIPPED_JUNGLE_LOG)
				.wood(Blocks.STRIPPED_JUNGLE_WOOD);
		this.registerHangingSign(
		...
		this
				.createLogTexturePool(Blocks.STRIPPED_CRIMSON_STEM)
				.stem(Blocks.STRIPPED_CRIMSON_STEM)
				.wood(Blocks.STRIPPED_CRIMSON_HYPHAE);
		this.registerHangingSign(
		...
		this
				.createLogTexturePool(Blocks.STRIPPED_WARPED_STEM)
				.stem(Blocks.STRIPPED_WARPED_STEM)
				.wood(Blocks.STRIPPED_WARPED_HYPHAE);
		this.registerHangingSign(
	...
	private void registerLightBlock() {
		...
		BlockStateVariantMap.SingleProperty<WeightedVariant, Integer>
				singleProperty =
				BlockStateVariantMap.models(Properties.LEVEL_15);
		...
		for (int i = 0; i <= 15; i++) {
			...
			singleProperty.register(
					...
					createWeightedVariant(Models.PARTICLE.upload(
							Blocks.LIGHT,
							string,
							TextureMap.particle(identifier),
							this.modelCollector
					))
			);
			ItemModel.Unbaked unbaked2 = ItemModels.basic(
					Models.GENERATED.upload(
							ModelIds.getItemSubModelId(Items.LIGHT, string),
							TextureMap.layer0(identifier),
							this.modelCollector
					)
			);
			map.put(i, unbaked2);
	...
	public final void registerCandle(Block candle, Block cake) {
		...
		WeightedVariant
				weightedVariant =
				createWeightedVariant(Models.TEMPLATE_CANDLE.upload(
						candle,
						"_one_candle",
						textureMap,
						this.modelCollector
		...
		WeightedVariant
				weightedVariant2 =
				createWeightedVariant(Models.TEMPLATE_TWO_CANDLES.upload(
						candle,
						"_two_candles",
						textureMap,
						this.modelCollector
		...
		WeightedVariant
				weightedVariant3 =
				createWeightedVariant(Models.TEMPLATE_THREE_CANDLES.upload(
						candle,
						"_three_candles",
						textureMap,
						this.modelCollector
		...
		WeightedVariant
				weightedVariant4 =
				createWeightedVariant(Models.TEMPLATE_FOUR_CANDLES.upload(
						candle,
						"_four_candles",
						textureMap,
						this.modelCollector
		...
		WeightedVariant weightedVariant7 = createWeightedVariant(
				Models.TEMPLATE_THREE_CANDLES.upload(candle, "_three_candles_lit", textureMap2, this.modelCollector)
		);
		WeightedVariant weightedVariant8 = createWeightedVariant(
				Models.TEMPLATE_FOUR_CANDLES.upload(candle, "_four_candles_lit", textureMap2, this.modelCollector)
		);
		this.blockStateCollector
				.accept(
						VariantsBlockModelDefinitionCreator.of(candle)
						                                   .with(
								                                   BlockStateVariantMap
										                                   .models(Properties.CANDLES, Properties.LIT)
		...
		WeightedVariant weightedVariant10 = createWeightedVariant(
				Models.TEMPLATE_CAKE_WITH_CANDLE.upload(
						cake,
						"_lit",
						TextureMap.candleCake(candle, true),
						this.modelCollector
				)
		);
		this.blockStateCollector
				.accept(VariantsBlockModelDefinitionCreator
						.of(cake)
						.with(createBooleanModelMap(Properties.LIT, weightedVariant10, weightedVariant9)));
	}

	@Environment(EnvType.CLIENT)
	/**
	 * {@code BlockTexturePool}.
	 */
	public class BlockTexturePool {
		...
		public BlockStateModelGenerator.BlockTexturePool base(Block block, Model model) {
			this.baseModelId =
					BlockStateModelGenerator.createModelVariant(model.upload(
							block,
							this.textures,
							BlockStateModelGenerator.this.modelCollector
					));
			if (BlockStateModelGenerator.BASE_WITH_CUSTOM_GENERATOR.containsKey(block)) {
				BlockStateModelGenerator.this.blockStateCollector
						.accept(
								BlockStateModelGenerator.BASE_WITH_CUSTOM_GENERATOR
										.get(block)
										.create(
												block,
												this.baseModelId,
				...
				BlockStateModelGenerator.this.blockStateCollector
						.accept(BlockStateModelGenerator.createSingletonBlockState(
								block,
								BlockStateModelGenerator.createWeightedVariant(this.baseModelId)
						));
			}
		...
		public BlockStateModelGenerator.BlockTexturePool parented(Block parent, Block child) {
			...
			BlockStateModelGenerator.this.blockStateCollector
					.accept(BlockStateModelGenerator.createSingletonBlockState(
							child,
							BlockStateModelGenerator.createWeightedVariant(identifier)
					));
		...
		public BlockStateModelGenerator.BlockTexturePool button(Block buttonBlock) {
			...
			BlockStateModelGenerator.this.blockStateCollector
					.accept(BlockStateModelGenerator.createButtonBlockState(
							buttonBlock,
							weightedVariant,
							weightedVariant2
					));
		...
		public BlockStateModelGenerator.BlockTexturePool customFence(Block customFenceBlock) {
			...
			WeightedVariant weightedVariant2 = BlockStateModelGenerator.createWeightedVariant(
					Models.CUSTOM_FENCE_SIDE_NORTH.upload(
							customFenceBlock,
							textureMap,
							BlockStateModelGenerator.this.modelCollector
					)
			...
			WeightedVariant weightedVariant3 = BlockStateModelGenerator.createWeightedVariant(
					Models.CUSTOM_FENCE_SIDE_EAST.upload(
							customFenceBlock,
							textureMap,
							BlockStateModelGenerator.this.modelCollector
					)
			...
			WeightedVariant weightedVariant4 = BlockStateModelGenerator.createWeightedVariant(
					Models.CUSTOM_FENCE_SIDE_SOUTH.upload(
							customFenceBlock,
							textureMap,
							BlockStateModelGenerator.this.modelCollector
					)
			...
			WeightedVariant weightedVariant5 = BlockStateModelGenerator.createWeightedVariant(
					Models.CUSTOM_FENCE_SIDE_WEST.upload(
							customFenceBlock,
							textureMap,
							BlockStateModelGenerator.this.modelCollector
					)
			...
			Identifier
					identifier =
					Models.CUSTOM_FENCE_INVENTORY.upload(
							customFenceBlock,
							textureMap,
							BlockStateModelGenerator.this.modelCollector
					);
		...
		public BlockStateModelGenerator.BlockTexturePool customFenceGate(Block customFenceGateBlock) {
			...
			WeightedVariant weightedVariant = BlockStateModelGenerator.createWeightedVariant(
					Models.TEMPLATE_CUSTOM_FENCE_GATE_OPEN.upload(
							customFenceGateBlock,
							textureMap,
							BlockStateModelGenerator.this.modelCollector
					)
			);
			WeightedVariant weightedVariant2 = BlockStateModelGenerator.createWeightedVariant(
					Models.TEMPLATE_CUSTOM_FENCE_GATE.upload(
							customFenceGateBlock,
							textureMap,
							BlockStateModelGenerator.this.modelCollector
					)
			...
			WeightedVariant weightedVariant3 = BlockStateModelGenerator.createWeightedVariant(
					Models.TEMPLATE_CUSTOM_FENCE_GATE_WALL_OPEN.upload(
							customFenceGateBlock,
							textureMap,
							BlockStateModelGenerator.this.modelCollector
					)
			...
			WeightedVariant weightedVariant4 = BlockStateModelGenerator.createWeightedVariant(
					Models.TEMPLATE_CUSTOM_FENCE_GATE_WALL.upload(
							customFenceGateBlock,
							textureMap,
							BlockStateModelGenerator.this.modelCollector
					)
		...
		public BlockStateModelGenerator.BlockTexturePool fenceGate(Block fenceGateBlock) {
			WeightedVariant weightedVariant = BlockStateModelGenerator.createWeightedVariant(
					Models.TEMPLATE_FENCE_GATE_OPEN.upload(
							fenceGateBlock,
							this.textures,
							BlockStateModelGenerator.this.modelCollector
					)
			...
			WeightedVariant weightedVariant2 = BlockStateModelGenerator.createWeightedVariant(
					Models.TEMPLATE_FENCE_GATE.upload(
							fenceGateBlock,
							this.textures,
							BlockStateModelGenerator.this.modelCollector
					)
			...
			WeightedVariant weightedVariant3 = BlockStateModelGenerator.createWeightedVariant(
					Models.TEMPLATE_FENCE_GATE_WALL_OPEN.upload(
							fenceGateBlock,
							this.textures,
							BlockStateModelGenerator.this.modelCollector
					)
			...
			WeightedVariant weightedVariant4 = BlockStateModelGenerator.createWeightedVariant(
					Models.TEMPLATE_FENCE_GATE_WALL.upload(
							fenceGateBlock,
							this.textures,
							BlockStateModelGenerator.this.modelCollector
					)
		...
		public BlockStateModelGenerator.BlockTexturePool pressurePlate(Block pressurePlateBlock) {
			...
			BlockStateModelGenerator.this.blockStateCollector
					.accept(BlockStateModelGenerator.createPressurePlateBlockState(
							pressurePlateBlock,
							weightedVariant,
							weightedVariant2
					));
		...
		public BlockStateModelGenerator.BlockTexturePool sign(Block signBlock) {
			if (this.family == null) {
				...
				BlockStateModelGenerator.this.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(
						signBlock,
						weightedVariant
				));
				BlockStateModelGenerator.this.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(
		...
		public BlockStateModelGenerator.BlockTexturePool slab(Block block) {
			if (this.baseModelId == null) {
				...
				WeightedVariant
						weightedVariant =
						BlockStateModelGenerator.createWeightedVariant(this.ensureModel(Models.SLAB_TOP, block));
				BlockStateModelGenerator.this.blockStateCollector
						.accept(
		...
		public BlockStateModelGenerator.BlockTexturePool stairs(Block block) {
			WeightedVariant
					weightedVariant =
					BlockStateModelGenerator.createWeightedVariant(this.ensureModel(Models.INNER_STAIRS, block));
			Identifier identifier = this.ensureModel(Models.STAIRS, block);
			WeightedVariant
					weightedVariant2 =
					BlockStateModelGenerator.createWeightedVariant(this.ensureModel(Models.OUTER_STAIRS, block));
			BlockStateModelGenerator.this.blockStateCollector
					.accept(
		...
		private BlockStateModelGenerator.BlockTexturePool block(Block block) {
			TexturedModel
					texturedModel =
					BlockStateModelGenerator.TEXTURED_MODELS.getOrDefault(block, TexturedModel.CUBE_ALL.get(block));
			WeightedVariant weightedVariant = BlockStateModelGenerator.createWeightedVariant(
					texturedModel.upload(block, BlockStateModelGenerator.this.modelCollector)
			);
			BlockStateModelGenerator.this.blockStateCollector.accept(BlockStateModelGenerator.createSingletonBlockState(
					block,
					weightedVariant
		...
		private Identifier ensureModel(Model model, Block block) {
			return this.knownModels.computeIfAbsent(
					model,
					newModel -> newModel.upload(block, this.textures, BlockStateModelGenerator.this.modelCollector)
			);
		}
			...
			family.getVariants().forEach((variant, block) -> {
				if (!this.children.contains(block)) {
					BiConsumer<BlockStateModelGenerator.BlockTexturePool, Block>
							biConsumer =
							BlockStateModelGenerator.VARIANT_POOL_FUNCTIONS.get(variant);
					if (biConsumer != null) {
	...
	@Environment(EnvType.CLIENT)
	/**
	 * {@code ChiseledBookshelfModelCacheKey}.
	 */
	...
	public static enum CrossType {
		...
		public Identifier registerItemModel(BlockStateModelGenerator modelGenerator, Block block) {
			...
			return this.emissive ? modelGenerator.uploadTwoLayerBlockItemModel(item, block, "_emissive")
			                     : modelGenerator.uploadBlockItemModel(item, block);
		}
	...
	public class LogTexturePool {
		...
		public BlockStateModelGenerator.LogTexturePool wood(Block woodBlock) {
			...
			Identifier
					identifier =
					Models.CUBE_COLUMN.upload(woodBlock, textureMap, BlockStateModelGenerator.this.modelCollector);
			BlockStateModelGenerator.this.blockStateCollector
					.accept(BlockStateModelGenerator.createAxisRotatedBlockState(
							woodBlock,
							BlockStateModelGenerator.createWeightedVariant(identifier)
					));
		...
		public BlockStateModelGenerator.LogTexturePool stem(Block stemBlock) {
			Identifier
					identifier =
					Models.CUBE_COLUMN.upload(stemBlock, this.textures, BlockStateModelGenerator.this.modelCollector);
			BlockStateModelGenerator.this.blockStateCollector
					.accept(BlockStateModelGenerator.createAxisRotatedBlockState(
							stemBlock,
							BlockStateModelGenerator.createWeightedVariant(identifier)
		...
		public BlockStateModelGenerator.LogTexturePool log(Block logBlock) {
			Identifier
					identifier =
					Models.CUBE_COLUMN.upload(logBlock, this.textures, BlockStateModelGenerator.this.modelCollector);
			WeightedVariant weightedVariant = BlockStateModelGenerator.createWeightedVariant(
		...
		public BlockStateModelGenerator.LogTexturePool uvLockedLog(Block logBlock) {
			BlockStateModelGenerator.this.blockStateCollector
					.accept(BlockStateModelGenerator.createUvLockedColumnBlockState(
							logBlock,
							this.textures,
							BlockStateModelGenerator.this.modelCollector
					));
	...
	interface StateFactory {
		...
		BlockModelDefinitionCreator create(
				Block block,
