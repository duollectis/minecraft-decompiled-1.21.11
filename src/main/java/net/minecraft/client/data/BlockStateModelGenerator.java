...
public class BlockStateModelGenerator {
      ...
      this.blockStateCollector
         .accept(
            MultipartBlockModelDefinitionCreator.create(block)
               .with(model1ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.NORTH)), model1)
               .with(
                  model1ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.EAST)), model1.apply(ROTATE_Y_90)
               )
               .with(
                  model1ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.SOUTH)),
                  model1.apply(ROTATE_Y_180)
               )
               .with(
                  model1ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.WEST)),
                  model1.apply(ROTATE_Y_270)
               )
               .with(model2ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.NORTH)), model2)
               .with(
                  model2ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.EAST)), model2.apply(ROTATE_Y_90)
               )
               .with(
                  model2ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.SOUTH)),
                  model2.apply(ROTATE_Y_180)
               )
               .with(
                  model2ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.WEST)),
                  model2.apply(ROTATE_Y_270)
               )
               .with(model3ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.NORTH)), model3)
               .with(
                  model3ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.EAST)), model3.apply(ROTATE_Y_90)
               )
               .with(
                  model3ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.SOUTH)),
                  model3.apply(ROTATE_Y_180)
               )
               .with(
                  model3ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.WEST)),
                  model3.apply(ROTATE_Y_270)
               )
               .with(model4ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.NORTH)), model4)
               .with(
                  model4ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.EAST)), model4.apply(ROTATE_Y_90)
               )
               .with(
                  model4ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.SOUTH)),
                  model4.apply(ROTATE_Y_180)
               )
               .with(
                  model4ConditionFunction.apply(createMultipartConditionBuilder().put(Properties.HORIZONTAL_FACING, Direction.WEST)),
                           ...
                           age -> {
                              ...
                              return createWeightedVariant(
                                 (Identifier)int2ObjectMap.computeIfAbsent(
                                    i, stage -> this.createSubModel(crop, "_stage" + stage, Models.CROP, TextureMap::crop)
                                 )
                              );
                           }
                        )
   ...
   public final void registerPottedAzaleaBush(Block block) {
      ...
      if (block == Blocks.POTTED_FLOWERING_AZALEA_BUSH) {
         weightedVariant = createWeightedVariant(
            Models.TEMPLATE_POTTED_FLOWERING_AZALEA_BUSH.upload(block, TextureMap.pottedAzaleaBush(block), this.modelCollector)
         );
      } else {
   ...
   private void registerSmoothStone() {
      ...
      this.blockStateCollector
         .accept(
            createSingletonBlockState(Blocks.SMOOTH_STONE, createWeightedVariant(Models.CUBE_ALL.upload(Blocks.SMOOTH_STONE, textureMap, this.modelCollector)))
         );
   }
      ...
      this.blockStateCollector
         .accept(
            MultipartBlockModelDefinitionCreator.create(Blocks.BREWING_STAND)
               ...
               .with(
                  createMultipartConditionBuilder().put(Properties.HAS_BOTTLE_0, true),
                  createWeightedVariant(TextureMap.getSubId(Blocks.BREWING_STAND, "_bottle0"))
               )
               .with(
                  createMultipartConditionBuilder().put(Properties.HAS_BOTTLE_1, true),
                  createWeightedVariant(TextureMap.getSubId(Blocks.BREWING_STAND, "_bottle1"))
               )
               .with(
                  createMultipartConditionBuilder().put(Properties.HAS_BOTTLE_2, true),
                  createWeightedVariant(TextureMap.getSubId(Blocks.BREWING_STAND, "_bottle2"))
               )
               .with(
                  createMultipartConditionBuilder().put(Properties.HAS_BOTTLE_0, false),
                  createWeightedVariant(TextureMap.getSubId(Blocks.BREWING_STAND, "_empty0"))
               )
               .with(
                  createMultipartConditionBuilder().put(Properties.HAS_BOTTLE_1, false),
                  createWeightedVariant(TextureMap.getSubId(Blocks.BREWING_STAND, "_empty1"))
               )
               .with(
                  createMultipartConditionBuilder().put(Properties.HAS_BOTTLE_2, false),
                  createWeightedVariant(TextureMap.getSubId(Blocks.BREWING_STAND, "_empty2"))
               )
         );
   }
      ...
      this.blockStateCollector
         .accept(
            createSingletonBlockState(
               Blocks.CARTOGRAPHY_TABLE, createWeightedVariant(Models.CUBE.upload(Blocks.CARTOGRAPHY_TABLE, textureMap, this.modelCollector))
            )
         );
   }
   ...
   private void registerSmithingTable() {
      ...
      this.blockStateCollector
         .accept(
            createSingletonBlockState(Blocks.SMITHING_TABLE, createWeightedVariant(Models.CUBE.upload(Blocks.SMITHING_TABLE, textureMap, this.modelCollector)))
         );
   }
            ...
            createSingletonBlockState(
               ...
               createWeightedVariant(
                  Models.TEMPLATE_CAULDRON_FULL
                     .upload(Blocks.LAVA_CAULDRON, TextureMap.cauldron(TextureMap.getSubId(Blocks.LAVA, "_still")), this.modelCollector)
               )
            )
         );
      this.blockStateCollector
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockModelDefinitionCreator.of(Blocks.CHORUS_FLOWER)
               .with(createValueFencedModelMap(Properties.AGE_5, 5, weightedVariant2, weightedVariant))
         );
   }
         ...
         .accept(
            MultipartBlockModelDefinitionCreator.create(Blocks.CHORUS_PLANT)
               ...
               .with(
                  ...
                  new WeightedVariant(
                     Pool.of(
                        new Weighted<>(modelVariant, 2), new Weighted<>(modelVariant2, 1), new Weighted<>(modelVariant3, 1), new Weighted<>(modelVariant4, 1)
                     )
                  )
               )
               .with(
      ...
      this.blockStateCollector
         .accept(
            MultipartBlockModelDefinitionCreator.create(Blocks.COMPOSTER)
               ...
               .with(
                  createMultipartConditionBuilder().put(Properties.LEVEL_8, 8), createWeightedVariant(TextureMap.getSubId(Blocks.COMPOSTER, "_contents_ready"))
               )
         );
   }
            ...
            VariantsBlockModelDefinitionCreator.of(Blocks.DAYLIGHT_DETECTOR)
               .with(
                  BlockStateVariantMap.models(Properties.INVERTED)
                     .register(
                        false, createWeightedVariant(Models.TEMPLATE_DAYLIGHT_DETECTOR.upload(Blocks.DAYLIGHT_DETECTOR, textureMap, this.modelCollector))
                     )
                     .register(
                        true,
                        createWeightedVariant(
   ...
   private void registerFarmland() {
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockModelDefinitionCreator.of(Blocks.FARMLAND).with(createValueFencedModelMap(Properties.MOISTURE, 7, weightedVariant2, weightedVariant))
         );
   }
   ...
   public final WeightedVariant getFireSideModels(Block texture) {
      return createWeightedVariant(
         ...
         createModelVariant(
            Models.TEMPLATE_FIRE_SIDE_ALT.upload(ModelIds.getBlockSubModelId(texture, "_side_alt0"), TextureMap.fire0(texture), this.modelCollector)
         ),
         createModelVariant(
            Models.TEMPLATE_FIRE_SIDE_ALT.upload(ModelIds.getBlockSubModelId(texture, "_side_alt1"), TextureMap.fire1(texture), this.modelCollector)
         )
      );
   }
   ...
   public final WeightedVariant getFireUpModels(Block texture) {
      return createWeightedVariant(
         ...
         createModelVariant(
            Models.TEMPLATE_FIRE_UP_ALT.upload(ModelIds.getBlockSubModelId(texture, "_up_alt0"), TextureMap.fire0(texture), this.modelCollector)
         ),
         createModelVariant(
            Models.TEMPLATE_FIRE_UP_ALT.upload(ModelIds.getBlockSubModelId(texture, "_up_alt1"), TextureMap.fire1(texture), this.modelCollector)
         )
      );
   }
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockModelDefinitionCreator.of(weightedPressurePlate)
               .with(createValueFencedModelMap(Properties.POWER, 1, weightedVariant2, weightedVariant))
         );
   }
               ...
               .with(
                  BlockStateVariantMap.models(Properties.SHORT, Properties.PISTON_TYPE)
                     .register(
                        false,
                        PistonType.DEFAULT,
                        createWeightedVariant(Models.TEMPLATE_PISTON_HEAD.upload(Blocks.PISTON, "_head", textureMap3, this.modelCollector))
                     )
                     .register(
                        false,
                        PistonType.STICKY,
                        createWeightedVariant(Models.TEMPLATE_PISTON_HEAD.upload(Blocks.PISTON, "_head_sticky", textureMap2, this.modelCollector))
                     )
                     .register(
                        true,
                        PistonType.DEFAULT,
   ...
   private void registerVault() {
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockModelDefinitionCreator.of(block)
               .with(BlockStateVariantMap.models(VaultBlock.VAULT_STATE, VaultBlock.OMINOUS).generate((state, ominous) -> {
                  return switch (state) {
   ...
   private void registerSculkShrieker() {
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockModelDefinitionCreator.of(Blocks.SCULK_SHRIEKER).with(createBooleanModelMap(Properties.CAN_SUMMON, weightedVariant2, weightedVariant))
         );
   }
   ...
   private void registerCaveVines() {
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockModelDefinitionCreator.of(Blocks.CAVE_VINES_PLANT).with(createBooleanModelMap(Properties.BERRIES, weightedVariant4, weightedVariant3))
         );
   }
   ...
   public final void registerTorch(Block torch, Block wallTorch) {
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockModelDefinitionCreator.of(
                  wallTorch, createWeightedVariant(Models.TEMPLATE_TORCH_WALL.upload(wallTorch, textureMap, this.modelCollector))
               )
            ...
            VariantsBlockModelDefinitionCreator.of(Blocks.STRUCTURE_BLOCK)
               .with(
                  BlockStateVariantMap.models(Properties.STRUCTURE_BLOCK_MODE)
                     .generate(
                        mode -> createWeightedVariant(this.createSubModel(Blocks.STRUCTURE_BLOCK, "_" + mode.asString(), Models.CUBE_ALL, TextureMap::all))
                     )
               )
         );
   }
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockModelDefinitionCreator.of(Blocks.TEST_BLOCK)
               .with(BlockStateVariantMap.models(Properties.TEST_BLOCK_MODE).generate(mode -> createWeightedVariant(map.get(mode))))
         );
      this.itemModelOutput
         .accept(
            Items.TEST_BLOCK,
            ...
            VariantsBlockModelDefinitionCreator.of(Blocks.TRIPWIRE)
               .with(
                  BlockStateVariantMap.models(Properties.ATTACHED, Properties.EAST, Properties.NORTH, Properties.SOUTH, Properties.WEST)
                     ...
                     .register(
                        true, false, false, true, false, createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.TRIPWIRE, "_attached_n")).apply(ROTATE_Y_180)
                     )
                     .register(
                        true, true, false, false, false, createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.TRIPWIRE, "_attached_n")).apply(ROTATE_Y_90)
                     )
                     .register(
                        true, false, false, false, true, createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.TRIPWIRE, "_attached_n")).apply(ROTATE_Y_270)
                     )
                     .register(true, true, true, false, false, createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.TRIPWIRE, "_attached_ne")))
                     .register(
                        true, true, false, true, false, createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.TRIPWIRE, "_attached_ne")).apply(ROTATE_Y_90)
                     )
                     .register(
                        true, false, false, true, true, createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.TRIPWIRE, "_attached_ne")).apply(ROTATE_Y_180)
                     )
                     .register(
                        true, false, true, false, true, createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.TRIPWIRE, "_attached_ne")).apply(ROTATE_Y_270)
                     )
                     .register(true, false, true, true, false, createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.TRIPWIRE, "_attached_ns")))
                     .register(
                        true, true, false, false, true, createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.TRIPWIRE, "_attached_ns")).apply(ROTATE_Y_90)
                     )
                     .register(true, true, true, true, false, createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.TRIPWIRE, "_attached_nse")))
                     .register(
                        true, true, false, true, true, createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.TRIPWIRE, "_attached_nse")).apply(ROTATE_Y_90)
                     )
                     .register(
                        true, false, true, true, true, createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.TRIPWIRE, "_attached_nse")).apply(ROTATE_Y_180)
                     )
                     .register(
                        true, true, true, false, true, createWeightedVariant(ModelIds.getBlockSubModelId(Blocks.TRIPWIRE, "_attached_nse")).apply(ROTATE_Y_270)
                     )
                  ...
                  BlockStateVariantMap.models(Properties.ATTACHED, Properties.POWERED)
                     .generate(
                        (attached, on) -> createWeightedVariant(
                           ModelIds.getBlockSubModelId(Blocks.TRIPWIRE_HOOK, (attached ? "_attached" : "") + (on ? "_on" : ""))
                        )
                     )
               )
               .apply(NORTH_DEFAULT_HORIZONTAL_ROTATION_OPERATIONS)
   ...
   public final ModelVariant getTurtleEggModel(int eggs, String prefix, TextureMap textures) {
      return switch (eggs) {
         case 1 -> createModelVariant(
            Models.TEMPLATE_TURTLE_EGG.upload(ModelIds.getMinecraftNamespacedBlock(prefix + "turtle_egg"), textures, this.modelCollector)
         );
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockModelDefinitionCreator.of(Blocks.TURTLE_EGG)
               .with(
                  BlockStateVariantMap.models(Properties.EGGS, Properties.HATCH)
                     .generate((eggs, hatch) -> modelWithYRotation(this.getTurtleEggModel(eggs, hatch)))
               )
         );
   }
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockModelDefinitionCreator.of(Blocks.DRIED_GHAST)
               .with(BlockStateVariantMap.models(DriedGhastBlock.HYDRATION).generate(hydration -> createWeightedVariant(function.apply(hydration))))
               .apply(NORTH_DEFAULT_HORIZONTAL_ROTATION_OPERATIONS)
         );
   }
   ...
   public final void registerMultifaceBlockModel(Block block) {
      ...
      map.forEach((property, operator) -> {
         multipartBlockModelDefinitionCreator.with(createMultipartConditionBuilder().put((Property<Boolean>)property, true), weightedVariant.apply(operator));
   ...
   public final void registerPaleMossCarpet(Block block) {
      ...
      map.forEach((property, operator) -> multipartModelConditionBuilder.put((Property<WallShape>)property, WallShape.NONE));
      ...
      map.forEach(
         (property, operator) -> {
            multipartBlockModelDefinitionCreator.with(
               createMultipartConditionBuilder().put((Property<WallShape>)property, WallShape.TALL), weightedVariant2.apply(operator)
            );
            multipartBlockModelDefinitionCreator.with(
               createMultipartConditionBuilder().put((Property<WallShape>)property, WallShape.LOW), weightedVariant3.apply(operator)
            );
   ...
   private void registerJigsaw() {
      ...
      this.blockStateCollector
         .accept(
            VariantsBlockModelDefinitionCreator.of(
                  Blocks.JIGSAW, createWeightedVariant(Models.CUBE_DIRECTIONAL.upload(Blocks.JIGSAW, textureMap, this.modelCollector))
               )
               .apply(BlockStateVariantMap.operations(Properties.ORIENTATION).generate(BlockStateModelGenerator::addJigsawOrientationToVariant))
         );
   }
   ...
   public class BlockTexturePool {
      ...
      public BlockStateModelGenerator.BlockTexturePool button(Block buttonBlock) {
         ...
         BlockStateModelGenerator.this.blockStateCollector
            .accept(BlockStateModelGenerator.createButtonBlockState(buttonBlock, weightedVariant, weightedVariant2));
      ...
      public BlockStateModelGenerator.BlockTexturePool fence(Block fenceBlock) {
         ...
         BlockStateModelGenerator.this.blockStateCollector
            .accept(BlockStateModelGenerator.createFenceBlockState(fenceBlock, weightedVariant, weightedVariant2));
         ...
         BlockStateModelGenerator.this.blockStateCollector
            .accept(
               BlockStateModelGenerator.createFenceGateBlockState(
                  customFenceGateBlock, weightedVariant, weightedVariant2, weightedVariant3, weightedVariant4, false
               )
            );
         return this;
      }
      ...
      public BlockStateModelGenerator.BlockTexturePool fenceGate(Block fenceGateBlock) {
         ...
         BlockStateModelGenerator.this.blockStateCollector
            .accept(
               BlockStateModelGenerator.createFenceGateBlockState(fenceGateBlock, weightedVariant, weightedVariant2, weightedVariant3, weightedVariant4, true)
            );
         return this;
      }
         ...
         BlockStateModelGenerator.this.blockStateCollector
            .accept(
               BlockStateModelGenerator.createStairsBlockState(
                  block, weightedVariant, BlockStateModelGenerator.createWeightedVariant(identifier), weightedVariant2
               )
            );
         BlockStateModelGenerator.this.registerParentedItemModel(block, identifier);
         return this;
      ...
      private BlockStateModelGenerator.BlockTexturePool block(Block block) {
         TexturedModel texturedModel = BlockStateModelGenerator.TEXTURED_MODELS.getOrDefault(block, TexturedModel.CUBE_ALL.get(block));
         WeightedVariant weightedVariant = BlockStateModelGenerator.createWeightedVariant(
