                           ...
                           thirdValue -> this.fourth
                              ...
                              .forEach(
                                 fourthValue -> this.register(
                                    ...
                                    (T3)thirdValue,
                                    (T4)fourthValue,
                                    (V)variantFactory.apply(firstValue, secondValue, thirdValue, fourthValue)
                                 )
                              )
                        )
                  )
                                 ...
                                 fourthValue -> this.fifth
                                    ...
                                    .forEach(
                                       fifthValue -> this.register(
                                          ...
                                          (T4)fourthValue,
                                          (T5)fifthValue,
                                          (V)variantFactory.apply(firstValue, secondValue, thirdValue, fourthValue, fifthValue)
                                       )
                                    )
                              )
                        )
                     ...
                     secondValue -> this.third
                        ...
                        .forEach(
                           thirdValue -> this.register(
                              (T1)firstValue, (T2)secondValue, (T3)thirdValue, (V)variantFactory.apply(firstValue, secondValue, thirdValue)
                           )
                        )
                  )
            );
