...
public class RealmsPopups {
	...
	public static PopupScreen createCustomPopup(
			...
			Text title,
			Text message,
			Consumer<PopupScreen> onContinuePressed
	) {
		return new PopupScreen.Builder(parent, title)
				.message(message)
	...
	public static PopupScreen createContinuableWarningPopup(
			Screen parent,
			Text message,
			Consumer<PopupScreen> onContinuePressed
	) {
	...
	public static PopupScreen createNonContinuableWarningPopup(
			Screen parent,
			Text message,
			Consumer<PopupScreen> onOkPressed
	) {
		return new PopupScreen.Builder(parent, WARNING_TEXT)
				.message(message)
				.button(ScreenTexts.OK, onOkPressed)
				.build();
	}
}
