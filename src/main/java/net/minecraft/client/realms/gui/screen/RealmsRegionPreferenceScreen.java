...
public class RealmsRegionPreferenceScreen extends Screen {
   ...
   protected void init() {
      ...
      this.regionList
         .setSelected(this.regionList.children().stream().filter(region -> Objects.equals(region.region, this.currentRegion)).findFirst().orElse(null));
      ...
      class RegionEntry extends AlwaysSelectedEntryListWidget.Entry<RealmsRegionPreferenceScreen.RegionListWidget.RegionEntry> {
         ...
         public void render(DrawContext context, int mouseX, int mouseY, boolean hovered, float deltaTicks) {
            ...
            if (this.region.region() != null && RealmsRegionPreferenceScreen.this.availableRegions.containsKey(this.region.region())) {
               ServiceQuality serviceQuality = RealmsRegionPreferenceScreen.this.availableRegions.getOrDefault(this.region.region(), ServiceQuality.UNKNOWN);
