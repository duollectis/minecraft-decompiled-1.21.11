...
public class EndLightFlashSoundInstance extends MovingSoundInstance {
   ...
   public EndLightFlashSoundInstance(
      SoundEvent soundEvent, SoundCategory category, Random random, Camera camera, float rotationDegreesX, float rotationDegreesY
   ) {
