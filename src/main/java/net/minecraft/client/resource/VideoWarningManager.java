...
public class VideoWarningManager extends SinglePreparationResourceReloader<VideoWarningManager.WarningPatternLoader> {
	...
	protected void apply(
			VideoWarningManager.WarningPatternLoader warningPatternLoader,
	...
	protected static final class WarningPatternLoader {
		...
		WarningPatternLoader(
				List<Pattern> rendererPatterns,
				List<Pattern> versionPatterns,
				List<Pattern> vendorPatterns
		) {
