...
public class RenderPipelines {
	...
	public static final RenderPipeline.Snippet TRANSFORMS_AND_PROJECTION_SNIPPET = RenderPipeline.builder()
	                                                                                             ...
	                                                                                             .buildSnippet();
	public static final RenderPipeline.Snippet
			FOG_SNIPPET =
	...
	public static final RenderPipeline.Snippet
			...
			RenderPipeline.builder(TRANSFORMS_AND_PROJECTION_SNIPPET, FOG_SNIPPET)
			              .buildSnippet();
	public static final RenderPipeline.Snippet TRANSFORMS_PROJECTION_FOG_LIGHTING_SNIPPET = RenderPipeline.builder(
	...
	public static final RenderPipeline
			SOLID_BLOCK =
			register(RenderPipeline.builder(BLOCK_SNIPPET).withLocation("pipeline/solid_block").build());
	public static final RenderPipeline
			SOLID_TERRAIN =
			register(RenderPipeline.builder(TERRAIN_SNIPPET).withLocation("pipeline/solid_terrain").build());
	public static final RenderPipeline WIREFRAME = register(
			RenderPipeline
					.builder(TERRAIN_SNIPPET)
	...
	public static final RenderPipeline END_PORTAL = register(
			RenderPipeline
					.builder(RENDERTYPE_END_PORTAL_SNIPPET)
	...
	public static final RenderPipeline FLAT_CLOUDS = register(
			RenderPipeline
					.builder(RENDERTYPE_CLOUDS_SNIPPET)
					.withLocation("pipeline/flat_clouds")
					.withCull(false)
					.build()
	);
	public static final RenderPipeline
			CLOUDS =
			register(RenderPipeline.builder(RENDERTYPE_CLOUDS_SNIPPET).withLocation("pipeline/clouds").build());
	public static final RenderPipeline
			LINES =
			register(RenderPipeline.builder(RENDERTYPE_LINES_SNIPPET).withLocation("pipeline/lines").build());
	public static final RenderPipeline LINES_TRANSLUCENT = register(
			RenderPipeline
					.builder(RENDERTYPE_LINES_SNIPPET)
					.withDepthWrite(false)
	...
	public static final RenderPipeline
			OPAQUE_PARTICLE =
			register(RenderPipeline.builder(PARTICLE_SNIPPET).withLocation("pipeline/opaque_particle").build());
	public static final RenderPipeline TRANSLUCENT_PARTICLE = register(
			RenderPipeline
					.builder(PARTICLE_SNIPPET)
	...
	public static final RenderPipeline
			WEATHER_DEPTH =
			register(RenderPipeline.builder(WEATHER_SNIPPET).withLocation("pipeline/weather_depth_write").build());
	public static final RenderPipeline WEATHER_NO_DEPTH = register(
			RenderPipeline
					.builder(WEATHER_SNIPPET)
	...
	public static final RenderPipeline
			GUI =
			register(RenderPipeline.builder(GUI_SNIPPET).withLocation("pipeline/gui").build());
	...
	public static final RenderPipeline
			GUI_TEXTURED =
			register(RenderPipeline.builder(POSITION_TEX_COLOR_SNIPPET).withLocation("pipeline/gui_textured").build());
	...
	public static final RenderPipeline GUI_OPAQUE_TEX_BG = register(
			RenderPipeline
					.builder(POSITION_TEX_COLOR_SNIPPET)
	...
	public static final RenderPipeline
			OUTLINE_CULL =
			register(RenderPipeline.builder(RENDERTYPE_OUTLINE_SNIPPET).withLocation("pipeline/outline_cull").build());
	public static final RenderPipeline OUTLINE_NO_CULL = register(
			RenderPipeline
					.builder(RENDERTYPE_OUTLINE_SNIPPET)
					.withLocation("pipeline/outline_no_cull")
					.withCull(false)
					.build()
	);
