...
public class MinecraftClient extends ReentrantThreadExecutor<Runnable> implements WindowEventHandler {
   ...
   public MinecraftClient(RunArgs args) {
      ...
      this.gameProfileFuture = this.offlineDeveloperMode
         ...
         : CompletableFuture.supplyAsync(
            () -> this.apiServices.sessionService().fetchProfile(this.session.getUuidOrNull(), true), Util.getDownloadWorkerExecutor()
         );
   ...
   private void handleResourceReloadException(Throwable throwable, MinecraftClient.@Nullable LoadingContext loadingContext) {
   ...
   public void onResourceReloadFailure(Throwable exception, @Nullable Text resourceName, MinecraftClient.@Nullable LoadingContext loadingContext) {
   ...
   private CompletableFuture<Void> reloadResources(boolean force, MinecraftClient.@Nullable LoadingContext loadingContext) {
   ...
   public CompletableFuture<Void> reloadResourcesConcurrently() {
      return this.<CompletableFuture<Void>>submit((Supplier<CompletableFuture<Void>>) this::reloadResources).thenCompose(future -> future);
   }
