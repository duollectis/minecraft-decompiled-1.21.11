...
public class TelemetryEventType {
	...
	public static final Codec<TelemetryEventType> CODEC = Codec.STRING.comapFlatMap(
			id -> {
				...
				return telemetryEventType != null ? DataResult.success(telemetryEventType)
	...
	public static class Builder {
		...
		public TelemetryEventType build() {
			TelemetryEventType
					telemetryEventType =
					new TelemetryEventType(this.id, this.exportKey, List.copyOf(this.properties), this.optional);
