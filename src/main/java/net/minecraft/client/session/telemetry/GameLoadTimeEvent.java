...
public class GameLoadTimeEvent {
   ...
   public synchronized void startTimer(TelemetryEventProperty<GameLoadTimeEvent.Measurement> property) {
      this.addTimer(property, (Function<TelemetryEventProperty<GameLoadTimeEvent.Measurement>, Stopwatch>)(propertyx -> Stopwatch.createStarted(this.ticker)));
   }

   public synchronized void addTimer(TelemetryEventProperty<GameLoadTimeEvent.Measurement> property, Stopwatch stopwatch) {
      this.addTimer(property, (Function<TelemetryEventProperty<GameLoadTimeEvent.Measurement>, Stopwatch>)(propertyx -> stopwatch));
   }
