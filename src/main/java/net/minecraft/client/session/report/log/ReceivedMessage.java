...
/**
 * {@code ReceivedMessage}.
 */
public interface ReceivedMessage extends ChatLogEntry {

	static ReceivedMessage.ChatMessage of(
			GameProfile gameProfile,
			SignedMessage message,
			MessageTrustStatus trustStatus
	) {
	...
	public record ChatMessage(
		...
		public static final MapCodec<ReceivedMessage.ChatMessage> CHAT_MESSAGE_CODEC = RecordCodecBuilder.mapCodec(
				instance -> instance.group(
						                    ...
						                    MessageTrustStatus.CODEC
								                    ...
								                    .forGetter(ReceivedMessage.ChatMessage::trustStatus)
				                    )
		...
		private Text getFormattedTimestamp() {
			...
			return Text
					.literal(zonedDateTime.format(DATE_TIME_FORMATTER))
