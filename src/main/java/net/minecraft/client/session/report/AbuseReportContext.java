		...
		if (this.draft != null) {
			...
			client.setScreen(
					new ConfirmScreen(
							...
							Text.translatable(
									quit ? "gui.abuseReport.draft.quittotitle.title" : "gui.abuseReport.draft.title"),
							Text.translatable(quit ? "gui.abuseReport.draft.quittotitle.content"
