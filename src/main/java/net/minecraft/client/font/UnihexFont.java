   ...
   public static class Loader implements FontLoader {
      public static final MapCodec<UnihexFont.Loader> CODEC = RecordCodecBuilder.mapCodec(
         instance -> instance.group(
               ...
               UnihexFont.DimensionOverride.CODEC.listOf().optionalFieldOf("size_overrides", List.of()).forGetter(loader -> loader.overrides)
            )
            ...
            new UploadableGlyph() {
               ...
               public void upload(int x, int y, GpuTexture texture) {
                  ...
                  RenderSystem.getDevice()
                     ...
                     .writeToTexture(texture, MemoryUtil.memByteBuffer(intBuffer), NativeImage.Format.RGBA, 0, 0, x, y, UnicodeTextureGlyph.this.width(), 16);
