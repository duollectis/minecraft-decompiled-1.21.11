...
public class DebugHudEntries {
	...
	public static final Identifier
			LOOKING_AT_BLOCK =
			registerVanilla("looking_at_block", new LookingAtBlockDebugHudEntry());
	public static final Identifier
			LOOKING_AT_FLUID =
			registerVanilla("looking_at_fluid", new LookingAtFluidDebugHudEntry());
	public static final Identifier
			LOOKING_AT_ENTITY =
			registerVanilla("looking_at_entity", new LookingAtEntityDebugHudEntry());
	public static final Identifier
			CHUNK_RENDER_STATS =
			registerVanilla("chunk_render_stats", new ChunkRenderStatsDebugHudEntry());
	public static final Identifier
			CHUNK_GENERATION_STATS =
			registerVanilla("chunk_generation_stats", new ChunkGenerationStatsDebugHudEntry());
	public static final Identifier
			ENTITY_RENDER_STATS =
			registerVanilla("entity_render_stats", new EntityRenderStatsDebugHudEntry());
	public static final Identifier
			PARTICLE_RENDER_STATS =
			registerVanilla("particle_render_stats", new ParticleRenderStatsDebugHudEntry());
	public static final Identifier
			CHUNK_SOURCE_STATS =
			registerVanilla("chunk_source_stats", new ChunkSourceStatsDebugHudEntry());
	public static final Identifier
			PLAYER_POSITION =
			registerVanilla("player_position", new PlayerPositionDebugHudEntry());
	public static final Identifier
			PLAYER_SECTION_POSITION =
			registerVanilla("player_section_position", new PlayerSectionPositionDebugHudEntry());
	...
	public static final Identifier
			LOCAL_DIFFICULTY =
			registerVanilla("local_difficulty", new LocalDifficultyDebugHudEntry());
	public static final Identifier
			ENTITY_SPAWN_COUNTS =
			registerVanilla("entity_spawn_counts", new EntitySpawnCountsDebugHudEntry());
	...
	public static final Identifier
			...
			registerVanilla("3d_crosshair", new RendererDebugHudEntry());
	public static final Identifier
			CHUNK_SECTION_PATHS =
			registerVanilla("chunk_section_paths", new RendererDebugHudEntry());
	public static final Identifier
			GPU_UTILIZATION =
			registerVanilla("gpu_utilization", new GpuUtilizationDebugHudEntry());
	public static final Identifier
			SIMPLE_PERFORMANCE_IMPACTORS =
			registerVanilla("simple_performance_impactors", new SimplePerformanceImpactorsDebugHudEntry());
	public static final Identifier
			CHUNK_SECTION_OCTREE =
			registerVanilla("chunk_section_octree", new RendererDebugHudEntry());
	public static final Identifier
			VISUALIZE_WATER_LEVELS =
			registerVanilla("visualize_water_levels", new RendererDebugHudEntry());
	public static final Identifier
			VISUALIZE_HEIGHTMAP =
			registerVanilla("visualize_heightmap", new RendererDebugHudEntry());
	public static final Identifier
			VISUALIZE_COLLISION_BOXES =
			registerVanilla("visualize_collision_boxes", new RendererDebugHudEntry());
	public static final Identifier
			VISUALIZE_ENTITY_SUPPORTING_BLOCKS =
			registerVanilla("visualize_entity_supporting_blocks", new RendererDebugHudEntry());
	public static final Identifier
			VISUALIZE_BLOCK_LIGHT_LEVELS =
			registerVanilla("visualize_block_light_levels", new RendererDebugHudEntry());
	public static final Identifier
			VISUALIZE_SKY_LIGHT_LEVELS =
			registerVanilla("visualize_sky_light_levels", new RendererDebugHudEntry());
	public static final Identifier
			VISUALIZE_SOLID_FACES =
			registerVanilla("visualize_solid_faces", new RendererDebugHudEntry());
	public static final Identifier
			VISUALIZE_CHUNKS_ON_SERVER =
			registerVanilla("visualize_chunks_on_server", new RendererDebugHudEntry());
	public static final Identifier
			VISUALIZE_SKY_LIGHT_SECTIONS =
			registerVanilla("visualize_sky_light_sections", new RendererDebugHudEntry());
	public static final Identifier
			CHUNK_SECTION_VISIBILITY =
			registerVanilla("chunk_section_visibility", new RendererDebugHudEntry());
