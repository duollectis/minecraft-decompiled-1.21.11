...
public class CommandBlockScreen extends AbstractCommandBlockScreen {
   ...
   protected void addAdditionalButtons() {
      ...
      this.conditionalModeButton = this.addDrawableChild(
         CyclingButtonWidget.onOffBuilder(Text.translatable("advMode.mode.conditional"), Text.translatable("advMode.mode.unconditional"), this.conditional)
            .omitKeyText()
      ...
      this.redstoneTriggerButton = this.addDrawableChild(
         CyclingButtonWidget.onOffBuilder(
               Text.translatable("advMode.mode.autoexec.bat"), Text.translatable("advMode.mode.redstoneTriggered"), this.autoActivate
            )
            .omitKeyText()
