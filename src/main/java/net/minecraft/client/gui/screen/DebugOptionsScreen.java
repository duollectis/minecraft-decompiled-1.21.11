...
public class DebugOptionsScreen extends Screen {
   ...
   class Category extends DebugOptionsScreen.AbstractEntry {
      ...
      public void render(DrawContext context, int mouseX, int mouseY, boolean hovered, float deltaTicks) {
         context.drawCenteredTextWithShadow(
            DebugOptionsScreen.this.client.textRenderer, this.label, this.getContentX() + this.getContentWidth() / 2, this.getContentY() + 5, -1
         );
      }
   ...
   class Entry extends DebugOptionsScreen.AbstractEntry {
      ...
      public Entry(final Identifier label) {
         ...
         this.alwaysOnButton = CyclingButtonWidget.onOffBuilder(
               DebugOptionsScreen.ALWAYS_ON_TEXT.copy().withColor(-2142128), DebugOptionsScreen.ALWAYS_ON_TEXT.copy().withColor(-4539718), false
            )
            .omitKeyText()
         ...
         this.inF3Button = CyclingButtonWidget.onOffBuilder(
               DebugOptionsScreen.IN_F3_TEXT.copy().withColor(-171), DebugOptionsScreen.IN_F3_TEXT.copy().withColor(-4539718), false
            )
            .omitKeyText()
            .narration(this::getNarrationMessage)
         ...
         this.neverButton = CyclingButtonWidget.onOffBuilder(
               DebugOptionsScreen.NEVER_TEXT.copy().withColor(-1), DebugOptionsScreen.NEVER_TEXT.copy().withColor(-4539718), false
            )
            .omitKeyText()
            .narration(this::getNarrationMessage)
      ...
      public void render(DrawContext context, int mouseX, int mouseY, boolean hovered, float deltaTicks) {
         ...
         context.drawTextWithShadow(DebugOptionsScreen.this.client.textRenderer, this.renderedLabel, i, j + 5, this.canShow ? -1 : -8355712);
   ...
   public class OptionsListWidget extends ElementListWidget<DebugOptionsScreen.AbstractEntry> {
      private static final Comparator<Map.Entry<Identifier, DebugHudEntry>> ENTRY_COMPARATOR = (a, b) -> {
         int i = FloatComparators.NATURAL_COMPARATOR.compare(a.getValue().getCategory().sortKey(), b.getValue().getCategory().sortKey());
