   ...
   class DetailsScreen extends Screen {
      ...
      class PackListWidgetEntry extends AlwaysSelectedEntryListWidget.Entry<ExperimentalWarningScreen.DetailsScreen.PackListWidgetEntry> {
         ...
         public void render(DrawContext context, int mouseX, int mouseY, boolean hovered, float deltaTicks) {
            ...
            context.drawTextWithShadow(DetailsScreen.this.client.textRenderer, this.displayName, this.getContentX(), this.getContentY(), -1);
            this.multilineDetails.draw(Alignment.LEFT, this.getContentX(), this.getContentY() + 12, 9, drawnTextConsumer);
         }
