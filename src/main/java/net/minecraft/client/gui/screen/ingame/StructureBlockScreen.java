   ...
   public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
      ...
      if (structureBlockMode == StructureBlockMode.LOAD || structureBlockMode == StructureBlockMode.SAVE) {
         ...
         context.drawTextWithShadow(
            this.textRenderer, INCLUDE_ENTITIES_TEXT, this.width / 2 + 154 - this.textRenderer.getWidth(INCLUDE_ENTITIES_TEXT), 150, -6250336
         );
      }
      ...
      if (structureBlockMode == StructureBlockMode.LOAD) {
         ...
         context.drawTextWithShadow(
            this.textRenderer, SHOW_BOUNDING_BOX_TEXT, this.width / 2 + 154 - this.textRenderer.getWidth(SHOW_BOUNDING_BOX_TEXT), 70, -6250336
         );
      }
