   ...
   class SuperflatLayersListWidget extends AlwaysSelectedEntryListWidget<CustomizeFlatLevelScreen.SuperflatLayersListWidget.Entry> {
      ...
      private void refreshLayers() {
         ...
         for (int i = 0; i < list.size(); i++) {
            this.addEntry(new CustomizeFlatLevelScreen.SuperflatLayersListWidget.SuperflatLayerEntry(list.get(i), i));
         }
      }
      ...
      static class HeaderEntry extends CustomizeFlatLevelScreen.SuperflatLayersListWidget.Entry {
         ...
         public void render(DrawContext context, int mouseX, int mouseY, boolean hovered, float deltaTicks) {
            context.drawTextWithShadow(
               this.textRenderer, CustomizeFlatLevelScreen.SuperflatLayersListWidget.LAYER_MATERIAL_TEXT, this.getContentX(), this.getContentY(), -1
            );
            context.drawTextWithShadow(
               this.textRenderer,
      ...
      class SuperflatLayerEntry extends CustomizeFlatLevelScreen.SuperflatLayersListWidget.Entry {
         ...
         public void render(DrawContext context, int mouseX, int mouseY, boolean hovered, float deltaTicks) {
            ...
            context.drawTextWithShadow(
               CustomizeFlatLevelScreen.this.textRenderer, text, this.getContentRightEnd() - CustomizeFlatLevelScreen.this.textRenderer.getWidth(text), i, -1
            );
         }
