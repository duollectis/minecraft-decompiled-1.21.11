      ...
      if (!this.draws.isEmpty()) {
         ...
         RenderSystem.setProjectionMatrix(
            this.guiProjectionMatrix
               .set((float)window.getFramebufferWidth() / window.getScaleFactor(), (float)window.getFramebufferHeight() / window.getScaleFactor()),
            ...
            .forEachItemElement(
               elem -> {
                  if (elem.oversizedBounds() != null) {
                     ...
                     GuiRenderer.RenderedItem renderedItem = this.renderedItems.get(keyedItemRenderState.getModelKey());
                     if (renderedItem == null || keyedItemRenderState.isAnimated() && renderedItem.frame != this.frame) {
                        ...
                        if (!bl && this.itemAtlasY + j > k) {
                           ...
                           if (bl) {
                              ...
                              this.renderedItems
                                 .put(elem.state().getModelKey(), new GuiRenderer.RenderedItem(this.itemAtlasX, this.itemAtlasY, f, g, this.frame));
                              this.itemAtlasX += j;
                           }
                        }
                     } else {
            ...
            this.state
               .forEachItemElement(
                  elem -> {
                     if (elem.oversizedBounds() != null) {
                        KeyedItemRenderState keyedItemRenderState = elem.state();
                        OversizedItemGuiElementRenderer oversizedItemGuiElementRenderer = this.oversizedItems
