...
/**
 * {@code InventoryChangedCriterion}.
 */
public class InventoryChangedCriterion extends AbstractCriterion<InventoryChangedCriterion.Conditions> {
	...
	public record Conditions(
		...
		public static final Codec<InventoryChangedCriterion.Conditions> CODEC = RecordCodecBuilder.create(
				instance -> instance.group(
						                    EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC
								                    ...
								                    .forGetter(InventoryChangedCriterion.Conditions::player),
						                    ...
						                    ItemPredicate.CODEC
								                    ...
								                    .forGetter(InventoryChangedCriterion.Conditions::items)
				                    )
		...
		public record Slots(NumberRange.IntRange occupied, NumberRange.IntRange full, NumberRange.IntRange empty) {
			...
			public static final InventoryChangedCriterion.Conditions.Slots
					ANY =
