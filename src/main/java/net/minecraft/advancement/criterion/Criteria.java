...
/**
 * Реестр всех критериев достижений игры. Каждое поле — зарегистрированный экземпляр критерия,
 * доступный по строковому идентификатору через {@link Registries#CRITERION}.
 */
public class Criteria {
	...
	public static final PlayerGeneratesContainerLootCriterion PLAYER_GENERATES_CONTAINER_LOOT = register("player_generates_container_loot", new PlayerGeneratesContainerLootCriterion());
	public static final ThrownItemPickedUpByEntityCriterion THROWN_ITEM_PICKED_UP_BY_ENTITY = register("thrown_item_picked_up_by_entity", new ThrownItemPickedUpByEntityCriterion());
	public static final ThrownItemPickedUpByEntityCriterion THROWN_ITEM_PICKED_UP_BY_PLAYER = register("thrown_item_picked_up_by_player", new ThrownItemPickedUpByEntityCriterion());
	public static final PlayerInteractedWithEntityCriterion PLAYER_INTERACTED_WITH_ENTITY = register("player_interacted_with_entity", new PlayerInteractedWithEntityCriterion());
	public static final PlayerInteractedWithEntityCriterion PLAYER_SHEARED_EQUIPMENT = register("player_sheared_equipment", new PlayerInteractedWithEntityCriterion());
