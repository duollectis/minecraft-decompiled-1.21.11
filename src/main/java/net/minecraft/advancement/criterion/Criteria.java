...
public class Criteria {
	...
	public static final OnKilledCriterion
			PLAYER_KILLED_ENTITY =
			register("player_killed_entity", new OnKilledCriterion());
	public static final OnKilledCriterion
			ENTITY_KILLED_PLAYER =
			register("entity_killed_player", new OnKilledCriterion());
	public static final EnterBlockCriterion ENTER_BLOCK = register("enter_block", new EnterBlockCriterion());
	public static final InventoryChangedCriterion
			INVENTORY_CHANGED =
			register("inventory_changed", new InventoryChangedCriterion());
	public static final RecipeUnlockedCriterion
			RECIPE_UNLOCKED =
			register("recipe_unlocked", new RecipeUnlockedCriterion());
	public static final PlayerHurtEntityCriterion
			PLAYER_HURT_ENTITY =
			register("player_hurt_entity", new PlayerHurtEntityCriterion());
	public static final EntityHurtPlayerCriterion
			ENTITY_HURT_PLAYER =
			register("entity_hurt_player", new EntityHurtPlayerCriterion());
	public static final EnchantedItemCriterion
			ENCHANTED_ITEM =
			register("enchanted_item", new EnchantedItemCriterion());
	...
	public static final ConstructBeaconCriterion
			CONSTRUCT_BEACON =
			register("construct_beacon", new ConstructBeaconCriterion());
	public static final UsedEnderEyeCriterion USED_ENDER_EYE = register("used_ender_eye", new UsedEnderEyeCriterion());
	public static final SummonedEntityCriterion
			SUMMONED_ENTITY =
			register("summoned_entity", new SummonedEntityCriterion());
	...
	public static final CuredZombieVillagerCriterion
			CURED_ZOMBIE_VILLAGER =
			register("cured_zombie_villager", new CuredZombieVillagerCriterion());
	public static final VillagerTradeCriterion
			VILLAGER_TRADE =
			register("villager_trade", new VillagerTradeCriterion());
	public static final ItemDurabilityChangedCriterion
			ITEM_DURABILITY_CHANGED =
			register("item_durability_changed", new ItemDurabilityChangedCriterion());
	public static final LevitationCriterion LEVITATION = register("levitation", new LevitationCriterion());
	public static final ChangedDimensionCriterion
			CHANGED_DIMENSION =
			register("changed_dimension", new ChangedDimensionCriterion());
	...
	public static final EffectsChangedCriterion
			EFFECTS_CHANGED =
			register("effects_changed", new EffectsChangedCriterion());
	...
	public static final FishingRodHookedCriterion
			FISHING_ROD_HOOKED =
			register("fishing_rod_hooked", new FishingRodHookedCriterion());
	public static final ChanneledLightningCriterion
			CHANNELED_LIGHTNING =
			register("channeled_lightning", new ChanneledLightningCriterion());
	public static final ShotCrossbowCriterion SHOT_CROSSBOW = register("shot_crossbow", new ShotCrossbowCriterion());
	public static final SpearMobsCriterion SPEAR_MOBS = register("spear_mobs", new SpearMobsCriterion());
	public static final KilledByArrowCriterion
			KILLED_BY_ARROW =
			register("killed_by_arrow", new KilledByArrowCriterion());
	...
	public static final SlideDownBlockCriterion
			SLIDE_DOWN_BLOCK =
			register("slide_down_block", new SlideDownBlockCriterion());
	public static final BeeNestDestroyedCriterion
			BEE_NEST_DESTROYED =
			register("bee_nest_destroyed", new BeeNestDestroyedCriterion());
	...
	public static final DefaultBlockUseCriterion
			DEFAULT_BLOCK_USE =
			register("default_block_use", new DefaultBlockUseCriterion());
	...
	public static final PlayerInteractedWithEntityCriterion PLAYER_SHEARED_EQUIPMENT = register(
			"player_sheared_equipment", new PlayerInteractedWithEntityCriterion()
	);
	public static final StartedRidingCriterion
			STARTED_RIDING =
			register("started_riding", new StartedRidingCriterion());
	public static final LightningStrikeCriterion
			LIGHTNING_STRIKE =
			register("lightning_strike", new LightningStrikeCriterion());
	...
	public static final OnKilledCriterion
			...
			register("kill_mob_near_sculk_catalyst", new OnKilledCriterion());
	public static final ItemCriterion
			ALLAY_DROP_ITEM_ON_BLOCK =
			register("allay_drop_item_on_block", new ItemCriterion());
	public static final TickCriterion AVOID_VIBRATION = register("avoid_vibration", new TickCriterion());
	public static final RecipeCraftedCriterion
			RECIPE_CRAFTED =
			register("recipe_crafted", new RecipeCraftedCriterion());
	public static final RecipeCraftedCriterion
			CRAFTER_RECIPE_CRAFTED =
			register("crafter_recipe_crafted", new RecipeCraftedCriterion());
	public static final FallAfterExplosionCriterion
			FALL_AFTER_EXPLOSION =
			register("fall_after_explosion", new FallAfterExplosionCriterion());
