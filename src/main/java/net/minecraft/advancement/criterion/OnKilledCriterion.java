	...
	public record Conditions(
		...
		public static final Codec<OnKilledCriterion.Conditions> CODEC = RecordCodecBuilder.create(
				instance -> instance.group(
						                    EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC
								                    ...
								                    .forGetter(OnKilledCriterion.Conditions::player),
						                    EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC
								                    .optionalFieldOf("entity")
								                    .forGetter(OnKilledCriterion.Conditions::entity),
						                    DamageSourcePredicate.CODEC
								                    .optionalFieldOf("killing_blow")
								                    .forGetter(OnKilledCriterion.Conditions::killingBlow)
				                    )
		...
		public static AdvancementCriterion<OnKilledCriterion.Conditions> createPlayerKilledEntity(Optional<EntityPredicate> entity) {
			return Criteria.PLAYER_KILLED_ENTITY
					.create(new OnKilledCriterion.Conditions(
							Optional.empty(),
		...
		public static AdvancementCriterion<OnKilledCriterion.Conditions> createPlayerKilledEntity() {
			return Criteria.PLAYER_KILLED_ENTITY.create(new OnKilledCriterion.Conditions(
					Optional.empty(),
					Optional.empty(),
					Optional.empty()
			));
		...
		public static AdvancementCriterion<OnKilledCriterion.Conditions> createKillMobNearSculkCatalyst() {
			return Criteria.KILL_MOB_NEAR_SCULK_CATALYST.create(new OnKilledCriterion.Conditions(
					Optional.empty(),
					Optional.empty(),
					Optional.empty()
			));
		...
		public static AdvancementCriterion<OnKilledCriterion.Conditions> createEntityKilledPlayer() {
			return Criteria.ENTITY_KILLED_PLAYER.create(new OnKilledCriterion.Conditions(
					Optional.empty(),
					Optional.empty(),
					Optional.empty()
			));
