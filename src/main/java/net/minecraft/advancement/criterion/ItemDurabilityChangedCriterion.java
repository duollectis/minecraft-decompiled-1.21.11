...
public class ItemDurabilityChangedCriterion extends AbstractCriterion<ItemDurabilityChangedCriterion.Conditions> {
   ...
   public record Conditions(Optional<LootContextPredicate> player, Optional<ItemPredicate> item, NumberRange.IntRange durability, NumberRange.IntRange delta)
      ...
      public static AdvancementCriterion<ItemDurabilityChangedCriterion.Conditions> create(
         ...
         return Criteria.ITEM_DURABILITY_CHANGED
            .create(new ItemDurabilityChangedCriterion.Conditions(playerPredicate, item, durability, NumberRange.IntRange.ANY));
      }
