...
public class TickCriterion extends AbstractCriterion<TickCriterion.Conditions> {
	...
	public record Conditions(Optional<LootContextPredicate> player) implements AbstractCriterion.Conditions {
		...
		public static final Codec<TickCriterion.Conditions> CODEC = RecordCodecBuilder.create(
				instance -> instance
						.group(EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC
								...
								.forGetter(TickCriterion.Conditions::player))
			...
			return Criteria.LOCATION
					.create(
							new TickCriterion.Conditions(
									Optional.of(EntityPredicate.contextPredicateFromEntityPredicate(EntityPredicate.Builder
											.create()
											.location(location)))
							)
					);
		...
		public static AdvancementCriterion<TickCriterion.Conditions> createLocation(EntityPredicate.Builder entity) {
			return Criteria.LOCATION.create(new TickCriterion.Conditions(Optional.of(EntityPredicate.asLootContextPredicate(
					entity.build()))));
		}

		public static AdvancementCriterion<TickCriterion.Conditions> createLocation(Optional<EntityPredicate> entity) {
			return Criteria.LOCATION.create(new TickCriterion.Conditions(EntityPredicate.contextPredicateFromEntityPredicate(
					entity)));
		}
