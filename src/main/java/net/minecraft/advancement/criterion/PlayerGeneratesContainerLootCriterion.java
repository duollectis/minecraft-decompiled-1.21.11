...
/**
 * {@code PlayerGeneratesContainerLootCriterion}.
 */
	...
	public record Conditions(
		...
		public static final Codec<PlayerGeneratesContainerLootCriterion.Conditions> CODEC = RecordCodecBuilder.create(
				instance -> instance.group(
						                    ...
						                    LootTable.TABLE_KEY
								                    .fieldOf("loot_table")
								                    .forGetter(PlayerGeneratesContainerLootCriterion.Conditions::lootTable)
				                    )
		...
		public static AdvancementCriterion<PlayerGeneratesContainerLootCriterion.Conditions> create(RegistryKey<LootTable> registryKey) {
			return Criteria.PLAYER_GENERATES_CONTAINER_LOOT.create(new PlayerGeneratesContainerLootCriterion.Conditions(
					Optional.empty(),
					registryKey
			));
		}
