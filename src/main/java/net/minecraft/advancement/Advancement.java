...
public record Advancement(
	...
	private static final Codec<Map<String, AdvancementCriterion<?>>>
			CRITERIA_CODEC =
			                                                                                     ...
			                                                                                     .apply(
					                                                                                     ...
					                                                                                     (parent, display, rewards, criteria, requirements, sendsTelemetryEvent) -> {
						                                                                                     AdvancementRequirements
								                                                                                     advancementRequirements =
								                                                                                     requirements.orElseGet(() -> AdvancementRequirements.allOf(criteria.keySet()));
	...
	public static final PacketCodec<RegistryByteBuf, Advancement>
			PACKET_CODEC =
	...
	private static Text createNameFromDisplay(AdvancementDisplay display) {
		...
		Text
				text2 =
				Texts
						.setStyleIfAbsent(text.copy(), Style.EMPTY.withColor(formatting))
						.append("\n")
				...
				.forEach(
						(name, criterion) -> {
							LootContextPredicateValidator
									lootContextPredicateValidator =
									new LootContextPredicateValidator(
	...
	public static class Builder {
		...
		private final com.google.common.collect.ImmutableMap.Builder<String, AdvancementCriterion<?>>
				criteria =
		...
		public AdvancementEntry build(Identifier id) {
			...
			AdvancementRequirements
					advancementRequirements =
					this.requirements.orElseGet(() -> this.merger.create(map.keySet()));
