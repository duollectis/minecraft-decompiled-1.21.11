...
public class LootNumberProviderTypes {
	...
	public static final Codec<LootNumberProvider> CODEC = Codec.lazyInitialized(
			() -> {
				Codec<LootNumberProvider>
						codec =
						Codec.withAlternative(BASE_CODEC, UniformLootNumberProvider.CODEC.codec());
				return Codec.either(ConstantLootNumberProvider.INLINE_CODEC, codec)
				            .xmap(
						            Either::unwrap,
						            provider ->
								            provider instanceof ConstantLootNumberProvider constantLootNumberProvider
	...
	public static final LootNumberProviderType
			ENCHANTMENT_LEVEL =
