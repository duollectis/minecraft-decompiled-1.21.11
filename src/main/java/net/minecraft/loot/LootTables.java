...
public class LootTables {
	...
	public static final RegistryKey<LootTable>
			...
			register("chests/village/village_weaponsmith");
	...
	public static final RegistryKey<LootTable>
			...
			register("chests/village/village_cartographer");
	...
	public static final RegistryKey<LootTable>
			...
			register("chests/village/village_desert_house");
	...
	public static final RegistryKey<LootTable>
			...
			register("chests/village/village_taiga_house");
	public static final RegistryKey<LootTable>
			VILLAGE_SNOWY_HOUSE_CHEST =
			register("chests/village/village_snowy_house");
	public static final RegistryKey<LootTable>
			VILLAGE_SAVANNA_HOUSE_CHEST =
			register("chests/village/village_savanna_house");
	...
	public static final RegistryKey<LootTable>
			...
			register("chests/jungle_temple_dispenser");
	...
	public static final RegistryKey<LootTable>
			...
			register("chests/trial_chambers/reward_common");
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBERS_REWARD_RARE_CHEST =
			register("chests/trial_chambers/reward_rare");
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBERS_REWARD_UNIQUE_CHEST =
			register("chests/trial_chambers/reward_unique");
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBERS_REWARD_OMINOUS_CHEST =
			register("chests/trial_chambers/reward_ominous");
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBERS_REWARD_OMINOUS_COMMON_CHEST =
			register("chests/trial_chambers/reward_ominous_common");
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBERS_REWARD_OMINOUS_RARE_CHEST =
			register("chests/trial_chambers/reward_ominous_rare");
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBERS_REWARD_OMINOUS_UNIQUE_CHEST =
			register("chests/trial_chambers/reward_ominous_unique");
	...
	public static final RegistryKey<LootTable>
			...
			register("chests/trial_chambers/corridor");
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBERS_INTERSECTION_CHEST =
			register("chests/trial_chambers/intersection");
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBERS_INTERSECTION_BARREL_CHEST =
			register("chests/trial_chambers/intersection_barrel");
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBERS_ENTRANCE_CHEST =
			register("chests/trial_chambers/entrance");
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBERS_CORRIDOR_DISPENSER =
			register("dispensers/trial_chambers/corridor");
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBERS_CHAMBER_DISPENSER =
			register("dispensers/trial_chambers/chamber");
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBERS_WATER_DISPENSER =
			register("dispensers/trial_chambers/water");
	...
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBER_RANGED_EQUIPMENT =
			register("equipment/trial_chamber_ranged");
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBER_MELEE_EQUIPMENT =
			register("equipment/trial_chamber_melee");
	public static final Map<DyeColor, RegistryKey<LootTable>>
			SHEEP_DROPS_FROM_DYE_COLOR =
			registerAllDyeColors("entities/sheep");
	...
	public static final RegistryKey<LootTable>
			...
			register("gameplay/hero_of_the_village/butcher_gift");
	public static final RegistryKey<LootTable>
			HERO_OF_THE_VILLAGE_CARTOGRAPHER_GIFT_GAMEPLAY =
			register("gameplay/hero_of_the_village/cartographer_gift");
	public static final RegistryKey<LootTable>
			HERO_OF_THE_VILLAGE_CLERIC_GIFT_GAMEPLAY =
			register("gameplay/hero_of_the_village/cleric_gift");
	public static final RegistryKey<LootTable>
			HERO_OF_THE_VILLAGE_FARMER_GIFT_GAMEPLAY =
			register("gameplay/hero_of_the_village/farmer_gift");
	public static final RegistryKey<LootTable>
			HERO_OF_THE_VILLAGE_FISHERMAN_GIFT_GAMEPLAY =
			register("gameplay/hero_of_the_village/fisherman_gift");
	public static final RegistryKey<LootTable>
			HERO_OF_THE_VILLAGE_FLETCHER_GIFT_GAMEPLAY =
			register("gameplay/hero_of_the_village/fletcher_gift");
	public static final RegistryKey<LootTable>
			HERO_OF_THE_VILLAGE_LEATHERWORKER_GIFT_GAMEPLAY =
			register("gameplay/hero_of_the_village/leatherworker_gift");
	public static final RegistryKey<LootTable>
			HERO_OF_THE_VILLAGE_LIBRARIAN_GIFT_GAMEPLAY =
			register("gameplay/hero_of_the_village/librarian_gift");
	public static final RegistryKey<LootTable>
			HERO_OF_THE_VILLAGE_MASON_GIFT_GAMEPLAY =
			register("gameplay/hero_of_the_village/mason_gift");
	public static final RegistryKey<LootTable>
			HERO_OF_THE_VILLAGE_SHEPHERD_GIFT_GAMEPLAY =
			register("gameplay/hero_of_the_village/shepherd_gift");
	public static final RegistryKey<LootTable>
			HERO_OF_THE_VILLAGE_TOOLSMITH_GIFT_GAMEPLAY =
			register("gameplay/hero_of_the_village/toolsmith_gift");
	public static final RegistryKey<LootTable>
			HERO_OF_THE_VILLAGE_WEAPONSMITH_GIFT_GAMEPLAY =
			register("gameplay/hero_of_the_village/weaponsmith_gift");
	public static final RegistryKey<LootTable>
			HERO_OF_THE_VILLAGE_UNEMPLOYED_GIFT_GAMEPLAY =
			register("gameplay/hero_of_the_village/unemployed_gift");
	public static final RegistryKey<LootTable>
			HERO_OF_THE_VILLAGE_BABY_GIFT_GAMEPLAY =
			register("gameplay/hero_of_the_village/baby_gift");
	...
	public static final RegistryKey<LootTable> TURTLE_GROW_GAMEPLAY = register("gameplay/turtle_grow");
	public static final RegistryKey<LootTable> CAVE_VINE_HARVEST = register("harvest/cave_vine");
	public static final RegistryKey<LootTable> SWEET_BERRY_BUSH_HARVEST = register("harvest/sweet_berry_bush");
	public static final RegistryKey<LootTable> BEEHIVE_HARVEST = register("harvest/beehive");
	public static final RegistryKey<LootTable> PUMPKIN_CARVE = register("carve/pumpkin");
	...
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBER_CONSUMABLES_SPAWNER =
			register("spawners/trial_chamber/consumables");
	public static final RegistryKey<LootTable>
			OMINOUS_TRIAL_CHAMBER_KEY_SPAWNER =
			register("spawners/ominous/trial_chamber/key");
	public static final RegistryKey<LootTable>
			OMINOUS_TRIAL_CHAMBER_CONSUMABLES_SPAWNER =
			register("spawners/ominous/trial_chamber/consumables");
	public static final RegistryKey<LootTable>
			TRIAL_CHAMBER_ITEMS_TO_DROP_WHEN_OMINOUS_SPAWNER =
			register("spawners/trial_chamber/items_to_drop_when_ominous");
	public static final RegistryKey<LootTable> ARMADILLO_BRUSH = register("brush/armadillo");
	...
	public static final Map<DyeColor, RegistryKey<LootTable>>
			SHEEP_SHEARING_FROM_DYE_COLOR =
			registerAllDyeColors("shearing/sheep");
	public static final RegistryKey<LootTable> ROOT_CHARGED_CREEPER = register("charged_creeper/root");
	public static final RegistryKey<LootTable> PIGLIN_CHARGED_CREEPER = register("charged_creeper/piglin");
	public static final RegistryKey<LootTable> CREEPER_CHARGED_CREEPER = register("charged_creeper/creeper");
	public static final RegistryKey<LootTable> SKELETON_CHARGED_CREEPER = register("charged_creeper/skeleton");
	public static final RegistryKey<LootTable>
			WITHER_SKELETON_CHARGED_CREEPER =
			register("charged_creeper/wither_skeleton");
	public static final RegistryKey<LootTable> ZOMBIE_CHARGED_CREEPER = register("charged_creeper/zombie");
	...
	public static final RegistryKey<LootTable>
			...
			register("archaeology/trail_ruins_common");
