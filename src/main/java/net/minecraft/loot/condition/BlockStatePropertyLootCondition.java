...
public record BlockStatePropertyLootCondition(RegistryEntry<Block> block, Optional<StatePredicate> properties) implements LootCondition {
   ...
   public static final MapCodec<BlockStatePropertyLootCondition> CODEC = (MapCodec<BlockStatePropertyLootCondition>) RecordCodecBuilder.<BlockStatePropertyLootCondition>mapCodec(
      ...
      .validate(condition -> BlockStatePropertyLootCondition.validateHasProperties((BlockStatePropertyLootCondition) condition));
