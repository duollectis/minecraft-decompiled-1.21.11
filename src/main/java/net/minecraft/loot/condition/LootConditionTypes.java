...
public class LootConditionTypes {
	...
	public static final LootConditionType
			ENTITY_PROPERTIES =
			register("entity_properties", EntityPropertiesLootCondition.CODEC);
	public static final LootConditionType
			KILLED_BY_PLAYER =
			register("killed_by_player", KilledByPlayerLootCondition.CODEC);
	public static final LootConditionType ENTITY_SCORES = register("entity_scores", EntityScoresLootCondition.CODEC);
	public static final LootConditionType
			BLOCK_STATE_PROPERTY =
			register("block_state_property", BlockStatePropertyLootCondition.CODEC);
	...
	public static final LootConditionType
			SURVIVES_EXPLOSION =
			register("survives_explosion", SurvivesExplosionLootCondition.CODEC);
	public static final LootConditionType
			DAMAGE_SOURCE_PROPERTIES =
			register("damage_source_properties", DamageSourcePropertiesLootCondition.CODEC);
	...
	public static final LootConditionType
			...
			register("enchantment_active_check", EnchantmentActiveCheckLootCondition.CODEC);
