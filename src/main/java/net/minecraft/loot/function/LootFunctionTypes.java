...
public class LootFunctionTypes {
	...
	public static final Codec<LootFunction>
			CODEC =
			Codec.lazyInitialized(() -> Codec.withAlternative(BASE_CODEC, AndLootFunction.INLINE_CODEC));
	public static final Codec<RegistryEntry<LootFunction>>
			ENTRY_CODEC =
	...
	public static final LootFunctionType<DiscardLootFunction> DISCARD = register("discard", DiscardLootFunction.CODEC);
