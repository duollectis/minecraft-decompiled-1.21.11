...
public interface LootEntityValueSource<R> {
   ...
   public static final class Builder<R> {
      ...
      public <T extends StringIdentifiable & LootEntityValueSource<? extends R>> LootEntityValueSource.Builder<R> addEntityReferences(T[] values) {
         return this.addEnum(values, value -> LootEntityValueSource.cast((LootEntityValueSource<? extends R>)value));
      }
      ...
      public LootEntityValueSource.Builder<R> forEntities(
         ...
         return this.addEnum(LootContext.EntityReference.values(), reference -> sourceFactory.apply(reference.contextParam()));
      }
      ...
      public LootEntityValueSource.Builder<R> forBlockEntities(
         ...
         return this.addEnum(LootContext.BlockEntityReference.values(), reference -> sourceFactory.apply(reference.contextParam()));
      }
      ...
      public LootEntityValueSource.Builder<R> forItemStacks(
         ...
         return this.addEnum(LootContext.ItemStackReference.values(), reference -> sourceFactory.apply(reference.contextParam()));
      }
