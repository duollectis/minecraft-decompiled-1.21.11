...
/** Реестр всех стандартных типов контекста таблиц лута с их наборами параметров. */
public class LootContextTypes {

	private static final BiMap<Identifier, ContextType> MAP = HashBiMap.create();

	public static final Codec<ContextType> CODEC = Identifier.CODEC.comapFlatMap(
		id -> Optional.ofNullable((ContextType) MAP.get(id))
			.<DataResult<ContextType>>map(DataResult::success)
	...
	public static final ContextType CHEST = register(
		"chest",
		builder -> builder.require(LootContextParameters.ORIGIN).allow(LootContextParameters.THIS_ENTITY)
	);
	...
	public static final ContextType SELECTOR = register(
		"selector",
		builder -> builder.require(LootContextParameters.ORIGIN).require(LootContextParameters.THIS_ENTITY)
	);
	...
	public static final ContextType GIFT = register(
		"gift",
		builder -> builder.require(LootContextParameters.ORIGIN).require(LootContextParameters.THIS_ENTITY)
	);
	public static final ContextType BARTER = register(
		"barter",
	...
	public static final ContextType ENTITY_INTERACT = register(
		"entity_interact",
		builder -> builder
			.require(LootContextParameters.TARGET_ENTITY)
			.allow(LootContextParameters.INTERACTING_ENTITY)
			.require(LootContextParameters.TOOL)
	);
	public static final ContextType BLOCK_INTERACT = register(
		"block_interact",
		builder -> builder
			.require(LootContextParameters.BLOCK_STATE)
			.allow(LootContextParameters.BLOCK_ENTITY)
	...
	public static final ContextType ENCHANTED_ITEM = register(
		"enchanted_item",
		builder -> builder.require(LootContextParameters.TOOL).require(LootContextParameters.ENCHANTMENT_LEVEL)
	);
	...
	private static ContextType register(String name, Consumer<ContextType.Builder> configurator) {
		...
		ContextType existing = MAP.put(id, contextType);
