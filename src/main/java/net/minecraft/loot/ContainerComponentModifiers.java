...
public interface ContainerComponentModifiers {
   ...
   Map<ComponentType<?>, ContainerComponentModifier<?>> TYPE_TO_MODIFIER = Stream.of(CONTAINER, BUNDLE_CONTENTS, CHARGED_PROJECTILES)
      .collect(
         Collectors.toMap(ContainerComponentModifier::getComponentType, containerComponentModifier -> (ContainerComponentModifier<?>)containerComponentModifier)
      );
