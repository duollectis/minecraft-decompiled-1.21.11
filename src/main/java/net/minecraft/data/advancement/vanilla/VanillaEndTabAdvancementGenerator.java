...
/**
 * {@code VanillaEndTabAdvancementGenerator}.
 */
public class VanillaEndTabAdvancementGenerator implements AdvancementTabGenerator {
	...
	public void accept(RegistryWrapper.WrapperLookup registries, Consumer<AdvancementEntry> exporter) {
		...
		AdvancementEntry advancementEntry = Advancement.Builder.create()
		                                                       ...
		                                                       .criterion(
				                                                       "entered_end",
				                                                       ChangedDimensionCriterion.Conditions.to(World.END)
		                                                       )
		...
		AdvancementEntry advancementEntry3 = Advancement.Builder.create()
		                                                        ...
		                                                        .criterion(
				                                                        "entered_end_gateway",
				                                                        EnterBlockCriterion.Conditions.block(Blocks.END_GATEWAY)
		                                                        )
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   ...
				                   SummonedEntityCriterion.Conditions.create(EntityPredicate.Builder
						                   .create()
						                   .type(registryEntryLookup, EntityType.ENDER_DRAGON))
		                   )
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   "levitated",
				                   LevitationCriterion.Conditions.create(DistancePredicate.y(NumberRange.DoubleRange.atLeast(
						                   50.0)))
		                   )
