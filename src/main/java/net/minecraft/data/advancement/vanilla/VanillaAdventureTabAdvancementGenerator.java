...
/**
 * {@code VanillaAdventureTabAdvancementGenerator}.
 */
public class VanillaAdventureTabAdvancementGenerator implements AdvancementTabGenerator {
	...
	private static AdvancementCriterion<LightningStrikeCriterion.Conditions> createLightningStrike(
	...
	private static AdvancementCriterion<UsingItemCriterion.Conditions> createLookingAtEntityUsing(
			EntityPredicate.Builder lookingAt,
			ItemPredicate.Builder using
	) {
		return UsingItemCriterion.Conditions.create(
				EntityPredicate.Builder
						.create()
						.typeSpecific(PlayerPredicate.Builder.create().lookingAt(lookingAt).build()), using
		);
	}
	...
	public void accept(RegistryWrapper.WrapperLookup registries, Consumer<AdvancementEntry> exporter) {
		...
		AdvancementEntry advancementEntry2 = Advancement.Builder.create()
		                                                        ...
		                                                        .criterion(
				                                                        "slept_in_bed",
				                                                        TickCriterion.Conditions.createSleptInBed()
		                                                        )
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   ...
				                   VillagerTradeCriterion.Conditions.create(
						                   EntityPredicate.Builder
								                   .create()
								                   .location(LocationPredicate.Builder.createY(NumberRange.DoubleRange.atLeast(
										                   319.0)))
				                   )
		                   )
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   "struck_villager",
				                   ChanneledLightningCriterion.Conditions.create(EntityPredicate.Builder
						                   .create()
						                   .type(registryWrapper, EntityType.VILLAGER))
		                   )
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   "summoned_golem",
				                   SummonedEntityCriterion.Conditions.create(EntityPredicate.Builder
						                   .create()
						                   .type(registryWrapper, EntityType.IRON_GOLEM))
		                   )
		                   ...
		                   .criterion(
				                   ...
				                   OnKilledCriterion.Conditions.createPlayerKilledEntity(
						                   EntityPredicate.Builder.create()
						                                          ...
						                                          .distance(DistancePredicate.horizontal(NumberRange.DoubleRange.atLeast(
								                                          50.0))),
						                   DamageSourcePredicate.Builder
								                   .create()
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   "used_totem",
				                   UsedTotemCriterion.Conditions.create(registryWrapper2, Items.TOTEM_OF_UNDYING)
		                   )
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion("spear_many_mobs", SpearMobsCriterion.Conditions.create(5))
		...
		AdvancementEntry advancementEntry7 = Advancement.Builder.create()
		                                                        ...
		                                                        .criterion(
				                                                        "shot_crossbow",
				                                                        ShotCrossbowCriterion.Conditions.create(
						                                                        registryWrapper2,
						                                                        Items.CROSSBOW
				                                                        )
		                                                        )
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   ...
				                   KilledByArrowCriterion.Conditions.createCrossbow(
						                   registryWrapper2,
						                   EntityPredicate.Builder.create().type(registryWrapper, EntityType.PILLAGER)
				                   )
		                   )
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   ...
				                   KilledByArrowCriterion.Conditions.createCrossbow(
						                   registryWrapper2,
						                   NumberRange.IntRange.exactly(5)
				                   )
		                   )
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   "honey_block_slide",
				                   SlideDownBlockCriterion.Conditions.create(Blocks.HONEY_BLOCK)
		                   )
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   ...
				                   createLightningStrike(
						                   NumberRange.IntRange.exactly(0),
						                   Optional.of(EntityPredicate.Builder
								                   .create()
								                   .type(registryWrapper, EntityType.VILLAGER)
								                   .build())
				                   )
		                   ...
		                   .criterion(
				                   ...
				                   ItemCriterion.Conditions.createItemUsedOnBlock(
						                   LocationPredicate.Builder.create()
						                                            .biome(RegistryEntryList.of(registries
								                                            .getOrThrow(RegistryKeys.BIOME)
								                                            .getOrThrow(BiomeKeys.MEADOW)))
						                                            .block(BlockPredicate.Builder
								                                            .create()
								                                            .blocks(registryWrapper3, Blocks.JUKEBOX)),
						                   ItemPredicate.Builder.create()
						                                        .components(ComponentsPredicate.Builder
								                                        .create()
								                                        .partial(
										                                        ComponentPredicateTypes.JUKEBOX_PLAYABLE,
										                                        JukeboxPlayablePredicate.empty()
								                                        )
								                                        .build())
				                   )
		                   )
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   ...
				                   createLookingAtEntityUsing(
						                   EntityPredicate.Builder
								                   .create()
								                   .type(registryWrapper, EntityType.ENDER_DRAGON),
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   ...
				                   TravelCriterion.Conditions.fallFromHeight(
						                   EntityPredicate.Builder
								                   .create()
								                   .location(LocationPredicate.Builder.createY(NumberRange.DoubleRange.atMost(
										                   -59.0))),
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   ...
				                   OnKilledCriterion.Conditions.createKillMobNearSculkCatalyst()
		                   )
		...
		Advancement.Builder.create()
		                   ...
		                   .display(
				                   DecoratedPotBlockEntity.getStackWith(
						                   new Sherds(
								                   Optional.empty(),
								                   Optional.of(Items.HEART_POTTERY_SHERD),
								                   Optional.empty(),
								                   Optional.of(Items.EXPLORER_POTTERY_SHERD)
						                   )
				                   ),
				                   Text.translatable(
		                   ...
		                   .criterion(
				                   ...
				                   RecipeCraftedCriterion.Conditions.create(
						                   ...
						                   List.of(
								                   ItemPredicate.Builder
										                   .create()
										                   .tag(registryWrapper2, ItemTags.DECORATED_POT_SHERDS),
								                   ItemPredicate.Builder
										                   .create()
										                   .tag(registryWrapper2, ItemTags.DECORATED_POT_SHERDS),
								                   ItemPredicate.Builder
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   "chiseled_bookshelf",
				                   requirePlacedBlockReadByComparator(registryWrapper3, Blocks.CHISELED_BOOKSHELF)
		                   )
		                   .criterion(
				                   "comparator",
				                   requirePlacedComparatorReadingBlock(registryWrapper3, Blocks.CHISELED_BOOKSHELF)
		                   )
		                   ...
		                   .criterion(
				                   ...
				                   PlayerInteractedWithEntityCriterion.Conditions.create(
						                   ...
						                   Optional.of(EntityPredicate.contextPredicateFromEntityPredicate(
								                   EntityPredicate.Builder
										                   .create()
										                   .type(registryWrapper, EntityType.ARMADILLO)))
				                   )
		                   )
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   ...
				                   ItemCriterion.Conditions.createItemUsedOnBlock(
						                   ...
						                   ItemPredicate.Builder
								                   .create()
								                   .items(registryWrapper2, Items.OMINOUS_TRIAL_KEY)
				                   )
		                   )
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   ...
				                   RecipeCraftedCriterion.Conditions.createCrafterRecipeCrafted(RegistryKey.of(
						                   RegistryKeys.RECIPE,
		                   ...
		                   .criterion(
				                   ...
				                   ItemCriterion.Conditions.createItemUsedOnBlock(
						                   LocationPredicate.Builder
								                   ...
								                   .block(BlockPredicate.Builder
										                   .create()
										                   .blocks(registryWrapper3, Blocks.LODESTONE)),
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   ...
				                   FallAfterExplosionCriterion.Conditions.create(
						                   DistancePredicate.y(NumberRange.DoubleRange.atLeast(7.0)),
						                   EntityPredicate.Builder
								                   .create()
								                   .type(registryWrapper, EntityType.WIND_CHARGE)
				                   )
		                   )
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   ...
				                   ItemCriterion.Conditions.createPlacedWithState(
						                   Blocks.CREAKING_HEART,
		                   ...
		                   .criterion(
				                   "place_pale_oak_log",
				                   requirePlacedPaleOakLog(registryWrapper3, BlockTags.PALE_OAK_LOGS)
		                   )
	...
	private static AdvancementCriterion<ItemCriterion.Conditions> requirePlacedBlockReadByComparator(
		...
		LootCondition.Builder[] builders = ComparatorBlock.FACING.getValues().stream().map(facing -> {
			...
			BlockPredicate.Builder
					builder2 =
					BlockPredicate.Builder.create().blocks(blockRegistry, Blocks.COMPARATOR).state(builder);
			return LocationCheckLootCondition.builder(
					LocationPredicate.Builder.create().block(builder2),
					new BlockPos(facing.getOpposite().getVector())
			);
		}).toArray(LootCondition.Builder[]::new);
		return ItemCriterion.Conditions.createPlacedBlock(
				BlockStatePropertyLootCondition.builder(block),
				AnyOfLootCondition.builder(builders)
		);
	}
				...
				.map(
						facing -> {
							StatePredicate.Builder
									builder =
									StatePredicate.Builder.create().exactMatch(ComparatorBlock.FACING, facing);
							BlockStatePropertyLootCondition.Builder
									builder2 =
									new BlockStatePropertyLootCondition.Builder(Blocks.COMPARATOR).properties(builder);
							LootCondition.Builder builder3 = LocationCheckLootCondition.builder(
									LocationPredicate.Builder
											.create()
											.block(BlockPredicate.Builder.create().blocks(blockRegistry, block)),
		                                         ...
		                                         .map(
				                                         direction -> {
					                                         ...
					                                         BlockPredicate.Builder
							                                         ...
							                                         BlockPredicate.Builder
									                                         .create()
									                                         .tag(blockRegistry, paleOakLogBlocks)
									                                         .state(builder);
	...
	private static Advancement.Builder requireTrimmedArmor(Advancement.Builder builder) {
		...
		VanillaRecipeGenerator.streamSmithingTemplates()
		                      ...
		                      .forEach(
				                      template -> builder.criterion(
						                      "armor_trimmed_" + template.getValue(),
						                      RecipeCraftedCriterion.Conditions.create((RegistryKey<Recipe<?>>) template)
				                      )
		                      );
		return builder;
	}

	private static Advancement.Builder requireSalvagedSherd(
		...
		builder.criterion(
				"has_sherd",
				InventoryChangedCriterion.Conditions.items(ItemPredicate.Builder
						.create()
						.tag(itemRegistry, ItemTags.DECORATED_POT_SHERDS))
		);
		builder.requirements(new AdvancementRequirements(List.of(
				list.stream().<String>map(Pair::getFirst).toList(),
				List.of("has_sherd")
		)));
		return builder;
	}
	...
	protected static void buildAdventuringTime(
		...
		requireListedBiomesVisited(
				Advancement.Builder.create(),
				registries,
				biomeSourceListPreset.biomeStream().toList()
		)
				.parent(parent)
				.display(
						Items.DIAMOND_BOOTS,
	...
	private static Advancement.Builder requireListedMobsKilled(
		...
		entityTypes.forEach(
				entityType -> builder.criterion(
						...
						OnKilledCriterion.Conditions.createPlayerKilledEntity(EntityPredicate.Builder
								.create()
								.type(entityTypeRegistry, (EntityType<?>) entityType))
				)
		);
		return builder;
	}
	...
	protected static Advancement.Builder requireListedBiomesVisited(
		...
		for (RegistryKey<Biome> registryKey : biomes) {
			builder.criterion(
					...
					TickCriterion.Conditions.createLocation(LocationPredicate.Builder.createBiome(registryEntryLookup.getOrThrow(
							registryKey)))
			);
		}
	...
	private static List<EntityType<?>> validateKillAllMobsTypeList(
