...
/**
 * {@code VanillaNetherTabAdvancementGenerator}.
 */
public class VanillaNetherTabAdvancementGenerator implements AdvancementTabGenerator {
	...
	public void accept(RegistryWrapper.WrapperLookup registries, Consumer<AdvancementEntry> exporter) {
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   "travelled",
				                   TravelCriterion.Conditions.netherTravel(DistancePredicate.horizontal(NumberRange.DoubleRange.atLeast(
						                   7000.0)))
		                   )
		                   ...
		                   .criterion(
				                   ...
				                   OnKilledCriterion.Conditions.createPlayerKilledEntity(
						                   EntityPredicate.Builder.create()
						                                          ...
						                                          .location(LocationPredicate.Builder.createDimension(
								                                          World.OVERWORLD))
				                   )
		                   )
		...
		AdvancementEntry advancementEntry7 = Advancement.Builder.create()
		                                                        ...
		                                                        .criterion(
				                                                        "beacon",
				                                                        ConstructBeaconCriterion.Conditions.level(
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   "beacon",
				                   ConstructBeaconCriterion.Conditions.level(NumberRange.IntRange.exactly(4))
		                   )
		                   ...
		                   .criterion(
				                   ...
				                   EffectsChangedCriterion.Conditions.create(
						                   EntityEffectPredicate.Builder.create()
						                                                ...
						                                                .addEffect(StatusEffects.BREATH_OF_THE_NAUTILUS)
				                   )
		                   )
		...
		VanillaAdventureTabAdvancementGenerator.requireListedBiomesVisited(
				                                       Advancement.Builder.create(),
				                                       registries,
				                                       MultiNoiseBiomeSourceParameterList.Preset.NETHER.biomeStream().toList()
		                                       )
		                                       .parent(advancementEntry12)
		                                       .display(
				                                       Items.NETHERITE_BOOTS,
		...
		Advancement.Builder.create()
		                   ...
		                   .criterion(
				                   "loot_bastion_other",
				                   PlayerGeneratesContainerLootCriterion.Conditions.create(LootTables.BASTION_OTHER_CHEST)
		                   )
		                   .criterion(
				                   "loot_bastion_treasure",
				                   PlayerGeneratesContainerLootCriterion.Conditions.create(LootTables.BASTION_TREASURE_CHEST)
		                   )
		                   .criterion(
				                   "loot_bastion_hoglin_stable",
				                   PlayerGeneratesContainerLootCriterion.Conditions.create(LootTables.BASTION_HOGLIN_STABLE_CHEST)
		                   )
		                   .criterion(
				                   "loot_bastion_bridge",
				                   PlayerGeneratesContainerLootCriterion.Conditions.create(LootTables.BASTION_BRIDGE_CHEST)
		                   )
				                   ...
				                   ThrownItemPickedUpByEntityCriterion.Conditions.createThrownItemPickedUpByEntity(
						                   ...
						                   Optional.of(
								                   EntityPredicate.contextPredicateFromEntityPredicate(
										                   EntityPredicate.Builder
												                   .create()
												                   .type(registryEntryLookup, EntityType.PIGLIN)
