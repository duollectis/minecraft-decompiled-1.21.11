         ...
         .forEach(
            (unwaxed, waxed) -> {
               if (waxed.getRequiredFeatures().isSubsetOf(enabledFeatures)) {
                  Pair<RecipeCategory, String> pair = (Pair<RecipeCategory, String>)HoneycombItem.WAXED_RECIPE_GROUPS
                     .getOrDefault(waxed, Pair.of(RecipeCategory.BUILDING_BLOCKS, getItemPath(waxed)));
