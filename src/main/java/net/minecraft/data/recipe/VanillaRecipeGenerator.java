...
public class VanillaRecipeGenerator extends RecipeGenerator {
   ...
   public void generate() {
      ...
      CookingRecipeJsonBuilder.createSmelting(
         ...
         .criterion("has_golden_nautilus_armor", this.conditionsFromItem(Items.GOLDEN_NAUTILUS_ARMOR))
      ...
      CookingRecipeJsonBuilder.createSmelting(
         ...
         .criterion("has_copper_nautilus_armor", this.conditionsFromItem(Items.COPPER_NAUTILUS_ARMOR))
      ...
      CookingRecipeJsonBuilder.createSmelting(
         ...
         .criterion("has_iron_nautilus_armor", this.conditionsFromItem(Items.IRON_NAUTILUS_ARMOR))
