...
public class VanillaRecipeGenerator extends RecipeGenerator {
	...
	public void generate() {
		...
		this.createShaped(RecipeCategory.DECORATIONS, Blocks.CHEST)
		    ...
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.DECORATIONS, Blocks.COPPER_CHEST)
		    .input('#', Items.COPPER_INGOT)
		    .input('X', Items.CHEST)
		    .pattern("###")
		    .pattern("#X#")
		    .pattern("###")
		    .criterion("has_copper_chest", this.conditionsFromItem(Items.COPPER_CHEST))
		    .offerTo(this.exporter);
		...
		this.createShaped(RecipeCategory.COMBAT, Items.DIAMOND_SWORD)
		    ...
		    .criterion("has_diamond", this.conditionsFromTag(ItemTags.DIAMOND_TOOL_MATERIALS))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.COMBAT, Items.DIAMOND_SPEAR)
		    .input('#', Items.STICK)
		    .input('X', ItemTags.DIAMOND_TOOL_MATERIALS)
		    .pattern("  X")
		    .pattern(" # ")
		...
		this.createShaped(RecipeCategory.COMBAT, Items.GOLDEN_SWORD)
		    ...
		    .criterion("has_gold_ingot", this.conditionsFromTag(ItemTags.GOLD_TOOL_MATERIALS))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.COMBAT, Items.GOLDEN_SPEAR)
		    .input('#', Items.STICK)
		    .input('X', ItemTags.GOLD_TOOL_MATERIALS)
		    .pattern("  X")
		    .pattern(" # ")
		...
		this.createShaped(RecipeCategory.DECORATIONS, Blocks.IRON_BARS, 16)
		    ...
		    .criterion("has_iron_ingot", this.conditionsFromItem(Items.IRON_INGOT))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.DECORATIONS, Blocks.COPPER_BARS.unaffected(), 16)
		    .input('#', Items.COPPER_INGOT)
		    .pattern("###")
		    .pattern("###")
		...
		this.createShaped(RecipeCategory.COMBAT, Items.IRON_SWORD)
		    ...
		    .criterion("has_iron_ingot", this.conditionsFromTag(ItemTags.IRON_TOOL_MATERIALS))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.COMBAT, Items.IRON_SPEAR)
		    .input('#', Items.STICK)
		    .input('X', ItemTags.IRON_TOOL_MATERIALS)
		    .pattern("  X")
		    .pattern(" # ")
		...
		this.createShaped(RecipeCategory.MISC, Items.LEATHER_HORSE_ARMOR)
		    ...
		    .criterion("has_leather", this.conditionsFromItem(Items.LEATHER))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.COMBAT, Items.SADDLE)
		    .input('X', Items.LEATHER)
		    .input('#', Items.IRON_INGOT)
		    .pattern(" X ")
		    .pattern("X#X")
		...
		this.createShaped(RecipeCategory.TOOLS, Items.COPPER_AXE)
		    .input('#', Items.STICK)
		    .input('X', ItemTags.COPPER_TOOL_MATERIALS)
		    .pattern("XX")
		    .pattern("X#")
		    .pattern(" #")
		    .criterion("has_copper_ingot", this.conditionsFromTag(ItemTags.COPPER_TOOL_MATERIALS))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.TOOLS, Items.COPPER_HOE)
		    .input('#', Items.STICK)
		    .input('X', ItemTags.COPPER_TOOL_MATERIALS)
		    .pattern("XX")
		    .pattern(" #")
		    ...
		    .criterion("has_copper_ingot", this.conditionsFromTag(ItemTags.COPPER_TOOL_MATERIALS))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.TOOLS, Items.COPPER_PICKAXE)
		    .input('#', Items.STICK)
		    .input('X', ItemTags.COPPER_TOOL_MATERIALS)
		    .pattern("XXX")
		    .pattern(" # ")
		    ...
		    .criterion("has_copper_ingot", this.conditionsFromTag(ItemTags.COPPER_TOOL_MATERIALS))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.TOOLS, Items.COPPER_SHOVEL)
		    .input('#', Items.STICK)
		    .input('X', ItemTags.COPPER_TOOL_MATERIALS)
		    .pattern("X")
		    .pattern("#")
		...
		this.createShaped(RecipeCategory.COMBAT, Items.COPPER_SWORD)
		    ...
		    .criterion("has_copper_ingot", this.conditionsFromTag(ItemTags.COPPER_TOOL_MATERIALS))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.COMBAT, Items.COPPER_SPEAR)
		    .input('#', Items.STICK)
		    .input('X', ItemTags.COPPER_TOOL_MATERIALS)
		    .pattern("  X")
		    .pattern(" # ")
		    ...
		    .criterion("has_copper_ingot", this.conditionsFromTag(ItemTags.COPPER_TOOL_MATERIALS))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.COMBAT, Items.COPPER_BOOTS)
		    .input('X', Items.COPPER_INGOT)
		    .pattern("X X")
		    .pattern("X X")
		    .criterion("has_copper_ingot", this.conditionsFromItem(Items.COPPER_INGOT))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.COMBAT, Items.COPPER_CHESTPLATE)
		    .input('X', Items.COPPER_INGOT)
		    .pattern("X X")
		    .pattern("XXX")
		    .pattern("XXX")
		    .criterion("has_copper_ingot", this.conditionsFromItem(Items.COPPER_INGOT))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.COMBAT, Items.COPPER_HELMET)
		    .input('X', Items.COPPER_INGOT)
		    .pattern("XXX")
		    .pattern("X X")
		    .criterion("has_copper_ingot", this.conditionsFromItem(Items.COPPER_INGOT))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.COMBAT, Items.COPPER_LEGGINGS)
		    .input('X', Items.COPPER_INGOT)
		    .pattern("XXX")
		    .pattern("X X")
		    .pattern("X X")
		...
		this.createShaped(RecipeCategory.COMBAT, Items.STONE_SWORD)
		    ...
		    .criterion("has_cobblestone", this.conditionsFromTag(ItemTags.STONE_TOOL_MATERIALS))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.COMBAT, Items.STONE_SPEAR)
		    .input('#', Items.STICK)
		    .input('X', ItemTags.STONE_TOOL_MATERIALS)
		    .pattern("  X")
		    .pattern(" # ")
		...
		this.createShaped(RecipeCategory.DECORATIONS, Blocks.SOUL_TORCH, 4)
		    ...
		    .criterion("has_soul_sand", this.conditionsFromTag(ItemTags.SOUL_FIRE_BASE_BLOCKS))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.DECORATIONS, Blocks.COPPER_TORCH, 4)
		    .input('X', Ingredient.ofItems(Items.COAL, Items.CHARCOAL))
		    .input('#', Items.STICK)
		    ...
		    .pattern("X")
		    .pattern("#")
		    .criterion("has_copper_nugget", this.conditionsFromItem(Items.COPPER_NUGGET))
		    .offerTo(this.exporter);
		...
		this.createShaped(RecipeCategory.DECORATIONS, Blocks.SOUL_LANTERN)
		    ...
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.DECORATIONS, Blocks.COPPER_LANTERNS.unaffected())
		    .input('#', Items.COPPER_TORCH)
		    .input('X', Items.COPPER_NUGGET)
		    .pattern("XXX")
		    .pattern("X#X")
		    .pattern("XXX")
		    .criterion("has_copper_torch", this.conditionsFromItem(Items.COPPER_TORCH))
		    .offerTo(this.exporter);
		...
		this.createShaped(RecipeCategory.COMBAT, Items.WOODEN_SWORD)
		    ...
		    .criterion("has_stick", this.conditionsFromItem(Items.STICK))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.COMBAT, Items.WOODEN_SPEAR)
		    .input('#', Items.STICK)
		    .input('X', ItemTags.WOODEN_TOOL_MATERIALS)
		    .pattern("  X")
		    .pattern(" # ")
		...
		this.createShaped(RecipeCategory.DECORATIONS, Blocks.IRON_CHAIN)
		    ...
		    .criterion("has_iron_ingot", this.conditionsFromItem(Items.IRON_INGOT))
		    .offerTo(this.exporter);
		this.createShaped(RecipeCategory.DECORATIONS, Blocks.COPPER_CHAINS.unaffected())
		...
		CookingRecipeJsonBuilder
				.createSmelting(
						this.ingredientFromTag(ItemTags.LOGS_THAT_BURN),
						RecipeCategory.MISC,
						Items.CHARCOAL,
						0.15F,
						200
		...
		CookingRecipeJsonBuilder.createSmelting(
				                        this.ingredientFromTag(ItemTags.SMELTS_TO_GLASS),
				                        RecipeCategory.BUILDING_BLOCKS,
				                        Blocks.GLASS.asItem(),
				                        0.1F,
				                        200
		...
		CookingRecipeJsonBuilder.createSmelting(
		                        ...
		                        .criterion("has_golden_spear", this.conditionsFromItem(Items.GOLDEN_SPEAR))
		                        ...
		                        .criterion(
				                        ...
				                        this.conditionsFromItem(Items.GOLDEN_NAUTILUS_ARMOR)
		                        )
		...
		CookingRecipeJsonBuilder.createSmelting(
		                        ...
		                        .criterion("has_copper_pickaxe", this.conditionsFromItem(Items.COPPER_PICKAXE))
		                        .criterion("has_copper_shovel", this.conditionsFromItem(Items.COPPER_SHOVEL))
		                        .criterion("has_copper_axe", this.conditionsFromItem(Items.COPPER_AXE))
		                        .criterion("has_copper_hoe", this.conditionsFromItem(Items.COPPER_HOE))
		                        .criterion("has_copper_sword", this.conditionsFromItem(Items.COPPER_SWORD))
		                        .criterion("has_copper_spear", this.conditionsFromItem(Items.COPPER_SPEAR))
		                        .criterion("has_copper_helmet", this.conditionsFromItem(Items.COPPER_HELMET))
		                        .criterion("has_copper_chestplate", this.conditionsFromItem(Items.COPPER_CHESTPLATE))
		                        .criterion("has_copper_leggings", this.conditionsFromItem(Items.COPPER_LEGGINGS))
		                        .criterion("has_copper_boots", this.conditionsFromItem(Items.COPPER_BOOTS))
		                        .criterion("has_copper_horse_armor", this.conditionsFromItem(Items.COPPER_HORSE_ARMOR))
		                        .criterion(
				                        "has_copper_nautilus_armor",
				                        this.conditionsFromItem(Items.COPPER_NAUTILUS_ARMOR)
		                        )
		                        .offerTo(this.exporter, getSmeltingItemPath(Items.COPPER_NUGGET));
		CookingRecipeJsonBuilder.createSmelting(
				                        Ingredient.ofItems(
						                        Items.IRON_PICKAXE,
						                        Items.IRON_SHOVEL,
		                        ...
		                        .criterion("has_iron_spear", this.conditionsFromItem(Items.IRON_SPEAR))
		                        ...
		                        .criterion(
				                        ...
				                        this.conditionsFromItem(Items.CHAINMAIL_CHESTPLATE)
		                        )
		                        ...
		                        .criterion(
				                        ...
				                        this.conditionsFromItem(Items.IRON_NAUTILUS_ARMOR)
		                        )
		...
		CookingRecipeJsonBuilder.createSmelting(
		                        ...
		                        .criterion(
				                        ...
				                        this.conditionsFromItem(Blocks.LIGHT_BLUE_TERRACOTTA)
		                        )
		                        .offerTo(this.exporter);
		CookingRecipeJsonBuilder.createSmelting(
		                        ...
		                        .criterion(
				                        ...
				                        this.conditionsFromItem(Blocks.LIGHT_GRAY_TERRACOTTA)
		                        )
		                        .offerTo(this.exporter);
		CookingRecipeJsonBuilder.createSmelting(
		...
		CookingRecipeJsonBuilder
				.createSmelting(
						this.ingredientFromTag(ItemTags.LEAVES),
						RecipeCategory.MISC,
						Blocks.LEAF_LITTER,
						0.1F,
						200
		...
		CookingRecipeJsonBuilder.createBlasting(
		                        ...
		                        .offerTo(this.exporter, getBlastingItemPath(Items.COPPER_NUGGET));
		CookingRecipeJsonBuilder.createBlasting(
				                        Ingredient.ofItems(
						                        Items.IRON_PICKAXE,
						                        Items.IRON_SHOVEL,
		...
		StonecuttingRecipeJsonBuilder.createStonecutting(
		                             ...
		                             .criterion(
				                             ...
				                             this.conditionsFromItem(Blocks.PRISMARINE_BRICKS)
		                             )
		...
		StonecuttingRecipeJsonBuilder.createStonecutting(
		                             ...
		                             .criterion(
				                             ...
				                             this.conditionsFromItem(Blocks.MOSSY_STONE_BRICKS)
		                             )
		                             .offerTo(
				                             this.exporter,
		...
		streamSmithingTemplates().forEach(template -> this.offerSmithingTrimRecipe(
				template.template(),
				template.patternId(),
				template.recipeId()
		));
		...
		this.offerNetheriteUpgradeRecipe(
		...
		this.offerSmithingTemplateCopyingRecipe(
		...
		this.offerWaxedChiseledCopperRecipe(
				Blocks.WAXED_WEATHERED_CHISELED_COPPER,
				Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB
		);
		this.offerWaxedChiseledCopperRecipe(
