                     ...
                     AlternativeEntry.builder(
                        AlternativeEntry.builder(
                              ...
                              layers -> ItemEntry.builder(Items.SNOWBALL)
                                 .conditionally(
                                    BlockStatePropertyLootCondition.builder(block)
                                       .properties(StatePredicate.Builder.create().exactMatch(SnowBlock.LAYERS, layers.intValue()))
                                 )
            ...
            LootPool.builder()
               ...
               .with(
                  DynamicEntry.builder(DecoratedPotBlock.SHERDS_DYNAMIC_DROP_ID)
                     ...
                     .alternatively(
                        ItemEntry.builder(block)
                           .apply(CopyComponentsLootFunction.blockEntity(LootContextParameters.BLOCK_ENTITY).include(DataComponentTypes.POT_DECORATIONS))
                     )
               )
         );
   }
