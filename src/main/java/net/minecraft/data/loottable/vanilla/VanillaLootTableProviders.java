   ...
   public static LootTableProvider createVanillaProvider(DataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
      return new LootTableProvider(
         ...
         List.of(
            ...
            new LootTableProvider.LootTypeGenerator(VanillaBrushLootTableGenerator::new, LootContextTypes.ENTITY_INTERACT),
            new LootTableProvider.LootTypeGenerator(VanillaHarvestLootTableGenerator::new, LootContextTypes.BLOCK_INTERACT),
            new LootTableProvider.LootTypeGenerator(VanillaChargedCreeperLootTableGenerator::new, LootContextTypes.ENTITY)
         ),
         registriesFuture
      );
   }
