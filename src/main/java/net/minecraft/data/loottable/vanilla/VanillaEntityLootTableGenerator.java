                        ...
                        .conditionally(
                           EntityPropertiesLootCondition.builder(
                              ...
                              EntityPredicate.Builder.create()
                                 .vehicle(EntityPredicate.Builder.create().type(EntityTypePredicate.create(registryEntryLookup, EntityType.CAMEL_HUSK)))
                                 .build()
                           )
                        )
                  )
                  ...
                  .with(
                     ItemEntry.builder(Items.MAGMA_CREAM)
                        ...
                        .conditionally(
                           EntityPropertiesLootCondition.builder(
                              LootContext.EntityReference.THIS,
                              EntityPredicate.Builder.create().typeSpecific(SlimePredicate.of(NumberRange.IntRange.atLeast(2)))
                           )
                        )
                  )
                  .with(
         ...
         LootTable.builder()
            .pool(
               LootPool.builder()
                  ...
                  .conditionally(KilledByPlayerLootCondition.builder())
                  .conditionally(RandomChanceWithEnchantedBonusLootCondition.builder(this.registries, 0.05F, 0.01F))
            )
      );
         ...
         LootTable.builder()
            .pool(
               LootPool.builder()
                  ...
                  .conditionally(
                     EntityPropertiesLootCondition.builder(
                        LootContext.EntityReference.THIS, EntityPredicate.Builder.create().typeSpecific(RaiderPredicate.CAPTAIN_WITHOUT_RAID)
                     )
                  )
            )
      );
         ...
         LootTable.builder()
            .pool(
               LootPool.builder()
                  ...
                  .conditionally(
                     EntityPropertiesLootCondition.builder(
                        LootContext.EntityReference.THIS, EntityPredicate.Builder.create().typeSpecific(SlimePredicate.of(NumberRange.IntRange.exactly(1)))
                     )
                  )
            )
      );
                     ...
                     ItemEntry.builder(Items.RED_MUSHROOM)
                        ...
                        .conditionally(
                           EntityPropertiesLootCondition.builder(
                              LootContext.EntityReference.THIS,
                              EntityPredicate.Builder.create()
                                 .vehicle(EntityPredicate.Builder.create().type(EntityTypePredicate.create(registryEntryLookup, EntityType.ZOMBIE_HORSE)))
                                 .build()
                           )
                        )
                  )
                  ...
                  .conditionally(
                     EntityPropertiesLootCondition.builder(
                        ...
                        EntityPredicate.Builder.create()
                           ...
                           .vehicle(EntityPredicate.Builder.create().type(registryEntryLookup, EntityType.CHICKEN))
                     )
                  )
            )
      );
