...
/**
 * {@code VanillaFishingLootTableGenerator}.
 */
				...
				LootTable.builder()
				         .pool(
						         LootPool.builder()
						                 ...
						                 .with(LootTableEntry
								                 .builder(LootTables.FISHING_JUNK_GAMEPLAY)
								                 .weight(10)
								                 .quality(-2))
						                 .with(
								                               ...
								                               .conditionally(
										                               EntityPropertiesLootCondition.builder(
												                               ...
												                               EntityPredicate.Builder
														                               .create()
														                               .typeSpecific(
																                               FishingHookPredicate.of(
																		                               true))
										                               )
								                               )
						                 )
						                 .with(LootTableEntry
								                 .builder(LootTables.FISHING_FISH_GAMEPLAY)
								                 .weight(85)
								                 .quality(-1))
				         )
		);
				         ...
				         .pool(
						         LootPool.builder()
						                 ...
						                 .with(ItemEntry
								                 ...
								                 .weight(10)
								                 .apply(SetDamageLootFunction.builder(UniformLootNumberProvider.create(
										                 0.0F,
										                 0.9F
								                 ))))
