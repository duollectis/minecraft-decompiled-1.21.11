...
public record VanillaGiftLootTableGenerator(RegistryWrapper.WrapperLookup registries) implements LootTableGenerator {
   ...
   public void accept(BiConsumer<RegistryKey<LootTable>, LootTable.Builder> lootTableBiConsumer) {
                                       ...
                                       ComponentsPredicate.Builder.create()
                                          .exact(
                                             ComponentMapPredicate.of(
                                                ...
                                                new LazyRegistryEntryReference<>(registryEntryLookup.getOrThrow(ChickenVariants.TEMPERATE))
                                             )
                                          )
                                          .build()
                                    )
                                    ...
                                    .components(
                                       ComponentsPredicate.Builder.create()
                                          .exact(
                                             ComponentMapPredicate.of(
                                                DataComponentTypes.CHICKEN_VARIANT,
                                                new LazyRegistryEntryReference<>(registryEntryLookup.getOrThrow(ChickenVariants.WARM))
                                             )
                                          )
                                          .build()
                                    )
                                    ...
                                    .components(
                                       ComponentsPredicate.Builder.create()
                                          .exact(
                                             ComponentMapPredicate.of(
                                                DataComponentTypes.CHICKEN_VARIANT,
                                                new LazyRegistryEntryReference<>(registryEntryLookup.getOrThrow(ChickenVariants.COLD))
                                             )
                                          )
                                          .build()
                                    )
      ...
      lootTableBiConsumer.accept(
         LootTables.TURTLE_GROW_GAMEPLAY,
         LootTable.builder().pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0F)).with(ItemEntry.builder(Items.TURTLE_SCUTE)))
      );
   }
}
