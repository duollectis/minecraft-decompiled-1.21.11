         ...
         LootTable.builder()
            ...
            .pool(
               LootPool.builder()
                  ...
                  .with(ItemEntry.builder(Items.IRON_SPEAR))
            )
            .pool(
               LootPool.builder()
            ...
            .pool(
               LootPool.builder()
                  .rolls(ConstantLootNumberProvider.create(1.0F))
                  .with(EmptyEntry.builder().weight(148))
                  .with(ItemEntry.builder(Items.COPPER_NAUTILUS_ARMOR).weight(20).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
                  .with(ItemEntry.builder(Items.IRON_NAUTILUS_ARMOR).weight(10).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
                  .with(ItemEntry.builder(Items.GOLDEN_NAUTILUS_ARMOR).weight(5).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
                  .with(ItemEntry.builder(Items.DIAMOND_NAUTILUS_ARMOR).weight(2).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
            )
      );
      ...
      lootTableBiConsumer.accept(
         ...
         LootTable.builder()
            .pool(
               LootPool.builder()
                  .rolls(UniformLootNumberProvider.create(1.0F, 3.0F))
                  .with(ItemEntry.builder(Items.LEATHER).weight(20).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 5.0F))))
                  ...
                  .with(ItemEntry.builder(Items.COPPER_HORSE_ARMOR).weight(15))
         ...
         LootTable.builder()
            .pool(
               LootPool.builder()
                  ...
                  .with(ItemEntry.builder(Items.GOLD_NUGGET).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 3.0F))))
                  .with(ItemEntry.builder(Items.EMERALD))
                  .with(ItemEntry.builder(Items.STONE_SPEAR).weight(2))
                  .with(ItemEntry.builder(Items.WHEAT).weight(10).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 3.0F))))
            )
            .pool(
               LootPool.builder()
         ...
         LootTable.builder()
            .pool(
               LootPool.builder()
                  ...
                  .with(ItemEntry.builder(Items.IRON_SPEAR).weight(5))
                  .with(ItemEntry.builder(Items.COPPER_SPEAR).weight(7))
      ...
      return LootTable.builder()
         .pool(
            LootPool.builder()
               ...
               .with(ItemEntry.builder(Items.COPPER_HORSE_ARMOR).weight(5))
      ...
      return LootTable.builder()
         ...
         .pool(
            LootPool.builder()
               ...
               .with(ItemEntry.builder(Blocks.IRON_CHAIN).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0F, 10.0F))))
      ...
      return LootTable.builder()
         .pool(
            LootPool.builder()
               ...
               .with(ItemEntry.builder(Items.LEATHER).weight(3).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1.0F, 5.0F))))
               .with(ItemEntry.builder(Items.COPPER_HORSE_ARMOR))
               .with(ItemEntry.builder(Items.IRON_HORSE_ARMOR))
               .with(ItemEntry.builder(Items.GOLDEN_HORSE_ARMOR))
               .with(ItemEntry.builder(Items.DIAMOND_HORSE_ARMOR))
