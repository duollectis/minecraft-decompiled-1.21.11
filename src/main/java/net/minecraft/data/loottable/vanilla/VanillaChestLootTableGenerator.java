...
/**
 * {@code VanillaChestLootTableGenerator}.
 */
public record VanillaChestLootTableGenerator(RegistryWrapper.WrapperLookup registries) implements LootTableGenerator {
	...
	public void accept(BiConsumer<RegistryKey<LootTable>, LootTable.Builder> lootTableBiConsumer) {
		...
		lootTableBiConsumer.accept(
				...
				this.createBastionHoglinStableChestTableBuilder()
		);
				...
				LootTable.builder()
				         ...
				         .pool(
						         LootPool.builder()
						                 ...
						                 .with(ItemEntry
								                 .builder(Items.COOKED_COD)
								                 .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(
										                 2.0F,
										                 4.0F
								                 ))))
						                 .with(ItemEntry
								                 .builder(Items.COOKED_SALMON)
								                 .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(
										                 2.0F,
										                 4.0F
								                 ))))
				         ...
				         .pool(
						         LootPool.builder()
						                 ...
						                 .with(ItemEntry
								                 .builder(Items.COPPER_NAUTILUS_ARMOR)
								                 .weight(20)
								                 .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(
										                 1.0F))))
						                 .with(ItemEntry
								                 .builder(Items.IRON_NAUTILUS_ARMOR)
								                 .weight(10)
								                 .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(
										                 1.0F))))
						                 .with(ItemEntry
								                 .builder(Items.GOLDEN_NAUTILUS_ARMOR)
								                 .weight(5)
								                 .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(
										                 1.0F))))
						                 .with(ItemEntry
								                 .builder(Items.DIAMOND_NAUTILUS_ARMOR)
								                 .weight(2)
								                 .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(
										                 1.0F))))
				         )
		...
		lootTableBiConsumer.accept(
				...
				this.createShipwreckTreasureChestTableBuilder()
		);
		lootTableBiConsumer.accept(
		...
		lootTableBiConsumer.accept(
				...
				this.createStrongholdCorridorChestTableBuilder()
		);
		lootTableBiConsumer.accept(
		...
		lootTableBiConsumer.accept(
				...
				this.createStrongholdLibraryChestTableBuilder()
		);
		lootTableBiConsumer.accept(
				...
				LootTable.builder()
				         .pool(
						         LootPool.builder()
						                 ...
						                 .with(ItemEntry
								                 .builder(Blocks.LIGHT_GRAY_WOOL)
								                 .weight(2)
								                 .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(
										                 1.0F,
										                 3.0F
				         ...
				         .pool(
						         LootPool.builder()
						                 ...
						                 .with(ItemEntry
								                 ...
								                 .weight(5))
						                 .with(ItemEntry
								                 .builder(Items.EMERALD_BLOCK)
								                 .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(
										                 1.0F)))
								                 .weight(5))
						                 .with(ItemEntry
								                 .builder(Items.DIAMOND_BLOCK)
								                 .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(
										                 1.0F)))
								                 .weight(1))
				         )
				...
				LootTable.builder()
				         .pool(
						         LootPool.builder()
						                 ...
						                 .with(
								                 ItemEntry
										                 .builder(Items.BAMBOO_HANGING_SIGN)
										                 .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(
												                 1.0F,
												                 4.0F
										                 )))
				...
				LootTable.builder()
				         .pool(
						         LootPool.builder()
						                 .rolls(ConstantLootNumberProvider.create(1.0F))
						                 .with(LootTableEntry
								                 .builder(LootTables.TRIAL_CHAMBERS_REWARD_RARE_CHEST)
								                 .weight(8))
						                 .with(LootTableEntry
								                 .builder(LootTables.TRIAL_CHAMBERS_REWARD_COMMON_CHEST)
								                 .weight(2))
				         )
				         .pool(
						         LootPool.builder()
				...
				LootTable.builder()
				         .pool(
						         LootPool.builder()
						                 .rolls(ConstantLootNumberProvider.create(1.0F))
						                 .with(LootTableEntry
								                 .builder(LootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_RARE_CHEST)
								                 .weight(8))
						                 .with(LootTableEntry
								                 .builder(LootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_COMMON_CHEST)
								                 .weight(2))
				         )
				         .pool(
						         LootPool.builder()
		...
		lootTableBiConsumer.accept(
				...
				LootTable
						...
						.pool(LootPool
								.builder()
								.rolls(ConstantLootNumberProvider.create(1.0F))
								.with(ItemEntry.builder(Items.TRIAL_KEY)))
		);
		lootTableBiConsumer.accept(
		...
		return LootTable.builder()
		                ...
		                .pool(
				                LootPool.builder()
				                        ...
				                        .with(ItemEntry
						                        .builder(Blocks.GLOWSTONE)
						                        .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(
								                        3.0F,
								                        6.0F
						                        ))))
				                        .with(ItemEntry
						                        .builder(Blocks.GILDED_BLACKSTONE)
						                        .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(
								                        2.0F,
								                        5.0F
						                        ))))
				                        .with(ItemEntry
						                        .builder(Blocks.SOUL_SAND)
						                        .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(
								                        2.0F,
								                        7.0F
						                        ))))
				                        .with(ItemEntry
						                        .builder(Blocks.CRIMSON_NYLIUM)
						                        .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(
								                        2.0F,
								                        7.0F
						                        ))))
				                        ...
				                        .with(ItemEntry
						                        .builder(Items.COOKED_PORKCHOP)
						                        .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(
								                        2.0F,
								                        5.0F
						                        ))))
				                        .with(ItemEntry
						                        .builder(Blocks.CRIMSON_FUNGUS)
						                        .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(
								                        2.0F,
								                        7.0F
						                        ))))
				                        .with(ItemEntry
						                        .builder(Blocks.CRIMSON_ROOTS)
						                        .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(
								                        2.0F,
								                        7.0F
						                        ))))
		...
		return LootTable.builder()
		                .pool(
				                LootPool.builder()
				                        .rolls(ConstantLootNumberProvider.create(3.0F))
				                        .with(ItemEntry
						                        .builder(Items.NETHERITE_INGOT)
						                        .weight(15)
						                        .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(
								                        1.0F))))
				                        .with(ItemEntry
						                        .builder(Blocks.ANCIENT_DEBRIS)
						                        .weight(10)
						                        .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(
								                        1.0F))))
				                        .with(ItemEntry
				                        ...
				                        .with(ItemEntry
						                        .builder(Items.ENCHANTED_GOLDEN_APPLE)
						                        .weight(2)
						                        .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(
								                        1.0F))))
		                )
		...
		return LootTable.builder()
		                .pool(
				                LootPool.builder()
				                        ...
				                        .with(ItemEntry
						                        .builder(Items.PIGLIN_BANNER_PATTERN)
						                        .weight(9)
						                        .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(
								                        1.0F))))
				                        .with(ItemEntry
						                        .builder(Items.MUSIC_DISC_PIGSTEP)
						                        .weight(5)
						                        .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(
								                        1.0F))))
				                        .with(ItemEntry
		...
		return LootTable.builder()
		                .pool(
				                LootPool.builder()
				                        ...
				                        .with(ItemEntry
						                        .builder(Items.COMPASS)
						                        .weight(2)
						                        .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(
								                        1.0F))))
				                        .with(ItemEntry
						                        .builder(Items.SCULK_CATALYST)
						                        .weight(2)
						                        .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(
								                        1.0F,
								                        2.0F
				                        ...
				                        .with(ItemEntry
						                        ...
						                        .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(
								                        1.0F))))
				                        .with(ItemEntry
						                        .builder(Items.DIAMOND_HORSE_ARMOR)
						                        .weight(2)
						                        .apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(
								                        1.0F))))
				                        .with(ItemEntry
				                        ...
				                        .with(ItemEntry
						                        .builder(Items.EXPERIENCE_BOTTLE)
						                        .weight(3)
						                        .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(
								                        1.0F,
								                        3.0F
