         ...
         LootTable.builder()
            .pool(
               LootPool.builder()
                  ...
                  .with(
                     LootTableEntry.builder(createEquipmentTableBuilder(Items.CHAINMAIL_HELMET, Items.CHAINMAIL_CHESTPLATE, armorTrim2, impl3).build())
                        .weight(4)
                  )
                     ...
                     ItemEntry.builder(Items.IRON_SWORD)
                        .apply(
                           new SetEnchantmentsLootFunction.Builder()
                              .enchantment(impl3.getOrThrow(Enchantments.SHARPNESS), ConstantLootNumberProvider.create(1.0F))
                        )
                  )
                  .with(
                     ItemEntry.builder(Items.IRON_SWORD)
                        .apply(
                           new SetEnchantmentsLootFunction.Builder()
                              .enchantment(impl3.getOrThrow(Enchantments.KNOCKBACK), ConstantLootNumberProvider.create(1.0F))
                        )
                  )
               ...
               LootPool.builder()
                  ...
                  .with(
                     ItemEntry.builder(Items.BOW)
                        .apply(
                           new SetEnchantmentsLootFunction.Builder().enchantment(impl3.getOrThrow(Enchantments.POWER), ConstantLootNumberProvider.create(1.0F))
                        )
                  )
                  .with(
                     ItemEntry.builder(Items.BOW)
                        .apply(
                           new SetEnchantmentsLootFunction.Builder().enchantment(impl3.getOrThrow(Enchantments.PUNCH), ConstantLootNumberProvider.create(1.0F))
                        )
                  )
            )
      );
