...
public class VanillaGameEventTagProvider extends SimpleTagProvider<GameEvent> {
   @VisibleForTesting
   ...
   protected void configure(RegistryWrapper.WrapperLookup registries) {
      this.builder(GameEventTags.VIBRATIONS).add(BASIC_GAME_EVENTS).add(Vibrations.RESONATIONS).add(GameEvent.FLAP.registryKey());
