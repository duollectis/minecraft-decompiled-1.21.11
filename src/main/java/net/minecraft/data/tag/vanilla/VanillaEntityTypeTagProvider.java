...
public class VanillaEntityTypeTagProvider extends ValueLookupTagProvider<EntityType<?>> {
	...
	protected void configure(RegistryWrapper.WrapperLookup registries) {
		...
		this
				.builder(EntityTypeTags.AXOLOTL_ALWAYS_HOSTILES)
				.add(EntityType.DROWNED, EntityType.GUARDIAN, EntityType.ELDER_GUARDIAN);
		this
				.builder(EntityTypeTags.FREEZE_IMMUNE_ENTITY_TYPES)
