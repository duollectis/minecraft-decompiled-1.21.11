...
public abstract class VanillaBlockItemTags {
	...
	protected void configure() {
		...
		this
				.builder(BlockTags.STONE_BUTTONS, ItemTags.STONE_BUTTONS)
				.add(Blocks.STONE_BUTTON, Blocks.POLISHED_BLACKSTONE_BUTTON);
		this
		...
		this
				.builder(BlockTags.BAMBOO_BLOCKS, ItemTags.BAMBOO_BLOCKS)
		...
		this
				.builder(BlockTags.LOGS, ItemTags.LOGS)
		...
		this
				.builder(BlockTags.DAMPENS_VIBRATIONS, ItemTags.DAMPENS_VIBRATIONS)
