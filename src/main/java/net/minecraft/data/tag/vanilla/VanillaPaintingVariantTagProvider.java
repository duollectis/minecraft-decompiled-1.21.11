...
/**
 * {@code VanillaPaintingVariantTagProvider}.
 */
public class VanillaPaintingVariantTagProvider extends SimpleTagProvider<PaintingVariant> {

	public VanillaPaintingVariantTagProvider(
			DataOutput output,
