...
/**
 * Реестр всех семейств блоков ванильного Майнкрафта.
 * Каждое семейство описывает базовый блок и его производные варианты (ступени, плиты, заборы и т.д.).
 * Используется генераторами рецептов и моделей для автоматического создания данных по всем вариантам.
 */
public class BlockFamilies {
	...
	public static final BlockFamily BRICK = register(Blocks.BRICKS)
	...
	public static final BlockFamily PURPUR = register(Blocks.PURPUR_BLOCK)
	...
	public static final BlockFamily SMOOTH_QUARTZ = register(Blocks.SMOOTH_QUARTZ)
	...
	public static final BlockFamily CUT_SANDSTONE = register(Blocks.CUT_SANDSTONE)
	...
	public static final BlockFamily CUT_RED_SANDSTONE = register(Blocks.CUT_RED_SANDSTONE)
	...
	/**
	 * Регистрирует базовый блок в реестре семейств и возвращает {@link BlockFamily.Builder} для дальнейшей настройки.
	 * Выбрасывает {@link IllegalStateException}, если для данного блока семейство уже зарегистрировано.
	 */
	public static BlockFamily.Builder register(Block baseBlock) {
		BlockFamily.Builder builder = new BlockFamily.Builder(baseBlock);
		BlockFamily existing = BASE_BLOCKS_TO_FAMILIES.put(baseBlock, builder.build());
