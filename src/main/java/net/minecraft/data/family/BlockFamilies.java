...
public class BlockFamilies {
	...
	public static final BlockFamily BAMBOO = register(Blocks.BAMBOO_PLANKS)
			...
			.unlockCriterionName("has_planks")
			.build();
	public static final BlockFamily
			BAMBOO_MOSAIC =
			register(Blocks.BAMBOO_MOSAIC).slab(Blocks.BAMBOO_MOSAIC_SLAB).stairs(Blocks.BAMBOO_MOSAIC_STAIRS).build();
	...
	public static final BlockFamily
			BRICK =
			register(Blocks.BRICKS).wall(Blocks.BRICK_WALL).stairs(Blocks.BRICK_STAIRS).slab(Blocks.BRICK_SLAB).build();
	...
	public static final BlockFamily
			COPPER_BLOCK =
			register(Blocks.COPPER_BLOCK).cut(Blocks.CUT_COPPER).noGenerateModels().build();
	...
	public static final BlockFamily
			EXPOSED_COPPER =
			register(Blocks.EXPOSED_COPPER).cut(Blocks.EXPOSED_CUT_COPPER).noGenerateModels().build();
	...
	public static final BlockFamily
			WEATHERED_COPPER =
			register(Blocks.WEATHERED_COPPER).cut(Blocks.WEATHERED_CUT_COPPER).noGenerateModels().build();
	...
	public static final BlockFamily
			OXIDIZED_COPPER =
			register(Blocks.OXIDIZED_COPPER).cut(Blocks.OXIDIZED_CUT_COPPER).noGenerateModels().build();
	...
	public static final BlockFamily
			SMOOTH_QUARTZ =
			register(Blocks.SMOOTH_QUARTZ).stairs(Blocks.SMOOTH_QUARTZ_STAIRS).slab(Blocks.SMOOTH_QUARTZ_SLAB).build();
	...
	public static final BlockFamily
			CUT_SANDSTONE =
			register(Blocks.CUT_SANDSTONE).slab(Blocks.CUT_SANDSTONE_SLAB).build();
	...
	public static final BlockFamily
			CUT_RED_SANDSTONE =
			register(Blocks.CUT_RED_SANDSTONE).slab(Blocks.CUT_RED_SANDSTONE_SLAB).build();
